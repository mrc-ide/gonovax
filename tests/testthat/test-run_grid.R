...
test_that("run_grid works as expected", {
  ...
  y <- run_grid(n = 2, t = 2, eff = c(0, 1), dur = c(1, 2), ve = 0.5,
                       full_output = TRUE)
  expect_equal(y$eff0.00_dur01$inc_incid, matrix(0, 2, 2), tolerance = 0.1)
  expect_equal(y$eff0.00_dur02$inc_incid, y$eff0.00_dur01$inc_incid,
               tolerance = 0.1)
  expect_true(all(unlist(y$inc_incid$eff0.10_dur01) > -0.1))
  expect_equal(y$eff0.00_dur01$inc_cum_incid,  matrix(0, 2, 2), tolerance = 0.1)
  expect_equal(y$eff0.00_dur02$inc_cum_incid,  matrix(0, 2, 2), tolerance = 0.1)
  ...
  expect_equal(y2$eff0.00_dur01$inc_incid, matrix(0, 2, 2), tolerance = 0.1)
  expect_equal(y2$eff0.00_dur02$inc_incid, y2$eff0.00_dur01$inc_incid,
               tolerance = 0.1)
  expect_true(all(unlist(y2$inc_incid) > -0.1))
  expect_equal(y2$eff0.00_dur01$inc_cum_incid, matrix(0, 2, 2), tolerance = 0.1)
  ...
  expect_equal(y3$eff0.00_dur01$inc_incid, matrix(0, 2, 2), tolerance = 0.1)
  expect_equal(y3$eff0.00_dur02$inc_incid, y3$eff0.00_dur01$inc_incid,
               tolerance = 0.1)
  expect_true(all(unlist(y3$inc_incid) > -0.1))
  expect_equal(y3$eff0.00_dur01$inc_cum_incid, matrix(0, 2, 2), tolerance = 0.1)
  ...
  expect_equal(y5$eff0.00_dur01$inc_incid, matrix(0, 2, 2), tolerance = 0.1)
  expect_equal(y5$eff0.00_dur02$inc_incid, y5$eff0.00_dur01$inc_incid,
               tolerance = 0.1)
  expect_true(all(unlist(y5$inc_incid) > -0.1))
  expect_equal(y5$eff0.00_dur01$inc_cum_incid, matrix(0, 2, 2), tolerance = 0.1)
  ...
  y4 <- run_grid(n = 2, t = 2, eff = c(0, 1), dur = c(1, 2), ve = 0.5,
                        baseline = y0)
  expect_equivalent(y4, y[-6], tolerance = 0.1)
