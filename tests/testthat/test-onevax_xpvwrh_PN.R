...
test_that("run_onevax_xpvwrh works correctly", {
  tt <- seq(0, 5)
  gp <- gono_params(1:2)
  y1 <- run_onevax_xpvwrh(tt, gp, vea = 0, dur_v = 1e3, PN = "yes")[[1]]
  ...
  y2 <- run_onevax_xpvwrh(tt, gp, vea = 0, dur_v = 1e10, vbe = 1, PN = "yes")
  ...
  y2.1 <- run_onevax_xpvwrh(tt, gp, vea = 0, dur_v = 1e3, vbe = 1, hes = 0.5, PN = "yes")
  ...
  y_h <- run_onevax_xpvwrh(tt, gp, vea = 0, dur_v = 1e3, vbe = 1, hes = 0.3, PN = "yes")
  ...
  y_h2 <- run_onevax_xpvwrh(tt, gp, vea = 0, dur_v = 1e3, vbe = 0, hes = 0.3, PN = "yes")
  ...
  y_h3 <- run_onevax_xpvwrh(tt, gp, vea = 0, dur_v = 1e3, hes = 0.5, PN = "yes")
  ...
  ### try VoPN - no test yet
  
  y_pn1 <- run_onevax_xpvwrh(tt, gp, vea = 0.5, dur_v = 1, vbe = 0.8, hes = 0,
                            r2 = 1, r1 = 0.5, booster_uptake = 0.3,
                            strategy = "VoN", PN = "yes")
