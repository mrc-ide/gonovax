test_that("run_onevax_waning works correctly", {
  ...
  expect_equal(apply(y2e$N, 1, sum), rep(6e5, 4), tol = 1e-5)
  ...
  expect_equal(apply(y3e$N, 1, sum), rep(6e5, 4), tol = 1e-5)
  ...
  expect_equal(apply(y4e$N, 1, sum), rep(6e5, 4), tol = 1e-5)
