...
test_that("run_onevax works correctly", {
  tt <- seq(0, 5)
  y1 <- run_onevax_xvwv(1, tt, eff = 0, dur = 1e3)[[1]]

  # check no-one is vaccinated with v switched off
  expect_true(all(y1$cum_vaccinated == 0))
  y2 <- run_onevax_xvwv(1, tt, eff = 0, dur = 1e3, ve = 1)[[1]]
  ...
  y2e <- run_onevax_xvwv(1, tt, eff = 0, dur = 1e3, ve = 1, equilib = TRUE)[[1]]
  ...
  y3e <- run_onevax_xvwv(1, tt, eff = 1, dur = 1e3, vd = 1, equilib = TRUE)[[1]]
  ...
  y4e <- run_onevax_xvwv(1, tt, eff = 1, dur = 1e3, vs = 1, equilib = TRUE)[[1]]
  ...
  y5e <- run_onevax_xvwv(1, tt, eff = 1, dur = 1e3,
