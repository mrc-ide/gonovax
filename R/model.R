...
run_repeated_xpvwr <- function(tt, gono_params, init_params = NULL, vax_params = NULL,
                       n_erlang = 1, n_diag_rec = 1, years_history = 1, hesgroups = 1,
                       transform = TRUE) {
  
  pars <- model_params_repeated_xpvwr(gono_params = gono_params,
                              init_params = init_params,
                              vax_params = vax_params,
                              n_erlang = n_erlang,
                              n_diag_rec = n_diag_rec,
