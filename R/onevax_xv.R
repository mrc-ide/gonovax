##' @name vax_params_xv
##' @title create vaccination parameters for use in onevax_xv model
...
vax_params_xv <- function(eff = 0, dur = 1e3,
...
##' @export
run_onevax_xv <- function(tt, gono_params, init_params,
                          eff, dur, ve = 0, vd = 0, vs = 0,
                          t_stop = 99) {
  
  vax_params <- Map(vax_params_xv, eff = eff, dur = dur,
                    ve = ve, vs = vs, vd = vd, t_stop = t_stop)
  Map(run, gono_params = gono_params, init_params = init_params,
