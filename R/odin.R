...
model_trial_ <- R6::R6Class(
  ...
  private = list(
    ...
    dll = "gonovax",
    user = c("A0", "diag_rec", "eta", "I0", "lambda", "mu", "nu", "psi",
...
old_model_ <- R6::R6Class(
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "old_model_rhs_dde",
      rhs_desolve = "old_model_rhs_desolve",
      initmod_desolve = "old_model_initmod_desolve",
      output_dde = "old_model_output_dde"),
    dll = "gonovax",
    ...
    registration = function() {
      if (FALSE) {
        .C("old_model_rhs_dde", package = "gonovax")
        .C("old_model_rhs_desolve", package = "gonovax")
        .C("old_model_initmod_desolve", package = "gonovax")
        .C("old_model_output_dde", package = "gonovax")
      }
    },

    ## This only does something in delay models
    set_initial = function(t, y, use_dde) {
      .Call("old_model_set_initial", private$ptr, t, y, use_dde,
            PACKAGE= "gonovax")
    },

    update_metadata = function() {
      meta <- .Call("old_model_metadata", private$ptr,
                    PACKAGE = "gonovax")
      private$variable_order <- meta$variable_order
      private$output_order <- meta$output_order
      private$n_out <- meta$n_out
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
                          unused_user_action = NULL) {
      private$odin <- asNamespace("odin")
      private$ptr <- .Call("old_model_create", user, PACKAGE = "gonovax")
      self$set_user(user = user, unused_user_action = unused_user_action)
      private$use_dde <- use_dde
      private$update_metadata()
    },
    ...
    ir = function() {
      path_ir <- system.file("odin/old_model.json", mustWork = TRUE,
                             package = "gonovax")
      json <- readLines(path_ir)
      class(json) <- "json"
      json
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      private$odin$support_check_user(user, private$user, unused_user_action)
      .Call("old_model_set_user", private$ptr, user, PACKAGE = "gonovax")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("old_model_initial_conditions", private$ptr, t, PACKAGE = "gonovax")
    },

    rhs = function(t, y) {
      .Call("old_model_rhs_r", private$ptr, t, y, PACKAGE = "gonovax")
    },
    ...
    contents = function() {
      .Call("old_model_contents", private$ptr, PACKAGE = "gonovax")
    },
...
old_model <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  asNamespace("odin")$deprecated_constructor_call("old_model")
  old_model_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
class(old_model) <- "odin_generator"
attr(old_model, "generator") <- old_model_
