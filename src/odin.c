...
typedef struct model_internal {
  ...
  int dim_cum_incid_1;
  int dim_cum_incid_2;
  int dim_cum_natrecover;
  int dim_cum_natrecover_1;
  int dim_cum_natrecover_2;
  int dim_cum_offered;
...
typedef struct model_trial_internal {
  ...
  int dim_cum_incid_1;
  int dim_cum_incid_2;
  int dim_cum_pye_noscreen_trial_pov;
  int dim_cum_pye_noscreen_trial_pov_1;
  int dim_cum_pye_noscreen_trial_pov_2;
  ...
  int dim_n_UI_1;
  int dim_n_UI_2;
  int dim_pye_noscreen_trial;
  int dim_pye_noscreen_trial_1;
  int dim_pye_noscreen_trial_2;
  int dim_pye_trial;
  int dim_pye_trial_1;
  int dim_pye_trial_2;
  int dim_S;
  ...
  double *initial_cum_diag_s;
  double *initial_cum_incid;
  double *initial_cum_pye_noscreen_trial_pov;
  ...
  int offset_variable_cum_diag_s;
  int offset_variable_cum_incid;
  int offset_variable_cum_pye_noscreen_trial_pov;
...
SEXP model_contents(SEXP internal_p) {
  ...
  SET_VECTOR_ELT(contents, 28, ScalarInteger(internal->dim_cum_natrecover));
  SET_VECTOR_ELT(contents, 29, ScalarInteger(internal->dim_cum_natrecover_1));
  SET_VECTOR_ELT(contents, 30, ScalarInteger(internal->dim_cum_natrecover_2));
  SET_VECTOR_ELT(contents, 31, ScalarInteger(internal->dim_cum_offered));
  SET_VECTOR_ELT(contents, 32, ScalarInteger(internal->dim_cum_offered_1));
  SET_VECTOR_ELT(contents, 33, ScalarInteger(internal->dim_cum_offered_2));
  SET_VECTOR_ELT(contents, 34, ScalarInteger(internal->dim_cum_offered_pn));
  SET_VECTOR_ELT(contents, 35, ScalarInteger(internal->dim_cum_offered_pn_1));
  SET_VECTOR_ELT(contents, 36, ScalarInteger(internal->dim_cum_offered_pn_2));
  SET_VECTOR_ELT(contents, 37, ScalarInteger(internal->dim_cum_offered_vbe));
  SET_VECTOR_ELT(contents, 38, ScalarInteger(internal->dim_cum_offered_vbe_1));
  SET_VECTOR_ELT(contents, 39, ScalarInteger(internal->dim_cum_offered_vbe_2));
  SET_VECTOR_ELT(contents, 40, ScalarInteger(internal->dim_cum_phi));
  SET_VECTOR_ELT(contents, 41, ScalarInteger(internal->dim_cum_phi_1));
  SET_VECTOR_ELT(contents, 42, ScalarInteger(internal->dim_cum_phi_2));
  ...
  SET_VECTOR_ELT(contents, 73, ScalarInteger(internal->dim_I));
  SET_VECTOR_ELT(contents, 74, ScalarInteger(internal->dim_I_1));
  SET_VECTOR_ELT(contents, 75, ScalarInteger(internal->dim_I_2));
  SET_VECTOR_ELT(contents, 76, ScalarInteger(internal->dim_I0));
  SET_VECTOR_ELT(contents, 77, ScalarInteger(internal->dim_I0_1));
  SET_VECTOR_ELT(contents, 78, ScalarInteger(internal->dim_I0_2));
  SET_VECTOR_ELT(contents, 79, ScalarInteger(internal->dim_lambda));
  SET_VECTOR_ELT(contents, 80, ScalarInteger(internal->dim_N));
  SET_VECTOR_ELT(contents, 81, ScalarInteger(internal->dim_N_1));
  SET_VECTOR_ELT(contents, 82, ScalarInteger(internal->dim_N_2));
  SET_VECTOR_ELT(contents, 83, ScalarInteger(internal->dim_n_AT));
  SET_VECTOR_ELT(contents, 84, ScalarInteger(internal->dim_n_AT_1));
  SET_VECTOR_ELT(contents, 85, ScalarInteger(internal->dim_n_AT_2));
  SET_VECTOR_ELT(contents, 86, ScalarInteger(internal->dim_n_AU));
  SET_VECTOR_ELT(contents, 87, ScalarInteger(internal->dim_n_AU_1));
  SET_VECTOR_ELT(contents, 88, ScalarInteger(internal->dim_n_AU_2));
  SET_VECTOR_ELT(contents, 89, ScalarInteger(internal->dim_n_diag_rec));
  SET_VECTOR_ELT(contents, 90, ScalarInteger(internal->dim_n_diag_rec_1));
  SET_VECTOR_ELT(contents, 91, ScalarInteger(internal->dim_n_diag_rec_12));
  SET_VECTOR_ELT(contents, 92, ScalarInteger(internal->dim_n_diag_rec_2));
  SET_VECTOR_ELT(contents, 93, ScalarInteger(internal->dim_n_diag_rec_3));
  SET_VECTOR_ELT(contents, 94, ScalarInteger(internal->dim_n_obe));
  SET_VECTOR_ELT(contents, 95, ScalarInteger(internal->dim_n_obe_1));
  SET_VECTOR_ELT(contents, 96, ScalarInteger(internal->dim_n_obe_12));
  SET_VECTOR_ELT(contents, 97, ScalarInteger(internal->dim_n_obe_2));
  SET_VECTOR_ELT(contents, 98, ScalarInteger(internal->dim_n_obe_3));
  SET_VECTOR_ELT(contents, 99, ScalarInteger(internal->dim_n_ood));
  SET_VECTOR_ELT(contents, 100, ScalarInteger(internal->dim_n_ood_1));
  SET_VECTOR_ELT(contents, 101, ScalarInteger(internal->dim_n_ood_12));
  SET_VECTOR_ELT(contents, 102, ScalarInteger(internal->dim_n_ood_2));
  SET_VECTOR_ELT(contents, 103, ScalarInteger(internal->dim_n_ood_3));
  SET_VECTOR_ELT(contents, 104, ScalarInteger(internal->dim_n_oopn));
  SET_VECTOR_ELT(contents, 105, ScalarInteger(internal->dim_n_oopn_1));
  SET_VECTOR_ELT(contents, 106, ScalarInteger(internal->dim_n_oopn_12));
  SET_VECTOR_ELT(contents, 107, ScalarInteger(internal->dim_n_oopn_2));
  SET_VECTOR_ELT(contents, 108, ScalarInteger(internal->dim_n_oopn_3));
  SET_VECTOR_ELT(contents, 109, ScalarInteger(internal->dim_n_oos));
  SET_VECTOR_ELT(contents, 110, ScalarInteger(internal->dim_n_oos_1));
  SET_VECTOR_ELT(contents, 111, ScalarInteger(internal->dim_n_oos_12));
  SET_VECTOR_ELT(contents, 112, ScalarInteger(internal->dim_n_oos_2));
  SET_VECTOR_ELT(contents, 113, ScalarInteger(internal->dim_n_oos_3));
  SET_VECTOR_ELT(contents, 114, ScalarInteger(internal->dim_n_ST));
  SET_VECTOR_ELT(contents, 115, ScalarInteger(internal->dim_n_ST_1));
  SET_VECTOR_ELT(contents, 116, ScalarInteger(internal->dim_n_ST_2));
  SET_VECTOR_ELT(contents, 117, ScalarInteger(internal->dim_n_TU));
  SET_VECTOR_ELT(contents, 118, ScalarInteger(internal->dim_n_TU_1));
  SET_VECTOR_ELT(contents, 119, ScalarInteger(internal->dim_n_TU_2));
  SET_VECTOR_ELT(contents, 120, ScalarInteger(internal->dim_n_UI));
  SET_VECTOR_ELT(contents, 121, ScalarInteger(internal->dim_n_UI_1));
  SET_VECTOR_ELT(contents, 122, ScalarInteger(internal->dim_n_UI_2));
  SET_VECTOR_ELT(contents, 123, ScalarInteger(internal->dim_n_vbe));
  SET_VECTOR_ELT(contents, 124, ScalarInteger(internal->dim_n_vbe_1));
  SET_VECTOR_ELT(contents, 125, ScalarInteger(internal->dim_n_vbe_12));
  SET_VECTOR_ELT(contents, 126, ScalarInteger(internal->dim_n_vbe_2));
  SET_VECTOR_ELT(contents, 127, ScalarInteger(internal->dim_n_vbe_3));
  SET_VECTOR_ELT(contents, 128, ScalarInteger(internal->dim_n_vod));
  SET_VECTOR_ELT(contents, 129, ScalarInteger(internal->dim_n_vod_1));
  SET_VECTOR_ELT(contents, 130, ScalarInteger(internal->dim_n_vod_12));
  SET_VECTOR_ELT(contents, 131, ScalarInteger(internal->dim_n_vod_2));
  SET_VECTOR_ELT(contents, 132, ScalarInteger(internal->dim_n_vod_3));
  SET_VECTOR_ELT(contents, 133, ScalarInteger(internal->dim_n_vopn));
  SET_VECTOR_ELT(contents, 134, ScalarInteger(internal->dim_n_vopn_1));
  SET_VECTOR_ELT(contents, 135, ScalarInteger(internal->dim_n_vopn_12));
  SET_VECTOR_ELT(contents, 136, ScalarInteger(internal->dim_n_vopn_2));
  SET_VECTOR_ELT(contents, 137, ScalarInteger(internal->dim_n_vopn_3));
  SET_VECTOR_ELT(contents, 138, ScalarInteger(internal->dim_n_vos));
  SET_VECTOR_ELT(contents, 139, ScalarInteger(internal->dim_n_vos_1));
  SET_VECTOR_ELT(contents, 140, ScalarInteger(internal->dim_n_vos_12));
  SET_VECTOR_ELT(contents, 141, ScalarInteger(internal->dim_n_vos_2));
  SET_VECTOR_ELT(contents, 142, ScalarInteger(internal->dim_n_vos_3));
  SET_VECTOR_ELT(contents, 143, ScalarInteger(internal->dim_notifiedandattended));
  SET_VECTOR_ELT(contents, 144, ScalarInteger(internal->dim_notifiedandattended_1));
  SET_VECTOR_ELT(contents, 145, ScalarInteger(internal->dim_notifiedandattended_2));
  SET_VECTOR_ELT(contents, 146, ScalarInteger(internal->dim_Np));
  SET_VECTOR_ELT(contents, 147, ScalarInteger(internal->dim_omega_C));
  SET_VECTOR_ELT(contents, 148, ScalarInteger(internal->dim_omega_C_1));
  SET_VECTOR_ELT(contents, 149, ScalarInteger(internal->dim_omega_C_2));
  SET_VECTOR_ELT(contents, 150, ScalarInteger(internal->dim_omega_C_withdiag));
  SET_VECTOR_ELT(contents, 151, ScalarInteger(internal->dim_omega_C_withdiag_1));
  SET_VECTOR_ELT(contents, 152, ScalarInteger(internal->dim_omega_C_withdiag_2));
  SET_VECTOR_ELT(contents, 153, ScalarInteger(internal->dim_omega_C_withdiag_rg));
  SET_VECTOR_ELT(contents, 154, ScalarInteger(internal->dim_omega_U));
  SET_VECTOR_ELT(contents, 155, ScalarInteger(internal->dim_omega_U_1));
  SET_VECTOR_ELT(contents, 156, ScalarInteger(internal->dim_omega_U_2));
  SET_VECTOR_ELT(contents, 157, ScalarInteger(internal->dim_omega_U_withdiag));
  SET_VECTOR_ELT(contents, 158, ScalarInteger(internal->dim_omega_U_withdiag_1));
  SET_VECTOR_ELT(contents, 159, ScalarInteger(internal->dim_omega_U_withdiag_2));
  SET_VECTOR_ELT(contents, 160, ScalarInteger(internal->dim_omega_U_withdiag_rg));
  SET_VECTOR_ELT(contents, 161, ScalarInteger(internal->dim_p));
  SET_VECTOR_ELT(contents, 162, ScalarInteger(internal->dim_phi));
  SET_VECTOR_ELT(contents, 163, ScalarInteger(internal->dim_phi_1));
  SET_VECTOR_ELT(contents, 164, ScalarInteger(internal->dim_phi_2));
  SET_VECTOR_ELT(contents, 165, ScalarInteger(internal->dim_prop_C));
  SET_VECTOR_ELT(contents, 166, ScalarInteger(internal->dim_prop_CCsubgroup));
  SET_VECTOR_ELT(contents, 167, ScalarInteger(internal->dim_prop_CCsubgroup_1));
  SET_VECTOR_ELT(contents, 168, ScalarInteger(internal->dim_prop_CCsubgroup_2));
  SET_VECTOR_ELT(contents, 169, ScalarInteger(internal->dim_prop_UUsubgroup));
  SET_VECTOR_ELT(contents, 170, ScalarInteger(internal->dim_prop_UUsubgroup_1));
  SET_VECTOR_ELT(contents, 171, ScalarInteger(internal->dim_prop_UUsubgroup_2));
  SET_VECTOR_ELT(contents, 172, ScalarInteger(internal->dim_q));
  SET_VECTOR_ELT(contents, 173, ScalarInteger(internal->dim_S));
  SET_VECTOR_ELT(contents, 174, ScalarInteger(internal->dim_S_1));
  SET_VECTOR_ELT(contents, 175, ScalarInteger(internal->dim_S_2));
  SET_VECTOR_ELT(contents, 176, ScalarInteger(internal->dim_S0));
  SET_VECTOR_ELT(contents, 177, ScalarInteger(internal->dim_S0_1));
  SET_VECTOR_ELT(contents, 178, ScalarInteger(internal->dim_S0_2));
  SET_VECTOR_ELT(contents, 179, ScalarInteger(internal->dim_screened));
  SET_VECTOR_ELT(contents, 180, ScalarInteger(internal->dim_screened_1));
  SET_VECTOR_ELT(contents, 181, ScalarInteger(internal->dim_screened_2));
  SET_VECTOR_ELT(contents, 182, ScalarInteger(internal->dim_T));
  SET_VECTOR_ELT(contents, 183, ScalarInteger(internal->dim_T_1));
  SET_VECTOR_ELT(contents, 184, ScalarInteger(internal->dim_T_2));
  SET_VECTOR_ELT(contents, 185, ScalarInteger(internal->dim_T0));
  SET_VECTOR_ELT(contents, 186, ScalarInteger(internal->dim_T0_1));
  SET_VECTOR_ELT(contents, 187, ScalarInteger(internal->dim_T0_2));
  SET_VECTOR_ELT(contents, 188, ScalarInteger(internal->dim_tt));
  SET_VECTOR_ELT(contents, 189, ScalarInteger(internal->dim_U));
  SET_VECTOR_ELT(contents, 190, ScalarInteger(internal->dim_U_1));
  SET_VECTOR_ELT(contents, 191, ScalarInteger(internal->dim_U_2));
  SET_VECTOR_ELT(contents, 192, ScalarInteger(internal->dim_u_d));
  SET_VECTOR_ELT(contents, 193, ScalarInteger(internal->dim_u_d_1));
  SET_VECTOR_ELT(contents, 194, ScalarInteger(internal->dim_u_d_12));
  SET_VECTOR_ELT(contents, 195, ScalarInteger(internal->dim_u_d_2));
  SET_VECTOR_ELT(contents, 196, ScalarInteger(internal->dim_u_d_3));
  SET_VECTOR_ELT(contents, 197, ScalarInteger(internal->dim_u_pn));
  SET_VECTOR_ELT(contents, 198, ScalarInteger(internal->dim_u_pn_1));
  SET_VECTOR_ELT(contents, 199, ScalarInteger(internal->dim_u_pn_12));
  SET_VECTOR_ELT(contents, 200, ScalarInteger(internal->dim_u_pn_2));
  SET_VECTOR_ELT(contents, 201, ScalarInteger(internal->dim_u_pn_3));
  SET_VECTOR_ELT(contents, 202, ScalarInteger(internal->dim_u_s));
  SET_VECTOR_ELT(contents, 203, ScalarInteger(internal->dim_u_s_1));
  SET_VECTOR_ELT(contents, 204, ScalarInteger(internal->dim_u_s_12));
  SET_VECTOR_ELT(contents, 205, ScalarInteger(internal->dim_u_s_2));
  SET_VECTOR_ELT(contents, 206, ScalarInteger(internal->dim_u_s_3));
  SET_VECTOR_ELT(contents, 207, ScalarInteger(internal->dim_U0));
  SET_VECTOR_ELT(contents, 208, ScalarInteger(internal->dim_U0_1));
  SET_VECTOR_ELT(contents, 209, ScalarInteger(internal->dim_U0_2));
  SET_VECTOR_ELT(contents, 210, ScalarInteger(internal->dim_Up));
  SET_VECTOR_ELT(contents, 211, ScalarInteger(internal->dim_vax_t));
  SET_VECTOR_ELT(contents, 212, ScalarInteger(internal->dim_vax_y));
  SET_VECTOR_ELT(contents, 213, ScalarInteger(internal->dim_vbe));
  SET_VECTOR_ELT(contents, 214, ScalarInteger(internal->dim_vbe_1));
  SET_VECTOR_ELT(contents, 215, ScalarInteger(internal->dim_vbe_12));
  SET_VECTOR_ELT(contents, 216, ScalarInteger(internal->dim_vbe_2));
  SET_VECTOR_ELT(contents, 217, ScalarInteger(internal->dim_vbe_3));
  SET_VECTOR_ELT(contents, 218, ScalarInteger(internal->dim_vea));
  SET_VECTOR_ELT(contents, 219, ScalarInteger(internal->dim_ved));
  SET_VECTOR_ELT(contents, 220, ScalarInteger(internal->dim_vei));
  SET_VECTOR_ELT(contents, 221, ScalarInteger(internal->dim_ves));
  SET_VECTOR_ELT(contents, 222, ScalarInteger(internal->dim_vod));
  SET_VECTOR_ELT(contents, 223, ScalarInteger(internal->dim_vod_1));
  SET_VECTOR_ELT(contents, 224, ScalarInteger(internal->dim_vod_12));
  SET_VECTOR_ELT(contents, 225, ScalarInteger(internal->dim_vod_2));
  SET_VECTOR_ELT(contents, 226, ScalarInteger(internal->dim_vod_3));
  SET_VECTOR_ELT(contents, 227, ScalarInteger(internal->dim_vopn));
  SET_VECTOR_ELT(contents, 228, ScalarInteger(internal->dim_vopn_1));
  SET_VECTOR_ELT(contents, 229, ScalarInteger(internal->dim_vopn_12));
  SET_VECTOR_ELT(contents, 230, ScalarInteger(internal->dim_vopn_2));
  SET_VECTOR_ELT(contents, 231, ScalarInteger(internal->dim_vopn_3));
  SET_VECTOR_ELT(contents, 232, ScalarInteger(internal->dim_vos));
  SET_VECTOR_ELT(contents, 233, ScalarInteger(internal->dim_vos_1));
  SET_VECTOR_ELT(contents, 234, ScalarInteger(internal->dim_vos_12));
  SET_VECTOR_ELT(contents, 235, ScalarInteger(internal->dim_vos_2));
  SET_VECTOR_ELT(contents, 236, ScalarInteger(internal->dim_vos_3));
  SET_VECTOR_ELT(contents, 237, ScalarInteger(internal->dim_w));
  SET_VECTOR_ELT(contents, 238, ScalarInteger(internal->dim_w_1));
  SET_VECTOR_ELT(contents, 239, ScalarInteger(internal->dim_w_2));
  SET_VECTOR_ELT(contents, 240, ScalarInteger(internal->dim_wA));
  SET_VECTOR_ELT(contents, 241, ScalarInteger(internal->dim_wA_1));
  SET_VECTOR_ELT(contents, 242, ScalarInteger(internal->dim_wA_12));
  SET_VECTOR_ELT(contents, 243, ScalarInteger(internal->dim_wA_2));
  SET_VECTOR_ELT(contents, 244, ScalarInteger(internal->dim_wA_3));
  SET_VECTOR_ELT(contents, 245, ScalarInteger(internal->dim_wd));
  SET_VECTOR_ELT(contents, 246, ScalarInteger(internal->dim_wd_1));
  SET_VECTOR_ELT(contents, 247, ScalarInteger(internal->dim_wd_2));
  SET_VECTOR_ELT(contents, 248, ScalarInteger(internal->dim_wdA));
  SET_VECTOR_ELT(contents, 249, ScalarInteger(internal->dim_wdA_1));
  SET_VECTOR_ELT(contents, 250, ScalarInteger(internal->dim_wdA_12));
  SET_VECTOR_ELT(contents, 251, ScalarInteger(internal->dim_wdA_2));
  SET_VECTOR_ELT(contents, 252, ScalarInteger(internal->dim_wdA_3));
  SET_VECTOR_ELT(contents, 253, ScalarInteger(internal->dim_wdI));
  SET_VECTOR_ELT(contents, 254, ScalarInteger(internal->dim_wdI_1));
  SET_VECTOR_ELT(contents, 255, ScalarInteger(internal->dim_wdI_12));
  SET_VECTOR_ELT(contents, 256, ScalarInteger(internal->dim_wdI_2));
  SET_VECTOR_ELT(contents, 257, ScalarInteger(internal->dim_wdI_3));
  SET_VECTOR_ELT(contents, 258, ScalarInteger(internal->dim_wdS));
  SET_VECTOR_ELT(contents, 259, ScalarInteger(internal->dim_wdS_1));
  SET_VECTOR_ELT(contents, 260, ScalarInteger(internal->dim_wdS_12));
  SET_VECTOR_ELT(contents, 261, ScalarInteger(internal->dim_wdS_2));
  SET_VECTOR_ELT(contents, 262, ScalarInteger(internal->dim_wdS_3));
  SET_VECTOR_ELT(contents, 263, ScalarInteger(internal->dim_wdT));
  SET_VECTOR_ELT(contents, 264, ScalarInteger(internal->dim_wdT_1));
  SET_VECTOR_ELT(contents, 265, ScalarInteger(internal->dim_wdT_12));
  SET_VECTOR_ELT(contents, 266, ScalarInteger(internal->dim_wdT_2));
  SET_VECTOR_ELT(contents, 267, ScalarInteger(internal->dim_wdT_3));
  SET_VECTOR_ELT(contents, 268, ScalarInteger(internal->dim_wdU));
  SET_VECTOR_ELT(contents, 269, ScalarInteger(internal->dim_wdU_1));
  SET_VECTOR_ELT(contents, 270, ScalarInteger(internal->dim_wdU_12));
  SET_VECTOR_ELT(contents, 271, ScalarInteger(internal->dim_wdU_2));
  SET_VECTOR_ELT(contents, 272, ScalarInteger(internal->dim_wdU_3));
  SET_VECTOR_ELT(contents, 273, ScalarInteger(internal->dim_wI));
  SET_VECTOR_ELT(contents, 274, ScalarInteger(internal->dim_wI_1));
  SET_VECTOR_ELT(contents, 275, ScalarInteger(internal->dim_wI_12));
  SET_VECTOR_ELT(contents, 276, ScalarInteger(internal->dim_wI_2));
  SET_VECTOR_ELT(contents, 277, ScalarInteger(internal->dim_wI_3));
  SET_VECTOR_ELT(contents, 278, ScalarInteger(internal->dim_willing));
  SET_VECTOR_ELT(contents, 279, ScalarInteger(internal->dim_wS));
  SET_VECTOR_ELT(contents, 280, ScalarInteger(internal->dim_wS_1));
  SET_VECTOR_ELT(contents, 281, ScalarInteger(internal->dim_wS_12));
  SET_VECTOR_ELT(contents, 282, ScalarInteger(internal->dim_wS_2));
  SET_VECTOR_ELT(contents, 283, ScalarInteger(internal->dim_wS_3));
  SET_VECTOR_ELT(contents, 284, ScalarInteger(internal->dim_wT));
  SET_VECTOR_ELT(contents, 285, ScalarInteger(internal->dim_wT_1));
  SET_VECTOR_ELT(contents, 286, ScalarInteger(internal->dim_wT_12));
  SET_VECTOR_ELT(contents, 287, ScalarInteger(internal->dim_wT_2));
  SET_VECTOR_ELT(contents, 288, ScalarInteger(internal->dim_wT_3));
  SET_VECTOR_ELT(contents, 289, ScalarInteger(internal->dim_wU));
  SET_VECTOR_ELT(contents, 290, ScalarInteger(internal->dim_wU_1));
  SET_VECTOR_ELT(contents, 291, ScalarInteger(internal->dim_wU_12));
  SET_VECTOR_ELT(contents, 292, ScalarInteger(internal->dim_wU_2));
  SET_VECTOR_ELT(contents, 293, ScalarInteger(internal->dim_wU_3));
  SET_VECTOR_ELT(contents, 294, ScalarInteger(internal->dim_xi));
  SET_VECTOR_ELT(contents, 295, ScalarInteger(internal->dim_xi_1));
  SET_VECTOR_ELT(contents, 296, ScalarInteger(internal->dim_xi_2));
  SET_VECTOR_ELT(contents, 297, ScalarReal(internal->enr));
  ...
  SET_VECTOR_ELT(contents, 298, entrants);
  SET_VECTOR_ELT(contents, 299, ScalarReal(internal->epsilon));
  SEXP eta = PROTECT(allocVector(REALSXP, internal->dim_eta));
  memcpy(REAL(eta), internal->eta, internal->dim_eta * sizeof(double));
  SET_VECTOR_ELT(contents, 300, eta);
  ...
  SET_VECTOR_ELT(contents, 301, eta_h_t);
  ...
  SET_VECTOR_ELT(contents, 302, eta_l_t);
  SET_VECTOR_ELT(contents, 303, ScalarReal(internal->exr));
  ...
  SET_VECTOR_ELT(contents, 304, foi_LH);
  ...
  SET_VECTOR_ELT(contents, 305, I0);
  ...
  SET_VECTOR_ELT(contents, 307, initial_cum_diag_a);
  ...
  SET_VECTOR_ELT(contents, 308, initial_cum_diag_s);
  ...
  SET_VECTOR_ELT(contents, 309, initial_cum_entrants);
  ...
  SET_VECTOR_ELT(contents, 310, initial_cum_incid);
  SEXP initial_cum_natrecover = PROTECT(allocVector(REALSXP, internal->dim_cum_natrecover));
  memcpy(REAL(initial_cum_natrecover), internal->initial_cum_natrecover, internal->dim_cum_natrecover * sizeof(double));
  odin_set_dim(initial_cum_natrecover, 2, internal->dim_cum_natrecover_1, internal->dim_cum_natrecover_2);
  SET_VECTOR_ELT(contents, 311, initial_cum_natrecover);
  ...
  SET_VECTOR_ELT(contents, 312, initial_cum_offered);
  ...
  SET_VECTOR_ELT(contents, 313, initial_cum_offered_pn);
  ...
  SET_VECTOR_ELT(contents, 314, initial_cum_offered_vbe);
  SEXP initial_cum_phi = PROTECT(allocVector(REALSXP, internal->dim_cum_phi));
  memcpy(REAL(initial_cum_phi), internal->initial_cum_phi, internal->dim_cum_phi * sizeof(double));
  odin_set_dim(initial_cum_phi, 2, internal->dim_cum_phi_1, internal->dim_cum_phi_2);
  SET_VECTOR_ELT(contents, 315, initial_cum_phi);
  ...
  SET_VECTOR_ELT(contents, 316, initial_cum_screened);
  ...
  SET_VECTOR_ELT(contents, 317, initial_cum_treated);
  ...
  SET_VECTOR_ELT(contents, 318, initial_cum_vaccinated);
  ...
  SET_VECTOR_ELT(contents, 319, initial_cum_vaccinated_pn);
  ...
  SET_VECTOR_ELT(contents, 320, initial_cum_vaccinated_screen);
  ...
  SET_VECTOR_ELT(contents, 321, initial_cum_vbe);
  ...
  SET_VECTOR_ELT(contents, 322, initial_I);
  ...
  SET_VECTOR_ELT(contents, 324, initial_T);
  ...
  SET_VECTOR_ELT(contents, 325, initial_U);
  SET_VECTOR_ELT(contents, 330, ScalarReal(internal->kappa));
  ...
  SET_VECTOR_ELT(contents, 331, lambda);
  SET_VECTOR_ELT(contents, 332, ScalarReal(internal->mu));
  ...
  SET_VECTOR_ELT(contents, 334, n_AT);
  ...
  SET_VECTOR_ELT(contents, 335, n_AU);
  ...
  SET_VECTOR_ELT(contents, 336, n_diag_rec);
  SET_VECTOR_ELT(contents, 337, ScalarInteger(internal->n_group));
  ...
  SET_VECTOR_ELT(contents, 338, n_obe);
  ...
  SET_VECTOR_ELT(contents, 339, n_ood);
  ...
  SET_VECTOR_ELT(contents, 340, n_oopn);
  ...
  SET_VECTOR_ELT(contents, 341, n_oos);
  ...
  SET_VECTOR_ELT(contents, 342, n_ST);
  ...
  SET_VECTOR_ELT(contents, 343, n_TU);
  ...
  SET_VECTOR_ELT(contents, 344, n_UI);
  SET_VECTOR_ELT(contents, 345, ScalarInteger(internal->n_vax));
  ...
  SET_VECTOR_ELT(contents, 346, n_vbe);
  ...
  SET_VECTOR_ELT(contents, 347, n_vod);
  ...
  SET_VECTOR_ELT(contents, 348, n_vopn);
  ...
  SET_VECTOR_ELT(contents, 349, n_vos);
  ...
  SET_VECTOR_ELT(contents, 350, notifiedandattended);
  SET_VECTOR_ELT(contents, 351, ScalarReal(internal->notifiedprev));
  SEXP Np = PROTECT(allocVector(REALSXP, internal->dim_Np));
  memcpy(REAL(Np), internal->Np, internal->dim_Np * sizeof(double));
  SET_VECTOR_ELT(contents, 352, Np);
  SET_VECTOR_ELT(contents, 353, ScalarReal(internal->nu));
  SET_VECTOR_ELT(contents, 354, ScalarInteger(internal->offset_output_lambda));
  SET_VECTOR_ELT(contents, 355, ScalarInteger(internal->offset_output_N));
  SET_VECTOR_ELT(contents, 356, ScalarInteger(internal->offset_output_notifiedandattended));
  SET_VECTOR_ELT(contents, 357, ScalarInteger(internal->offset_output_phi));
  SET_VECTOR_ELT(contents, 358, ScalarInteger(internal->offset_variable_A));
  SET_VECTOR_ELT(contents, 359, ScalarInteger(internal->offset_variable_cum_diag_a));
  SET_VECTOR_ELT(contents, 360, ScalarInteger(internal->offset_variable_cum_diag_s));
  SET_VECTOR_ELT(contents, 361, ScalarInteger(internal->offset_variable_cum_entrants));
  SET_VECTOR_ELT(contents, 362, ScalarInteger(internal->offset_variable_cum_incid));
  SET_VECTOR_ELT(contents, 363, ScalarInteger(internal->offset_variable_cum_natrecover));
  SET_VECTOR_ELT(contents, 364, ScalarInteger(internal->offset_variable_cum_offered));
  SET_VECTOR_ELT(contents, 365, ScalarInteger(internal->offset_variable_cum_offered_pn));
  SET_VECTOR_ELT(contents, 366, ScalarInteger(internal->offset_variable_cum_offered_vbe));
  SET_VECTOR_ELT(contents, 367, ScalarInteger(internal->offset_variable_cum_phi));
  SET_VECTOR_ELT(contents, 368, ScalarInteger(internal->offset_variable_cum_screened));
  SET_VECTOR_ELT(contents, 369, ScalarInteger(internal->offset_variable_cum_treated));
  SET_VECTOR_ELT(contents, 370, ScalarInteger(internal->offset_variable_cum_vaccinated));
  SET_VECTOR_ELT(contents, 371, ScalarInteger(internal->offset_variable_cum_vaccinated_pn));
  SET_VECTOR_ELT(contents, 372, ScalarInteger(internal->offset_variable_cum_vaccinated_screen));
  SET_VECTOR_ELT(contents, 373, ScalarInteger(internal->offset_variable_cum_vbe));
  SET_VECTOR_ELT(contents, 374, ScalarInteger(internal->offset_variable_S));
  SET_VECTOR_ELT(contents, 375, ScalarInteger(internal->offset_variable_T));
  ...
  SET_VECTOR_ELT(contents, 376, omega_C);
  ...
  SET_VECTOR_ELT(contents, 377, omega_C_withdiag);
  ...
  SET_VECTOR_ELT(contents, 378, omega_C_withdiag_rg);
  ...
  SET_VECTOR_ELT(contents, 379, omega_U);
  ...
  SET_VECTOR_ELT(contents, 380, omega_U_withdiag);
  ...
  SET_VECTOR_ELT(contents, 383, phi);
  ...
  SET_VECTOR_ELT(contents, 384, prop_C);
  ...
  SET_VECTOR_ELT(contents, 385, prop_CCsubgroup);
  ...
  SET_VECTOR_ELT(contents, 395, u_d);
  ...
  SET_VECTOR_ELT(contents, 396, u_pn);
  ...
  SET_VECTOR_ELT(contents, 397, u_s);
  SET_VECTOR_ELT(contents, 398, ScalarReal(internal->u_vbe));
  ...
  SET_VECTOR_ELT(contents, 401, vax_t);
  ...
  SET_VECTOR_ELT(contents, 402, vax_y);
  ...
  SET_VECTOR_ELT(contents, 408, vod);
  ...
  SET_VECTOR_ELT(contents, 409, vopn);
  ...
  SET_VECTOR_ELT(contents, 410, vos);
  ...
  SET_VECTOR_ELT(contents, 412, wA);
  ...
  SET_VECTOR_ELT(contents, 413, wd);
  ...
  SET_VECTOR_ELT(contents, 414, wdA);
  ...
  SET_VECTOR_ELT(contents, 415, wdI);
  ...
  SET_VECTOR_ELT(contents, 416, wdS);
  ...
  SET_VECTOR_ELT(contents, 417, wdT);
  ...
  SET_VECTOR_ELT(contents, 418, wdU);
  ...
  SET_VECTOR_ELT(contents, 419, wI);
  ...
  SET_VECTOR_ELT(contents, 420, willing);
  ...
  SET_VECTOR_ELT(contents, 421, wS);
  ...
  SET_VECTOR_ELT(contents, 422, wT);
  ...
  SET_VECTOR_ELT(contents, 423, wU);
  ...
  SET_VECTOR_ELT(contents, 424, xi);
  ...
  SET_STRING_ELT(nms, 28, mkChar("dim_cum_natrecover"));
  SET_STRING_ELT(nms, 29, mkChar("dim_cum_natrecover_1"));
  SET_STRING_ELT(nms, 30, mkChar("dim_cum_natrecover_2"));
  SET_STRING_ELT(nms, 31, mkChar("dim_cum_offered"));
  SET_STRING_ELT(nms, 32, mkChar("dim_cum_offered_1"));
  SET_STRING_ELT(nms, 33, mkChar("dim_cum_offered_2"));
  SET_STRING_ELT(nms, 34, mkChar("dim_cum_offered_pn"));
  SET_STRING_ELT(nms, 35, mkChar("dim_cum_offered_pn_1"));
  SET_STRING_ELT(nms, 36, mkChar("dim_cum_offered_pn_2"));
  SET_STRING_ELT(nms, 37, mkChar("dim_cum_offered_vbe"));
  SET_STRING_ELT(nms, 38, mkChar("dim_cum_offered_vbe_1"));
  SET_STRING_ELT(nms, 39, mkChar("dim_cum_offered_vbe_2"));
  SET_STRING_ELT(nms, 40, mkChar("dim_cum_phi"));
  SET_STRING_ELT(nms, 41, mkChar("dim_cum_phi_1"));
  SET_STRING_ELT(nms, 42, mkChar("dim_cum_phi_2"));
  ...
  SET_STRING_ELT(nms, 73, mkChar("dim_I"));
  SET_STRING_ELT(nms, 74, mkChar("dim_I_1"));
  SET_STRING_ELT(nms, 75, mkChar("dim_I_2"));
  SET_STRING_ELT(nms, 76, mkChar("dim_I0"));
  SET_STRING_ELT(nms, 77, mkChar("dim_I0_1"));
  SET_STRING_ELT(nms, 78, mkChar("dim_I0_2"));
  SET_STRING_ELT(nms, 79, mkChar("dim_lambda"));
  SET_STRING_ELT(nms, 80, mkChar("dim_N"));
  SET_STRING_ELT(nms, 81, mkChar("dim_N_1"));
  SET_STRING_ELT(nms, 82, mkChar("dim_N_2"));
  SET_STRING_ELT(nms, 83, mkChar("dim_n_AT"));
  SET_STRING_ELT(nms, 84, mkChar("dim_n_AT_1"));
  SET_STRING_ELT(nms, 85, mkChar("dim_n_AT_2"));
  SET_STRING_ELT(nms, 86, mkChar("dim_n_AU"));
  SET_STRING_ELT(nms, 87, mkChar("dim_n_AU_1"));
  SET_STRING_ELT(nms, 88, mkChar("dim_n_AU_2"));
  SET_STRING_ELT(nms, 89, mkChar("dim_n_diag_rec"));
  SET_STRING_ELT(nms, 90, mkChar("dim_n_diag_rec_1"));
  SET_STRING_ELT(nms, 91, mkChar("dim_n_diag_rec_12"));
  SET_STRING_ELT(nms, 92, mkChar("dim_n_diag_rec_2"));
  SET_STRING_ELT(nms, 93, mkChar("dim_n_diag_rec_3"));
  SET_STRING_ELT(nms, 94, mkChar("dim_n_obe"));
  SET_STRING_ELT(nms, 95, mkChar("dim_n_obe_1"));
  SET_STRING_ELT(nms, 96, mkChar("dim_n_obe_12"));
  SET_STRING_ELT(nms, 97, mkChar("dim_n_obe_2"));
  SET_STRING_ELT(nms, 98, mkChar("dim_n_obe_3"));
  SET_STRING_ELT(nms, 99, mkChar("dim_n_ood"));
  SET_STRING_ELT(nms, 100, mkChar("dim_n_ood_1"));
  SET_STRING_ELT(nms, 101, mkChar("dim_n_ood_12"));
  SET_STRING_ELT(nms, 102, mkChar("dim_n_ood_2"));
  SET_STRING_ELT(nms, 103, mkChar("dim_n_ood_3"));
  SET_STRING_ELT(nms, 104, mkChar("dim_n_oopn"));
  SET_STRING_ELT(nms, 105, mkChar("dim_n_oopn_1"));
  SET_STRING_ELT(nms, 106, mkChar("dim_n_oopn_12"));
  SET_STRING_ELT(nms, 107, mkChar("dim_n_oopn_2"));
  SET_STRING_ELT(nms, 108, mkChar("dim_n_oopn_3"));
  SET_STRING_ELT(nms, 109, mkChar("dim_n_oos"));
  SET_STRING_ELT(nms, 110, mkChar("dim_n_oos_1"));
  SET_STRING_ELT(nms, 111, mkChar("dim_n_oos_12"));
  SET_STRING_ELT(nms, 112, mkChar("dim_n_oos_2"));
  SET_STRING_ELT(nms, 113, mkChar("dim_n_oos_3"));
  SET_STRING_ELT(nms, 114, mkChar("dim_n_ST"));
  SET_STRING_ELT(nms, 115, mkChar("dim_n_ST_1"));
  SET_STRING_ELT(nms, 116, mkChar("dim_n_ST_2"));
  SET_STRING_ELT(nms, 117, mkChar("dim_n_TU"));
  SET_STRING_ELT(nms, 118, mkChar("dim_n_TU_1"));
  SET_STRING_ELT(nms, 119, mkChar("dim_n_TU_2"));
  SET_STRING_ELT(nms, 120, mkChar("dim_n_UI"));
  SET_STRING_ELT(nms, 121, mkChar("dim_n_UI_1"));
  SET_STRING_ELT(nms, 122, mkChar("dim_n_UI_2"));
  SET_STRING_ELT(nms, 123, mkChar("dim_n_vbe"));
  SET_STRING_ELT(nms, 124, mkChar("dim_n_vbe_1"));
  SET_STRING_ELT(nms, 125, mkChar("dim_n_vbe_12"));
  SET_STRING_ELT(nms, 126, mkChar("dim_n_vbe_2"));
  SET_STRING_ELT(nms, 127, mkChar("dim_n_vbe_3"));
  SET_STRING_ELT(nms, 128, mkChar("dim_n_vod"));
  SET_STRING_ELT(nms, 129, mkChar("dim_n_vod_1"));
  SET_STRING_ELT(nms, 130, mkChar("dim_n_vod_12"));
  SET_STRING_ELT(nms, 131, mkChar("dim_n_vod_2"));
  SET_STRING_ELT(nms, 132, mkChar("dim_n_vod_3"));
  SET_STRING_ELT(nms, 133, mkChar("dim_n_vopn"));
  SET_STRING_ELT(nms, 134, mkChar("dim_n_vopn_1"));
  SET_STRING_ELT(nms, 135, mkChar("dim_n_vopn_12"));
  SET_STRING_ELT(nms, 136, mkChar("dim_n_vopn_2"));
  SET_STRING_ELT(nms, 137, mkChar("dim_n_vopn_3"));
  SET_STRING_ELT(nms, 138, mkChar("dim_n_vos"));
  SET_STRING_ELT(nms, 139, mkChar("dim_n_vos_1"));
  SET_STRING_ELT(nms, 140, mkChar("dim_n_vos_12"));
  SET_STRING_ELT(nms, 141, mkChar("dim_n_vos_2"));
  SET_STRING_ELT(nms, 142, mkChar("dim_n_vos_3"));
  SET_STRING_ELT(nms, 143, mkChar("dim_notifiedandattended"));
  SET_STRING_ELT(nms, 144, mkChar("dim_notifiedandattended_1"));
  SET_STRING_ELT(nms, 145, mkChar("dim_notifiedandattended_2"));
  SET_STRING_ELT(nms, 146, mkChar("dim_Np"));
  SET_STRING_ELT(nms, 147, mkChar("dim_omega_C"));
  SET_STRING_ELT(nms, 148, mkChar("dim_omega_C_1"));
  SET_STRING_ELT(nms, 149, mkChar("dim_omega_C_2"));
  SET_STRING_ELT(nms, 150, mkChar("dim_omega_C_withdiag"));
  SET_STRING_ELT(nms, 151, mkChar("dim_omega_C_withdiag_1"));
  SET_STRING_ELT(nms, 152, mkChar("dim_omega_C_withdiag_2"));
  SET_STRING_ELT(nms, 153, mkChar("dim_omega_C_withdiag_rg"));
  SET_STRING_ELT(nms, 154, mkChar("dim_omega_U"));
  SET_STRING_ELT(nms, 155, mkChar("dim_omega_U_1"));
  SET_STRING_ELT(nms, 156, mkChar("dim_omega_U_2"));
  SET_STRING_ELT(nms, 157, mkChar("dim_omega_U_withdiag"));
  SET_STRING_ELT(nms, 158, mkChar("dim_omega_U_withdiag_1"));
  SET_STRING_ELT(nms, 159, mkChar("dim_omega_U_withdiag_2"));
  SET_STRING_ELT(nms, 160, mkChar("dim_omega_U_withdiag_rg"));
  SET_STRING_ELT(nms, 161, mkChar("dim_p"));
  SET_STRING_ELT(nms, 162, mkChar("dim_phi"));
  SET_STRING_ELT(nms, 163, mkChar("dim_phi_1"));
  SET_STRING_ELT(nms, 164, mkChar("dim_phi_2"));
  SET_STRING_ELT(nms, 165, mkChar("dim_prop_C"));
  SET_STRING_ELT(nms, 166, mkChar("dim_prop_CCsubgroup"));
  SET_STRING_ELT(nms, 167, mkChar("dim_prop_CCsubgroup_1"));
  SET_STRING_ELT(nms, 168, mkChar("dim_prop_CCsubgroup_2"));
  SET_STRING_ELT(nms, 169, mkChar("dim_prop_UUsubgroup"));
  SET_STRING_ELT(nms, 170, mkChar("dim_prop_UUsubgroup_1"));
  SET_STRING_ELT(nms, 171, mkChar("dim_prop_UUsubgroup_2"));
  SET_STRING_ELT(nms, 172, mkChar("dim_q"));
  SET_STRING_ELT(nms, 173, mkChar("dim_S"));
  SET_STRING_ELT(nms, 174, mkChar("dim_S_1"));
  SET_STRING_ELT(nms, 175, mkChar("dim_S_2"));
  SET_STRING_ELT(nms, 176, mkChar("dim_S0"));
  SET_STRING_ELT(nms, 177, mkChar("dim_S0_1"));
  SET_STRING_ELT(nms, 178, mkChar("dim_S0_2"));
  SET_STRING_ELT(nms, 179, mkChar("dim_screened"));
  SET_STRING_ELT(nms, 180, mkChar("dim_screened_1"));
  SET_STRING_ELT(nms, 181, mkChar("dim_screened_2"));
  SET_STRING_ELT(nms, 182, mkChar("dim_T"));
  SET_STRING_ELT(nms, 183, mkChar("dim_T_1"));
  SET_STRING_ELT(nms, 184, mkChar("dim_T_2"));
  SET_STRING_ELT(nms, 185, mkChar("dim_T0"));
  SET_STRING_ELT(nms, 186, mkChar("dim_T0_1"));
  SET_STRING_ELT(nms, 187, mkChar("dim_T0_2"));
  SET_STRING_ELT(nms, 188, mkChar("dim_tt"));
  SET_STRING_ELT(nms, 189, mkChar("dim_U"));
  SET_STRING_ELT(nms, 190, mkChar("dim_U_1"));
  SET_STRING_ELT(nms, 191, mkChar("dim_U_2"));
  SET_STRING_ELT(nms, 192, mkChar("dim_u_d"));
  SET_STRING_ELT(nms, 193, mkChar("dim_u_d_1"));
  SET_STRING_ELT(nms, 194, mkChar("dim_u_d_12"));
  SET_STRING_ELT(nms, 195, mkChar("dim_u_d_2"));
  SET_STRING_ELT(nms, 196, mkChar("dim_u_d_3"));
  SET_STRING_ELT(nms, 197, mkChar("dim_u_pn"));
  SET_STRING_ELT(nms, 198, mkChar("dim_u_pn_1"));
  SET_STRING_ELT(nms, 199, mkChar("dim_u_pn_12"));
  SET_STRING_ELT(nms, 200, mkChar("dim_u_pn_2"));
  SET_STRING_ELT(nms, 201, mkChar("dim_u_pn_3"));
  SET_STRING_ELT(nms, 202, mkChar("dim_u_s"));
  SET_STRING_ELT(nms, 203, mkChar("dim_u_s_1"));
  SET_STRING_ELT(nms, 204, mkChar("dim_u_s_12"));
  SET_STRING_ELT(nms, 205, mkChar("dim_u_s_2"));
  SET_STRING_ELT(nms, 206, mkChar("dim_u_s_3"));
  SET_STRING_ELT(nms, 207, mkChar("dim_U0"));
  SET_STRING_ELT(nms, 208, mkChar("dim_U0_1"));
  SET_STRING_ELT(nms, 209, mkChar("dim_U0_2"));
  SET_STRING_ELT(nms, 210, mkChar("dim_Up"));
  SET_STRING_ELT(nms, 211, mkChar("dim_vax_t"));
  SET_STRING_ELT(nms, 212, mkChar("dim_vax_y"));
  SET_STRING_ELT(nms, 213, mkChar("dim_vbe"));
  SET_STRING_ELT(nms, 214, mkChar("dim_vbe_1"));
  SET_STRING_ELT(nms, 215, mkChar("dim_vbe_12"));
  SET_STRING_ELT(nms, 216, mkChar("dim_vbe_2"));
  SET_STRING_ELT(nms, 217, mkChar("dim_vbe_3"));
  SET_STRING_ELT(nms, 218, mkChar("dim_vea"));
  SET_STRING_ELT(nms, 219, mkChar("dim_ved"));
  SET_STRING_ELT(nms, 220, mkChar("dim_vei"));
  SET_STRING_ELT(nms, 221, mkChar("dim_ves"));
  SET_STRING_ELT(nms, 222, mkChar("dim_vod"));
  SET_STRING_ELT(nms, 223, mkChar("dim_vod_1"));
  SET_STRING_ELT(nms, 224, mkChar("dim_vod_12"));
  SET_STRING_ELT(nms, 225, mkChar("dim_vod_2"));
  SET_STRING_ELT(nms, 226, mkChar("dim_vod_3"));
  SET_STRING_ELT(nms, 227, mkChar("dim_vopn"));
  SET_STRING_ELT(nms, 228, mkChar("dim_vopn_1"));
  SET_STRING_ELT(nms, 229, mkChar("dim_vopn_12"));
  SET_STRING_ELT(nms, 230, mkChar("dim_vopn_2"));
  SET_STRING_ELT(nms, 231, mkChar("dim_vopn_3"));
  SET_STRING_ELT(nms, 232, mkChar("dim_vos"));
  SET_STRING_ELT(nms, 233, mkChar("dim_vos_1"));
  SET_STRING_ELT(nms, 234, mkChar("dim_vos_12"));
  SET_STRING_ELT(nms, 235, mkChar("dim_vos_2"));
  SET_STRING_ELT(nms, 236, mkChar("dim_vos_3"));
  SET_STRING_ELT(nms, 237, mkChar("dim_w"));
  SET_STRING_ELT(nms, 238, mkChar("dim_w_1"));
  SET_STRING_ELT(nms, 239, mkChar("dim_w_2"));
  SET_STRING_ELT(nms, 240, mkChar("dim_wA"));
  SET_STRING_ELT(nms, 241, mkChar("dim_wA_1"));
  SET_STRING_ELT(nms, 242, mkChar("dim_wA_12"));
  SET_STRING_ELT(nms, 243, mkChar("dim_wA_2"));
  SET_STRING_ELT(nms, 244, mkChar("dim_wA_3"));
  SET_STRING_ELT(nms, 245, mkChar("dim_wd"));
  SET_STRING_ELT(nms, 246, mkChar("dim_wd_1"));
  SET_STRING_ELT(nms, 247, mkChar("dim_wd_2"));
  SET_STRING_ELT(nms, 248, mkChar("dim_wdA"));
  SET_STRING_ELT(nms, 249, mkChar("dim_wdA_1"));
  SET_STRING_ELT(nms, 250, mkChar("dim_wdA_12"));
  SET_STRING_ELT(nms, 251, mkChar("dim_wdA_2"));
  SET_STRING_ELT(nms, 252, mkChar("dim_wdA_3"));
  SET_STRING_ELT(nms, 253, mkChar("dim_wdI"));
  SET_STRING_ELT(nms, 254, mkChar("dim_wdI_1"));
  SET_STRING_ELT(nms, 255, mkChar("dim_wdI_12"));
  SET_STRING_ELT(nms, 256, mkChar("dim_wdI_2"));
  SET_STRING_ELT(nms, 257, mkChar("dim_wdI_3"));
  SET_STRING_ELT(nms, 258, mkChar("dim_wdS"));
  SET_STRING_ELT(nms, 259, mkChar("dim_wdS_1"));
  SET_STRING_ELT(nms, 260, mkChar("dim_wdS_12"));
  SET_STRING_ELT(nms, 261, mkChar("dim_wdS_2"));
  SET_STRING_ELT(nms, 262, mkChar("dim_wdS_3"));
  SET_STRING_ELT(nms, 263, mkChar("dim_wdT"));
  SET_STRING_ELT(nms, 264, mkChar("dim_wdT_1"));
  SET_STRING_ELT(nms, 265, mkChar("dim_wdT_12"));
  SET_STRING_ELT(nms, 266, mkChar("dim_wdT_2"));
  SET_STRING_ELT(nms, 267, mkChar("dim_wdT_3"));
  SET_STRING_ELT(nms, 268, mkChar("dim_wdU"));
  SET_STRING_ELT(nms, 269, mkChar("dim_wdU_1"));
  SET_STRING_ELT(nms, 270, mkChar("dim_wdU_12"));
  SET_STRING_ELT(nms, 271, mkChar("dim_wdU_2"));
  SET_STRING_ELT(nms, 272, mkChar("dim_wdU_3"));
  SET_STRING_ELT(nms, 273, mkChar("dim_wI"));
  SET_STRING_ELT(nms, 274, mkChar("dim_wI_1"));
  SET_STRING_ELT(nms, 275, mkChar("dim_wI_12"));
  SET_STRING_ELT(nms, 276, mkChar("dim_wI_2"));
  SET_STRING_ELT(nms, 277, mkChar("dim_wI_3"));
  SET_STRING_ELT(nms, 278, mkChar("dim_willing"));
  SET_STRING_ELT(nms, 279, mkChar("dim_wS"));
  SET_STRING_ELT(nms, 280, mkChar("dim_wS_1"));
  SET_STRING_ELT(nms, 281, mkChar("dim_wS_12"));
  SET_STRING_ELT(nms, 282, mkChar("dim_wS_2"));
  SET_STRING_ELT(nms, 283, mkChar("dim_wS_3"));
  SET_STRING_ELT(nms, 284, mkChar("dim_wT"));
  SET_STRING_ELT(nms, 285, mkChar("dim_wT_1"));
  SET_STRING_ELT(nms, 286, mkChar("dim_wT_12"));
  SET_STRING_ELT(nms, 287, mkChar("dim_wT_2"));
  SET_STRING_ELT(nms, 288, mkChar("dim_wT_3"));
  SET_STRING_ELT(nms, 289, mkChar("dim_wU"));
  SET_STRING_ELT(nms, 290, mkChar("dim_wU_1"));
  SET_STRING_ELT(nms, 291, mkChar("dim_wU_12"));
  SET_STRING_ELT(nms, 292, mkChar("dim_wU_2"));
  SET_STRING_ELT(nms, 293, mkChar("dim_wU_3"));
  SET_STRING_ELT(nms, 294, mkChar("dim_xi"));
  SET_STRING_ELT(nms, 295, mkChar("dim_xi_1"));
  SET_STRING_ELT(nms, 296, mkChar("dim_xi_2"));
  SET_STRING_ELT(nms, 297, mkChar("enr"));
  SET_STRING_ELT(nms, 298, mkChar("entrants"));
  SET_STRING_ELT(nms, 299, mkChar("epsilon"));
  SET_STRING_ELT(nms, 300, mkChar("eta"));
  SET_STRING_ELT(nms, 301, mkChar("eta_h_t"));
  SET_STRING_ELT(nms, 302, mkChar("eta_l_t"));
  SET_STRING_ELT(nms, 303, mkChar("exr"));
  SET_STRING_ELT(nms, 304, mkChar("foi_LH"));
  SET_STRING_ELT(nms, 305, mkChar("I0"));
  SET_STRING_ELT(nms, 306, mkChar("initial_A"));
  SET_STRING_ELT(nms, 307, mkChar("initial_cum_diag_a"));
  SET_STRING_ELT(nms, 308, mkChar("initial_cum_diag_s"));
  SET_STRING_ELT(nms, 309, mkChar("initial_cum_entrants"));
  SET_STRING_ELT(nms, 310, mkChar("initial_cum_incid"));
  SET_STRING_ELT(nms, 311, mkChar("initial_cum_natrecover"));
  SET_STRING_ELT(nms, 312, mkChar("initial_cum_offered"));
  SET_STRING_ELT(nms, 313, mkChar("initial_cum_offered_pn"));
  SET_STRING_ELT(nms, 314, mkChar("initial_cum_offered_vbe"));
  SET_STRING_ELT(nms, 315, mkChar("initial_cum_phi"));
  SET_STRING_ELT(nms, 316, mkChar("initial_cum_screened"));
  SET_STRING_ELT(nms, 317, mkChar("initial_cum_treated"));
  SET_STRING_ELT(nms, 318, mkChar("initial_cum_vaccinated"));
  SET_STRING_ELT(nms, 319, mkChar("initial_cum_vaccinated_pn"));
  SET_STRING_ELT(nms, 320, mkChar("initial_cum_vaccinated_screen"));
  SET_STRING_ELT(nms, 321, mkChar("initial_cum_vbe"));
  SET_STRING_ELT(nms, 322, mkChar("initial_I"));
  SET_STRING_ELT(nms, 323, mkChar("initial_S"));
  SET_STRING_ELT(nms, 324, mkChar("initial_T"));
  SET_STRING_ELT(nms, 325, mkChar("initial_U"));
  SET_STRING_ELT(nms, 326, mkChar("interpolate_beta"));
  SET_STRING_ELT(nms, 327, mkChar("interpolate_eta_h"));
  SET_STRING_ELT(nms, 328, mkChar("interpolate_eta_l"));
  SET_STRING_ELT(nms, 329, mkChar("interpolate_vax_switch"));
  SET_STRING_ELT(nms, 330, mkChar("kappa"));
  SET_STRING_ELT(nms, 331, mkChar("lambda"));
  SET_STRING_ELT(nms, 332, mkChar("mu"));
  SET_STRING_ELT(nms, 333, mkChar("N"));
  SET_STRING_ELT(nms, 334, mkChar("n_AT"));
  SET_STRING_ELT(nms, 335, mkChar("n_AU"));
  SET_STRING_ELT(nms, 336, mkChar("n_diag_rec"));
  SET_STRING_ELT(nms, 337, mkChar("n_group"));
  SET_STRING_ELT(nms, 338, mkChar("n_obe"));
  SET_STRING_ELT(nms, 339, mkChar("n_ood"));
  SET_STRING_ELT(nms, 340, mkChar("n_oopn"));
  SET_STRING_ELT(nms, 341, mkChar("n_oos"));
  SET_STRING_ELT(nms, 342, mkChar("n_ST"));
  SET_STRING_ELT(nms, 343, mkChar("n_TU"));
  SET_STRING_ELT(nms, 344, mkChar("n_UI"));
  SET_STRING_ELT(nms, 345, mkChar("n_vax"));
  SET_STRING_ELT(nms, 346, mkChar("n_vbe"));
  SET_STRING_ELT(nms, 347, mkChar("n_vod"));
  SET_STRING_ELT(nms, 348, mkChar("n_vopn"));
  SET_STRING_ELT(nms, 349, mkChar("n_vos"));
  SET_STRING_ELT(nms, 350, mkChar("notifiedandattended"));
  SET_STRING_ELT(nms, 351, mkChar("notifiedprev"));
  SET_STRING_ELT(nms, 352, mkChar("Np"));
  SET_STRING_ELT(nms, 353, mkChar("nu"));
  SET_STRING_ELT(nms, 354, mkChar("offset_output_lambda"));
  SET_STRING_ELT(nms, 355, mkChar("offset_output_N"));
  SET_STRING_ELT(nms, 356, mkChar("offset_output_notifiedandattended"));
  SET_STRING_ELT(nms, 357, mkChar("offset_output_phi"));
  SET_STRING_ELT(nms, 358, mkChar("offset_variable_A"));
  SET_STRING_ELT(nms, 359, mkChar("offset_variable_cum_diag_a"));
  SET_STRING_ELT(nms, 360, mkChar("offset_variable_cum_diag_s"));
  SET_STRING_ELT(nms, 361, mkChar("offset_variable_cum_entrants"));
  SET_STRING_ELT(nms, 362, mkChar("offset_variable_cum_incid"));
  SET_STRING_ELT(nms, 363, mkChar("offset_variable_cum_natrecover"));
  SET_STRING_ELT(nms, 364, mkChar("offset_variable_cum_offered"));
  SET_STRING_ELT(nms, 365, mkChar("offset_variable_cum_offered_pn"));
  SET_STRING_ELT(nms, 366, mkChar("offset_variable_cum_offered_vbe"));
  SET_STRING_ELT(nms, 367, mkChar("offset_variable_cum_phi"));
  SET_STRING_ELT(nms, 368, mkChar("offset_variable_cum_screened"));
  SET_STRING_ELT(nms, 369, mkChar("offset_variable_cum_treated"));
  SET_STRING_ELT(nms, 370, mkChar("offset_variable_cum_vaccinated"));
  SET_STRING_ELT(nms, 371, mkChar("offset_variable_cum_vaccinated_pn"));
  SET_STRING_ELT(nms, 372, mkChar("offset_variable_cum_vaccinated_screen"));
  SET_STRING_ELT(nms, 373, mkChar("offset_variable_cum_vbe"));
  SET_STRING_ELT(nms, 374, mkChar("offset_variable_S"));
  SET_STRING_ELT(nms, 375, mkChar("offset_variable_T"));
  SET_STRING_ELT(nms, 376, mkChar("omega_C"));
  SET_STRING_ELT(nms, 377, mkChar("omega_C_withdiag"));
  SET_STRING_ELT(nms, 378, mkChar("omega_C_withdiag_rg"));
  SET_STRING_ELT(nms, 379, mkChar("omega_U"));
  SET_STRING_ELT(nms, 380, mkChar("omega_U_withdiag"));
  SET_STRING_ELT(nms, 381, mkChar("omega_U_withdiag_rg"));
  SET_STRING_ELT(nms, 382, mkChar("p"));
  SET_STRING_ELT(nms, 383, mkChar("phi"));
  SET_STRING_ELT(nms, 384, mkChar("prop_C"));
  SET_STRING_ELT(nms, 385, mkChar("prop_CCsubgroup"));
  ...
  SET_STRING_ELT(nms, 393, mkChar("T0"));
  SET_STRING_ELT(nms, 394, mkChar("tt"));
  SET_STRING_ELT(nms, 395, mkChar("u_d"));
  SET_STRING_ELT(nms, 396, mkChar("u_pn"));
  SET_STRING_ELT(nms, 397, mkChar("u_s"));
  SET_STRING_ELT(nms, 398, mkChar("u_vbe"));
  SET_STRING_ELT(nms, 399, mkChar("U0"));
  SET_STRING_ELT(nms, 400, mkChar("Up"));
  SET_STRING_ELT(nms, 401, mkChar("vax_t"));
  SET_STRING_ELT(nms, 402, mkChar("vax_y"));
  SET_STRING_ELT(nms, 403, mkChar("vbe"));
  SET_STRING_ELT(nms, 404, mkChar("vea"));
  SET_STRING_ELT(nms, 405, mkChar("ved"));
  SET_STRING_ELT(nms, 406, mkChar("vei"));
  SET_STRING_ELT(nms, 407, mkChar("ves"));
  SET_STRING_ELT(nms, 408, mkChar("vod"));
  SET_STRING_ELT(nms, 409, mkChar("vopn"));
  SET_STRING_ELT(nms, 410, mkChar("vos"));
  SET_STRING_ELT(nms, 411, mkChar("w"));
  SET_STRING_ELT(nms, 412, mkChar("wA"));
  SET_STRING_ELT(nms, 413, mkChar("wd"));
  SET_STRING_ELT(nms, 414, mkChar("wdA"));
  SET_STRING_ELT(nms, 415, mkChar("wdI"));
  SET_STRING_ELT(nms, 416, mkChar("wdS"));
  SET_STRING_ELT(nms, 417, mkChar("wdT"));
  SET_STRING_ELT(nms, 418, mkChar("wdU"));
  SET_STRING_ELT(nms, 419, mkChar("wI"));
  SET_STRING_ELT(nms, 420, mkChar("willing"));
  SET_STRING_ELT(nms, 421, mkChar("wS"));
  SET_STRING_ELT(nms, 422, mkChar("wT"));
  SET_STRING_ELT(nms, 423, mkChar("wU"));
  SET_STRING_ELT(nms, 424, mkChar("xi"));
...
SEXP model_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->dim_cum_natrecover_1 = internal->n_group;
  internal->dim_cum_natrecover_2 = internal->n_vax;
  ...
  internal->dim_cum_phi_1 = internal->n_group;
  internal->dim_cum_phi_2 = internal->n_vax;
  ...
  internal->dim_cum_natrecover = internal->dim_cum_natrecover_1 * internal->dim_cum_natrecover_2;
  ...
  internal->dim_cum_phi = internal->dim_cum_phi_1 * internal->dim_cum_phi_2;
  ...
  R_Free(internal->initial_cum_natrecover);
  internal->initial_cum_natrecover = (double*) R_Calloc(internal->dim_cum_natrecover, double);
  R_Free(internal->initial_cum_offered);
  ...
  R_Free(internal->initial_cum_phi);
  internal->initial_cum_phi = (double*) R_Calloc(internal->dim_cum_phi, double);
  R_Free(internal->initial_cum_screened);
  ...
  for (int i = 1; i <= internal->dim_cum_natrecover_1; ++i) {
    for (int j = 1; j <= internal->dim_cum_natrecover_2; ++j) {
      internal->initial_cum_natrecover[i - 1 + internal->dim_cum_natrecover_1 * (j - 1)] = 0;
    }
  }
  ...
  for (int i = 1; i <= internal->dim_cum_phi_1; ++i) {
    for (int j = 1; j <= internal->dim_cum_phi_2; ++j) {
      internal->initial_cum_phi[i - 1 + internal->dim_cum_phi_1 * (j - 1)] = 0;
    }
  }
  ...
  internal->offset_variable_cum_entrants = internal->dim_A + internal->dim_cum_diag_a + internal->dim_cum_diag_s + internal->dim_cum_incid + internal->dim_cum_natrecover + internal->dim_cum_offered + internal->dim_cum_offered_pn + internal->dim_cum_offered_vbe + internal->dim_cum_phi + internal->dim_cum_screened + internal->dim_cum_treated + internal->dim_cum_vaccinated + internal->dim_cum_vaccinated_pn + internal->dim_cum_vaccinated_screen + internal->dim_cum_vbe + internal->dim_I + internal->dim_S + internal->dim_T + internal->dim_U;
  internal->offset_variable_cum_incid = internal->dim_A + internal->dim_I + internal->dim_S + internal->dim_T + internal->dim_U;
  internal->offset_variable_cum_natrecover = internal->dim_A + internal->dim_cum_diag_a + internal->dim_cum_diag_s + internal->dim_cum_incid + internal->dim_cum_screened + internal->dim_cum_treated + internal->dim_I + internal->dim_S + internal->dim_T + internal->dim_U;
  internal->offset_variable_cum_offered = internal->dim_A + internal->dim_cum_diag_a + internal->dim_cum_diag_s + internal->dim_cum_incid + internal->dim_cum_natrecover + internal->dim_cum_phi + internal->dim_cum_screened + internal->dim_cum_treated + internal->dim_I + internal->dim_S + internal->dim_T + internal->dim_U;
  internal->offset_variable_cum_offered_pn = internal->dim_A + internal->dim_cum_diag_a + internal->dim_cum_diag_s + internal->dim_cum_incid + internal->dim_cum_natrecover + internal->dim_cum_offered + internal->dim_cum_phi + internal->dim_cum_screened + internal->dim_cum_treated + internal->dim_cum_vaccinated + internal->dim_cum_vaccinated_screen + internal->dim_I + internal->dim_S + internal->dim_T + internal->dim_U;
  internal->offset_variable_cum_offered_vbe = internal->dim_A + internal->dim_cum_diag_a + internal->dim_cum_diag_s + internal->dim_cum_incid + internal->dim_cum_natrecover + internal->dim_cum_offered + internal->dim_cum_offered_pn + internal->dim_cum_phi + internal->dim_cum_screened + internal->dim_cum_treated + internal->dim_cum_vaccinated + internal->dim_cum_vaccinated_pn + internal->dim_cum_vaccinated_screen + internal->dim_cum_vbe + internal->dim_I + internal->dim_S + internal->dim_T + internal->dim_U;
  internal->offset_variable_cum_phi = internal->dim_A + internal->dim_cum_diag_a + internal->dim_cum_diag_s + internal->dim_cum_incid + internal->dim_cum_natrecover + internal->dim_cum_screened + internal->dim_cum_treated + internal->dim_I + internal->dim_S + internal->dim_T + internal->dim_U;
  ...
  internal->offset_variable_cum_vaccinated = internal->dim_A + internal->dim_cum_diag_a + internal->dim_cum_diag_s + internal->dim_cum_incid + internal->dim_cum_natrecover + internal->dim_cum_offered + internal->dim_cum_phi + internal->dim_cum_screened + internal->dim_cum_treated + internal->dim_I + internal->dim_S + internal->dim_T + internal->dim_U;
  internal->offset_variable_cum_vaccinated_pn = internal->dim_A + internal->dim_cum_diag_a + internal->dim_cum_diag_s + internal->dim_cum_incid + internal->dim_cum_natrecover + internal->dim_cum_offered + internal->dim_cum_offered_pn + internal->dim_cum_phi + internal->dim_cum_screened + internal->dim_cum_treated + internal->dim_cum_vaccinated + internal->dim_cum_vaccinated_screen + internal->dim_I + internal->dim_S + internal->dim_T + internal->dim_U;
  internal->offset_variable_cum_vaccinated_screen = internal->dim_A + internal->dim_cum_diag_a + internal->dim_cum_diag_s + internal->dim_cum_incid + internal->dim_cum_natrecover + internal->dim_cum_offered + internal->dim_cum_phi + internal->dim_cum_screened + internal->dim_cum_treated + internal->dim_cum_vaccinated + internal->dim_I + internal->dim_S + internal->dim_T + internal->dim_U;
  internal->offset_variable_cum_vbe = internal->dim_A + internal->dim_cum_diag_a + internal->dim_cum_diag_s + internal->dim_cum_incid + internal->dim_cum_natrecover + internal->dim_cum_offered + internal->dim_cum_offered_pn + internal->dim_cum_phi + internal->dim_cum_screened + internal->dim_cum_treated + internal->dim_cum_vaccinated + internal->dim_cum_vaccinated_pn + internal->dim_cum_vaccinated_screen + internal->dim_I + internal->dim_S + internal->dim_T + internal->dim_U;
...
SEXP model_metadata(SEXP internal_p) {
  ...
  int * dim_cum_natrecover = INTEGER(VECTOR_ELT(variable_length, 10));
  dim_cum_natrecover[0] = internal->dim_cum_natrecover_1;
  dim_cum_natrecover[1] = internal->dim_cum_natrecover_2;
  SET_VECTOR_ELT(variable_length, 11, allocVector(INTSXP, 2));
  int * dim_cum_phi = INTEGER(VECTOR_ELT(variable_length, 11));
  dim_cum_phi[0] = internal->dim_cum_phi_1;
  dim_cum_phi[1] = internal->dim_cum_phi_2;
  SET_VECTOR_ELT(variable_length, 12, allocVector(INTSXP, 2));
  int * dim_cum_offered = INTEGER(VECTOR_ELT(variable_length, 12));
  ...
  int * dim_cum_vaccinated = INTEGER(VECTOR_ELT(variable_length, 13));
  ...
  int * dim_cum_vaccinated_screen = INTEGER(VECTOR_ELT(variable_length, 14));
  ...
  int * dim_cum_offered_pn = INTEGER(VECTOR_ELT(variable_length, 15));
  ...
  int * dim_cum_vaccinated_pn = INTEGER(VECTOR_ELT(variable_length, 16));
  ...
  int * dim_cum_vbe = INTEGER(VECTOR_ELT(variable_length, 17));
  ...
  int * dim_cum_offered_vbe = INTEGER(VECTOR_ELT(variable_length, 18));
  ...
  int * dim_cum_entrants = INTEGER(VECTOR_ELT(variable_length, 19));
  ...
  SET_STRING_ELT(variable_names, 10, mkChar("cum_natrecover"));
  SET_STRING_ELT(variable_names, 11, mkChar("cum_phi"));
  SET_STRING_ELT(variable_names, 12, mkChar("cum_offered"));
  SET_STRING_ELT(variable_names, 13, mkChar("cum_vaccinated"));
  SET_STRING_ELT(variable_names, 14, mkChar("cum_vaccinated_screen"));
  SET_STRING_ELT(variable_names, 15, mkChar("cum_offered_pn"));
  SET_STRING_ELT(variable_names, 16, mkChar("cum_vaccinated_pn"));
  SET_STRING_ELT(variable_names, 17, mkChar("cum_vbe"));
  SET_STRING_ELT(variable_names, 18, mkChar("cum_offered_vbe"));
  SET_STRING_ELT(variable_names, 19, mkChar("cum_entrants"));
...
SEXP model_initial_conditions(SEXP internal_p, SEXP t_ptr) {
  model_internal *internal = model_get_internal(internal_p, 1);
  SEXP r_state = PROTECT(allocVector(REALSXP, internal->dim_A + internal->dim_cum_diag_a + internal->dim_cum_diag_s + internal->dim_cum_entrants + internal->dim_cum_incid + internal->dim_cum_natrecover + internal->dim_cum_offered + internal->dim_cum_offered_pn + internal->dim_cum_offered_vbe + internal->dim_cum_phi + internal->dim_cum_screened + internal->dim_cum_treated + internal->dim_cum_vaccinated + internal->dim_cum_vaccinated_pn + internal->dim_cum_vaccinated_screen + internal->dim_cum_vbe + internal->dim_I + internal->dim_S + internal->dim_T + internal->dim_U));
  ...
  memcpy(state + internal->offset_variable_cum_natrecover, internal->initial_cum_natrecover, internal->dim_cum_natrecover * sizeof(double));
  memcpy(state + internal->offset_variable_cum_phi, internal->initial_cum_phi, internal->dim_cum_phi * sizeof(double));
...
void model_rhs(model_internal* internal, double t, double * state, double * dstatedt, double * output) {
  ...
  for (int i = 1; i <= internal->dim_cum_natrecover_1; ++i) {
    for (int j = 1; j <= internal->dim_cum_natrecover_2; ++j) {
      dstatedt[internal->offset_variable_cum_natrecover + i - 1 + internal->dim_cum_natrecover_1 * (j - 1)] = internal->n_AU[internal->dim_n_AU_1 * (j - 1) + i - 1];
    }
  }
  for (int i = 1; i <= internal->dim_cum_treated_1; ++i) {
    for (int j = 1; j <= internal->dim_cum_treated_2; ++j) {
  ...
  for (int i = 1; i <= internal->dim_cum_phi_1; ++i) {
    for (int j = 1; j <= internal->dim_cum_phi_2; ++j) {
      dstatedt[internal->offset_variable_cum_phi + i - 1 + internal->dim_cum_phi_1 * (j - 1)] = internal->phi[internal->dim_phi_1 * (j - 1) + i - 1];
    }
  }
  for (int i = 1; i <= internal->dim_cum_vaccinated_screen_1; ++i) {
    for (int j = 1; j <= internal->dim_cum_vaccinated_screen_2; ++j) {
...
void model_trial_finalise(SEXP internal_p) {
  ...
  if (internal_p) {
    ...
    R_Free(internal->initial_cum_diag_s);
    R_Free(internal->initial_cum_incid);
    R_Free(internal->initial_cum_pye_noscreen_trial_pov);
    ...
    R_Free(internal->n_TU);
    R_Free(internal->n_UI);
    R_Free(internal->pye_noscreen_trial);
...
SEXP model_trial_create(SEXP user) {
  ...
  internal->initial_cum_diag_s = NULL;
  internal->initial_cum_incid = NULL;
  internal->initial_cum_pye_noscreen_trial_pov = NULL;
  ...
  internal->n_TU = NULL;
  internal->n_UI = NULL;
  internal->pye_noscreen_trial = NULL;
...
SEXP model_trial_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 186));
  SEXP A0 = PROTECT(allocVector(REALSXP, internal->dim_A0));
  memcpy(REAL(A0), internal->A0, internal->dim_A0 * sizeof(double));
  odin_set_dim(A0, 2, internal->dim_A0_1, internal->dim_A0_2);
  SET_VECTOR_ELT(contents, 0, A0);
  ...
  SET_VECTOR_ELT(contents, 18, ScalarInteger(internal->dim_cum_pye_noscreen_trial_pov));
  SET_VECTOR_ELT(contents, 19, ScalarInteger(internal->dim_cum_pye_noscreen_trial_pov_1));
  SET_VECTOR_ELT(contents, 20, ScalarInteger(internal->dim_cum_pye_noscreen_trial_pov_2));
  SET_VECTOR_ELT(contents, 21, ScalarInteger(internal->dim_cum_pye_trial_pov));
  SET_VECTOR_ELT(contents, 22, ScalarInteger(internal->dim_cum_pye_trial_pov_1));
  SET_VECTOR_ELT(contents, 23, ScalarInteger(internal->dim_cum_pye_trial_pov_2));
  SET_VECTOR_ELT(contents, 24, ScalarInteger(internal->dim_cum_pye_true));
  SET_VECTOR_ELT(contents, 25, ScalarInteger(internal->dim_cum_pye_true_1));
  SET_VECTOR_ELT(contents, 26, ScalarInteger(internal->dim_cum_pye_true_2));
  SET_VECTOR_ELT(contents, 27, ScalarInteger(internal->dim_cum_screened));
  SET_VECTOR_ELT(contents, 28, ScalarInteger(internal->dim_cum_screened_1));
  SET_VECTOR_ELT(contents, 29, ScalarInteger(internal->dim_cum_screened_2));
  SET_VECTOR_ELT(contents, 30, ScalarInteger(internal->dim_cum_treated));
  SET_VECTOR_ELT(contents, 31, ScalarInteger(internal->dim_cum_treated_1));
  SET_VECTOR_ELT(contents, 32, ScalarInteger(internal->dim_cum_treated_2));
  SET_VECTOR_ELT(contents, 33, ScalarInteger(internal->dim_diag_rec_a));
  SET_VECTOR_ELT(contents, 34, ScalarInteger(internal->dim_diag_rec_a_1));
  SET_VECTOR_ELT(contents, 35, ScalarInteger(internal->dim_diag_rec_a_12));
  SET_VECTOR_ELT(contents, 36, ScalarInteger(internal->dim_diag_rec_a_2));
  SET_VECTOR_ELT(contents, 37, ScalarInteger(internal->dim_diag_rec_a_3));
  SET_VECTOR_ELT(contents, 38, ScalarInteger(internal->dim_diag_rec_s));
  SET_VECTOR_ELT(contents, 39, ScalarInteger(internal->dim_diag_rec_s_1));
  SET_VECTOR_ELT(contents, 40, ScalarInteger(internal->dim_diag_rec_s_12));
  SET_VECTOR_ELT(contents, 41, ScalarInteger(internal->dim_diag_rec_s_2));
  SET_VECTOR_ELT(contents, 42, ScalarInteger(internal->dim_diag_rec_s_3));
  SET_VECTOR_ELT(contents, 43, ScalarInteger(internal->dim_I));
  SET_VECTOR_ELT(contents, 44, ScalarInteger(internal->dim_I_1));
  SET_VECTOR_ELT(contents, 45, ScalarInteger(internal->dim_I_2));
  SET_VECTOR_ELT(contents, 46, ScalarInteger(internal->dim_I0));
  SET_VECTOR_ELT(contents, 47, ScalarInteger(internal->dim_I0_1));
  SET_VECTOR_ELT(contents, 48, ScalarInteger(internal->dim_I0_2));
  SET_VECTOR_ELT(contents, 49, ScalarInteger(internal->dim_N));
  SET_VECTOR_ELT(contents, 50, ScalarInteger(internal->dim_N_1));
  SET_VECTOR_ELT(contents, 51, ScalarInteger(internal->dim_N_2));
  SET_VECTOR_ELT(contents, 52, ScalarInteger(internal->dim_n_AT));
  SET_VECTOR_ELT(contents, 53, ScalarInteger(internal->dim_n_AT_1));
  SET_VECTOR_ELT(contents, 54, ScalarInteger(internal->dim_n_AT_2));
  SET_VECTOR_ELT(contents, 55, ScalarInteger(internal->dim_n_AU));
  SET_VECTOR_ELT(contents, 56, ScalarInteger(internal->dim_n_AU_1));
  SET_VECTOR_ELT(contents, 57, ScalarInteger(internal->dim_n_AU_2));
  SET_VECTOR_ELT(contents, 58, ScalarInteger(internal->dim_n_diag_rec));
  SET_VECTOR_ELT(contents, 59, ScalarInteger(internal->dim_n_diag_rec_1));
  SET_VECTOR_ELT(contents, 60, ScalarInteger(internal->dim_n_diag_rec_12));
  SET_VECTOR_ELT(contents, 61, ScalarInteger(internal->dim_n_diag_rec_2));
  SET_VECTOR_ELT(contents, 62, ScalarInteger(internal->dim_n_diag_rec_3));
  SET_VECTOR_ELT(contents, 63, ScalarInteger(internal->dim_n_ST));
  SET_VECTOR_ELT(contents, 64, ScalarInteger(internal->dim_n_ST_1));
  SET_VECTOR_ELT(contents, 65, ScalarInteger(internal->dim_n_ST_2));
  SET_VECTOR_ELT(contents, 66, ScalarInteger(internal->dim_n_TU));
  SET_VECTOR_ELT(contents, 67, ScalarInteger(internal->dim_n_TU_1));
  SET_VECTOR_ELT(contents, 68, ScalarInteger(internal->dim_n_TU_2));
  SET_VECTOR_ELT(contents, 69, ScalarInteger(internal->dim_n_UI));
  SET_VECTOR_ELT(contents, 70, ScalarInteger(internal->dim_n_UI_1));
  SET_VECTOR_ELT(contents, 71, ScalarInteger(internal->dim_n_UI_2));
  SET_VECTOR_ELT(contents, 72, ScalarInteger(internal->dim_pye_noscreen_trial));
  SET_VECTOR_ELT(contents, 73, ScalarInteger(internal->dim_pye_noscreen_trial_1));
  SET_VECTOR_ELT(contents, 74, ScalarInteger(internal->dim_pye_noscreen_trial_2));
  SET_VECTOR_ELT(contents, 75, ScalarInteger(internal->dim_pye_trial));
  SET_VECTOR_ELT(contents, 76, ScalarInteger(internal->dim_pye_trial_1));
  SET_VECTOR_ELT(contents, 77, ScalarInteger(internal->dim_pye_trial_2));
  SET_VECTOR_ELT(contents, 78, ScalarInteger(internal->dim_S));
  SET_VECTOR_ELT(contents, 79, ScalarInteger(internal->dim_S_1));
  SET_VECTOR_ELT(contents, 80, ScalarInteger(internal->dim_S_2));
  SET_VECTOR_ELT(contents, 81, ScalarInteger(internal->dim_S0));
  SET_VECTOR_ELT(contents, 82, ScalarInteger(internal->dim_S0_1));
  SET_VECTOR_ELT(contents, 83, ScalarInteger(internal->dim_S0_2));
  SET_VECTOR_ELT(contents, 84, ScalarInteger(internal->dim_screened));
  SET_VECTOR_ELT(contents, 85, ScalarInteger(internal->dim_screened_1));
  SET_VECTOR_ELT(contents, 86, ScalarInteger(internal->dim_screened_2));
  SET_VECTOR_ELT(contents, 87, ScalarInteger(internal->dim_T));
  SET_VECTOR_ELT(contents, 88, ScalarInteger(internal->dim_T_1));
  SET_VECTOR_ELT(contents, 89, ScalarInteger(internal->dim_T_2));
  SET_VECTOR_ELT(contents, 90, ScalarInteger(internal->dim_T0));
  SET_VECTOR_ELT(contents, 91, ScalarInteger(internal->dim_T0_1));
  SET_VECTOR_ELT(contents, 92, ScalarInteger(internal->dim_T0_2));
  SET_VECTOR_ELT(contents, 93, ScalarInteger(internal->dim_U));
  SET_VECTOR_ELT(contents, 94, ScalarInteger(internal->dim_U_1));
  SET_VECTOR_ELT(contents, 95, ScalarInteger(internal->dim_U_2));
  SET_VECTOR_ELT(contents, 96, ScalarInteger(internal->dim_U0));
  SET_VECTOR_ELT(contents, 97, ScalarInteger(internal->dim_U0_1));
  SET_VECTOR_ELT(contents, 98, ScalarInteger(internal->dim_U0_2));
  SET_VECTOR_ELT(contents, 99, ScalarInteger(internal->dim_vea));
  SET_VECTOR_ELT(contents, 100, ScalarInteger(internal->dim_ved));
  SET_VECTOR_ELT(contents, 101, ScalarInteger(internal->dim_ves));
  SET_VECTOR_ELT(contents, 102, ScalarInteger(internal->dim_w));
  SET_VECTOR_ELT(contents, 103, ScalarInteger(internal->dim_w_1));
  SET_VECTOR_ELT(contents, 104, ScalarInteger(internal->dim_w_2));
  SET_VECTOR_ELT(contents, 105, ScalarInteger(internal->dim_wA));
  SET_VECTOR_ELT(contents, 106, ScalarInteger(internal->dim_wA_1));
  SET_VECTOR_ELT(contents, 107, ScalarInteger(internal->dim_wA_12));
  SET_VECTOR_ELT(contents, 108, ScalarInteger(internal->dim_wA_2));
  SET_VECTOR_ELT(contents, 109, ScalarInteger(internal->dim_wA_3));
  SET_VECTOR_ELT(contents, 110, ScalarInteger(internal->dim_wI));
  SET_VECTOR_ELT(contents, 111, ScalarInteger(internal->dim_wI_1));
  SET_VECTOR_ELT(contents, 112, ScalarInteger(internal->dim_wI_12));
  SET_VECTOR_ELT(contents, 113, ScalarInteger(internal->dim_wI_2));
  SET_VECTOR_ELT(contents, 114, ScalarInteger(internal->dim_wI_3));
  SET_VECTOR_ELT(contents, 115, ScalarInteger(internal->dim_wS));
  SET_VECTOR_ELT(contents, 116, ScalarInteger(internal->dim_wS_1));
  SET_VECTOR_ELT(contents, 117, ScalarInteger(internal->dim_wS_12));
  SET_VECTOR_ELT(contents, 118, ScalarInteger(internal->dim_wS_2));
  SET_VECTOR_ELT(contents, 119, ScalarInteger(internal->dim_wS_3));
  SET_VECTOR_ELT(contents, 120, ScalarInteger(internal->dim_wT));
  SET_VECTOR_ELT(contents, 121, ScalarInteger(internal->dim_wT_1));
  SET_VECTOR_ELT(contents, 122, ScalarInteger(internal->dim_wT_12));
  SET_VECTOR_ELT(contents, 123, ScalarInteger(internal->dim_wT_2));
  SET_VECTOR_ELT(contents, 124, ScalarInteger(internal->dim_wT_3));
  SET_VECTOR_ELT(contents, 125, ScalarInteger(internal->dim_wU));
  SET_VECTOR_ELT(contents, 126, ScalarInteger(internal->dim_wU_1));
  SET_VECTOR_ELT(contents, 127, ScalarInteger(internal->dim_wU_12));
  SET_VECTOR_ELT(contents, 128, ScalarInteger(internal->dim_wU_2));
  SET_VECTOR_ELT(contents, 129, ScalarInteger(internal->dim_wU_3));
  SET_VECTOR_ELT(contents, 130, ScalarReal(internal->eta));
  SEXP I0 = PROTECT(allocVector(REALSXP, internal->dim_I0));
  memcpy(REAL(I0), internal->I0, internal->dim_I0 * sizeof(double));
  odin_set_dim(I0, 2, internal->dim_I0_1, internal->dim_I0_2);
  SET_VECTOR_ELT(contents, 131, I0);
  SEXP initial_A = PROTECT(allocVector(REALSXP, internal->dim_A));
  memcpy(REAL(initial_A), internal->initial_A, internal->dim_A * sizeof(double));
  odin_set_dim(initial_A, 2, internal->dim_A_1, internal->dim_A_2);
  SET_VECTOR_ELT(contents, 132, initial_A);
  SEXP initial_cum_diag_a = PROTECT(allocVector(REALSXP, internal->dim_cum_diag_a));
  memcpy(REAL(initial_cum_diag_a), internal->initial_cum_diag_a, internal->dim_cum_diag_a * sizeof(double));
  odin_set_dim(initial_cum_diag_a, 2, internal->dim_cum_diag_a_1, internal->dim_cum_diag_a_2);
  SET_VECTOR_ELT(contents, 133, initial_cum_diag_a);
  SEXP initial_cum_diag_s = PROTECT(allocVector(REALSXP, internal->dim_cum_diag_s));
  memcpy(REAL(initial_cum_diag_s), internal->initial_cum_diag_s, internal->dim_cum_diag_s * sizeof(double));
  odin_set_dim(initial_cum_diag_s, 2, internal->dim_cum_diag_s_1, internal->dim_cum_diag_s_2);
  SET_VECTOR_ELT(contents, 134, initial_cum_diag_s);
  SEXP initial_cum_incid = PROTECT(allocVector(REALSXP, internal->dim_cum_incid));
  memcpy(REAL(initial_cum_incid), internal->initial_cum_incid, internal->dim_cum_incid * sizeof(double));
  odin_set_dim(initial_cum_incid, 2, internal->dim_cum_incid_1, internal->dim_cum_incid_2);
  SET_VECTOR_ELT(contents, 135, initial_cum_incid);
  SEXP initial_cum_pye_noscreen_trial_pov = PROTECT(allocVector(REALSXP, internal->dim_cum_pye_noscreen_trial_pov));
  memcpy(REAL(initial_cum_pye_noscreen_trial_pov), internal->initial_cum_pye_noscreen_trial_pov, internal->dim_cum_pye_noscreen_trial_pov * sizeof(double));
  odin_set_dim(initial_cum_pye_noscreen_trial_pov, 2, internal->dim_cum_pye_noscreen_trial_pov_1, internal->dim_cum_pye_noscreen_trial_pov_2);
  SET_VECTOR_ELT(contents, 136, initial_cum_pye_noscreen_trial_pov);
  ...
  SET_VECTOR_ELT(contents, 137, initial_cum_pye_trial_pov);
  ...
  SET_VECTOR_ELT(contents, 138, initial_cum_pye_true);
  SEXP initial_cum_screened = PROTECT(allocVector(REALSXP, internal->dim_cum_screened));
  memcpy(REAL(initial_cum_screened), internal->initial_cum_screened, internal->dim_cum_screened * sizeof(double));
  odin_set_dim(initial_cum_screened, 2, internal->dim_cum_screened_1, internal->dim_cum_screened_2);
  SET_VECTOR_ELT(contents, 139, initial_cum_screened);
  SEXP initial_cum_treated = PROTECT(allocVector(REALSXP, internal->dim_cum_treated));
  memcpy(REAL(initial_cum_treated), internal->initial_cum_treated, internal->dim_cum_treated * sizeof(double));
  odin_set_dim(initial_cum_treated, 2, internal->dim_cum_treated_1, internal->dim_cum_treated_2);
  SET_VECTOR_ELT(contents, 140, initial_cum_treated);
  SEXP initial_I = PROTECT(allocVector(REALSXP, internal->dim_I));
  memcpy(REAL(initial_I), internal->initial_I, internal->dim_I * sizeof(double));
  odin_set_dim(initial_I, 2, internal->dim_I_1, internal->dim_I_2);
  SET_VECTOR_ELT(contents, 141, initial_I);
  SEXP initial_S = PROTECT(allocVector(REALSXP, internal->dim_S));
  memcpy(REAL(initial_S), internal->initial_S, internal->dim_S * sizeof(double));
  odin_set_dim(initial_S, 2, internal->dim_S_1, internal->dim_S_2);
  SET_VECTOR_ELT(contents, 142, initial_S);
  SEXP initial_T = PROTECT(allocVector(REALSXP, internal->dim_T));
  memcpy(REAL(initial_T), internal->initial_T, internal->dim_T * sizeof(double));
  odin_set_dim(initial_T, 2, internal->dim_T_1, internal->dim_T_2);
  SET_VECTOR_ELT(contents, 143, initial_T);
  SEXP initial_U = PROTECT(allocVector(REALSXP, internal->dim_U));
  memcpy(REAL(initial_U), internal->initial_U, internal->dim_U * sizeof(double));
  odin_set_dim(initial_U, 2, internal->dim_U_1, internal->dim_U_2);
  SET_VECTOR_ELT(contents, 144, initial_U);
  SET_VECTOR_ELT(contents, 145, ScalarReal(internal->lambda));
  SET_VECTOR_ELT(contents, 146, ScalarReal(internal->mu));
  SEXP N = PROTECT(allocVector(REALSXP, internal->dim_N));
  memcpy(REAL(N), internal->N, internal->dim_N * sizeof(double));
  odin_set_dim(N, 2, internal->dim_N_1, internal->dim_N_2);
  SET_VECTOR_ELT(contents, 147, N);
  SEXP n_AT = PROTECT(allocVector(REALSXP, internal->dim_n_AT));
  memcpy(REAL(n_AT), internal->n_AT, internal->dim_n_AT * sizeof(double));
  odin_set_dim(n_AT, 2, internal->dim_n_AT_1, internal->dim_n_AT_2);
  SET_VECTOR_ELT(contents, 148, n_AT);
  SEXP n_AU = PROTECT(allocVector(REALSXP, internal->dim_n_AU));
  memcpy(REAL(n_AU), internal->n_AU, internal->dim_n_AU * sizeof(double));
  odin_set_dim(n_AU, 2, internal->dim_n_AU_1, internal->dim_n_AU_2);
  SET_VECTOR_ELT(contents, 149, n_AU);
  SEXP n_diag_rec = PROTECT(allocVector(REALSXP, internal->dim_n_diag_rec));
  memcpy(REAL(n_diag_rec), internal->n_diag_rec, internal->dim_n_diag_rec * sizeof(double));
  odin_set_dim(n_diag_rec, 3, internal->dim_n_diag_rec_1, internal->dim_n_diag_rec_2, internal->dim_n_diag_rec_3);
  SET_VECTOR_ELT(contents, 150, n_diag_rec);
  SET_VECTOR_ELT(contents, 151, ScalarInteger(internal->n_group));
  SEXP n_ST = PROTECT(allocVector(REALSXP, internal->dim_n_ST));
  memcpy(REAL(n_ST), internal->n_ST, internal->dim_n_ST * sizeof(double));
  odin_set_dim(n_ST, 2, internal->dim_n_ST_1, internal->dim_n_ST_2);
  SET_VECTOR_ELT(contents, 152, n_ST);
  SEXP n_TU = PROTECT(allocVector(REALSXP, internal->dim_n_TU));
  memcpy(REAL(n_TU), internal->n_TU, internal->dim_n_TU * sizeof(double));
  odin_set_dim(n_TU, 2, internal->dim_n_TU_1, internal->dim_n_TU_2);
  SET_VECTOR_ELT(contents, 153, n_TU);
  SEXP n_UI = PROTECT(allocVector(REALSXP, internal->dim_n_UI));
  memcpy(REAL(n_UI), internal->n_UI, internal->dim_n_UI * sizeof(double));
  odin_set_dim(n_UI, 2, internal->dim_n_UI_1, internal->dim_n_UI_2);
  SET_VECTOR_ELT(contents, 154, n_UI);
  SET_VECTOR_ELT(contents, 155, ScalarInteger(internal->n_vax));
  SET_VECTOR_ELT(contents, 156, ScalarReal(internal->nu));
  SET_VECTOR_ELT(contents, 157, ScalarInteger(internal->offset_variable_A));
  SET_VECTOR_ELT(contents, 158, ScalarInteger(internal->offset_variable_cum_diag_a));
  SET_VECTOR_ELT(contents, 159, ScalarInteger(internal->offset_variable_cum_diag_s));
  SET_VECTOR_ELT(contents, 160, ScalarInteger(internal->offset_variable_cum_incid));
  SET_VECTOR_ELT(contents, 161, ScalarInteger(internal->offset_variable_cum_pye_noscreen_trial_pov));
  SET_VECTOR_ELT(contents, 162, ScalarInteger(internal->offset_variable_cum_pye_trial_pov));
  SET_VECTOR_ELT(contents, 163, ScalarInteger(internal->offset_variable_cum_pye_true));
  SET_VECTOR_ELT(contents, 164, ScalarInteger(internal->offset_variable_cum_screened));
  SET_VECTOR_ELT(contents, 165, ScalarInteger(internal->offset_variable_cum_treated));
  SET_VECTOR_ELT(contents, 166, ScalarInteger(internal->offset_variable_S));
  SET_VECTOR_ELT(contents, 167, ScalarInteger(internal->offset_variable_T));
  SET_VECTOR_ELT(contents, 168, ScalarReal(internal->psi));
  SEXP pye_noscreen_trial = PROTECT(allocVector(REALSXP, internal->dim_pye_noscreen_trial));
  memcpy(REAL(pye_noscreen_trial), internal->pye_noscreen_trial, internal->dim_pye_noscreen_trial * sizeof(double));
  odin_set_dim(pye_noscreen_trial, 2, internal->dim_pye_noscreen_trial_1, internal->dim_pye_noscreen_trial_2);
  SET_VECTOR_ELT(contents, 169, pye_noscreen_trial);
  ...
  SET_VECTOR_ELT(contents, 170, pye_trial);
  SET_VECTOR_ELT(contents, 171, ScalarReal(internal->rho));
  SEXP S0 = PROTECT(allocVector(REALSXP, internal->dim_S0));
  memcpy(REAL(S0), internal->S0, internal->dim_S0 * sizeof(double));
  odin_set_dim(S0, 2, internal->dim_S0_1, internal->dim_S0_2);
  SET_VECTOR_ELT(contents, 172, S0);
  SEXP screened = PROTECT(allocVector(REALSXP, internal->dim_screened));
  memcpy(REAL(screened), internal->screened, internal->dim_screened * sizeof(double));
  odin_set_dim(screened, 2, internal->dim_screened_1, internal->dim_screened_2);
  SET_VECTOR_ELT(contents, 173, screened);
  SET_VECTOR_ELT(contents, 174, ScalarReal(internal->sigma));
  SEXP T0 = PROTECT(allocVector(REALSXP, internal->dim_T0));
  memcpy(REAL(T0), internal->T0, internal->dim_T0 * sizeof(double));
  odin_set_dim(T0, 2, internal->dim_T0_1, internal->dim_T0_2);
  SET_VECTOR_ELT(contents, 175, T0);
  SEXP U0 = PROTECT(allocVector(REALSXP, internal->dim_U0));
  memcpy(REAL(U0), internal->U0, internal->dim_U0 * sizeof(double));
  odin_set_dim(U0, 2, internal->dim_U0_1, internal->dim_U0_2);
  SET_VECTOR_ELT(contents, 176, U0);
  SEXP vea = PROTECT(allocVector(REALSXP, internal->dim_vea));
  memcpy(REAL(vea), internal->vea, internal->dim_vea * sizeof(double));
  SET_VECTOR_ELT(contents, 177, vea);
  SEXP ved = PROTECT(allocVector(REALSXP, internal->dim_ved));
  memcpy(REAL(ved), internal->ved, internal->dim_ved * sizeof(double));
  SET_VECTOR_ELT(contents, 178, ved);
  SEXP ves = PROTECT(allocVector(REALSXP, internal->dim_ves));
  memcpy(REAL(ves), internal->ves, internal->dim_ves * sizeof(double));
  SET_VECTOR_ELT(contents, 179, ves);
  SEXP w = PROTECT(allocVector(REALSXP, internal->dim_w));
  memcpy(REAL(w), internal->w, internal->dim_w * sizeof(double));
  odin_set_dim(w, 2, internal->dim_w_1, internal->dim_w_2);
  SET_VECTOR_ELT(contents, 180, w);
  SEXP wA = PROTECT(allocVector(REALSXP, internal->dim_wA));
  memcpy(REAL(wA), internal->wA, internal->dim_wA * sizeof(double));
  odin_set_dim(wA, 3, internal->dim_wA_1, internal->dim_wA_2, internal->dim_wA_3);
  SET_VECTOR_ELT(contents, 181, wA);
  SEXP wI = PROTECT(allocVector(REALSXP, internal->dim_wI));
  memcpy(REAL(wI), internal->wI, internal->dim_wI * sizeof(double));
  odin_set_dim(wI, 3, internal->dim_wI_1, internal->dim_wI_2, internal->dim_wI_3);
  SET_VECTOR_ELT(contents, 182, wI);
  SEXP wS = PROTECT(allocVector(REALSXP, internal->dim_wS));
  memcpy(REAL(wS), internal->wS, internal->dim_wS * sizeof(double));
  odin_set_dim(wS, 3, internal->dim_wS_1, internal->dim_wS_2, internal->dim_wS_3);
  SET_VECTOR_ELT(contents, 183, wS);
  SEXP wT = PROTECT(allocVector(REALSXP, internal->dim_wT));
  memcpy(REAL(wT), internal->wT, internal->dim_wT * sizeof(double));
  odin_set_dim(wT, 3, internal->dim_wT_1, internal->dim_wT_2, internal->dim_wT_3);
  SET_VECTOR_ELT(contents, 184, wT);
  SEXP wU = PROTECT(allocVector(REALSXP, internal->dim_wU));
  memcpy(REAL(wU), internal->wU, internal->dim_wU * sizeof(double));
  odin_set_dim(wU, 3, internal->dim_wU_1, internal->dim_wU_2, internal->dim_wU_3);
  SET_VECTOR_ELT(contents, 185, wU);
  SEXP nms = PROTECT(allocVector(STRSXP, 186));
  SET_STRING_ELT(nms, 0, mkChar("A0"));
  ...
  SET_STRING_ELT(nms, 18, mkChar("dim_cum_pye_noscreen_trial_pov"));
  SET_STRING_ELT(nms, 19, mkChar("dim_cum_pye_noscreen_trial_pov_1"));
  SET_STRING_ELT(nms, 20, mkChar("dim_cum_pye_noscreen_trial_pov_2"));
  SET_STRING_ELT(nms, 21, mkChar("dim_cum_pye_trial_pov"));
  SET_STRING_ELT(nms, 22, mkChar("dim_cum_pye_trial_pov_1"));
  SET_STRING_ELT(nms, 23, mkChar("dim_cum_pye_trial_pov_2"));
  SET_STRING_ELT(nms, 24, mkChar("dim_cum_pye_true"));
  SET_STRING_ELT(nms, 25, mkChar("dim_cum_pye_true_1"));
  SET_STRING_ELT(nms, 26, mkChar("dim_cum_pye_true_2"));
  SET_STRING_ELT(nms, 27, mkChar("dim_cum_screened"));
  SET_STRING_ELT(nms, 28, mkChar("dim_cum_screened_1"));
  SET_STRING_ELT(nms, 29, mkChar("dim_cum_screened_2"));
  SET_STRING_ELT(nms, 30, mkChar("dim_cum_treated"));
  SET_STRING_ELT(nms, 31, mkChar("dim_cum_treated_1"));
  SET_STRING_ELT(nms, 32, mkChar("dim_cum_treated_2"));
  SET_STRING_ELT(nms, 33, mkChar("dim_diag_rec_a"));
  SET_STRING_ELT(nms, 34, mkChar("dim_diag_rec_a_1"));
  SET_STRING_ELT(nms, 35, mkChar("dim_diag_rec_a_12"));
  SET_STRING_ELT(nms, 36, mkChar("dim_diag_rec_a_2"));
  SET_STRING_ELT(nms, 37, mkChar("dim_diag_rec_a_3"));
  SET_STRING_ELT(nms, 38, mkChar("dim_diag_rec_s"));
  SET_STRING_ELT(nms, 39, mkChar("dim_diag_rec_s_1"));
  SET_STRING_ELT(nms, 40, mkChar("dim_diag_rec_s_12"));
  SET_STRING_ELT(nms, 41, mkChar("dim_diag_rec_s_2"));
  SET_STRING_ELT(nms, 42, mkChar("dim_diag_rec_s_3"));
  SET_STRING_ELT(nms, 43, mkChar("dim_I"));
  SET_STRING_ELT(nms, 44, mkChar("dim_I_1"));
  SET_STRING_ELT(nms, 45, mkChar("dim_I_2"));
  SET_STRING_ELT(nms, 46, mkChar("dim_I0"));
  SET_STRING_ELT(nms, 47, mkChar("dim_I0_1"));
  SET_STRING_ELT(nms, 48, mkChar("dim_I0_2"));
  SET_STRING_ELT(nms, 49, mkChar("dim_N"));
  SET_STRING_ELT(nms, 50, mkChar("dim_N_1"));
  SET_STRING_ELT(nms, 51, mkChar("dim_N_2"));
  SET_STRING_ELT(nms, 52, mkChar("dim_n_AT"));
  SET_STRING_ELT(nms, 53, mkChar("dim_n_AT_1"));
  SET_STRING_ELT(nms, 54, mkChar("dim_n_AT_2"));
  SET_STRING_ELT(nms, 55, mkChar("dim_n_AU"));
  SET_STRING_ELT(nms, 56, mkChar("dim_n_AU_1"));
  SET_STRING_ELT(nms, 57, mkChar("dim_n_AU_2"));
  SET_STRING_ELT(nms, 58, mkChar("dim_n_diag_rec"));
  SET_STRING_ELT(nms, 59, mkChar("dim_n_diag_rec_1"));
  SET_STRING_ELT(nms, 60, mkChar("dim_n_diag_rec_12"));
  SET_STRING_ELT(nms, 61, mkChar("dim_n_diag_rec_2"));
  SET_STRING_ELT(nms, 62, mkChar("dim_n_diag_rec_3"));
  SET_STRING_ELT(nms, 63, mkChar("dim_n_ST"));
  SET_STRING_ELT(nms, 64, mkChar("dim_n_ST_1"));
  SET_STRING_ELT(nms, 65, mkChar("dim_n_ST_2"));
  SET_STRING_ELT(nms, 66, mkChar("dim_n_TU"));
  SET_STRING_ELT(nms, 67, mkChar("dim_n_TU_1"));
  SET_STRING_ELT(nms, 68, mkChar("dim_n_TU_2"));
  SET_STRING_ELT(nms, 69, mkChar("dim_n_UI"));
  SET_STRING_ELT(nms, 70, mkChar("dim_n_UI_1"));
  SET_STRING_ELT(nms, 71, mkChar("dim_n_UI_2"));
  SET_STRING_ELT(nms, 72, mkChar("dim_pye_noscreen_trial"));
  SET_STRING_ELT(nms, 73, mkChar("dim_pye_noscreen_trial_1"));
  SET_STRING_ELT(nms, 74, mkChar("dim_pye_noscreen_trial_2"));
  SET_STRING_ELT(nms, 75, mkChar("dim_pye_trial"));
  SET_STRING_ELT(nms, 76, mkChar("dim_pye_trial_1"));
  SET_STRING_ELT(nms, 77, mkChar("dim_pye_trial_2"));
  SET_STRING_ELT(nms, 78, mkChar("dim_S"));
  SET_STRING_ELT(nms, 79, mkChar("dim_S_1"));
  SET_STRING_ELT(nms, 80, mkChar("dim_S_2"));
  SET_STRING_ELT(nms, 81, mkChar("dim_S0"));
  SET_STRING_ELT(nms, 82, mkChar("dim_S0_1"));
  SET_STRING_ELT(nms, 83, mkChar("dim_S0_2"));
  SET_STRING_ELT(nms, 84, mkChar("dim_screened"));
  SET_STRING_ELT(nms, 85, mkChar("dim_screened_1"));
  SET_STRING_ELT(nms, 86, mkChar("dim_screened_2"));
  SET_STRING_ELT(nms, 87, mkChar("dim_T"));
  SET_STRING_ELT(nms, 88, mkChar("dim_T_1"));
  SET_STRING_ELT(nms, 89, mkChar("dim_T_2"));
  SET_STRING_ELT(nms, 90, mkChar("dim_T0"));
  SET_STRING_ELT(nms, 91, mkChar("dim_T0_1"));
  SET_STRING_ELT(nms, 92, mkChar("dim_T0_2"));
  SET_STRING_ELT(nms, 93, mkChar("dim_U"));
  SET_STRING_ELT(nms, 94, mkChar("dim_U_1"));
  SET_STRING_ELT(nms, 95, mkChar("dim_U_2"));
  SET_STRING_ELT(nms, 96, mkChar("dim_U0"));
  SET_STRING_ELT(nms, 97, mkChar("dim_U0_1"));
  SET_STRING_ELT(nms, 98, mkChar("dim_U0_2"));
  SET_STRING_ELT(nms, 99, mkChar("dim_vea"));
  SET_STRING_ELT(nms, 100, mkChar("dim_ved"));
  SET_STRING_ELT(nms, 101, mkChar("dim_ves"));
  SET_STRING_ELT(nms, 102, mkChar("dim_w"));
  SET_STRING_ELT(nms, 103, mkChar("dim_w_1"));
  SET_STRING_ELT(nms, 104, mkChar("dim_w_2"));
  SET_STRING_ELT(nms, 105, mkChar("dim_wA"));
  SET_STRING_ELT(nms, 106, mkChar("dim_wA_1"));
  SET_STRING_ELT(nms, 107, mkChar("dim_wA_12"));
  SET_STRING_ELT(nms, 108, mkChar("dim_wA_2"));
  SET_STRING_ELT(nms, 109, mkChar("dim_wA_3"));
  SET_STRING_ELT(nms, 110, mkChar("dim_wI"));
  SET_STRING_ELT(nms, 111, mkChar("dim_wI_1"));
  SET_STRING_ELT(nms, 112, mkChar("dim_wI_12"));
  SET_STRING_ELT(nms, 113, mkChar("dim_wI_2"));
  SET_STRING_ELT(nms, 114, mkChar("dim_wI_3"));
  SET_STRING_ELT(nms, 115, mkChar("dim_wS"));
  SET_STRING_ELT(nms, 116, mkChar("dim_wS_1"));
  SET_STRING_ELT(nms, 117, mkChar("dim_wS_12"));
  SET_STRING_ELT(nms, 118, mkChar("dim_wS_2"));
  SET_STRING_ELT(nms, 119, mkChar("dim_wS_3"));
  SET_STRING_ELT(nms, 120, mkChar("dim_wT"));
  SET_STRING_ELT(nms, 121, mkChar("dim_wT_1"));
  SET_STRING_ELT(nms, 122, mkChar("dim_wT_12"));
  SET_STRING_ELT(nms, 123, mkChar("dim_wT_2"));
  SET_STRING_ELT(nms, 124, mkChar("dim_wT_3"));
  SET_STRING_ELT(nms, 125, mkChar("dim_wU"));
  SET_STRING_ELT(nms, 126, mkChar("dim_wU_1"));
  SET_STRING_ELT(nms, 127, mkChar("dim_wU_12"));
  SET_STRING_ELT(nms, 128, mkChar("dim_wU_2"));
  SET_STRING_ELT(nms, 129, mkChar("dim_wU_3"));
  SET_STRING_ELT(nms, 130, mkChar("eta"));
  SET_STRING_ELT(nms, 131, mkChar("I0"));
  SET_STRING_ELT(nms, 132, mkChar("initial_A"));
  SET_STRING_ELT(nms, 133, mkChar("initial_cum_diag_a"));
  SET_STRING_ELT(nms, 134, mkChar("initial_cum_diag_s"));
  SET_STRING_ELT(nms, 135, mkChar("initial_cum_incid"));
  SET_STRING_ELT(nms, 136, mkChar("initial_cum_pye_noscreen_trial_pov"));
  SET_STRING_ELT(nms, 137, mkChar("initial_cum_pye_trial_pov"));
  SET_STRING_ELT(nms, 138, mkChar("initial_cum_pye_true"));
  SET_STRING_ELT(nms, 139, mkChar("initial_cum_screened"));
  SET_STRING_ELT(nms, 140, mkChar("initial_cum_treated"));
  SET_STRING_ELT(nms, 141, mkChar("initial_I"));
  SET_STRING_ELT(nms, 142, mkChar("initial_S"));
  SET_STRING_ELT(nms, 143, mkChar("initial_T"));
  SET_STRING_ELT(nms, 144, mkChar("initial_U"));
  SET_STRING_ELT(nms, 145, mkChar("lambda"));
  SET_STRING_ELT(nms, 146, mkChar("mu"));
  SET_STRING_ELT(nms, 147, mkChar("N"));
  SET_STRING_ELT(nms, 148, mkChar("n_AT"));
  SET_STRING_ELT(nms, 149, mkChar("n_AU"));
  SET_STRING_ELT(nms, 150, mkChar("n_diag_rec"));
  SET_STRING_ELT(nms, 151, mkChar("n_group"));
  SET_STRING_ELT(nms, 152, mkChar("n_ST"));
  SET_STRING_ELT(nms, 153, mkChar("n_TU"));
  SET_STRING_ELT(nms, 154, mkChar("n_UI"));
  SET_STRING_ELT(nms, 155, mkChar("n_vax"));
  SET_STRING_ELT(nms, 156, mkChar("nu"));
  SET_STRING_ELT(nms, 157, mkChar("offset_variable_A"));
  SET_STRING_ELT(nms, 158, mkChar("offset_variable_cum_diag_a"));
  SET_STRING_ELT(nms, 159, mkChar("offset_variable_cum_diag_s"));
  SET_STRING_ELT(nms, 160, mkChar("offset_variable_cum_incid"));
  SET_STRING_ELT(nms, 161, mkChar("offset_variable_cum_pye_noscreen_trial_pov"));
  SET_STRING_ELT(nms, 162, mkChar("offset_variable_cum_pye_trial_pov"));
  SET_STRING_ELT(nms, 163, mkChar("offset_variable_cum_pye_true"));
  SET_STRING_ELT(nms, 164, mkChar("offset_variable_cum_screened"));
  SET_STRING_ELT(nms, 165, mkChar("offset_variable_cum_treated"));
  SET_STRING_ELT(nms, 166, mkChar("offset_variable_S"));
  SET_STRING_ELT(nms, 167, mkChar("offset_variable_T"));
  SET_STRING_ELT(nms, 168, mkChar("psi"));
  SET_STRING_ELT(nms, 169, mkChar("pye_noscreen_trial"));
  SET_STRING_ELT(nms, 170, mkChar("pye_trial"));
  SET_STRING_ELT(nms, 171, mkChar("rho"));
  SET_STRING_ELT(nms, 172, mkChar("S0"));
  SET_STRING_ELT(nms, 173, mkChar("screened"));
  SET_STRING_ELT(nms, 174, mkChar("sigma"));
  SET_STRING_ELT(nms, 175, mkChar("T0"));
  SET_STRING_ELT(nms, 176, mkChar("U0"));
  SET_STRING_ELT(nms, 177, mkChar("vea"));
  SET_STRING_ELT(nms, 178, mkChar("ved"));
  SET_STRING_ELT(nms, 179, mkChar("ves"));
  SET_STRING_ELT(nms, 180, mkChar("w"));
  SET_STRING_ELT(nms, 181, mkChar("wA"));
  SET_STRING_ELT(nms, 182, mkChar("wI"));
  SET_STRING_ELT(nms, 183, mkChar("wS"));
  SET_STRING_ELT(nms, 184, mkChar("wT"));
  SET_STRING_ELT(nms, 185, mkChar("wU"));
  setAttrib(contents, R_NamesSymbol, nms);
  UNPROTECT(41);
  return contents;
}
SEXP model_trial_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->dim_cum_incid_1 = internal->n_group;
  internal->dim_cum_incid_2 = internal->n_vax;
  internal->dim_cum_pye_noscreen_trial_pov_1 = internal->n_group;
  internal->dim_cum_pye_noscreen_trial_pov_2 = internal->n_vax;
  ...
  internal->dim_n_UI_1 = internal->n_group;
  internal->dim_n_UI_2 = internal->n_vax;
  internal->dim_pye_noscreen_trial_1 = internal->n_group;
  internal->dim_pye_noscreen_trial_2 = internal->n_vax;
  ...
  internal->dim_cum_diag_s = internal->dim_cum_diag_s_1 * internal->dim_cum_diag_s_2;
  internal->dim_cum_incid = internal->dim_cum_incid_1 * internal->dim_cum_incid_2;
  internal->dim_cum_pye_noscreen_trial_pov = internal->dim_cum_pye_noscreen_trial_pov_1 * internal->dim_cum_pye_noscreen_trial_pov_2;
  ...
  internal->dim_n_TU = internal->dim_n_TU_1 * internal->dim_n_TU_2;
  internal->dim_n_UI = internal->dim_n_UI_1 * internal->dim_n_UI_2;
  internal->dim_pye_noscreen_trial = internal->dim_pye_noscreen_trial_1 * internal->dim_pye_noscreen_trial_2;
  ...
  internal->initial_cum_incid = (double*) R_Calloc(internal->dim_cum_incid, double);
  R_Free(internal->initial_cum_pye_noscreen_trial_pov);
  internal->initial_cum_pye_noscreen_trial_pov = (double*) R_Calloc(internal->dim_cum_pye_noscreen_trial_pov, double);
  R_Free(internal->initial_cum_pye_trial_pov);
  ...
  internal->n_UI = (double*) R_Calloc(internal->dim_n_UI, double);
  R_Free(internal->pye_noscreen_trial);
  internal->pye_noscreen_trial = (double*) R_Calloc(internal->dim_pye_noscreen_trial, double);
  R_Free(internal->pye_trial);
  ...
  for (int i = 1; i <= internal->dim_cum_pye_noscreen_trial_pov_1; ++i) {
    for (int j = 1; j <= internal->dim_cum_pye_noscreen_trial_pov_2; ++j) {
      internal->initial_cum_pye_noscreen_trial_pov[i - 1 + internal->dim_cum_pye_noscreen_trial_pov_1 * (j - 1)] = 0;
    }
  }
  ...
  internal->offset_variable_cum_diag_s = internal->dim_A + internal->dim_cum_diag_a + internal->dim_cum_incid + internal->dim_I + internal->dim_S + internal->dim_T + internal->dim_U;
  internal->offset_variable_cum_incid = internal->dim_A + internal->dim_I + internal->dim_S + internal->dim_T + internal->dim_U;
  internal->offset_variable_cum_pye_noscreen_trial_pov = internal->dim_A + internal->dim_cum_diag_a + internal->dim_cum_diag_s + internal->dim_cum_incid + internal->dim_cum_pye_trial_pov + internal->dim_cum_screened + internal->dim_cum_treated + internal->dim_I + internal->dim_S + internal->dim_T + internal->dim_U;
  ...
  internal->offset_variable_cum_pye_true = internal->dim_A + internal->dim_cum_diag_a + internal->dim_cum_diag_s + internal->dim_cum_incid + internal->dim_cum_pye_noscreen_trial_pov + internal->dim_cum_pye_trial_pov + internal->dim_cum_screened + internal->dim_cum_treated + internal->dim_I + internal->dim_S + internal->dim_T + internal->dim_U;
  internal->offset_variable_cum_screened = internal->dim_A + internal->dim_cum_diag_a + internal->dim_cum_diag_s + internal->dim_cum_incid + internal->dim_cum_treated + internal->dim_I + internal->dim_S + internal->dim_T + internal->dim_U;
  internal->offset_variable_cum_treated = internal->dim_A + internal->dim_cum_diag_a + internal->dim_cum_diag_s + internal->dim_cum_incid + internal->dim_I + internal->dim_S + internal->dim_T + internal->dim_U;
  internal->offset_variable_S = internal->dim_A + internal->dim_I + internal->dim_U;
  internal->offset_variable_T = internal->dim_A + internal->dim_I + internal->dim_S + internal->dim_U;
...
SEXP model_trial_metadata(SEXP internal_p) {
  ...
  SET_VECTOR_ELT(variable_length, 11, allocVector(INTSXP, 2));
  int * dim_cum_pye_noscreen_trial_pov = INTEGER(VECTOR_ELT(variable_length, 11));
  dim_cum_pye_noscreen_trial_pov[0] = internal->dim_cum_pye_noscreen_trial_pov_1;
  dim_cum_pye_noscreen_trial_pov[1] = internal->dim_cum_pye_noscreen_trial_pov_2;
  SET_VECTOR_ELT(variable_length, 12, allocVector(INTSXP, 2));
  ...
  SET_STRING_ELT(variable_names, 11, mkChar("cum_pye_noscreen_trial_pov"));
...
SEXP model_trial_initial_conditions(SEXP internal_p, SEXP t_ptr) {
  model_trial_internal *internal = model_trial_get_internal(internal_p, 1);
  SEXP r_state = PROTECT(allocVector(REALSXP, internal->dim_A + internal->dim_cum_diag_a + internal->dim_cum_diag_s + internal->dim_cum_incid + internal->dim_cum_pye_noscreen_trial_pov + internal->dim_cum_pye_trial_pov + internal->dim_cum_pye_true + internal->dim_cum_screened + internal->dim_cum_treated + internal->dim_I + internal->dim_S + internal->dim_T + internal->dim_U));
  double * state = REAL(r_state);
  memcpy(state + 0, internal->initial_U, internal->dim_U * sizeof(double));
  memcpy(state + internal->dim_U, internal->initial_I, internal->dim_I * sizeof(double));
  memcpy(state + internal->offset_variable_A, internal->initial_A, internal->dim_A * sizeof(double));
  ...
  memcpy(state + internal->offset_variable_cum_pye_noscreen_trial_pov, internal->initial_cum_pye_noscreen_trial_pov, internal->dim_cum_pye_noscreen_trial_pov * sizeof(double));
...
void model_trial_rhs(model_trial_internal* internal, double t, double * state, double * dstatedt, double * output) {
  ...
  for (int i = 1; i <= internal->dim_pye_noscreen_trial_1; ++i) {
    for (int j = 1; j <= internal->dim_pye_noscreen_trial_2; ++j) {
      internal->pye_noscreen_trial[i - 1 + internal->dim_pye_noscreen_trial_1 * (j - 1)] = U[internal->dim_U_1 * (j - 1) + i - 1] + I[internal->dim_I_1 * (j - 1) + i - 1] + A[internal->dim_A_1 * (j - 1) + i - 1] + S[internal->dim_S_1 * (j - 1) + i - 1] + T[internal->dim_T_1 * (j - 1) + i - 1];
    }
  }
  ...
  for (int i = 1; i <= internal->dim_cum_pye_noscreen_trial_pov_1; ++i) {
    for (int j = 1; j <= internal->dim_cum_pye_noscreen_trial_pov_2; ++j) {
      dstatedt[internal->offset_variable_cum_pye_noscreen_trial_pov + i - 1 + internal->dim_cum_pye_noscreen_trial_pov_1 * (j - 1)] = internal->pye_noscreen_trial[internal->dim_pye_noscreen_trial_1 * (j - 1) + i - 1];
    }
  }
  for (int i = 1; i <= internal->dim_cum_pye_trial_pov_1; ++i) {
    for (int j = 1; j <= internal->dim_cum_pye_trial_pov_2; ++j) {
...
SEXP model_trial_stochastic_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 296));
  SEXP A0 = PROTECT(allocVector(REALSXP, internal->dim_A0));
  memcpy(REAL(A0), internal->A0, internal->dim_A0 * sizeof(double));
  odin_set_dim(A0, 2, internal->dim_A0_1, internal->dim_A0_2);
  SET_VECTOR_ELT(contents, 0, A0);
  ...
  SET_VECTOR_ELT(contents, 19, ScalarInteger(internal->dim_cum_pye_noscreen_trial_pov));
  SET_VECTOR_ELT(contents, 20, ScalarInteger(internal->dim_cum_pye_noscreen_trial_pov_1));
  SET_VECTOR_ELT(contents, 21, ScalarInteger(internal->dim_cum_pye_noscreen_trial_pov_2));
  SET_VECTOR_ELT(contents, 22, ScalarInteger(internal->dim_cum_pye_trial_pov));
  SET_VECTOR_ELT(contents, 23, ScalarInteger(internal->dim_cum_pye_trial_pov_1));
  SET_VECTOR_ELT(contents, 24, ScalarInteger(internal->dim_cum_pye_trial_pov_2));
  SET_VECTOR_ELT(contents, 25, ScalarInteger(internal->dim_cum_pye_true));
  SET_VECTOR_ELT(contents, 26, ScalarInteger(internal->dim_cum_pye_true_1));
  SET_VECTOR_ELT(contents, 27, ScalarInteger(internal->dim_cum_pye_true_2));
  ...
  SET_VECTOR_ELT(contents, 35, ScalarInteger(internal->dim_diag_rec_a));
  SET_VECTOR_ELT(contents, 36, ScalarInteger(internal->dim_diag_rec_a_1));
  SET_VECTOR_ELT(contents, 37, ScalarInteger(internal->dim_diag_rec_a_12));
  SET_VECTOR_ELT(contents, 38, ScalarInteger(internal->dim_diag_rec_a_2));
  SET_VECTOR_ELT(contents, 39, ScalarInteger(internal->dim_diag_rec_a_3));
  SET_VECTOR_ELT(contents, 40, ScalarInteger(internal->dim_diag_rec_s));
  SET_VECTOR_ELT(contents, 41, ScalarInteger(internal->dim_diag_rec_s_1));
  SET_VECTOR_ELT(contents, 42, ScalarInteger(internal->dim_diag_rec_s_12));
  SET_VECTOR_ELT(contents, 43, ScalarInteger(internal->dim_diag_rec_s_2));
  SET_VECTOR_ELT(contents, 44, ScalarInteger(internal->dim_diag_rec_s_3));
  SET_VECTOR_ELT(contents, 45, ScalarInteger(internal->dim_I));
  SET_VECTOR_ELT(contents, 46, ScalarInteger(internal->dim_I_1));
  SET_VECTOR_ELT(contents, 47, ScalarInteger(internal->dim_I_2));
  SET_VECTOR_ELT(contents, 48, ScalarInteger(internal->dim_I0));
  SET_VECTOR_ELT(contents, 49, ScalarInteger(internal->dim_I0_1));
  SET_VECTOR_ELT(contents, 50, ScalarInteger(internal->dim_I0_2));
  SET_VECTOR_ELT(contents, 51, ScalarInteger(internal->dim_N));
  SET_VECTOR_ELT(contents, 52, ScalarInteger(internal->dim_N_1));
  SET_VECTOR_ELT(contents, 53, ScalarInteger(internal->dim_N_2));
  SET_VECTOR_ELT(contents, 54, ScalarInteger(internal->dim_n_A_ext));
  SET_VECTOR_ELT(contents, 55, ScalarInteger(internal->dim_n_A_ext_1));
  SET_VECTOR_ELT(contents, 56, ScalarInteger(internal->dim_n_A_ext_2));
  ...
  SET_VECTOR_ELT(contents, 63, ScalarInteger(internal->dim_n_AUT));
  SET_VECTOR_ELT(contents, 64, ScalarInteger(internal->dim_n_AUT_1));
  SET_VECTOR_ELT(contents, 65, ScalarInteger(internal->dim_n_AUT_2));
  SET_VECTOR_ELT(contents, 66, ScalarInteger(internal->dim_n_Aw));
  SET_VECTOR_ELT(contents, 67, ScalarInteger(internal->dim_n_Aw_1));
  SET_VECTOR_ELT(contents, 68, ScalarInteger(internal->dim_n_Aw_2));
  SET_VECTOR_ELT(contents, 69, ScalarInteger(internal->dim_n_diag_rec));
  SET_VECTOR_ELT(contents, 70, ScalarInteger(internal->dim_n_diag_rec_1));
  SET_VECTOR_ELT(contents, 71, ScalarInteger(internal->dim_n_diag_rec_12));
  SET_VECTOR_ELT(contents, 72, ScalarInteger(internal->dim_n_diag_rec_2));
  SET_VECTOR_ELT(contents, 73, ScalarInteger(internal->dim_n_diag_rec_3));
  SET_VECTOR_ELT(contents, 74, ScalarInteger(internal->dim_n_I_ext));
  SET_VECTOR_ELT(contents, 75, ScalarInteger(internal->dim_n_I_ext_1));
  SET_VECTOR_ELT(contents, 76, ScalarInteger(internal->dim_n_I_ext_2));
  SET_VECTOR_ELT(contents, 77, ScalarInteger(internal->dim_n_IA));
  SET_VECTOR_ELT(contents, 78, ScalarInteger(internal->dim_n_IA_1));
  SET_VECTOR_ELT(contents, 79, ScalarInteger(internal->dim_n_IA_2));
  SET_VECTOR_ELT(contents, 80, ScalarInteger(internal->dim_n_IAS));
  SET_VECTOR_ELT(contents, 81, ScalarInteger(internal->dim_n_IAS_1));
  SET_VECTOR_ELT(contents, 82, ScalarInteger(internal->dim_n_IAS_2));
  SET_VECTOR_ELT(contents, 83, ScalarInteger(internal->dim_n_IS));
  SET_VECTOR_ELT(contents, 84, ScalarInteger(internal->dim_n_IS_1));
  SET_VECTOR_ELT(contents, 85, ScalarInteger(internal->dim_n_IS_2));
  SET_VECTOR_ELT(contents, 86, ScalarInteger(internal->dim_n_Iw));
  SET_VECTOR_ELT(contents, 87, ScalarInteger(internal->dim_n_Iw_1));
  SET_VECTOR_ELT(contents, 88, ScalarInteger(internal->dim_n_Iw_2));
  SET_VECTOR_ELT(contents, 89, ScalarInteger(internal->dim_n_S_ext));
  SET_VECTOR_ELT(contents, 90, ScalarInteger(internal->dim_n_S_ext_1));
  SET_VECTOR_ELT(contents, 91, ScalarInteger(internal->dim_n_S_ext_2));
  SET_VECTOR_ELT(contents, 92, ScalarInteger(internal->dim_n_ST));
  SET_VECTOR_ELT(contents, 93, ScalarInteger(internal->dim_n_ST_1));
  SET_VECTOR_ELT(contents, 94, ScalarInteger(internal->dim_n_ST_2));
  SET_VECTOR_ELT(contents, 95, ScalarInteger(internal->dim_n_Sw));
  SET_VECTOR_ELT(contents, 96, ScalarInteger(internal->dim_n_Sw_1));
  SET_VECTOR_ELT(contents, 97, ScalarInteger(internal->dim_n_Sw_2));
  SET_VECTOR_ELT(contents, 98, ScalarInteger(internal->dim_n_T_ext));
  SET_VECTOR_ELT(contents, 99, ScalarInteger(internal->dim_n_T_ext_1));
  SET_VECTOR_ELT(contents, 100, ScalarInteger(internal->dim_n_T_ext_2));
  SET_VECTOR_ELT(contents, 101, ScalarInteger(internal->dim_n_TU));
  SET_VECTOR_ELT(contents, 102, ScalarInteger(internal->dim_n_TU_1));
  SET_VECTOR_ELT(contents, 103, ScalarInteger(internal->dim_n_TU_2));
  SET_VECTOR_ELT(contents, 104, ScalarInteger(internal->dim_n_Tw));
  SET_VECTOR_ELT(contents, 105, ScalarInteger(internal->dim_n_Tw_1));
  SET_VECTOR_ELT(contents, 106, ScalarInteger(internal->dim_n_Tw_2));
  SET_VECTOR_ELT(contents, 107, ScalarInteger(internal->dim_n_U_ext));
  SET_VECTOR_ELT(contents, 108, ScalarInteger(internal->dim_n_U_ext_1));
  SET_VECTOR_ELT(contents, 109, ScalarInteger(internal->dim_n_U_ext_2));
  SET_VECTOR_ELT(contents, 110, ScalarInteger(internal->dim_n_UI));
  SET_VECTOR_ELT(contents, 111, ScalarInteger(internal->dim_n_UI_1));
  SET_VECTOR_ELT(contents, 112, ScalarInteger(internal->dim_n_UI_2));
  SET_VECTOR_ELT(contents, 113, ScalarInteger(internal->dim_n_Uw));
  SET_VECTOR_ELT(contents, 114, ScalarInteger(internal->dim_n_Uw_1));
  SET_VECTOR_ELT(contents, 115, ScalarInteger(internal->dim_n_Uw_2));
  SET_VECTOR_ELT(contents, 116, ScalarInteger(internal->dim_p_A_ext));
  SET_VECTOR_ELT(contents, 117, ScalarInteger(internal->dim_p_A_ext_1));
  SET_VECTOR_ELT(contents, 118, ScalarInteger(internal->dim_p_A_ext_2));
  SET_VECTOR_ELT(contents, 119, ScalarInteger(internal->dim_p_I_ext));
  SET_VECTOR_ELT(contents, 120, ScalarInteger(internal->dim_p_I_ext_1));
  SET_VECTOR_ELT(contents, 121, ScalarInteger(internal->dim_p_I_ext_2));
  SET_VECTOR_ELT(contents, 122, ScalarInteger(internal->dim_p_S_ext));
  SET_VECTOR_ELT(contents, 123, ScalarInteger(internal->dim_p_S_ext_1));
  SET_VECTOR_ELT(contents, 124, ScalarInteger(internal->dim_p_S_ext_2));
  SET_VECTOR_ELT(contents, 125, ScalarInteger(internal->dim_p_T_ext));
  SET_VECTOR_ELT(contents, 126, ScalarInteger(internal->dim_p_T_ext_1));
  SET_VECTOR_ELT(contents, 127, ScalarInteger(internal->dim_p_T_ext_2));
  SET_VECTOR_ELT(contents, 128, ScalarInteger(internal->dim_p_U_ext));
  SET_VECTOR_ELT(contents, 129, ScalarInteger(internal->dim_p_U_ext_1));
  SET_VECTOR_ELT(contents, 130, ScalarInteger(internal->dim_p_U_ext_2));
  SET_VECTOR_ELT(contents, 131, ScalarInteger(internal->dim_pye_noscreen_trial));
  SET_VECTOR_ELT(contents, 132, ScalarInteger(internal->dim_pye_noscreen_trial_1));
  SET_VECTOR_ELT(contents, 133, ScalarInteger(internal->dim_pye_noscreen_trial_2));
  SET_VECTOR_ELT(contents, 134, ScalarInteger(internal->dim_pye_trial));
  SET_VECTOR_ELT(contents, 135, ScalarInteger(internal->dim_pye_trial_1));
  SET_VECTOR_ELT(contents, 136, ScalarInteger(internal->dim_pye_trial_2));
  SET_VECTOR_ELT(contents, 137, ScalarInteger(internal->dim_r_AT));
  SET_VECTOR_ELT(contents, 138, ScalarInteger(internal->dim_r_AT_1));
  SET_VECTOR_ELT(contents, 139, ScalarInteger(internal->dim_r_AT_2));
  SET_VECTOR_ELT(contents, 140, ScalarInteger(internal->dim_r_AU));
  SET_VECTOR_ELT(contents, 141, ScalarInteger(internal->dim_r_AU_1));
  SET_VECTOR_ELT(contents, 142, ScalarInteger(internal->dim_r_AU_2));
  SET_VECTOR_ELT(contents, 143, ScalarInteger(internal->dim_Rel_A));
  SET_VECTOR_ELT(contents, 144, ScalarInteger(internal->dim_Rel_A_1));
  SET_VECTOR_ELT(contents, 145, ScalarInteger(internal->dim_Rel_A_2));
  SET_VECTOR_ELT(contents, 146, ScalarInteger(internal->dim_Rel_I));
  SET_VECTOR_ELT(contents, 147, ScalarInteger(internal->dim_Rel_I_1));
  SET_VECTOR_ELT(contents, 148, ScalarInteger(internal->dim_Rel_I_2));
  SET_VECTOR_ELT(contents, 149, ScalarInteger(internal->dim_Rel_S));
  SET_VECTOR_ELT(contents, 150, ScalarInteger(internal->dim_Rel_S_1));
  SET_VECTOR_ELT(contents, 151, ScalarInteger(internal->dim_Rel_S_2));
  SET_VECTOR_ELT(contents, 152, ScalarInteger(internal->dim_Rel_T));
  SET_VECTOR_ELT(contents, 153, ScalarInteger(internal->dim_Rel_T_1));
  SET_VECTOR_ELT(contents, 154, ScalarInteger(internal->dim_Rel_T_2));
  SET_VECTOR_ELT(contents, 155, ScalarInteger(internal->dim_Rel_U));
  SET_VECTOR_ELT(contents, 156, ScalarInteger(internal->dim_Rel_U_1));
  SET_VECTOR_ELT(contents, 157, ScalarInteger(internal->dim_Rel_U_2));
  SET_VECTOR_ELT(contents, 158, ScalarInteger(internal->dim_S));
  SET_VECTOR_ELT(contents, 159, ScalarInteger(internal->dim_S_1));
  SET_VECTOR_ELT(contents, 160, ScalarInteger(internal->dim_S_2));
  SET_VECTOR_ELT(contents, 161, ScalarInteger(internal->dim_S0));
  SET_VECTOR_ELT(contents, 162, ScalarInteger(internal->dim_S0_1));
  SET_VECTOR_ELT(contents, 163, ScalarInteger(internal->dim_S0_2));
  SET_VECTOR_ELT(contents, 164, ScalarInteger(internal->dim_screened));
  SET_VECTOR_ELT(contents, 165, ScalarInteger(internal->dim_screened_1));
  SET_VECTOR_ELT(contents, 166, ScalarInteger(internal->dim_screened_2));
  SET_VECTOR_ELT(contents, 167, ScalarInteger(internal->dim_T));
  SET_VECTOR_ELT(contents, 168, ScalarInteger(internal->dim_T_1));
  SET_VECTOR_ELT(contents, 169, ScalarInteger(internal->dim_T_2));
  SET_VECTOR_ELT(contents, 170, ScalarInteger(internal->dim_T0));
  SET_VECTOR_ELT(contents, 171, ScalarInteger(internal->dim_T0_1));
  SET_VECTOR_ELT(contents, 172, ScalarInteger(internal->dim_T0_2));
  SET_VECTOR_ELT(contents, 173, ScalarInteger(internal->dim_U));
  SET_VECTOR_ELT(contents, 174, ScalarInteger(internal->dim_U_1));
  SET_VECTOR_ELT(contents, 175, ScalarInteger(internal->dim_U_2));
  SET_VECTOR_ELT(contents, 176, ScalarInteger(internal->dim_U0));
  SET_VECTOR_ELT(contents, 177, ScalarInteger(internal->dim_U0_1));
  SET_VECTOR_ELT(contents, 178, ScalarInteger(internal->dim_U0_2));
  SET_VECTOR_ELT(contents, 179, ScalarInteger(internal->dim_vea));
  SET_VECTOR_ELT(contents, 180, ScalarInteger(internal->dim_ved));
  SET_VECTOR_ELT(contents, 181, ScalarInteger(internal->dim_ves));
  SET_VECTOR_ELT(contents, 182, ScalarInteger(internal->dim_w));
  SET_VECTOR_ELT(contents, 183, ScalarInteger(internal->dim_w_1));
  SET_VECTOR_ELT(contents, 184, ScalarInteger(internal->dim_w_2));
  SET_VECTOR_ELT(contents, 185, ScalarInteger(internal->dim_wA));
  SET_VECTOR_ELT(contents, 186, ScalarInteger(internal->dim_wA_1));
  SET_VECTOR_ELT(contents, 187, ScalarInteger(internal->dim_wA_12));
  SET_VECTOR_ELT(contents, 188, ScalarInteger(internal->dim_wA_2));
  SET_VECTOR_ELT(contents, 189, ScalarInteger(internal->dim_wA_3));
  SET_VECTOR_ELT(contents, 190, ScalarInteger(internal->dim_wI));
  SET_VECTOR_ELT(contents, 191, ScalarInteger(internal->dim_wI_1));
  SET_VECTOR_ELT(contents, 192, ScalarInteger(internal->dim_wI_12));
  SET_VECTOR_ELT(contents, 193, ScalarInteger(internal->dim_wI_2));
  SET_VECTOR_ELT(contents, 194, ScalarInteger(internal->dim_wI_3));
  SET_VECTOR_ELT(contents, 195, ScalarInteger(internal->dim_wS));
  SET_VECTOR_ELT(contents, 196, ScalarInteger(internal->dim_wS_1));
  SET_VECTOR_ELT(contents, 197, ScalarInteger(internal->dim_wS_12));
  SET_VECTOR_ELT(contents, 198, ScalarInteger(internal->dim_wS_2));
  SET_VECTOR_ELT(contents, 199, ScalarInteger(internal->dim_wS_3));
  SET_VECTOR_ELT(contents, 200, ScalarInteger(internal->dim_wT));
  SET_VECTOR_ELT(contents, 201, ScalarInteger(internal->dim_wT_1));
  SET_VECTOR_ELT(contents, 202, ScalarInteger(internal->dim_wT_12));
  SET_VECTOR_ELT(contents, 203, ScalarInteger(internal->dim_wT_2));
  SET_VECTOR_ELT(contents, 204, ScalarInteger(internal->dim_wT_3));
  SET_VECTOR_ELT(contents, 205, ScalarInteger(internal->dim_wU));
  SET_VECTOR_ELT(contents, 206, ScalarInteger(internal->dim_wU_1));
  SET_VECTOR_ELT(contents, 207, ScalarInteger(internal->dim_wU_12));
  SET_VECTOR_ELT(contents, 208, ScalarInteger(internal->dim_wU_2));
  SET_VECTOR_ELT(contents, 209, ScalarInteger(internal->dim_wU_3));
  SET_VECTOR_ELT(contents, 210, ScalarReal(internal->dt));
  SET_VECTOR_ELT(contents, 211, ScalarReal(internal->eta));
  SEXP I0 = PROTECT(allocVector(REALSXP, internal->dim_I0));
  memcpy(REAL(I0), internal->I0, internal->dim_I0 * sizeof(double));
  odin_set_dim(I0, 2, internal->dim_I0_1, internal->dim_I0_2);
  SET_VECTOR_ELT(contents, 212, I0);
  SEXP initial_A = PROTECT(allocVector(REALSXP, internal->dim_A));
  memcpy(REAL(initial_A), internal->initial_A, internal->dim_A * sizeof(double));
  odin_set_dim(initial_A, 2, internal->dim_A_1, internal->dim_A_2);
  SET_VECTOR_ELT(contents, 213, initial_A);
  SEXP initial_cum_diag_a = PROTECT(allocVector(REALSXP, internal->dim_cum_diag_a));
  memcpy(REAL(initial_cum_diag_a), internal->initial_cum_diag_a, internal->dim_cum_diag_a * sizeof(double));
  odin_set_dim(initial_cum_diag_a, 2, internal->dim_cum_diag_a_1, internal->dim_cum_diag_a_2);
  SET_VECTOR_ELT(contents, 214, initial_cum_diag_a);
  SEXP initial_cum_diag_s = PROTECT(allocVector(REALSXP, internal->dim_cum_diag_s));
  memcpy(REAL(initial_cum_diag_s), internal->initial_cum_diag_s, internal->dim_cum_diag_s * sizeof(double));
  odin_set_dim(initial_cum_diag_s, 2, internal->dim_cum_diag_s_1, internal->dim_cum_diag_s_2);
  SET_VECTOR_ELT(contents, 215, initial_cum_diag_s);
  SEXP initial_cum_incid = PROTECT(allocVector(REALSXP, internal->dim_cum_incid));
  memcpy(REAL(initial_cum_incid), internal->initial_cum_incid, internal->dim_cum_incid * sizeof(double));
  odin_set_dim(initial_cum_incid, 2, internal->dim_cum_incid_1, internal->dim_cum_incid_2);
  SET_VECTOR_ELT(contents, 216, initial_cum_incid);
  SEXP initial_cum_pye_noscreen_trial_pov = PROTECT(allocVector(REALSXP, internal->dim_cum_pye_noscreen_trial_pov));
  memcpy(REAL(initial_cum_pye_noscreen_trial_pov), internal->initial_cum_pye_noscreen_trial_pov, internal->dim_cum_pye_noscreen_trial_pov * sizeof(double));
  odin_set_dim(initial_cum_pye_noscreen_trial_pov, 2, internal->dim_cum_pye_noscreen_trial_pov_1, internal->dim_cum_pye_noscreen_trial_pov_2);
  SET_VECTOR_ELT(contents, 217, initial_cum_pye_noscreen_trial_pov);
  SEXP initial_cum_pye_trial_pov = PROTECT(allocVector(REALSXP, internal->dim_cum_pye_trial_pov));
  memcpy(REAL(initial_cum_pye_trial_pov), internal->initial_cum_pye_trial_pov, internal->dim_cum_pye_trial_pov * sizeof(double));
  odin_set_dim(initial_cum_pye_trial_pov, 2, internal->dim_cum_pye_trial_pov_1, internal->dim_cum_pye_trial_pov_2);
  SET_VECTOR_ELT(contents, 218, initial_cum_pye_trial_pov);
  SEXP initial_cum_pye_true = PROTECT(allocVector(REALSXP, internal->dim_cum_pye_true));
  memcpy(REAL(initial_cum_pye_true), internal->initial_cum_pye_true, internal->dim_cum_pye_true * sizeof(double));
  odin_set_dim(initial_cum_pye_true, 2, internal->dim_cum_pye_true_1, internal->dim_cum_pye_true_2);
  SET_VECTOR_ELT(contents, 219, initial_cum_pye_true);
  SEXP initial_cum_screened = PROTECT(allocVector(REALSXP, internal->dim_cum_screened));
  memcpy(REAL(initial_cum_screened), internal->initial_cum_screened, internal->dim_cum_screened * sizeof(double));
  odin_set_dim(initial_cum_screened, 2, internal->dim_cum_screened_1, internal->dim_cum_screened_2);
  SET_VECTOR_ELT(contents, 220, initial_cum_screened);
  SEXP initial_cum_treated = PROTECT(allocVector(REALSXP, internal->dim_cum_treated));
  memcpy(REAL(initial_cum_treated), internal->initial_cum_treated, internal->dim_cum_treated * sizeof(double));
  odin_set_dim(initial_cum_treated, 2, internal->dim_cum_treated_1, internal->dim_cum_treated_2);
  SET_VECTOR_ELT(contents, 221, initial_cum_treated);
  SEXP initial_I = PROTECT(allocVector(REALSXP, internal->dim_I));
  memcpy(REAL(initial_I), internal->initial_I, internal->dim_I * sizeof(double));
  odin_set_dim(initial_I, 2, internal->dim_I_1, internal->dim_I_2);
  SET_VECTOR_ELT(contents, 222, initial_I);
  SEXP initial_S = PROTECT(allocVector(REALSXP, internal->dim_S));
  memcpy(REAL(initial_S), internal->initial_S, internal->dim_S * sizeof(double));
  odin_set_dim(initial_S, 2, internal->dim_S_1, internal->dim_S_2);
  SET_VECTOR_ELT(contents, 223, initial_S);
  SEXP initial_T = PROTECT(allocVector(REALSXP, internal->dim_T));
  memcpy(REAL(initial_T), internal->initial_T, internal->dim_T * sizeof(double));
  odin_set_dim(initial_T, 2, internal->dim_T_1, internal->dim_T_2);
  SET_VECTOR_ELT(contents, 224, initial_T);
  SET_VECTOR_ELT(contents, 225, ScalarReal(internal->initial_time));
  SEXP initial_U = PROTECT(allocVector(REALSXP, internal->dim_U));
  memcpy(REAL(initial_U), internal->initial_U, internal->dim_U * sizeof(double));
  odin_set_dim(initial_U, 2, internal->dim_U_1, internal->dim_U_2);
  SET_VECTOR_ELT(contents, 226, initial_U);
  SET_VECTOR_ELT(contents, 227, ScalarReal(internal->lambda));
  SET_VECTOR_ELT(contents, 228, ScalarReal(internal->mu));
  SEXP N = PROTECT(allocVector(REALSXP, internal->dim_N));
  memcpy(REAL(N), internal->N, internal->dim_N * sizeof(double));
  odin_set_dim(N, 2, internal->dim_N_1, internal->dim_N_2);
  SET_VECTOR_ELT(contents, 229, N);
  ...
  SET_VECTOR_ELT(contents, 230, n_A_ext);
  SEXP n_AT = PROTECT(allocVector(REALSXP, internal->dim_n_AT));
  memcpy(REAL(n_AT), internal->n_AT, internal->dim_n_AT * sizeof(double));
  odin_set_dim(n_AT, 2, internal->dim_n_AT_1, internal->dim_n_AT_2);
  SET_VECTOR_ELT(contents, 231, n_AT);
  SEXP n_AU = PROTECT(allocVector(REALSXP, internal->dim_n_AU));
  memcpy(REAL(n_AU), internal->n_AU, internal->dim_n_AU * sizeof(double));
  odin_set_dim(n_AU, 2, internal->dim_n_AU_1, internal->dim_n_AU_2);
  SET_VECTOR_ELT(contents, 232, n_AU);
  ...
  SET_VECTOR_ELT(contents, 233, n_AUT);
  ...
  SET_VECTOR_ELT(contents, 234, n_Aw);
  SEXP n_diag_rec = PROTECT(allocVector(REALSXP, internal->dim_n_diag_rec));
  memcpy(REAL(n_diag_rec), internal->n_diag_rec, internal->dim_n_diag_rec * sizeof(double));
  odin_set_dim(n_diag_rec, 3, internal->dim_n_diag_rec_1, internal->dim_n_diag_rec_2, internal->dim_n_diag_rec_3);
  SET_VECTOR_ELT(contents, 235, n_diag_rec);
  SET_VECTOR_ELT(contents, 236, ScalarInteger(internal->n_group));
  ...
  SET_VECTOR_ELT(contents, 237, n_I_ext);
  ...
  SET_VECTOR_ELT(contents, 238, n_IA);
  ...
  SET_VECTOR_ELT(contents, 239, n_IAS);
  ...
  SET_VECTOR_ELT(contents, 240, n_IS);
  ...
  SET_VECTOR_ELT(contents, 241, n_Iw);
  ...
  SET_VECTOR_ELT(contents, 242, n_S_ext);
  SEXP n_ST = PROTECT(allocVector(REALSXP, internal->dim_n_ST));
  memcpy(REAL(n_ST), internal->n_ST, internal->dim_n_ST * sizeof(double));
  odin_set_dim(n_ST, 2, internal->dim_n_ST_1, internal->dim_n_ST_2);
  SET_VECTOR_ELT(contents, 243, n_ST);
  ...
  SET_VECTOR_ELT(contents, 244, n_Sw);
  ...
  SET_VECTOR_ELT(contents, 245, n_T_ext);
  SEXP n_TU = PROTECT(allocVector(REALSXP, internal->dim_n_TU));
  memcpy(REAL(n_TU), internal->n_TU, internal->dim_n_TU * sizeof(double));
  odin_set_dim(n_TU, 2, internal->dim_n_TU_1, internal->dim_n_TU_2);
  SET_VECTOR_ELT(contents, 246, n_TU);
  ...
  SET_VECTOR_ELT(contents, 247, n_Tw);
  ...
  SET_VECTOR_ELT(contents, 248, n_U_ext);
  SEXP n_UI = PROTECT(allocVector(REALSXP, internal->dim_n_UI));
  memcpy(REAL(n_UI), internal->n_UI, internal->dim_n_UI * sizeof(double));
  odin_set_dim(n_UI, 2, internal->dim_n_UI_1, internal->dim_n_UI_2);
  SET_VECTOR_ELT(contents, 249, n_UI);
  ...
  SET_VECTOR_ELT(contents, 250, n_Uw);
  SET_VECTOR_ELT(contents, 251, ScalarInteger(internal->n_vax));
  SET_VECTOR_ELT(contents, 252, ScalarReal(internal->nu));
  SET_VECTOR_ELT(contents, 253, ScalarInteger(internal->offset_variable_A));
  SET_VECTOR_ELT(contents, 254, ScalarInteger(internal->offset_variable_cum_diag_a));
  SET_VECTOR_ELT(contents, 255, ScalarInteger(internal->offset_variable_cum_diag_s));
  SET_VECTOR_ELT(contents, 256, ScalarInteger(internal->offset_variable_cum_incid));
  SET_VECTOR_ELT(contents, 257, ScalarInteger(internal->offset_variable_cum_pye_noscreen_trial_pov));
  SET_VECTOR_ELT(contents, 258, ScalarInteger(internal->offset_variable_cum_pye_trial_pov));
  SET_VECTOR_ELT(contents, 259, ScalarInteger(internal->offset_variable_cum_pye_true));
  SET_VECTOR_ELT(contents, 260, ScalarInteger(internal->offset_variable_cum_screened));
  SET_VECTOR_ELT(contents, 261, ScalarInteger(internal->offset_variable_cum_treated));
  SET_VECTOR_ELT(contents, 262, ScalarInteger(internal->offset_variable_I));
  SET_VECTOR_ELT(contents, 263, ScalarInteger(internal->offset_variable_S));
  SET_VECTOR_ELT(contents, 264, ScalarInteger(internal->offset_variable_T));
  ...
  SET_VECTOR_ELT(contents, 265, p_A_ext);
  ...
  SET_VECTOR_ELT(contents, 266, p_I_ext);
  ...
  SET_VECTOR_ELT(contents, 267, p_S_ext);
  ...
  SET_VECTOR_ELT(contents, 268, p_T_ext);
  ...
  SET_VECTOR_ELT(contents, 269, p_U_ext);
  SET_VECTOR_ELT(contents, 270, ScalarReal(internal->psi));
  SEXP pye_noscreen_trial = PROTECT(allocVector(REALSXP, internal->dim_pye_noscreen_trial));
  memcpy(REAL(pye_noscreen_trial), internal->pye_noscreen_trial, internal->dim_pye_noscreen_trial * sizeof(double));
  odin_set_dim(pye_noscreen_trial, 2, internal->dim_pye_noscreen_trial_1, internal->dim_pye_noscreen_trial_2);
  SET_VECTOR_ELT(contents, 271, pye_noscreen_trial);
  SEXP pye_trial = PROTECT(allocVector(REALSXP, internal->dim_pye_trial));
  memcpy(REAL(pye_trial), internal->pye_trial, internal->dim_pye_trial * sizeof(double));
  odin_set_dim(pye_trial, 2, internal->dim_pye_trial_1, internal->dim_pye_trial_2);
  SET_VECTOR_ELT(contents, 272, pye_trial);
  ...
  SET_VECTOR_ELT(contents, 273, r_AT);
  ...
  SET_VECTOR_ELT(contents, 274, r_AU);
  ...
  SET_VECTOR_ELT(contents, 275, Rel_A);
  ...
  SET_VECTOR_ELT(contents, 276, Rel_I);
  ...
  SET_VECTOR_ELT(contents, 277, Rel_S);
  ...
  SET_VECTOR_ELT(contents, 278, Rel_T);
  ...
  SET_VECTOR_ELT(contents, 279, Rel_U);
  SET_VECTOR_ELT(contents, 280, ScalarReal(internal->rho));
  SEXP S0 = PROTECT(allocVector(REALSXP, internal->dim_S0));
  memcpy(REAL(S0), internal->S0, internal->dim_S0 * sizeof(double));
  odin_set_dim(S0, 2, internal->dim_S0_1, internal->dim_S0_2);
  SET_VECTOR_ELT(contents, 281, S0);
  SEXP screened = PROTECT(allocVector(REALSXP, internal->dim_screened));
  memcpy(REAL(screened), internal->screened, internal->dim_screened * sizeof(double));
  odin_set_dim(screened, 2, internal->dim_screened_1, internal->dim_screened_2);
  SET_VECTOR_ELT(contents, 282, screened);
  SET_VECTOR_ELT(contents, 283, ScalarReal(internal->sigma));
  SET_VECTOR_ELT(contents, 284, ScalarReal(internal->steps_per_year));
  SEXP T0 = PROTECT(allocVector(REALSXP, internal->dim_T0));
  memcpy(REAL(T0), internal->T0, internal->dim_T0 * sizeof(double));
  odin_set_dim(T0, 2, internal->dim_T0_1, internal->dim_T0_2);
  SET_VECTOR_ELT(contents, 285, T0);
  SEXP U0 = PROTECT(allocVector(REALSXP, internal->dim_U0));
  memcpy(REAL(U0), internal->U0, internal->dim_U0 * sizeof(double));
  odin_set_dim(U0, 2, internal->dim_U0_1, internal->dim_U0_2);
  SET_VECTOR_ELT(contents, 286, U0);
  SEXP vea = PROTECT(allocVector(REALSXP, internal->dim_vea));
  memcpy(REAL(vea), internal->vea, internal->dim_vea * sizeof(double));
  SET_VECTOR_ELT(contents, 287, vea);
  SEXP ved = PROTECT(allocVector(REALSXP, internal->dim_ved));
  memcpy(REAL(ved), internal->ved, internal->dim_ved * sizeof(double));
  SET_VECTOR_ELT(contents, 288, ved);
  SEXP ves = PROTECT(allocVector(REALSXP, internal->dim_ves));
  memcpy(REAL(ves), internal->ves, internal->dim_ves * sizeof(double));
  SET_VECTOR_ELT(contents, 289, ves);
  SEXP w = PROTECT(allocVector(REALSXP, internal->dim_w));
  memcpy(REAL(w), internal->w, internal->dim_w * sizeof(double));
  odin_set_dim(w, 2, internal->dim_w_1, internal->dim_w_2);
  SET_VECTOR_ELT(contents, 290, w);
  SEXP wA = PROTECT(allocVector(REALSXP, internal->dim_wA));
  memcpy(REAL(wA), internal->wA, internal->dim_wA * sizeof(double));
  odin_set_dim(wA, 3, internal->dim_wA_1, internal->dim_wA_2, internal->dim_wA_3);
  SET_VECTOR_ELT(contents, 291, wA);
  SEXP wI = PROTECT(allocVector(REALSXP, internal->dim_wI));
  memcpy(REAL(wI), internal->wI, internal->dim_wI * sizeof(double));
  odin_set_dim(wI, 3, internal->dim_wI_1, internal->dim_wI_2, internal->dim_wI_3);
  SET_VECTOR_ELT(contents, 292, wI);
  SEXP wS = PROTECT(allocVector(REALSXP, internal->dim_wS));
  memcpy(REAL(wS), internal->wS, internal->dim_wS * sizeof(double));
  odin_set_dim(wS, 3, internal->dim_wS_1, internal->dim_wS_2, internal->dim_wS_3);
  SET_VECTOR_ELT(contents, 293, wS);
  SEXP wT = PROTECT(allocVector(REALSXP, internal->dim_wT));
  memcpy(REAL(wT), internal->wT, internal->dim_wT * sizeof(double));
  odin_set_dim(wT, 3, internal->dim_wT_1, internal->dim_wT_2, internal->dim_wT_3);
  SET_VECTOR_ELT(contents, 294, wT);
  SEXP wU = PROTECT(allocVector(REALSXP, internal->dim_wU));
  memcpy(REAL(wU), internal->wU, internal->dim_wU * sizeof(double));
  odin_set_dim(wU, 3, internal->dim_wU_1, internal->dim_wU_2, internal->dim_wU_3);
  SET_VECTOR_ELT(contents, 295, wU);
  SEXP nms = PROTECT(allocVector(STRSXP, 296));
  SET_STRING_ELT(nms, 0, mkChar("A0"));
  ...
  SET_STRING_ELT(nms, 19, mkChar("dim_cum_pye_noscreen_trial_pov"));
  SET_STRING_ELT(nms, 20, mkChar("dim_cum_pye_noscreen_trial_pov_1"));
  SET_STRING_ELT(nms, 21, mkChar("dim_cum_pye_noscreen_trial_pov_2"));
  SET_STRING_ELT(nms, 22, mkChar("dim_cum_pye_trial_pov"));
  SET_STRING_ELT(nms, 23, mkChar("dim_cum_pye_trial_pov_1"));
  SET_STRING_ELT(nms, 24, mkChar("dim_cum_pye_trial_pov_2"));
  SET_STRING_ELT(nms, 25, mkChar("dim_cum_pye_true"));
  SET_STRING_ELT(nms, 26, mkChar("dim_cum_pye_true_1"));
  SET_STRING_ELT(nms, 27, mkChar("dim_cum_pye_true_2"));
  ...
  SET_STRING_ELT(nms, 35, mkChar("dim_diag_rec_a"));
  SET_STRING_ELT(nms, 36, mkChar("dim_diag_rec_a_1"));
  SET_STRING_ELT(nms, 37, mkChar("dim_diag_rec_a_12"));
  SET_STRING_ELT(nms, 38, mkChar("dim_diag_rec_a_2"));
  SET_STRING_ELT(nms, 39, mkChar("dim_diag_rec_a_3"));
  SET_STRING_ELT(nms, 40, mkChar("dim_diag_rec_s"));
  SET_STRING_ELT(nms, 41, mkChar("dim_diag_rec_s_1"));
  SET_STRING_ELT(nms, 42, mkChar("dim_diag_rec_s_12"));
  SET_STRING_ELT(nms, 43, mkChar("dim_diag_rec_s_2"));
  SET_STRING_ELT(nms, 44, mkChar("dim_diag_rec_s_3"));
  SET_STRING_ELT(nms, 45, mkChar("dim_I"));
  SET_STRING_ELT(nms, 46, mkChar("dim_I_1"));
  SET_STRING_ELT(nms, 47, mkChar("dim_I_2"));
  SET_STRING_ELT(nms, 48, mkChar("dim_I0"));
  SET_STRING_ELT(nms, 49, mkChar("dim_I0_1"));
  SET_STRING_ELT(nms, 50, mkChar("dim_I0_2"));
  SET_STRING_ELT(nms, 51, mkChar("dim_N"));
  SET_STRING_ELT(nms, 52, mkChar("dim_N_1"));
  SET_STRING_ELT(nms, 53, mkChar("dim_N_2"));
  SET_STRING_ELT(nms, 54, mkChar("dim_n_A_ext"));
  SET_STRING_ELT(nms, 55, mkChar("dim_n_A_ext_1"));
  SET_STRING_ELT(nms, 56, mkChar("dim_n_A_ext_2"));
  ...
  SET_STRING_ELT(nms, 63, mkChar("dim_n_AUT"));
  SET_STRING_ELT(nms, 64, mkChar("dim_n_AUT_1"));
  SET_STRING_ELT(nms, 65, mkChar("dim_n_AUT_2"));
  SET_STRING_ELT(nms, 66, mkChar("dim_n_Aw"));
  SET_STRING_ELT(nms, 67, mkChar("dim_n_Aw_1"));
  SET_STRING_ELT(nms, 68, mkChar("dim_n_Aw_2"));
  SET_STRING_ELT(nms, 69, mkChar("dim_n_diag_rec"));
  SET_STRING_ELT(nms, 70, mkChar("dim_n_diag_rec_1"));
  SET_STRING_ELT(nms, 71, mkChar("dim_n_diag_rec_12"));
  SET_STRING_ELT(nms, 72, mkChar("dim_n_diag_rec_2"));
  SET_STRING_ELT(nms, 73, mkChar("dim_n_diag_rec_3"));
  SET_STRING_ELT(nms, 74, mkChar("dim_n_I_ext"));
  SET_STRING_ELT(nms, 75, mkChar("dim_n_I_ext_1"));
  SET_STRING_ELT(nms, 76, mkChar("dim_n_I_ext_2"));
  SET_STRING_ELT(nms, 77, mkChar("dim_n_IA"));
  SET_STRING_ELT(nms, 78, mkChar("dim_n_IA_1"));
  SET_STRING_ELT(nms, 79, mkChar("dim_n_IA_2"));
  SET_STRING_ELT(nms, 80, mkChar("dim_n_IAS"));
  SET_STRING_ELT(nms, 81, mkChar("dim_n_IAS_1"));
  SET_STRING_ELT(nms, 82, mkChar("dim_n_IAS_2"));
  SET_STRING_ELT(nms, 83, mkChar("dim_n_IS"));
  SET_STRING_ELT(nms, 84, mkChar("dim_n_IS_1"));
  SET_STRING_ELT(nms, 85, mkChar("dim_n_IS_2"));
  SET_STRING_ELT(nms, 86, mkChar("dim_n_Iw"));
  SET_STRING_ELT(nms, 87, mkChar("dim_n_Iw_1"));
  SET_STRING_ELT(nms, 88, mkChar("dim_n_Iw_2"));
  SET_STRING_ELT(nms, 89, mkChar("dim_n_S_ext"));
  SET_STRING_ELT(nms, 90, mkChar("dim_n_S_ext_1"));
  SET_STRING_ELT(nms, 91, mkChar("dim_n_S_ext_2"));
  SET_STRING_ELT(nms, 92, mkChar("dim_n_ST"));
  SET_STRING_ELT(nms, 93, mkChar("dim_n_ST_1"));
  SET_STRING_ELT(nms, 94, mkChar("dim_n_ST_2"));
  SET_STRING_ELT(nms, 95, mkChar("dim_n_Sw"));
  SET_STRING_ELT(nms, 96, mkChar("dim_n_Sw_1"));
  SET_STRING_ELT(nms, 97, mkChar("dim_n_Sw_2"));
  SET_STRING_ELT(nms, 98, mkChar("dim_n_T_ext"));
  SET_STRING_ELT(nms, 99, mkChar("dim_n_T_ext_1"));
  SET_STRING_ELT(nms, 100, mkChar("dim_n_T_ext_2"));
  SET_STRING_ELT(nms, 101, mkChar("dim_n_TU"));
  SET_STRING_ELT(nms, 102, mkChar("dim_n_TU_1"));
  SET_STRING_ELT(nms, 103, mkChar("dim_n_TU_2"));
  SET_STRING_ELT(nms, 104, mkChar("dim_n_Tw"));
  SET_STRING_ELT(nms, 105, mkChar("dim_n_Tw_1"));
  SET_STRING_ELT(nms, 106, mkChar("dim_n_Tw_2"));
  SET_STRING_ELT(nms, 107, mkChar("dim_n_U_ext"));
  SET_STRING_ELT(nms, 108, mkChar("dim_n_U_ext_1"));
  SET_STRING_ELT(nms, 109, mkChar("dim_n_U_ext_2"));
  SET_STRING_ELT(nms, 110, mkChar("dim_n_UI"));
  SET_STRING_ELT(nms, 111, mkChar("dim_n_UI_1"));
  SET_STRING_ELT(nms, 112, mkChar("dim_n_UI_2"));
  SET_STRING_ELT(nms, 113, mkChar("dim_n_Uw"));
  SET_STRING_ELT(nms, 114, mkChar("dim_n_Uw_1"));
  SET_STRING_ELT(nms, 115, mkChar("dim_n_Uw_2"));
  SET_STRING_ELT(nms, 116, mkChar("dim_p_A_ext"));
  SET_STRING_ELT(nms, 117, mkChar("dim_p_A_ext_1"));
  SET_STRING_ELT(nms, 118, mkChar("dim_p_A_ext_2"));
  SET_STRING_ELT(nms, 119, mkChar("dim_p_I_ext"));
  SET_STRING_ELT(nms, 120, mkChar("dim_p_I_ext_1"));
  SET_STRING_ELT(nms, 121, mkChar("dim_p_I_ext_2"));
  SET_STRING_ELT(nms, 122, mkChar("dim_p_S_ext"));
  SET_STRING_ELT(nms, 123, mkChar("dim_p_S_ext_1"));
  SET_STRING_ELT(nms, 124, mkChar("dim_p_S_ext_2"));
  SET_STRING_ELT(nms, 125, mkChar("dim_p_T_ext"));
  SET_STRING_ELT(nms, 126, mkChar("dim_p_T_ext_1"));
  SET_STRING_ELT(nms, 127, mkChar("dim_p_T_ext_2"));
  SET_STRING_ELT(nms, 128, mkChar("dim_p_U_ext"));
  SET_STRING_ELT(nms, 129, mkChar("dim_p_U_ext_1"));
  SET_STRING_ELT(nms, 130, mkChar("dim_p_U_ext_2"));
  SET_STRING_ELT(nms, 131, mkChar("dim_pye_noscreen_trial"));
  SET_STRING_ELT(nms, 132, mkChar("dim_pye_noscreen_trial_1"));
  SET_STRING_ELT(nms, 133, mkChar("dim_pye_noscreen_trial_2"));
  SET_STRING_ELT(nms, 134, mkChar("dim_pye_trial"));
  SET_STRING_ELT(nms, 135, mkChar("dim_pye_trial_1"));
  SET_STRING_ELT(nms, 136, mkChar("dim_pye_trial_2"));
  SET_STRING_ELT(nms, 137, mkChar("dim_r_AT"));
  SET_STRING_ELT(nms, 138, mkChar("dim_r_AT_1"));
  SET_STRING_ELT(nms, 139, mkChar("dim_r_AT_2"));
  SET_STRING_ELT(nms, 140, mkChar("dim_r_AU"));
  SET_STRING_ELT(nms, 141, mkChar("dim_r_AU_1"));
  SET_STRING_ELT(nms, 142, mkChar("dim_r_AU_2"));
  SET_STRING_ELT(nms, 143, mkChar("dim_Rel_A"));
  SET_STRING_ELT(nms, 144, mkChar("dim_Rel_A_1"));
  SET_STRING_ELT(nms, 145, mkChar("dim_Rel_A_2"));
  SET_STRING_ELT(nms, 146, mkChar("dim_Rel_I"));
  SET_STRING_ELT(nms, 147, mkChar("dim_Rel_I_1"));
  SET_STRING_ELT(nms, 148, mkChar("dim_Rel_I_2"));
  SET_STRING_ELT(nms, 149, mkChar("dim_Rel_S"));
  SET_STRING_ELT(nms, 150, mkChar("dim_Rel_S_1"));
  SET_STRING_ELT(nms, 151, mkChar("dim_Rel_S_2"));
  SET_STRING_ELT(nms, 152, mkChar("dim_Rel_T"));
  SET_STRING_ELT(nms, 153, mkChar("dim_Rel_T_1"));
  SET_STRING_ELT(nms, 154, mkChar("dim_Rel_T_2"));
  SET_STRING_ELT(nms, 155, mkChar("dim_Rel_U"));
  SET_STRING_ELT(nms, 156, mkChar("dim_Rel_U_1"));
  SET_STRING_ELT(nms, 157, mkChar("dim_Rel_U_2"));
  SET_STRING_ELT(nms, 158, mkChar("dim_S"));
  SET_STRING_ELT(nms, 159, mkChar("dim_S_1"));
  SET_STRING_ELT(nms, 160, mkChar("dim_S_2"));
  SET_STRING_ELT(nms, 161, mkChar("dim_S0"));
  SET_STRING_ELT(nms, 162, mkChar("dim_S0_1"));
  SET_STRING_ELT(nms, 163, mkChar("dim_S0_2"));
  SET_STRING_ELT(nms, 164, mkChar("dim_screened"));
  SET_STRING_ELT(nms, 165, mkChar("dim_screened_1"));
  SET_STRING_ELT(nms, 166, mkChar("dim_screened_2"));
  SET_STRING_ELT(nms, 167, mkChar("dim_T"));
  SET_STRING_ELT(nms, 168, mkChar("dim_T_1"));
  SET_STRING_ELT(nms, 169, mkChar("dim_T_2"));
  SET_STRING_ELT(nms, 170, mkChar("dim_T0"));
  SET_STRING_ELT(nms, 171, mkChar("dim_T0_1"));
  SET_STRING_ELT(nms, 172, mkChar("dim_T0_2"));
  SET_STRING_ELT(nms, 173, mkChar("dim_U"));
  SET_STRING_ELT(nms, 174, mkChar("dim_U_1"));
  SET_STRING_ELT(nms, 175, mkChar("dim_U_2"));
  SET_STRING_ELT(nms, 176, mkChar("dim_U0"));
  SET_STRING_ELT(nms, 177, mkChar("dim_U0_1"));
  SET_STRING_ELT(nms, 178, mkChar("dim_U0_2"));
  SET_STRING_ELT(nms, 179, mkChar("dim_vea"));
  SET_STRING_ELT(nms, 180, mkChar("dim_ved"));
  SET_STRING_ELT(nms, 181, mkChar("dim_ves"));
  SET_STRING_ELT(nms, 182, mkChar("dim_w"));
  SET_STRING_ELT(nms, 183, mkChar("dim_w_1"));
  SET_STRING_ELT(nms, 184, mkChar("dim_w_2"));
  SET_STRING_ELT(nms, 185, mkChar("dim_wA"));
  SET_STRING_ELT(nms, 186, mkChar("dim_wA_1"));
  SET_STRING_ELT(nms, 187, mkChar("dim_wA_12"));
  SET_STRING_ELT(nms, 188, mkChar("dim_wA_2"));
  SET_STRING_ELT(nms, 189, mkChar("dim_wA_3"));
  SET_STRING_ELT(nms, 190, mkChar("dim_wI"));
  SET_STRING_ELT(nms, 191, mkChar("dim_wI_1"));
  SET_STRING_ELT(nms, 192, mkChar("dim_wI_12"));
  SET_STRING_ELT(nms, 193, mkChar("dim_wI_2"));
  SET_STRING_ELT(nms, 194, mkChar("dim_wI_3"));
  SET_STRING_ELT(nms, 195, mkChar("dim_wS"));
  SET_STRING_ELT(nms, 196, mkChar("dim_wS_1"));
  SET_STRING_ELT(nms, 197, mkChar("dim_wS_12"));
  SET_STRING_ELT(nms, 198, mkChar("dim_wS_2"));
  SET_STRING_ELT(nms, 199, mkChar("dim_wS_3"));
  SET_STRING_ELT(nms, 200, mkChar("dim_wT"));
  SET_STRING_ELT(nms, 201, mkChar("dim_wT_1"));
  SET_STRING_ELT(nms, 202, mkChar("dim_wT_12"));
  SET_STRING_ELT(nms, 203, mkChar("dim_wT_2"));
  SET_STRING_ELT(nms, 204, mkChar("dim_wT_3"));
  SET_STRING_ELT(nms, 205, mkChar("dim_wU"));
  SET_STRING_ELT(nms, 206, mkChar("dim_wU_1"));
  SET_STRING_ELT(nms, 207, mkChar("dim_wU_12"));
  SET_STRING_ELT(nms, 208, mkChar("dim_wU_2"));
  SET_STRING_ELT(nms, 209, mkChar("dim_wU_3"));
  SET_STRING_ELT(nms, 210, mkChar("dt"));
  SET_STRING_ELT(nms, 211, mkChar("eta"));
  SET_STRING_ELT(nms, 212, mkChar("I0"));
  SET_STRING_ELT(nms, 213, mkChar("initial_A"));
  SET_STRING_ELT(nms, 214, mkChar("initial_cum_diag_a"));
  SET_STRING_ELT(nms, 215, mkChar("initial_cum_diag_s"));
  SET_STRING_ELT(nms, 216, mkChar("initial_cum_incid"));
  SET_STRING_ELT(nms, 217, mkChar("initial_cum_pye_noscreen_trial_pov"));
  SET_STRING_ELT(nms, 218, mkChar("initial_cum_pye_trial_pov"));
  SET_STRING_ELT(nms, 219, mkChar("initial_cum_pye_true"));
  SET_STRING_ELT(nms, 220, mkChar("initial_cum_screened"));
  SET_STRING_ELT(nms, 221, mkChar("initial_cum_treated"));
  SET_STRING_ELT(nms, 222, mkChar("initial_I"));
  SET_STRING_ELT(nms, 223, mkChar("initial_S"));
  SET_STRING_ELT(nms, 224, mkChar("initial_T"));
  SET_STRING_ELT(nms, 225, mkChar("initial_time"));
  SET_STRING_ELT(nms, 226, mkChar("initial_U"));
  SET_STRING_ELT(nms, 227, mkChar("lambda"));
  SET_STRING_ELT(nms, 228, mkChar("mu"));
  SET_STRING_ELT(nms, 229, mkChar("N"));
  SET_STRING_ELT(nms, 230, mkChar("n_A_ext"));
  SET_STRING_ELT(nms, 231, mkChar("n_AT"));
  SET_STRING_ELT(nms, 232, mkChar("n_AU"));
  SET_STRING_ELT(nms, 233, mkChar("n_AUT"));
  SET_STRING_ELT(nms, 234, mkChar("n_Aw"));
  SET_STRING_ELT(nms, 235, mkChar("n_diag_rec"));
  SET_STRING_ELT(nms, 236, mkChar("n_group"));
  SET_STRING_ELT(nms, 237, mkChar("n_I_ext"));
  SET_STRING_ELT(nms, 238, mkChar("n_IA"));
  SET_STRING_ELT(nms, 239, mkChar("n_IAS"));
  SET_STRING_ELT(nms, 240, mkChar("n_IS"));
  SET_STRING_ELT(nms, 241, mkChar("n_Iw"));
  SET_STRING_ELT(nms, 242, mkChar("n_S_ext"));
  SET_STRING_ELT(nms, 243, mkChar("n_ST"));
  SET_STRING_ELT(nms, 244, mkChar("n_Sw"));
  SET_STRING_ELT(nms, 245, mkChar("n_T_ext"));
  SET_STRING_ELT(nms, 246, mkChar("n_TU"));
  SET_STRING_ELT(nms, 247, mkChar("n_Tw"));
  SET_STRING_ELT(nms, 248, mkChar("n_U_ext"));
  SET_STRING_ELT(nms, 249, mkChar("n_UI"));
  SET_STRING_ELT(nms, 250, mkChar("n_Uw"));
  SET_STRING_ELT(nms, 251, mkChar("n_vax"));
  SET_STRING_ELT(nms, 252, mkChar("nu"));
  SET_STRING_ELT(nms, 253, mkChar("offset_variable_A"));
  SET_STRING_ELT(nms, 254, mkChar("offset_variable_cum_diag_a"));
  SET_STRING_ELT(nms, 255, mkChar("offset_variable_cum_diag_s"));
  SET_STRING_ELT(nms, 256, mkChar("offset_variable_cum_incid"));
  SET_STRING_ELT(nms, 257, mkChar("offset_variable_cum_pye_noscreen_trial_pov"));
  SET_STRING_ELT(nms, 258, mkChar("offset_variable_cum_pye_trial_pov"));
  SET_STRING_ELT(nms, 259, mkChar("offset_variable_cum_pye_true"));
  SET_STRING_ELT(nms, 260, mkChar("offset_variable_cum_screened"));
  SET_STRING_ELT(nms, 261, mkChar("offset_variable_cum_treated"));
  SET_STRING_ELT(nms, 262, mkChar("offset_variable_I"));
  SET_STRING_ELT(nms, 263, mkChar("offset_variable_S"));
  SET_STRING_ELT(nms, 264, mkChar("offset_variable_T"));
  SET_STRING_ELT(nms, 265, mkChar("p_A_ext"));
  SET_STRING_ELT(nms, 266, mkChar("p_I_ext"));
  SET_STRING_ELT(nms, 267, mkChar("p_S_ext"));
  SET_STRING_ELT(nms, 268, mkChar("p_T_ext"));
  SET_STRING_ELT(nms, 269, mkChar("p_U_ext"));
  SET_STRING_ELT(nms, 270, mkChar("psi"));
  SET_STRING_ELT(nms, 271, mkChar("pye_noscreen_trial"));
  SET_STRING_ELT(nms, 272, mkChar("pye_trial"));
  SET_STRING_ELT(nms, 273, mkChar("r_AT"));
  SET_STRING_ELT(nms, 274, mkChar("r_AU"));
  SET_STRING_ELT(nms, 275, mkChar("Rel_A"));
  SET_STRING_ELT(nms, 276, mkChar("Rel_I"));
  SET_STRING_ELT(nms, 277, mkChar("Rel_S"));
  SET_STRING_ELT(nms, 278, mkChar("Rel_T"));
  SET_STRING_ELT(nms, 279, mkChar("Rel_U"));
  SET_STRING_ELT(nms, 280, mkChar("rho"));
  SET_STRING_ELT(nms, 281, mkChar("S0"));
  SET_STRING_ELT(nms, 282, mkChar("screened"));
  SET_STRING_ELT(nms, 283, mkChar("sigma"));
  SET_STRING_ELT(nms, 284, mkChar("steps_per_year"));
  SET_STRING_ELT(nms, 285, mkChar("T0"));
  SET_STRING_ELT(nms, 286, mkChar("U0"));
  SET_STRING_ELT(nms, 287, mkChar("vea"));
  SET_STRING_ELT(nms, 288, mkChar("ved"));
  SET_STRING_ELT(nms, 289, mkChar("ves"));
  SET_STRING_ELT(nms, 290, mkChar("w"));
  SET_STRING_ELT(nms, 291, mkChar("wA"));
  SET_STRING_ELT(nms, 292, mkChar("wI"));
  SET_STRING_ELT(nms, 293, mkChar("wS"));
  SET_STRING_ELT(nms, 294, mkChar("wT"));
  SET_STRING_ELT(nms, 295, mkChar("wU"));
  setAttrib(contents, R_NamesSymbol, nms);
  UNPROTECT(68);
  return contents;
}
SEXP model_trial_stochastic_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->offset_variable_cum_pye_noscreen_trial_pov = internal->dim_A + internal->dim_cum_diag_a + internal->dim_cum_diag_s + internal->dim_cum_incid + internal->dim_cum_pye_trial_pov + internal->dim_cum_screened + internal->dim_cum_treated + internal->dim_I + internal->dim_S + internal->dim_T + internal->dim_U + 1;
  ...
  internal->offset_variable_cum_pye_true = internal->dim_A + internal->dim_cum_diag_a + internal->dim_cum_diag_s + internal->dim_cum_incid + internal->dim_cum_pye_noscreen_trial_pov + internal->dim_cum_pye_trial_pov + internal->dim_cum_screened + internal->dim_cum_treated + internal->dim_I + internal->dim_S + internal->dim_T + internal->dim_U + 1;
...
SEXP model_trial_stochastic_metadata(SEXP internal_p) {
  ...
  dim_cum_pye_trial_pov[1] = internal->dim_cum_pye_trial_pov_2;
  SET_VECTOR_ELT(variable_length, 12, allocVector(INTSXP, 2));
  int * dim_cum_pye_noscreen_trial_pov = INTEGER(VECTOR_ELT(variable_length, 12));
  dim_cum_pye_noscreen_trial_pov[0] = internal->dim_cum_pye_noscreen_trial_pov_1;
  dim_cum_pye_noscreen_trial_pov[1] = internal->dim_cum_pye_noscreen_trial_pov_2;
  SET_VECTOR_ELT(variable_length, 13, allocVector(INTSXP, 2));
  int * dim_cum_pye_true = INTEGER(VECTOR_ELT(variable_length, 13));
  dim_cum_pye_true[0] = internal->dim_cum_pye_true_1;
  dim_cum_pye_true[1] = internal->dim_cum_pye_true_2;
  ...
  SET_STRING_ELT(variable_names, 12, mkChar("cum_pye_noscreen_trial_pov"));
  SET_STRING_ELT(variable_names, 13, mkChar("cum_pye_true"));
  SET_VECTOR_ELT(ret, 0, variable_length);
  UNPROTECT(2);
  SEXP output_length = PROTECT(allocVector(VECSXP, 3));
  SEXP output_names = PROTECT(allocVector(STRSXP, 3));
...
SEXP model_trial_stochastic_initial_conditions(SEXP internal_p, SEXP step_ptr) {
  model_trial_stochastic_internal *internal = model_trial_stochastic_get_internal(internal_p, 1);
  SEXP r_state = PROTECT(allocVector(REALSXP, internal->dim_A + internal->dim_cum_diag_a + internal->dim_cum_diag_s + internal->dim_cum_incid + internal->dim_cum_pye_noscreen_trial_pov + internal->dim_cum_pye_trial_pov + internal->dim_cum_pye_true + internal->dim_cum_screened + internal->dim_cum_treated + internal->dim_I + internal->dim_S + internal->dim_T + internal->dim_U + 1));
  double * state = REAL(r_state);
...
void model_trial_stochastic_rhs(model_trial_stochastic_internal* internal, size_t step, double * state, double * state_next, double * output) {
  ...
  double * cum_pye_noscreen_trial_pov = state + internal->offset_variable_cum_pye_noscreen_trial_pov;
  ...
  for (int i = 1; i <= internal->dim_pye_noscreen_trial_1; ++i) {
    for (int j = 1; j <= internal->dim_pye_noscreen_trial_2; ++j) {
      internal->pye_noscreen_trial[i - 1 + internal->dim_pye_noscreen_trial_1 * (j - 1)] = (U[internal->dim_U_1 * (j - 1) + i - 1] + I[internal->dim_I_1 * (j - 1) + i - 1] + A[internal->dim_A_1 * (j - 1) + i - 1] + S[internal->dim_S_1 * (j - 1) + i - 1] + T[internal->dim_T_1 * (j - 1) + i - 1]) * internal->dt;
    }
  }
  for (int i = 1; i <= internal->dim_pye_trial_1; ++i) {
    for (int j = 1; j <= internal->dim_pye_trial_2; ++j) {
  ...
  for (int i = 1; i <= internal->dim_cum_pye_noscreen_trial_pov_1; ++i) {
    for (int j = 1; j <= internal->dim_cum_pye_noscreen_trial_pov_2; ++j) {
      state_next[internal->offset_variable_cum_pye_noscreen_trial_pov + i - 1 + internal->dim_cum_pye_noscreen_trial_pov_1 * (j - 1)] = cum_pye_noscreen_trial_pov[internal->dim_cum_pye_noscreen_trial_pov_1 * (j - 1) + i - 1] + internal->pye_noscreen_trial[internal->dim_pye_noscreen_trial_1 * (j - 1) + i - 1];
    }
  }
  for (int i = 1; i <= internal->dim_cum_pye_trial_pov_1; ++i) {
    for (int j = 1; j <= internal->dim_cum_pye_trial_pov_2; ++j) {
