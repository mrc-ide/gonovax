...
SEXP model_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 336));
  ...
  SET_VECTOR_ELT(contents, 26, ScalarInteger(internal->dim_cum_incid));
  SET_VECTOR_ELT(contents, 27, ScalarInteger(internal->dim_cum_incid_1));
  SET_VECTOR_ELT(contents, 28, ScalarInteger(internal->dim_cum_incid_2));
  SET_VECTOR_ELT(contents, 29, ScalarInteger(internal->dim_cum_lifeyears_U));
  SET_VECTOR_ELT(contents, 30, ScalarInteger(internal->dim_cum_lifeyears_U_1));
  SET_VECTOR_ELT(contents, 31, ScalarInteger(internal->dim_cum_lifeyears_U_2));
  SET_VECTOR_ELT(contents, 32, ScalarInteger(internal->dim_cum_offered));
  SET_VECTOR_ELT(contents, 33, ScalarInteger(internal->dim_cum_offered_1));
  SET_VECTOR_ELT(contents, 34, ScalarInteger(internal->dim_cum_offered_2));
  SET_VECTOR_ELT(contents, 35, ScalarInteger(internal->dim_cum_screened));
  SET_VECTOR_ELT(contents, 36, ScalarInteger(internal->dim_cum_screened_1));
  SET_VECTOR_ELT(contents, 37, ScalarInteger(internal->dim_cum_screened_2));
  SET_VECTOR_ELT(contents, 38, ScalarInteger(internal->dim_cum_treated));
  SET_VECTOR_ELT(contents, 39, ScalarInteger(internal->dim_cum_treated_1));
  SET_VECTOR_ELT(contents, 40, ScalarInteger(internal->dim_cum_treated_2));
  SET_VECTOR_ELT(contents, 41, ScalarInteger(internal->dim_cum_vaccinated));
  SET_VECTOR_ELT(contents, 42, ScalarInteger(internal->dim_cum_vaccinated_1));
  SET_VECTOR_ELT(contents, 43, ScalarInteger(internal->dim_cum_vaccinated_2));
  SET_VECTOR_ELT(contents, 44, ScalarInteger(internal->dim_cum_vaccinated_screen));
  SET_VECTOR_ELT(contents, 45, ScalarInteger(internal->dim_cum_vaccinated_screen_1));
  SET_VECTOR_ELT(contents, 46, ScalarInteger(internal->dim_cum_vaccinated_screen_2));
  ...
  SET_VECTOR_ELT(contents, 59, ScalarInteger(internal->dim_hesgroupmatrix));
  SET_VECTOR_ELT(contents, 60, ScalarInteger(internal->dim_hesgroupmatrix_1));
  SET_VECTOR_ELT(contents, 61, ScalarInteger(internal->dim_hesgroupmatrix_2));
  SET_VECTOR_ELT(contents, 62, ScalarInteger(internal->dim_I));
  SET_VECTOR_ELT(contents, 63, ScalarInteger(internal->dim_I_1));
  SET_VECTOR_ELT(contents, 64, ScalarInteger(internal->dim_I_2));
  SET_VECTOR_ELT(contents, 65, ScalarInteger(internal->dim_I0));
  SET_VECTOR_ELT(contents, 66, ScalarInteger(internal->dim_I0_1));
  SET_VECTOR_ELT(contents, 67, ScalarInteger(internal->dim_I0_2));
  SET_VECTOR_ELT(contents, 68, ScalarInteger(internal->dim_lambda));
  SET_VECTOR_ELT(contents, 69, ScalarInteger(internal->dim_lambda_1));
  SET_VECTOR_ELT(contents, 70, ScalarInteger(internal->dim_lambda_2));
  SET_VECTOR_ELT(contents, 71, ScalarInteger(internal->dim_N));
  SET_VECTOR_ELT(contents, 72, ScalarInteger(internal->dim_N_1));
  SET_VECTOR_ELT(contents, 73, ScalarInteger(internal->dim_N_2));
  SET_VECTOR_ELT(contents, 74, ScalarInteger(internal->dim_n_AT));
  SET_VECTOR_ELT(contents, 75, ScalarInteger(internal->dim_n_AT_1));
  SET_VECTOR_ELT(contents, 76, ScalarInteger(internal->dim_n_AT_2));
  SET_VECTOR_ELT(contents, 77, ScalarInteger(internal->dim_n_AU));
  SET_VECTOR_ELT(contents, 78, ScalarInteger(internal->dim_n_AU_1));
  SET_VECTOR_ELT(contents, 79, ScalarInteger(internal->dim_n_AU_2));
  SET_VECTOR_ELT(contents, 80, ScalarInteger(internal->dim_n_diag_rec));
  SET_VECTOR_ELT(contents, 81, ScalarInteger(internal->dim_n_diag_rec_1));
  SET_VECTOR_ELT(contents, 82, ScalarInteger(internal->dim_n_diag_rec_12));
  SET_VECTOR_ELT(contents, 83, ScalarInteger(internal->dim_n_diag_rec_2));
  SET_VECTOR_ELT(contents, 84, ScalarInteger(internal->dim_n_diag_rec_3));
  SET_VECTOR_ELT(contents, 85, ScalarInteger(internal->dim_n_doses));
  SET_VECTOR_ELT(contents, 86, ScalarInteger(internal->dim_n_doses_1));
  SET_VECTOR_ELT(contents, 87, ScalarInteger(internal->dim_n_doses_12));
  SET_VECTOR_ELT(contents, 88, ScalarInteger(internal->dim_n_doses_2));
  SET_VECTOR_ELT(contents, 89, ScalarInteger(internal->dim_n_doses_3));
  SET_VECTOR_ELT(contents, 90, ScalarInteger(internal->dim_N_hesgroup));
  SET_VECTOR_ELT(contents, 91, ScalarInteger(internal->dim_N_hesgroup_1));
  SET_VECTOR_ELT(contents, 92, ScalarInteger(internal->dim_N_hesgroup_12));
  SET_VECTOR_ELT(contents, 93, ScalarInteger(internal->dim_N_hesgroup_2));
  SET_VECTOR_ELT(contents, 94, ScalarInteger(internal->dim_N_hesgroup_3));
  SET_VECTOR_ELT(contents, 95, ScalarInteger(internal->dim_n_ood));
  SET_VECTOR_ELT(contents, 96, ScalarInteger(internal->dim_n_ood_1));
  SET_VECTOR_ELT(contents, 97, ScalarInteger(internal->dim_n_ood_12));
  SET_VECTOR_ELT(contents, 98, ScalarInteger(internal->dim_n_ood_2));
  SET_VECTOR_ELT(contents, 99, ScalarInteger(internal->dim_n_ood_3));
  SET_VECTOR_ELT(contents, 100, ScalarInteger(internal->dim_n_oos));
  SET_VECTOR_ELT(contents, 101, ScalarInteger(internal->dim_n_oos_1));
  SET_VECTOR_ELT(contents, 102, ScalarInteger(internal->dim_n_oos_12));
  SET_VECTOR_ELT(contents, 103, ScalarInteger(internal->dim_n_oos_2));
  SET_VECTOR_ELT(contents, 104, ScalarInteger(internal->dim_n_oos_3));
  SET_VECTOR_ELT(contents, 105, ScalarInteger(internal->dim_n_ST));
  SET_VECTOR_ELT(contents, 106, ScalarInteger(internal->dim_n_ST_1));
  SET_VECTOR_ELT(contents, 107, ScalarInteger(internal->dim_n_ST_2));
  SET_VECTOR_ELT(contents, 108, ScalarInteger(internal->dim_n_TU));
  SET_VECTOR_ELT(contents, 109, ScalarInteger(internal->dim_n_TU_1));
  SET_VECTOR_ELT(contents, 110, ScalarInteger(internal->dim_n_TU_2));
  SET_VECTOR_ELT(contents, 111, ScalarInteger(internal->dim_n_UI));
  SET_VECTOR_ELT(contents, 112, ScalarInteger(internal->dim_n_UI_1));
  SET_VECTOR_ELT(contents, 113, ScalarInteger(internal->dim_n_UI_2));
  SET_VECTOR_ELT(contents, 114, ScalarInteger(internal->dim_n_vod));
  SET_VECTOR_ELT(contents, 115, ScalarInteger(internal->dim_n_vod_1));
  SET_VECTOR_ELT(contents, 116, ScalarInteger(internal->dim_n_vod_12));
  SET_VECTOR_ELT(contents, 117, ScalarInteger(internal->dim_n_vod_2));
  SET_VECTOR_ELT(contents, 118, ScalarInteger(internal->dim_n_vod_3));
  SET_VECTOR_ELT(contents, 119, ScalarInteger(internal->dim_n_vos));
  SET_VECTOR_ELT(contents, 120, ScalarInteger(internal->dim_n_vos_1));
  SET_VECTOR_ELT(contents, 121, ScalarInteger(internal->dim_n_vos_12));
  SET_VECTOR_ELT(contents, 122, ScalarInteger(internal->dim_n_vos_2));
  SET_VECTOR_ELT(contents, 123, ScalarInteger(internal->dim_n_vos_3));
  SET_VECTOR_ELT(contents, 124, ScalarInteger(internal->dim_Np));
  SET_VECTOR_ELT(contents, 125, ScalarInteger(internal->dim_p));
  SET_VECTOR_ELT(contents, 126, ScalarInteger(internal->dim_prop_C));
  SET_VECTOR_ELT(contents, 127, ScalarInteger(internal->dim_prop_C_hesgroup));
  SET_VECTOR_ELT(contents, 128, ScalarInteger(internal->dim_prop_C_hesriskgroup));
  SET_VECTOR_ELT(contents, 129, ScalarInteger(internal->dim_prop_C_hesriskgroup_1));
  SET_VECTOR_ELT(contents, 130, ScalarInteger(internal->dim_prop_C_hesriskgroup_2));
  SET_VECTOR_ELT(contents, 131, ScalarInteger(internal->dim_q));
  SET_VECTOR_ELT(contents, 132, ScalarInteger(internal->dim_S));
  SET_VECTOR_ELT(contents, 133, ScalarInteger(internal->dim_S_1));
  SET_VECTOR_ELT(contents, 134, ScalarInteger(internal->dim_S_2));
  SET_VECTOR_ELT(contents, 135, ScalarInteger(internal->dim_S0));
  SET_VECTOR_ELT(contents, 136, ScalarInteger(internal->dim_S0_1));
  SET_VECTOR_ELT(contents, 137, ScalarInteger(internal->dim_S0_2));
  SET_VECTOR_ELT(contents, 138, ScalarInteger(internal->dim_screened));
  SET_VECTOR_ELT(contents, 139, ScalarInteger(internal->dim_screened_1));
  SET_VECTOR_ELT(contents, 140, ScalarInteger(internal->dim_screened_2));
  SET_VECTOR_ELT(contents, 141, ScalarInteger(internal->dim_stratum_doses));
  SET_VECTOR_ELT(contents, 142, ScalarInteger(internal->dim_T));
  SET_VECTOR_ELT(contents, 143, ScalarInteger(internal->dim_T_1));
  SET_VECTOR_ELT(contents, 144, ScalarInteger(internal->dim_T_2));
  SET_VECTOR_ELT(contents, 145, ScalarInteger(internal->dim_T0));
  SET_VECTOR_ELT(contents, 146, ScalarInteger(internal->dim_T0_1));
  SET_VECTOR_ELT(contents, 147, ScalarInteger(internal->dim_T0_2));
  SET_VECTOR_ELT(contents, 148, ScalarInteger(internal->dim_tt));
  ...
  SET_VECTOR_ELT(contents, 152, ScalarInteger(internal->dim_u_d));
  SET_VECTOR_ELT(contents, 153, ScalarInteger(internal->dim_u_d_1));
  SET_VECTOR_ELT(contents, 154, ScalarInteger(internal->dim_u_d_12));
  SET_VECTOR_ELT(contents, 155, ScalarInteger(internal->dim_u_d_2));
  SET_VECTOR_ELT(contents, 156, ScalarInteger(internal->dim_u_d_3));
  SET_VECTOR_ELT(contents, 157, ScalarInteger(internal->dim_u_s));
  SET_VECTOR_ELT(contents, 158, ScalarInteger(internal->dim_u_s_1));
  SET_VECTOR_ELT(contents, 159, ScalarInteger(internal->dim_u_s_12));
  SET_VECTOR_ELT(contents, 160, ScalarInteger(internal->dim_u_s_2));
  SET_VECTOR_ELT(contents, 161, ScalarInteger(internal->dim_u_s_3));
  SET_VECTOR_ELT(contents, 162, ScalarInteger(internal->dim_U0));
  SET_VECTOR_ELT(contents, 163, ScalarInteger(internal->dim_U0_1));
  SET_VECTOR_ELT(contents, 164, ScalarInteger(internal->dim_U0_2));
  SET_VECTOR_ELT(contents, 165, ScalarInteger(internal->dim_vax_t));
  SET_VECTOR_ELT(contents, 166, ScalarInteger(internal->dim_vax_y));
  SET_VECTOR_ELT(contents, 167, ScalarInteger(internal->dim_vea));
  SET_VECTOR_ELT(contents, 168, ScalarInteger(internal->dim_ved));
  SET_VECTOR_ELT(contents, 169, ScalarInteger(internal->dim_vei));
  SET_VECTOR_ELT(contents, 170, ScalarInteger(internal->dim_ves));
  SET_VECTOR_ELT(contents, 171, ScalarInteger(internal->dim_vod));
  SET_VECTOR_ELT(contents, 172, ScalarInteger(internal->dim_vod_1));
  SET_VECTOR_ELT(contents, 173, ScalarInteger(internal->dim_vod_12));
  SET_VECTOR_ELT(contents, 174, ScalarInteger(internal->dim_vod_2));
  SET_VECTOR_ELT(contents, 175, ScalarInteger(internal->dim_vod_3));
  SET_VECTOR_ELT(contents, 176, ScalarInteger(internal->dim_vos));
  SET_VECTOR_ELT(contents, 177, ScalarInteger(internal->dim_vos_1));
  SET_VECTOR_ELT(contents, 178, ScalarInteger(internal->dim_vos_12));
  SET_VECTOR_ELT(contents, 179, ScalarInteger(internal->dim_vos_2));
  SET_VECTOR_ELT(contents, 180, ScalarInteger(internal->dim_vos_3));
  SET_VECTOR_ELT(contents, 181, ScalarInteger(internal->dim_w));
  SET_VECTOR_ELT(contents, 182, ScalarInteger(internal->dim_w_1));
  SET_VECTOR_ELT(contents, 183, ScalarInteger(internal->dim_w_2));
  SET_VECTOR_ELT(contents, 184, ScalarInteger(internal->dim_wA));
  SET_VECTOR_ELT(contents, 185, ScalarInteger(internal->dim_wA_1));
  SET_VECTOR_ELT(contents, 186, ScalarInteger(internal->dim_wA_12));
  SET_VECTOR_ELT(contents, 187, ScalarInteger(internal->dim_wA_2));
  SET_VECTOR_ELT(contents, 188, ScalarInteger(internal->dim_wA_3));
  SET_VECTOR_ELT(contents, 189, ScalarInteger(internal->dim_wd));
  SET_VECTOR_ELT(contents, 190, ScalarInteger(internal->dim_wd_1));
  SET_VECTOR_ELT(contents, 191, ScalarInteger(internal->dim_wd_2));
  SET_VECTOR_ELT(contents, 192, ScalarInteger(internal->dim_wdA));
  SET_VECTOR_ELT(contents, 193, ScalarInteger(internal->dim_wdA_1));
  SET_VECTOR_ELT(contents, 194, ScalarInteger(internal->dim_wdA_12));
  SET_VECTOR_ELT(contents, 195, ScalarInteger(internal->dim_wdA_2));
  SET_VECTOR_ELT(contents, 196, ScalarInteger(internal->dim_wdA_3));
  SET_VECTOR_ELT(contents, 197, ScalarInteger(internal->dim_wdI));
  SET_VECTOR_ELT(contents, 198, ScalarInteger(internal->dim_wdI_1));
  SET_VECTOR_ELT(contents, 199, ScalarInteger(internal->dim_wdI_12));
  SET_VECTOR_ELT(contents, 200, ScalarInteger(internal->dim_wdI_2));
  SET_VECTOR_ELT(contents, 201, ScalarInteger(internal->dim_wdI_3));
  SET_VECTOR_ELT(contents, 202, ScalarInteger(internal->dim_wdS));
  SET_VECTOR_ELT(contents, 203, ScalarInteger(internal->dim_wdS_1));
  SET_VECTOR_ELT(contents, 204, ScalarInteger(internal->dim_wdS_12));
  SET_VECTOR_ELT(contents, 205, ScalarInteger(internal->dim_wdS_2));
  SET_VECTOR_ELT(contents, 206, ScalarInteger(internal->dim_wdS_3));
  SET_VECTOR_ELT(contents, 207, ScalarInteger(internal->dim_wdT));
  SET_VECTOR_ELT(contents, 208, ScalarInteger(internal->dim_wdT_1));
  SET_VECTOR_ELT(contents, 209, ScalarInteger(internal->dim_wdT_12));
  SET_VECTOR_ELT(contents, 210, ScalarInteger(internal->dim_wdT_2));
  SET_VECTOR_ELT(contents, 211, ScalarInteger(internal->dim_wdT_3));
  SET_VECTOR_ELT(contents, 212, ScalarInteger(internal->dim_wdU));
  SET_VECTOR_ELT(contents, 213, ScalarInteger(internal->dim_wdU_1));
  SET_VECTOR_ELT(contents, 214, ScalarInteger(internal->dim_wdU_12));
  SET_VECTOR_ELT(contents, 215, ScalarInteger(internal->dim_wdU_2));
  SET_VECTOR_ELT(contents, 216, ScalarInteger(internal->dim_wdU_3));
  SET_VECTOR_ELT(contents, 217, ScalarInteger(internal->dim_wI));
  SET_VECTOR_ELT(contents, 218, ScalarInteger(internal->dim_wI_1));
  SET_VECTOR_ELT(contents, 219, ScalarInteger(internal->dim_wI_12));
  SET_VECTOR_ELT(contents, 220, ScalarInteger(internal->dim_wI_2));
  SET_VECTOR_ELT(contents, 221, ScalarInteger(internal->dim_wI_3));
  SET_VECTOR_ELT(contents, 222, ScalarInteger(internal->dim_willing));
  SET_VECTOR_ELT(contents, 223, ScalarInteger(internal->dim_wS));
  SET_VECTOR_ELT(contents, 224, ScalarInteger(internal->dim_wS_1));
  SET_VECTOR_ELT(contents, 225, ScalarInteger(internal->dim_wS_12));
  SET_VECTOR_ELT(contents, 226, ScalarInteger(internal->dim_wS_2));
  SET_VECTOR_ELT(contents, 227, ScalarInteger(internal->dim_wS_3));
  SET_VECTOR_ELT(contents, 228, ScalarInteger(internal->dim_wT));
  SET_VECTOR_ELT(contents, 229, ScalarInteger(internal->dim_wT_1));
  SET_VECTOR_ELT(contents, 230, ScalarInteger(internal->dim_wT_12));
  SET_VECTOR_ELT(contents, 231, ScalarInteger(internal->dim_wT_2));
  SET_VECTOR_ELT(contents, 232, ScalarInteger(internal->dim_wT_3));
  SET_VECTOR_ELT(contents, 233, ScalarInteger(internal->dim_wU));
  SET_VECTOR_ELT(contents, 234, ScalarInteger(internal->dim_wU_1));
  SET_VECTOR_ELT(contents, 235, ScalarInteger(internal->dim_wU_12));
  SET_VECTOR_ELT(contents, 236, ScalarInteger(internal->dim_wU_2));
  SET_VECTOR_ELT(contents, 237, ScalarInteger(internal->dim_wU_3));
  SET_VECTOR_ELT(contents, 238, ScalarReal(internal->enr));
  ...
  SET_VECTOR_ELT(contents, 239, entrants);
  SET_VECTOR_ELT(contents, 240, ScalarReal(internal->epsilon));
  SET_VECTOR_ELT(contents, 241, ScalarReal(internal->epsilon_hes));
  SEXP eta = PROTECT(allocVector(REALSXP, internal->dim_eta));
  memcpy(REAL(eta), internal->eta, internal->dim_eta * sizeof(double));
  SET_VECTOR_ELT(contents, 242, eta);
  ...
  SET_VECTOR_ELT(contents, 243, eta_h_t);
  ...
  SET_VECTOR_ELT(contents, 244, eta_l_t);
  SET_VECTOR_ELT(contents, 245, ScalarReal(internal->exr));
  ...
  SET_VECTOR_ELT(contents, 246, foi_LH);
  ...
  SET_VECTOR_ELT(contents, 247, hesgroupmatrix);
  ...
  SET_VECTOR_ELT(contents, 248, I0);
  ...
  SET_VECTOR_ELT(contents, 249, initial_A);
  ...
  SET_VECTOR_ELT(contents, 250, initial_cum_diag_a);
  ...
  SET_VECTOR_ELT(contents, 251, initial_cum_diag_s);
  ...
  SET_VECTOR_ELT(contents, 252, initial_cum_incid);
  ...
  SET_VECTOR_ELT(contents, 253, initial_cum_lifeyears_U);
  ...
  SET_VECTOR_ELT(contents, 254, initial_cum_offered);
  ...
  SET_VECTOR_ELT(contents, 255, initial_cum_screened);
  ...
  SET_VECTOR_ELT(contents, 256, initial_cum_treated);
  ...
  SET_VECTOR_ELT(contents, 257, initial_cum_vaccinated);
  ...
  SET_VECTOR_ELT(contents, 258, initial_cum_vaccinated_screen);
  ...
  SET_VECTOR_ELT(contents, 259, initial_I);
  ...
  SET_VECTOR_ELT(contents, 260, initial_S);
  ...
  SET_VECTOR_ELT(contents, 261, initial_T);
  ...
  SET_VECTOR_ELT(contents, 262, initial_U);
  ...
  SET_VECTOR_ELT(contents, 268, ScalarReal(internal->mu));
  ...
  SET_VECTOR_ELT(contents, 270, n_AT);
  ...
  SET_VECTOR_ELT(contents, 271, n_AU);
  ...
  SET_VECTOR_ELT(contents, 272, n_diag_rec);
  ...
  SET_VECTOR_ELT(contents, 273, n_doses);
  SET_VECTOR_ELT(contents, 274, ScalarInteger(internal->n_group));
  ...
  SET_VECTOR_ELT(contents, 275, N_hesgroup);
  ...
  SET_VECTOR_ELT(contents, 276, n_ood);
  ...
  SET_VECTOR_ELT(contents, 277, n_oos);
  ...
  SET_VECTOR_ELT(contents, 278, n_ST);
  ...
  SET_VECTOR_ELT(contents, 279, n_TU);
  ...
  SET_VECTOR_ELT(contents, 280, n_UI);
  SET_VECTOR_ELT(contents, 281, ScalarInteger(internal->n_vax));
  ...
  SET_VECTOR_ELT(contents, 282, n_vod);
  ...
  SET_VECTOR_ELT(contents, 283, n_vos);
  SEXP Np = PROTECT(allocVector(REALSXP, internal->dim_Np));
  memcpy(REAL(Np), internal->Np, internal->dim_Np * sizeof(double));
  SET_VECTOR_ELT(contents, 284, Np);
  SET_VECTOR_ELT(contents, 285, ScalarReal(internal->nu));
  SET_VECTOR_ELT(contents, 286, ScalarInteger(internal->offset_variable_A));
  SET_VECTOR_ELT(contents, 287, ScalarInteger(internal->offset_variable_cum_diag_a));
  SET_VECTOR_ELT(contents, 288, ScalarInteger(internal->offset_variable_cum_diag_s));
  SET_VECTOR_ELT(contents, 289, ScalarInteger(internal->offset_variable_cum_incid));
  SET_VECTOR_ELT(contents, 290, ScalarInteger(internal->offset_variable_cum_lifeyears_U));
  SET_VECTOR_ELT(contents, 291, ScalarInteger(internal->offset_variable_cum_offered));
  SET_VECTOR_ELT(contents, 292, ScalarInteger(internal->offset_variable_cum_screened));
  SET_VECTOR_ELT(contents, 293, ScalarInteger(internal->offset_variable_cum_treated));
  SET_VECTOR_ELT(contents, 294, ScalarInteger(internal->offset_variable_cum_vaccinated));
  SET_VECTOR_ELT(contents, 295, ScalarInteger(internal->offset_variable_cum_vaccinated_screen));
  SET_VECTOR_ELT(contents, 296, ScalarInteger(internal->offset_variable_S));
  SET_VECTOR_ELT(contents, 297, ScalarInteger(internal->offset_variable_T));
  SEXP p = PROTECT(allocVector(REALSXP, internal->dim_p));
  memcpy(REAL(p), internal->p, internal->dim_p * sizeof(double));
  SET_VECTOR_ELT(contents, 298, p);
  ...
  SET_VECTOR_ELT(contents, 299, prop_C);
  ...
  SET_VECTOR_ELT(contents, 300, prop_C_hesgroup);
  ...
  SET_VECTOR_ELT(contents, 301, prop_C_hesriskgroup);
  SET_VECTOR_ELT(contents, 302, ScalarReal(internal->psi));
  SEXP q = PROTECT(allocVector(REALSXP, internal->dim_q));
  memcpy(REAL(q), internal->q, internal->dim_q * sizeof(double));
  SET_VECTOR_ELT(contents, 303, q);
  SET_VECTOR_ELT(contents, 304, ScalarReal(internal->rho));
  ...
  SET_VECTOR_ELT(contents, 305, S0);
  ...
  SET_VECTOR_ELT(contents, 306, screened);
  SET_VECTOR_ELT(contents, 307, ScalarReal(internal->sigma));
  ...
  SET_VECTOR_ELT(contents, 308, stratum_doses);
  ...
  SET_VECTOR_ELT(contents, 311, u_d);
  ...
  SET_VECTOR_ELT(contents, 312, u_s);
  ...
  SET_VECTOR_ELT(contents, 313, U0);
  SET_VECTOR_ELT(contents, 314, ScalarReal(internal->vax_switch_2));
  ...
  SET_VECTOR_ELT(contents, 315, vax_t);
  ...
  SET_VECTOR_ELT(contents, 321, vod);
  ...
  SET_VECTOR_ELT(contents, 322, vos);
  ...
  SET_VECTOR_ELT(contents, 324, wA);
  ...
  SET_VECTOR_ELT(contents, 325, wd);
  ...
  SET_VECTOR_ELT(contents, 326, wdA);
  ...
  SET_VECTOR_ELT(contents, 327, wdI);
  ...
  SET_VECTOR_ELT(contents, 328, wdS);
  ...
  SET_VECTOR_ELT(contents, 329, wdT);
  ...
  SET_VECTOR_ELT(contents, 330, wdU);
  ...
  SET_VECTOR_ELT(contents, 331, wI);
  ...
  SET_VECTOR_ELT(contents, 332, willing);
  ...
  SET_VECTOR_ELT(contents, 333, wS);
  ...
  SET_VECTOR_ELT(contents, 334, wT);
  ...
  SET_VECTOR_ELT(contents, 335, wU);
  SEXP nms = PROTECT(allocVector(STRSXP, 336));
  ...
  SET_STRING_ELT(nms, 26, mkChar("dim_cum_incid"));
  SET_STRING_ELT(nms, 27, mkChar("dim_cum_incid_1"));
  SET_STRING_ELT(nms, 28, mkChar("dim_cum_incid_2"));
  SET_STRING_ELT(nms, 29, mkChar("dim_cum_lifeyears_U"));
  SET_STRING_ELT(nms, 30, mkChar("dim_cum_lifeyears_U_1"));
  SET_STRING_ELT(nms, 31, mkChar("dim_cum_lifeyears_U_2"));
  SET_STRING_ELT(nms, 32, mkChar("dim_cum_offered"));
  SET_STRING_ELT(nms, 33, mkChar("dim_cum_offered_1"));
  SET_STRING_ELT(nms, 34, mkChar("dim_cum_offered_2"));
  SET_STRING_ELT(nms, 35, mkChar("dim_cum_screened"));
  SET_STRING_ELT(nms, 36, mkChar("dim_cum_screened_1"));
  SET_STRING_ELT(nms, 37, mkChar("dim_cum_screened_2"));
  SET_STRING_ELT(nms, 38, mkChar("dim_cum_treated"));
  SET_STRING_ELT(nms, 39, mkChar("dim_cum_treated_1"));
  SET_STRING_ELT(nms, 40, mkChar("dim_cum_treated_2"));
  SET_STRING_ELT(nms, 41, mkChar("dim_cum_vaccinated"));
  SET_STRING_ELT(nms, 42, mkChar("dim_cum_vaccinated_1"));
  SET_STRING_ELT(nms, 43, mkChar("dim_cum_vaccinated_2"));
  SET_STRING_ELT(nms, 44, mkChar("dim_cum_vaccinated_screen"));
  SET_STRING_ELT(nms, 45, mkChar("dim_cum_vaccinated_screen_1"));
  SET_STRING_ELT(nms, 46, mkChar("dim_cum_vaccinated_screen_2"));
  ...
  SET_STRING_ELT(nms, 59, mkChar("dim_hesgroupmatrix"));
  SET_STRING_ELT(nms, 60, mkChar("dim_hesgroupmatrix_1"));
  SET_STRING_ELT(nms, 61, mkChar("dim_hesgroupmatrix_2"));
  SET_STRING_ELT(nms, 62, mkChar("dim_I"));
  SET_STRING_ELT(nms, 63, mkChar("dim_I_1"));
  SET_STRING_ELT(nms, 64, mkChar("dim_I_2"));
  SET_STRING_ELT(nms, 65, mkChar("dim_I0"));
  SET_STRING_ELT(nms, 66, mkChar("dim_I0_1"));
  SET_STRING_ELT(nms, 67, mkChar("dim_I0_2"));
  SET_STRING_ELT(nms, 68, mkChar("dim_lambda"));
  SET_STRING_ELT(nms, 69, mkChar("dim_lambda_1"));
  SET_STRING_ELT(nms, 70, mkChar("dim_lambda_2"));
  SET_STRING_ELT(nms, 71, mkChar("dim_N"));
  SET_STRING_ELT(nms, 72, mkChar("dim_N_1"));
  SET_STRING_ELT(nms, 73, mkChar("dim_N_2"));
  SET_STRING_ELT(nms, 74, mkChar("dim_n_AT"));
  SET_STRING_ELT(nms, 75, mkChar("dim_n_AT_1"));
  SET_STRING_ELT(nms, 76, mkChar("dim_n_AT_2"));
  SET_STRING_ELT(nms, 77, mkChar("dim_n_AU"));
  SET_STRING_ELT(nms, 78, mkChar("dim_n_AU_1"));
  SET_STRING_ELT(nms, 79, mkChar("dim_n_AU_2"));
  SET_STRING_ELT(nms, 80, mkChar("dim_n_diag_rec"));
  SET_STRING_ELT(nms, 81, mkChar("dim_n_diag_rec_1"));
  SET_STRING_ELT(nms, 82, mkChar("dim_n_diag_rec_12"));
  SET_STRING_ELT(nms, 83, mkChar("dim_n_diag_rec_2"));
  SET_STRING_ELT(nms, 84, mkChar("dim_n_diag_rec_3"));
  SET_STRING_ELT(nms, 85, mkChar("dim_n_doses"));
  SET_STRING_ELT(nms, 86, mkChar("dim_n_doses_1"));
  SET_STRING_ELT(nms, 87, mkChar("dim_n_doses_12"));
  SET_STRING_ELT(nms, 88, mkChar("dim_n_doses_2"));
  SET_STRING_ELT(nms, 89, mkChar("dim_n_doses_3"));
  SET_STRING_ELT(nms, 90, mkChar("dim_N_hesgroup"));
  SET_STRING_ELT(nms, 91, mkChar("dim_N_hesgroup_1"));
  SET_STRING_ELT(nms, 92, mkChar("dim_N_hesgroup_12"));
  SET_STRING_ELT(nms, 93, mkChar("dim_N_hesgroup_2"));
  SET_STRING_ELT(nms, 94, mkChar("dim_N_hesgroup_3"));
  SET_STRING_ELT(nms, 95, mkChar("dim_n_ood"));
  SET_STRING_ELT(nms, 96, mkChar("dim_n_ood_1"));
  SET_STRING_ELT(nms, 97, mkChar("dim_n_ood_12"));
  SET_STRING_ELT(nms, 98, mkChar("dim_n_ood_2"));
  SET_STRING_ELT(nms, 99, mkChar("dim_n_ood_3"));
  SET_STRING_ELT(nms, 100, mkChar("dim_n_oos"));
  SET_STRING_ELT(nms, 101, mkChar("dim_n_oos_1"));
  SET_STRING_ELT(nms, 102, mkChar("dim_n_oos_12"));
  SET_STRING_ELT(nms, 103, mkChar("dim_n_oos_2"));
  SET_STRING_ELT(nms, 104, mkChar("dim_n_oos_3"));
  SET_STRING_ELT(nms, 105, mkChar("dim_n_ST"));
  SET_STRING_ELT(nms, 106, mkChar("dim_n_ST_1"));
  SET_STRING_ELT(nms, 107, mkChar("dim_n_ST_2"));
  SET_STRING_ELT(nms, 108, mkChar("dim_n_TU"));
  SET_STRING_ELT(nms, 109, mkChar("dim_n_TU_1"));
  SET_STRING_ELT(nms, 110, mkChar("dim_n_TU_2"));
  SET_STRING_ELT(nms, 111, mkChar("dim_n_UI"));
  SET_STRING_ELT(nms, 112, mkChar("dim_n_UI_1"));
  SET_STRING_ELT(nms, 113, mkChar("dim_n_UI_2"));
  SET_STRING_ELT(nms, 114, mkChar("dim_n_vod"));
  SET_STRING_ELT(nms, 115, mkChar("dim_n_vod_1"));
  SET_STRING_ELT(nms, 116, mkChar("dim_n_vod_12"));
  SET_STRING_ELT(nms, 117, mkChar("dim_n_vod_2"));
  SET_STRING_ELT(nms, 118, mkChar("dim_n_vod_3"));
  SET_STRING_ELT(nms, 119, mkChar("dim_n_vos"));
  SET_STRING_ELT(nms, 120, mkChar("dim_n_vos_1"));
  SET_STRING_ELT(nms, 121, mkChar("dim_n_vos_12"));
  SET_STRING_ELT(nms, 122, mkChar("dim_n_vos_2"));
  SET_STRING_ELT(nms, 123, mkChar("dim_n_vos_3"));
  SET_STRING_ELT(nms, 124, mkChar("dim_Np"));
  SET_STRING_ELT(nms, 125, mkChar("dim_p"));
  SET_STRING_ELT(nms, 126, mkChar("dim_prop_C"));
  SET_STRING_ELT(nms, 127, mkChar("dim_prop_C_hesgroup"));
  SET_STRING_ELT(nms, 128, mkChar("dim_prop_C_hesriskgroup"));
  SET_STRING_ELT(nms, 129, mkChar("dim_prop_C_hesriskgroup_1"));
  SET_STRING_ELT(nms, 130, mkChar("dim_prop_C_hesriskgroup_2"));
  SET_STRING_ELT(nms, 131, mkChar("dim_q"));
  SET_STRING_ELT(nms, 132, mkChar("dim_S"));
  SET_STRING_ELT(nms, 133, mkChar("dim_S_1"));
  SET_STRING_ELT(nms, 134, mkChar("dim_S_2"));
  SET_STRING_ELT(nms, 135, mkChar("dim_S0"));
  SET_STRING_ELT(nms, 136, mkChar("dim_S0_1"));
  SET_STRING_ELT(nms, 137, mkChar("dim_S0_2"));
  SET_STRING_ELT(nms, 138, mkChar("dim_screened"));
  SET_STRING_ELT(nms, 139, mkChar("dim_screened_1"));
  SET_STRING_ELT(nms, 140, mkChar("dim_screened_2"));
  SET_STRING_ELT(nms, 141, mkChar("dim_stratum_doses"));
  SET_STRING_ELT(nms, 142, mkChar("dim_T"));
  SET_STRING_ELT(nms, 143, mkChar("dim_T_1"));
  SET_STRING_ELT(nms, 144, mkChar("dim_T_2"));
  SET_STRING_ELT(nms, 145, mkChar("dim_T0"));
  SET_STRING_ELT(nms, 146, mkChar("dim_T0_1"));
  SET_STRING_ELT(nms, 147, mkChar("dim_T0_2"));
  SET_STRING_ELT(nms, 148, mkChar("dim_tt"));
  SET_STRING_ELT(nms, 149, mkChar("dim_U"));
  SET_STRING_ELT(nms, 150, mkChar("dim_U_1"));
  SET_STRING_ELT(nms, 151, mkChar("dim_U_2"));
  SET_STRING_ELT(nms, 152, mkChar("dim_u_d"));
  SET_STRING_ELT(nms, 153, mkChar("dim_u_d_1"));
  SET_STRING_ELT(nms, 154, mkChar("dim_u_d_12"));
  SET_STRING_ELT(nms, 155, mkChar("dim_u_d_2"));
  SET_STRING_ELT(nms, 156, mkChar("dim_u_d_3"));
  SET_STRING_ELT(nms, 157, mkChar("dim_u_s"));
  SET_STRING_ELT(nms, 158, mkChar("dim_u_s_1"));
  SET_STRING_ELT(nms, 159, mkChar("dim_u_s_12"));
  SET_STRING_ELT(nms, 160, mkChar("dim_u_s_2"));
  SET_STRING_ELT(nms, 161, mkChar("dim_u_s_3"));
  SET_STRING_ELT(nms, 162, mkChar("dim_U0"));
  SET_STRING_ELT(nms, 163, mkChar("dim_U0_1"));
  SET_STRING_ELT(nms, 164, mkChar("dim_U0_2"));
  SET_STRING_ELT(nms, 165, mkChar("dim_vax_t"));
  SET_STRING_ELT(nms, 166, mkChar("dim_vax_y"));
  SET_STRING_ELT(nms, 167, mkChar("dim_vea"));
  SET_STRING_ELT(nms, 168, mkChar("dim_ved"));
  SET_STRING_ELT(nms, 169, mkChar("dim_vei"));
  SET_STRING_ELT(nms, 170, mkChar("dim_ves"));
  SET_STRING_ELT(nms, 171, mkChar("dim_vod"));
  SET_STRING_ELT(nms, 172, mkChar("dim_vod_1"));
  SET_STRING_ELT(nms, 173, mkChar("dim_vod_12"));
  SET_STRING_ELT(nms, 174, mkChar("dim_vod_2"));
  SET_STRING_ELT(nms, 175, mkChar("dim_vod_3"));
  SET_STRING_ELT(nms, 176, mkChar("dim_vos"));
  SET_STRING_ELT(nms, 177, mkChar("dim_vos_1"));
  SET_STRING_ELT(nms, 178, mkChar("dim_vos_12"));
  SET_STRING_ELT(nms, 179, mkChar("dim_vos_2"));
  SET_STRING_ELT(nms, 180, mkChar("dim_vos_3"));
  SET_STRING_ELT(nms, 181, mkChar("dim_w"));
  SET_STRING_ELT(nms, 182, mkChar("dim_w_1"));
  SET_STRING_ELT(nms, 183, mkChar("dim_w_2"));
  SET_STRING_ELT(nms, 184, mkChar("dim_wA"));
  SET_STRING_ELT(nms, 185, mkChar("dim_wA_1"));
  SET_STRING_ELT(nms, 186, mkChar("dim_wA_12"));
  SET_STRING_ELT(nms, 187, mkChar("dim_wA_2"));
  SET_STRING_ELT(nms, 188, mkChar("dim_wA_3"));
  SET_STRING_ELT(nms, 189, mkChar("dim_wd"));
  SET_STRING_ELT(nms, 190, mkChar("dim_wd_1"));
  SET_STRING_ELT(nms, 191, mkChar("dim_wd_2"));
  SET_STRING_ELT(nms, 192, mkChar("dim_wdA"));
  SET_STRING_ELT(nms, 193, mkChar("dim_wdA_1"));
  SET_STRING_ELT(nms, 194, mkChar("dim_wdA_12"));
  SET_STRING_ELT(nms, 195, mkChar("dim_wdA_2"));
  SET_STRING_ELT(nms, 196, mkChar("dim_wdA_3"));
  SET_STRING_ELT(nms, 197, mkChar("dim_wdI"));
  SET_STRING_ELT(nms, 198, mkChar("dim_wdI_1"));
  SET_STRING_ELT(nms, 199, mkChar("dim_wdI_12"));
  SET_STRING_ELT(nms, 200, mkChar("dim_wdI_2"));
  SET_STRING_ELT(nms, 201, mkChar("dim_wdI_3"));
  SET_STRING_ELT(nms, 202, mkChar("dim_wdS"));
  SET_STRING_ELT(nms, 203, mkChar("dim_wdS_1"));
  SET_STRING_ELT(nms, 204, mkChar("dim_wdS_12"));
  SET_STRING_ELT(nms, 205, mkChar("dim_wdS_2"));
  SET_STRING_ELT(nms, 206, mkChar("dim_wdS_3"));
  SET_STRING_ELT(nms, 207, mkChar("dim_wdT"));
  SET_STRING_ELT(nms, 208, mkChar("dim_wdT_1"));
  SET_STRING_ELT(nms, 209, mkChar("dim_wdT_12"));
  SET_STRING_ELT(nms, 210, mkChar("dim_wdT_2"));
  SET_STRING_ELT(nms, 211, mkChar("dim_wdT_3"));
  SET_STRING_ELT(nms, 212, mkChar("dim_wdU"));
  SET_STRING_ELT(nms, 213, mkChar("dim_wdU_1"));
  SET_STRING_ELT(nms, 214, mkChar("dim_wdU_12"));
  SET_STRING_ELT(nms, 215, mkChar("dim_wdU_2"));
  SET_STRING_ELT(nms, 216, mkChar("dim_wdU_3"));
  SET_STRING_ELT(nms, 217, mkChar("dim_wI"));
  SET_STRING_ELT(nms, 218, mkChar("dim_wI_1"));
  SET_STRING_ELT(nms, 219, mkChar("dim_wI_12"));
  SET_STRING_ELT(nms, 220, mkChar("dim_wI_2"));
  SET_STRING_ELT(nms, 221, mkChar("dim_wI_3"));
  SET_STRING_ELT(nms, 222, mkChar("dim_willing"));
  SET_STRING_ELT(nms, 223, mkChar("dim_wS"));
  SET_STRING_ELT(nms, 224, mkChar("dim_wS_1"));
  SET_STRING_ELT(nms, 225, mkChar("dim_wS_12"));
  SET_STRING_ELT(nms, 226, mkChar("dim_wS_2"));
  SET_STRING_ELT(nms, 227, mkChar("dim_wS_3"));
  SET_STRING_ELT(nms, 228, mkChar("dim_wT"));
  SET_STRING_ELT(nms, 229, mkChar("dim_wT_1"));
  SET_STRING_ELT(nms, 230, mkChar("dim_wT_12"));
  SET_STRING_ELT(nms, 231, mkChar("dim_wT_2"));
  SET_STRING_ELT(nms, 232, mkChar("dim_wT_3"));
  SET_STRING_ELT(nms, 233, mkChar("dim_wU"));
  SET_STRING_ELT(nms, 234, mkChar("dim_wU_1"));
  SET_STRING_ELT(nms, 235, mkChar("dim_wU_12"));
  SET_STRING_ELT(nms, 236, mkChar("dim_wU_2"));
  SET_STRING_ELT(nms, 237, mkChar("dim_wU_3"));
  SET_STRING_ELT(nms, 238, mkChar("enr"));
  SET_STRING_ELT(nms, 239, mkChar("entrants"));
  SET_STRING_ELT(nms, 240, mkChar("epsilon"));
  SET_STRING_ELT(nms, 241, mkChar("epsilon_hes"));
  SET_STRING_ELT(nms, 242, mkChar("eta"));
  SET_STRING_ELT(nms, 243, mkChar("eta_h_t"));
  SET_STRING_ELT(nms, 244, mkChar("eta_l_t"));
  SET_STRING_ELT(nms, 245, mkChar("exr"));
  SET_STRING_ELT(nms, 246, mkChar("foi_LH"));
  SET_STRING_ELT(nms, 247, mkChar("hesgroupmatrix"));
  SET_STRING_ELT(nms, 248, mkChar("I0"));
  SET_STRING_ELT(nms, 249, mkChar("initial_A"));
  SET_STRING_ELT(nms, 250, mkChar("initial_cum_diag_a"));
  SET_STRING_ELT(nms, 251, mkChar("initial_cum_diag_s"));
  SET_STRING_ELT(nms, 252, mkChar("initial_cum_incid"));
  SET_STRING_ELT(nms, 253, mkChar("initial_cum_lifeyears_U"));
  SET_STRING_ELT(nms, 254, mkChar("initial_cum_offered"));
  SET_STRING_ELT(nms, 255, mkChar("initial_cum_screened"));
  SET_STRING_ELT(nms, 256, mkChar("initial_cum_treated"));
  SET_STRING_ELT(nms, 257, mkChar("initial_cum_vaccinated"));
  SET_STRING_ELT(nms, 258, mkChar("initial_cum_vaccinated_screen"));
  SET_STRING_ELT(nms, 259, mkChar("initial_I"));
  SET_STRING_ELT(nms, 260, mkChar("initial_S"));
  SET_STRING_ELT(nms, 261, mkChar("initial_T"));
  SET_STRING_ELT(nms, 262, mkChar("initial_U"));
  SET_STRING_ELT(nms, 263, mkChar("interpolate_beta"));
  SET_STRING_ELT(nms, 264, mkChar("interpolate_eta_h"));
  SET_STRING_ELT(nms, 265, mkChar("interpolate_eta_l"));
  SET_STRING_ELT(nms, 266, mkChar("interpolate_vax_switch_1"));
  SET_STRING_ELT(nms, 267, mkChar("lambda"));
  SET_STRING_ELT(nms, 268, mkChar("mu"));
  SET_STRING_ELT(nms, 269, mkChar("N"));
  SET_STRING_ELT(nms, 270, mkChar("n_AT"));
  SET_STRING_ELT(nms, 271, mkChar("n_AU"));
  SET_STRING_ELT(nms, 272, mkChar("n_diag_rec"));
  SET_STRING_ELT(nms, 273, mkChar("n_doses"));
  SET_STRING_ELT(nms, 274, mkChar("n_group"));
  SET_STRING_ELT(nms, 275, mkChar("N_hesgroup"));
  SET_STRING_ELT(nms, 276, mkChar("n_ood"));
  SET_STRING_ELT(nms, 277, mkChar("n_oos"));
  SET_STRING_ELT(nms, 278, mkChar("n_ST"));
  SET_STRING_ELT(nms, 279, mkChar("n_TU"));
  SET_STRING_ELT(nms, 280, mkChar("n_UI"));
  SET_STRING_ELT(nms, 281, mkChar("n_vax"));
  SET_STRING_ELT(nms, 282, mkChar("n_vod"));
  SET_STRING_ELT(nms, 283, mkChar("n_vos"));
  SET_STRING_ELT(nms, 284, mkChar("Np"));
  SET_STRING_ELT(nms, 285, mkChar("nu"));
  SET_STRING_ELT(nms, 286, mkChar("offset_variable_A"));
  SET_STRING_ELT(nms, 287, mkChar("offset_variable_cum_diag_a"));
  SET_STRING_ELT(nms, 288, mkChar("offset_variable_cum_diag_s"));
  SET_STRING_ELT(nms, 289, mkChar("offset_variable_cum_incid"));
  SET_STRING_ELT(nms, 290, mkChar("offset_variable_cum_lifeyears_U"));
  SET_STRING_ELT(nms, 291, mkChar("offset_variable_cum_offered"));
  SET_STRING_ELT(nms, 292, mkChar("offset_variable_cum_screened"));
  SET_STRING_ELT(nms, 293, mkChar("offset_variable_cum_treated"));
  SET_STRING_ELT(nms, 294, mkChar("offset_variable_cum_vaccinated"));
  SET_STRING_ELT(nms, 295, mkChar("offset_variable_cum_vaccinated_screen"));
  SET_STRING_ELT(nms, 296, mkChar("offset_variable_S"));
  SET_STRING_ELT(nms, 297, mkChar("offset_variable_T"));
  SET_STRING_ELT(nms, 298, mkChar("p"));
  SET_STRING_ELT(nms, 299, mkChar("prop_C"));
  SET_STRING_ELT(nms, 300, mkChar("prop_C_hesgroup"));
  SET_STRING_ELT(nms, 301, mkChar("prop_C_hesriskgroup"));
  SET_STRING_ELT(nms, 302, mkChar("psi"));
  SET_STRING_ELT(nms, 303, mkChar("q"));
  SET_STRING_ELT(nms, 304, mkChar("rho"));
  SET_STRING_ELT(nms, 305, mkChar("S0"));
  SET_STRING_ELT(nms, 306, mkChar("screened"));
  SET_STRING_ELT(nms, 307, mkChar("sigma"));
  SET_STRING_ELT(nms, 308, mkChar("stratum_doses"));
  SET_STRING_ELT(nms, 309, mkChar("T0"));
  SET_STRING_ELT(nms, 310, mkChar("tt"));
  SET_STRING_ELT(nms, 311, mkChar("u_d"));
  SET_STRING_ELT(nms, 312, mkChar("u_s"));
  SET_STRING_ELT(nms, 313, mkChar("U0"));
  SET_STRING_ELT(nms, 314, mkChar("vax_switch_2"));
  SET_STRING_ELT(nms, 315, mkChar("vax_t"));
  SET_STRING_ELT(nms, 316, mkChar("vax_y"));
  SET_STRING_ELT(nms, 317, mkChar("vea"));
  SET_STRING_ELT(nms, 318, mkChar("ved"));
  SET_STRING_ELT(nms, 319, mkChar("vei"));
  SET_STRING_ELT(nms, 320, mkChar("ves"));
  SET_STRING_ELT(nms, 321, mkChar("vod"));
  SET_STRING_ELT(nms, 322, mkChar("vos"));
  SET_STRING_ELT(nms, 323, mkChar("w"));
  SET_STRING_ELT(nms, 324, mkChar("wA"));
  SET_STRING_ELT(nms, 325, mkChar("wd"));
  SET_STRING_ELT(nms, 326, mkChar("wdA"));
  SET_STRING_ELT(nms, 327, mkChar("wdI"));
  SET_STRING_ELT(nms, 328, mkChar("wdS"));
  SET_STRING_ELT(nms, 329, mkChar("wdT"));
  SET_STRING_ELT(nms, 330, mkChar("wdU"));
  SET_STRING_ELT(nms, 331, mkChar("wI"));
  SET_STRING_ELT(nms, 332, mkChar("willing"));
  SET_STRING_ELT(nms, 333, mkChar("wS"));
  SET_STRING_ELT(nms, 334, mkChar("wT"));
  SET_STRING_ELT(nms, 335, mkChar("wU"));
...
SEXP model_metadata(SEXP internal_p) {
  ...
  int * dim_cum_lifeyears_U = INTEGER(VECTOR_ELT(variable_length, 13));
  ...
  SET_STRING_ELT(variable_names, 13, mkChar("cum_lifeyears_U"));
...
void model_rhs(model_internal* internal, double t, double * state, double * dstatedt, double * output) {
  ...
  for (int i = 1; i <= internal->dim_cum_offered_1; ++i) {
    for (int j = 1; j <= internal->dim_cum_offered_2; ++j) {
      dstatedt[internal->offset_variable_cum_offered + i - 1 + internal->dim_cum_offered_1 * (j - 1)] = internal->n_oos[internal->dim_n_oos_12 * (j - 1) + internal->dim_n_oos_1 * (j - 1) + i - 1] + internal->n_ood[internal->dim_n_ood_12 * (j - 1) + internal->dim_n_ood_1 * (j - 1) + i - 1];
    }
  }
  for (int i = 1; i <= internal->dim_I_1; ++i) {
    for (int j = 1; j <= internal->dim_I_2; ++j) {
  ...
  for (int i = 1; i <= internal->dim_cum_vaccinated_1; ++i) {
    for (int j = 1; j <= internal->dim_cum_vaccinated_2; ++j) {
      dstatedt[internal->offset_variable_cum_vaccinated + i - 1 + internal->dim_cum_vaccinated_1 * (j - 1)] = internal->n_vos[internal->dim_n_vos_12 * (j - 1) + internal->dim_n_vos_1 * (j - 1) + i - 1] + internal->n_vod[internal->dim_n_vod_12 * (j - 1) + internal->dim_n_vod_1 * (j - 1) + i - 1];
    }
  }
  for (int i = 1; i <= internal->dim_cum_vaccinated_screen_1; ++i) {
    for (int j = 1; j <= internal->dim_cum_vaccinated_screen_2; ++j) {
    ...
    for (int i = 1; i <= internal->dim_n_doses_1; ++i) {
      for (int j = 1; j <= internal->dim_n_doses_2; ++j) {
        for (int k = 1; k <= internal->dim_n_doses_3; ++k) {
          internal->n_doses[i - 1 + internal->dim_n_doses_1 * (j - 1) + internal->dim_n_doses_12 * (k - 1)] = (j == k ? 0 : -(1) * (internal->n_vos[internal->dim_n_vos_12 * (k - 1) + internal->dim_n_vos_1 * (j - 1) + i - 1] + internal->n_vod[internal->dim_n_vod_12 * (k - 1) + internal->dim_n_vod_1 * (j - 1) + i - 1]) * internal->stratum_doses[j - 1]);
        }
      }
    }
