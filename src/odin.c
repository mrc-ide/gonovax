...
SEXP model_contents(SEXP internal_p) {
  ...
  SET_VECTOR_ELT(contents, 85, ScalarInteger(internal->dim_vd_2));
  SET_VECTOR_ELT(contents, 86, ScalarInteger(internal->dim_ve));
  SET_VECTOR_ELT(contents, 87, ScalarInteger(internal->dim_vs));
  SET_VECTOR_ELT(contents, 88, ScalarInteger(internal->dim_vs_1));
  SET_VECTOR_ELT(contents, 89, ScalarInteger(internal->dim_vs_2));
  ...
  SET_VECTOR_ELT(contents, 118, eff);
  SET_VECTOR_ELT(contents, 119, ScalarReal(internal->enr));
  SET_VECTOR_ELT(contents, 120, ScalarReal(internal->epsilon));
  SET_VECTOR_ELT(contents, 121, ScalarReal(internal->eta));
  SET_VECTOR_ELT(contents, 122, ScalarReal(internal->exr));
  ...
  SET_VECTOR_ELT(contents, 123, foi);
  ...
  SET_VECTOR_ELT(contents, 124, I0);
  ...
  SET_VECTOR_ELT(contents, 125, incid);
  ...
  SET_VECTOR_ELT(contents, 127, initial_cum_incid);
  ...
  SET_VECTOR_ELT(contents, 128, initial_cum_screened);
  ...
  SET_VECTOR_ELT(contents, 129, initial_cum_treated);
  ...
  SET_VECTOR_ELT(contents, 130, initial_cum_vaccinated);
  ...
  SET_VECTOR_ELT(contents, 131, initial_I);
  ...
  SET_VECTOR_ELT(contents, 132, initial_S);
  ...
  SET_VECTOR_ELT(contents, 133, initial_T);
  ...
  SET_VECTOR_ELT(contents, 134, initial_U);
  ...
  SET_VECTOR_ELT(contents, 135, m);
  SET_VECTOR_ELT(contents, 136, ScalarReal(internal->mu));
  ...
  SET_VECTOR_ELT(contents, 137, N);
  SET_VECTOR_ELT(contents, 138, ScalarInteger(internal->n_group));
  SET_VECTOR_ELT(contents, 139, ScalarInteger(internal->n_vax));
  ...
  SET_VECTOR_ELT(contents, 140, n_vd);
  ...
  SET_VECTOR_ELT(contents, 141, n_ve);
  ...
  SET_VECTOR_ELT(contents, 142, n_vs);
  SEXP Np = PROTECT(allocVector(REALSXP, internal->dim_Np));
  memcpy(REAL(Np), internal->Np, internal->dim_Np * sizeof(double));
  SET_VECTOR_ELT(contents, 143, Np);
  SET_VECTOR_ELT(contents, 144, ScalarReal(internal->nu));
  SET_VECTOR_ELT(contents, 145, ScalarInteger(internal->offset_variable_A));
  SET_VECTOR_ELT(contents, 146, ScalarInteger(internal->offset_variable_cum_incid));
  SET_VECTOR_ELT(contents, 147, ScalarInteger(internal->offset_variable_cum_screened));
  SET_VECTOR_ELT(contents, 148, ScalarInteger(internal->offset_variable_cum_treated));
  SET_VECTOR_ELT(contents, 149, ScalarInteger(internal->offset_variable_cum_vaccinated));
  SET_VECTOR_ELT(contents, 150, ScalarInteger(internal->offset_variable_S));
  SET_VECTOR_ELT(contents, 151, ScalarInteger(internal->offset_variable_T));
  SEXP p = PROTECT(allocVector(REALSXP, internal->dim_p));
  memcpy(REAL(p), internal->p, internal->dim_p * sizeof(double));
  SET_VECTOR_ELT(contents, 152, p);
  SET_VECTOR_ELT(contents, 153, ScalarReal(internal->psi));
  SEXP q = PROTECT(allocVector(REALSXP, internal->dim_q));
  memcpy(REAL(q), internal->q, internal->dim_q * sizeof(double));
  SET_VECTOR_ELT(contents, 154, q);
  SET_VECTOR_ELT(contents, 155, ScalarReal(internal->rho));
  ...
  SET_VECTOR_ELT(contents, 156, S0);
  ...
  SET_VECTOR_ELT(contents, 157, screened);
  SET_VECTOR_ELT(contents, 158, ScalarReal(internal->sigma));
  ...
  SET_VECTOR_ELT(contents, 159, T0);
  ...
  SET_VECTOR_ELT(contents, 160, treated);
  ...
  SET_VECTOR_ELT(contents, 164, vs);
  ...
  SET_STRING_ELT(nms, 85, mkChar("dim_vd_2"));
  SET_STRING_ELT(nms, 86, mkChar("dim_ve"));
  SET_STRING_ELT(nms, 87, mkChar("dim_vs"));
  SET_STRING_ELT(nms, 88, mkChar("dim_vs_1"));
  SET_STRING_ELT(nms, 89, mkChar("dim_vs_2"));
  ...
  SET_STRING_ELT(nms, 118, mkChar("eff"));
  SET_STRING_ELT(nms, 119, mkChar("enr"));
  SET_STRING_ELT(nms, 120, mkChar("epsilon"));
  SET_STRING_ELT(nms, 121, mkChar("eta"));
  SET_STRING_ELT(nms, 122, mkChar("exr"));
  SET_STRING_ELT(nms, 123, mkChar("foi"));
  SET_STRING_ELT(nms, 124, mkChar("I0"));
  SET_STRING_ELT(nms, 125, mkChar("incid"));
  SET_STRING_ELT(nms, 126, mkChar("initial_A"));
  SET_STRING_ELT(nms, 127, mkChar("initial_cum_incid"));
  SET_STRING_ELT(nms, 128, mkChar("initial_cum_screened"));
  SET_STRING_ELT(nms, 129, mkChar("initial_cum_treated"));
  SET_STRING_ELT(nms, 130, mkChar("initial_cum_vaccinated"));
  SET_STRING_ELT(nms, 131, mkChar("initial_I"));
  SET_STRING_ELT(nms, 132, mkChar("initial_S"));
  SET_STRING_ELT(nms, 133, mkChar("initial_T"));
  SET_STRING_ELT(nms, 134, mkChar("initial_U"));
  SET_STRING_ELT(nms, 135, mkChar("m"));
  SET_STRING_ELT(nms, 136, mkChar("mu"));
  SET_STRING_ELT(nms, 137, mkChar("N"));
  SET_STRING_ELT(nms, 138, mkChar("n_group"));
  SET_STRING_ELT(nms, 139, mkChar("n_vax"));
  SET_STRING_ELT(nms, 140, mkChar("n_vd"));
  SET_STRING_ELT(nms, 141, mkChar("n_ve"));
  SET_STRING_ELT(nms, 142, mkChar("n_vs"));
  SET_STRING_ELT(nms, 143, mkChar("Np"));
  SET_STRING_ELT(nms, 144, mkChar("nu"));
  SET_STRING_ELT(nms, 145, mkChar("offset_variable_A"));
  SET_STRING_ELT(nms, 146, mkChar("offset_variable_cum_incid"));
  SET_STRING_ELT(nms, 147, mkChar("offset_variable_cum_screened"));
  SET_STRING_ELT(nms, 148, mkChar("offset_variable_cum_treated"));
  SET_STRING_ELT(nms, 149, mkChar("offset_variable_cum_vaccinated"));
  SET_STRING_ELT(nms, 150, mkChar("offset_variable_S"));
  SET_STRING_ELT(nms, 151, mkChar("offset_variable_T"));
  SET_STRING_ELT(nms, 152, mkChar("p"));
  SET_STRING_ELT(nms, 153, mkChar("psi"));
  SET_STRING_ELT(nms, 154, mkChar("q"));
  SET_STRING_ELT(nms, 155, mkChar("rho"));
  SET_STRING_ELT(nms, 156, mkChar("S0"));
  SET_STRING_ELT(nms, 157, mkChar("screened"));
  SET_STRING_ELT(nms, 158, mkChar("sigma"));
  SET_STRING_ELT(nms, 159, mkChar("T0"));
  SET_STRING_ELT(nms, 160, mkChar("treated"));
  SET_STRING_ELT(nms, 161, mkChar("U0"));
  SET_STRING_ELT(nms, 162, mkChar("vd"));
  SET_STRING_ELT(nms, 163, mkChar("ve"));
  SET_STRING_ELT(nms, 164, mkChar("vs"));
  ...
  for (int i = 1; i <= internal->dim_n_vd_1; ++i) {
    for (int j = 1; j <= internal->dim_n_vd_2; ++j) {
      for (int k = 1; k <= internal->dim_n_vd_3; ++k) {
        internal->n_vd[i - 1 + internal->dim_n_vd_1 * (j - 1) + internal->dim_n_vd_12 * (k - 1)] = internal->vd[internal->dim_vd_1 * (k - 1) + j - 1] * internal->treated[internal->dim_treated_1 * (k - 1) + i - 1];
      }
    }
  }
  for (int i = 1; i <= internal->dim_n_vs_1; ++i) {
    for (int j = 1; j <= internal->dim_n_vs_2; ++j) {
      for (int k = 1; k <= internal->dim_n_vs_3; ++k) {
        internal->n_vs[i - 1 + internal->dim_n_vs_1 * (j - 1) + internal->dim_n_vs_12 * (k - 1)] = internal->vs[internal->dim_vs_1 * (k - 1) + j - 1] * internal->screened[internal->dim_screened_1 * (k - 1) + i - 1];
      }
    }
  }
  for (int i = 1; i <= internal->dim_cum_vaccinated_1; ++i) {
