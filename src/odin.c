...
void model_trial_stochastic_finalise(SEXP internal_p) {
  ...
  if (internal_p) {
    ...
    R_Free(internal->p_A_or_S);
    R_Free(internal->p_ST);
    R_Free(internal->p_T_or_U);
    R_Free(internal->p_TU);
    R_Free(internal->p_UI);
...
SEXP model_trial_stochastic_create(SEXP user) {
  ...
  internal->n_UI = NULL;
  internal->n_Uw = NULL;
  internal->p_A_or_S = NULL;
  internal->p_ST = NULL;
  internal->p_T_or_U = NULL;
  internal->p_TU = NULL;
  internal->p_UI = NULL;
  internal->r_AT = NULL;
  internal->r_AU = NULL;
...
SEXP model_trial_stochastic_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 218));
  SEXP A0 = PROTECT(allocVector(REALSXP, internal->dim_A0));
  memcpy(REAL(A0), internal->A0, internal->dim_A0 * sizeof(double));
  odin_set_dim(A0, 2, internal->dim_A0_1, internal->dim_A0_2);
  SET_VECTOR_ELT(contents, 0, A0);
  ...
  SET_VECTOR_ELT(contents, 23, ScalarInteger(internal->dim_D));
  SET_VECTOR_ELT(contents, 24, ScalarInteger(internal->dim_eta));
  SET_VECTOR_ELT(contents, 25, ScalarInteger(internal->dim_I));
  SET_VECTOR_ELT(contents, 26, ScalarInteger(internal->dim_I_1));
  SET_VECTOR_ELT(contents, 27, ScalarInteger(internal->dim_I_2));
  SET_VECTOR_ELT(contents, 28, ScalarInteger(internal->dim_I0));
  SET_VECTOR_ELT(contents, 29, ScalarInteger(internal->dim_I0_1));
  SET_VECTOR_ELT(contents, 30, ScalarInteger(internal->dim_I0_2));
  SET_VECTOR_ELT(contents, 31, ScalarInteger(internal->dim_N));
  SET_VECTOR_ELT(contents, 32, ScalarInteger(internal->dim_N_1));
  SET_VECTOR_ELT(contents, 33, ScalarInteger(internal->dim_N_2));
  SET_VECTOR_ELT(contents, 34, ScalarInteger(internal->dim_n_AT));
  SET_VECTOR_ELT(contents, 35, ScalarInteger(internal->dim_n_AT_1));
  SET_VECTOR_ELT(contents, 36, ScalarInteger(internal->dim_n_AT_2));
  SET_VECTOR_ELT(contents, 37, ScalarInteger(internal->dim_n_AU));
  SET_VECTOR_ELT(contents, 38, ScalarInteger(internal->dim_n_AU_1));
  SET_VECTOR_ELT(contents, 39, ScalarInteger(internal->dim_n_AU_2));
  SET_VECTOR_ELT(contents, 40, ScalarInteger(internal->dim_n_AUT));
  SET_VECTOR_ELT(contents, 41, ScalarInteger(internal->dim_n_AUT_1));
  SET_VECTOR_ELT(contents, 42, ScalarInteger(internal->dim_n_AUT_2));
  SET_VECTOR_ELT(contents, 43, ScalarInteger(internal->dim_n_Aw));
  SET_VECTOR_ELT(contents, 44, ScalarInteger(internal->dim_n_Aw_1));
  SET_VECTOR_ELT(contents, 45, ScalarInteger(internal->dim_n_Aw_2));
  SET_VECTOR_ELT(contents, 46, ScalarInteger(internal->dim_n_IA));
  SET_VECTOR_ELT(contents, 47, ScalarInteger(internal->dim_n_IA_1));
  SET_VECTOR_ELT(contents, 48, ScalarInteger(internal->dim_n_IA_2));
  SET_VECTOR_ELT(contents, 49, ScalarInteger(internal->dim_n_IAS));
  SET_VECTOR_ELT(contents, 50, ScalarInteger(internal->dim_n_IAS_1));
  SET_VECTOR_ELT(contents, 51, ScalarInteger(internal->dim_n_IAS_2));
  SET_VECTOR_ELT(contents, 52, ScalarInteger(internal->dim_n_IS));
  SET_VECTOR_ELT(contents, 53, ScalarInteger(internal->dim_n_IS_1));
  SET_VECTOR_ELT(contents, 54, ScalarInteger(internal->dim_n_IS_2));
  SET_VECTOR_ELT(contents, 55, ScalarInteger(internal->dim_n_Iw));
  SET_VECTOR_ELT(contents, 56, ScalarInteger(internal->dim_n_Iw_1));
  SET_VECTOR_ELT(contents, 57, ScalarInteger(internal->dim_n_Iw_2));
  SET_VECTOR_ELT(contents, 58, ScalarInteger(internal->dim_n_ST));
  SET_VECTOR_ELT(contents, 59, ScalarInteger(internal->dim_n_ST_1));
  SET_VECTOR_ELT(contents, 60, ScalarInteger(internal->dim_n_ST_2));
  SET_VECTOR_ELT(contents, 61, ScalarInteger(internal->dim_n_Sw));
  SET_VECTOR_ELT(contents, 62, ScalarInteger(internal->dim_n_Sw_1));
  SET_VECTOR_ELT(contents, 63, ScalarInteger(internal->dim_n_Sw_2));
  SET_VECTOR_ELT(contents, 64, ScalarInteger(internal->dim_n_TU));
  SET_VECTOR_ELT(contents, 65, ScalarInteger(internal->dim_n_TU_1));
  SET_VECTOR_ELT(contents, 66, ScalarInteger(internal->dim_n_TU_2));
  SET_VECTOR_ELT(contents, 67, ScalarInteger(internal->dim_n_Tw));
  SET_VECTOR_ELT(contents, 68, ScalarInteger(internal->dim_n_Tw_1));
  SET_VECTOR_ELT(contents, 69, ScalarInteger(internal->dim_n_Tw_2));
  SET_VECTOR_ELT(contents, 70, ScalarInteger(internal->dim_n_UI));
  SET_VECTOR_ELT(contents, 71, ScalarInteger(internal->dim_n_UI_1));
  SET_VECTOR_ELT(contents, 72, ScalarInteger(internal->dim_n_UI_2));
  SET_VECTOR_ELT(contents, 73, ScalarInteger(internal->dim_n_Uw));
  SET_VECTOR_ELT(contents, 74, ScalarInteger(internal->dim_n_Uw_1));
  SET_VECTOR_ELT(contents, 75, ScalarInteger(internal->dim_n_Uw_2));
  SET_VECTOR_ELT(contents, 76, ScalarInteger(internal->dim_p_A_or_S));
  SET_VECTOR_ELT(contents, 77, ScalarInteger(internal->dim_p_A_or_S_1));
  SET_VECTOR_ELT(contents, 78, ScalarInteger(internal->dim_p_A_or_S_2));
  SET_VECTOR_ELT(contents, 79, ScalarInteger(internal->dim_p_ST));
  SET_VECTOR_ELT(contents, 80, ScalarInteger(internal->dim_p_ST_1));
  SET_VECTOR_ELT(contents, 81, ScalarInteger(internal->dim_p_ST_2));
  SET_VECTOR_ELT(contents, 82, ScalarInteger(internal->dim_p_T_or_U));
  SET_VECTOR_ELT(contents, 83, ScalarInteger(internal->dim_p_T_or_U_1));
  SET_VECTOR_ELT(contents, 84, ScalarInteger(internal->dim_p_T_or_U_2));
  SET_VECTOR_ELT(contents, 85, ScalarInteger(internal->dim_p_TU));
  SET_VECTOR_ELT(contents, 86, ScalarInteger(internal->dim_p_TU_1));
  SET_VECTOR_ELT(contents, 87, ScalarInteger(internal->dim_p_TU_2));
  SET_VECTOR_ELT(contents, 88, ScalarInteger(internal->dim_p_UI));
  SET_VECTOR_ELT(contents, 89, ScalarInteger(internal->dim_p_UI_1));
  SET_VECTOR_ELT(contents, 90, ScalarInteger(internal->dim_p_UI_2));
  SET_VECTOR_ELT(contents, 91, ScalarInteger(internal->dim_r_AT));
  SET_VECTOR_ELT(contents, 92, ScalarInteger(internal->dim_r_AT_1));
  SET_VECTOR_ELT(contents, 93, ScalarInteger(internal->dim_r_AT_2));
  SET_VECTOR_ELT(contents, 94, ScalarInteger(internal->dim_r_AU));
  SET_VECTOR_ELT(contents, 95, ScalarInteger(internal->dim_r_AU_1));
  SET_VECTOR_ELT(contents, 96, ScalarInteger(internal->dim_r_AU_2));
  SET_VECTOR_ELT(contents, 97, ScalarInteger(internal->dim_S));
  SET_VECTOR_ELT(contents, 98, ScalarInteger(internal->dim_S_1));
  SET_VECTOR_ELT(contents, 99, ScalarInteger(internal->dim_S_2));
  SET_VECTOR_ELT(contents, 100, ScalarInteger(internal->dim_S0));
  SET_VECTOR_ELT(contents, 101, ScalarInteger(internal->dim_S0_1));
  SET_VECTOR_ELT(contents, 102, ScalarInteger(internal->dim_S0_2));
  SET_VECTOR_ELT(contents, 103, ScalarInteger(internal->dim_screened));
  SET_VECTOR_ELT(contents, 104, ScalarInteger(internal->dim_screened_1));
  SET_VECTOR_ELT(contents, 105, ScalarInteger(internal->dim_screened_2));
  SET_VECTOR_ELT(contents, 106, ScalarInteger(internal->dim_T));
  SET_VECTOR_ELT(contents, 107, ScalarInteger(internal->dim_T_1));
  SET_VECTOR_ELT(contents, 108, ScalarInteger(internal->dim_T_2));
  SET_VECTOR_ELT(contents, 109, ScalarInteger(internal->dim_T0));
  SET_VECTOR_ELT(contents, 110, ScalarInteger(internal->dim_T0_1));
  SET_VECTOR_ELT(contents, 111, ScalarInteger(internal->dim_T0_2));
  SET_VECTOR_ELT(contents, 112, ScalarInteger(internal->dim_U));
  SET_VECTOR_ELT(contents, 113, ScalarInteger(internal->dim_U_1));
  SET_VECTOR_ELT(contents, 114, ScalarInteger(internal->dim_U_2));
  SET_VECTOR_ELT(contents, 115, ScalarInteger(internal->dim_U0));
  SET_VECTOR_ELT(contents, 116, ScalarInteger(internal->dim_U0_1));
  SET_VECTOR_ELT(contents, 117, ScalarInteger(internal->dim_U0_2));
  SET_VECTOR_ELT(contents, 118, ScalarInteger(internal->dim_vea));
  SET_VECTOR_ELT(contents, 119, ScalarInteger(internal->dim_ved));
  SET_VECTOR_ELT(contents, 120, ScalarInteger(internal->dim_ves));
  SET_VECTOR_ELT(contents, 121, ScalarInteger(internal->dim_w));
  SET_VECTOR_ELT(contents, 122, ScalarInteger(internal->dim_w_1));
  SET_VECTOR_ELT(contents, 123, ScalarInteger(internal->dim_w_2));
  SET_VECTOR_ELT(contents, 124, ScalarInteger(internal->dim_wA));
  SET_VECTOR_ELT(contents, 125, ScalarInteger(internal->dim_wA_1));
  SET_VECTOR_ELT(contents, 126, ScalarInteger(internal->dim_wA_12));
  SET_VECTOR_ELT(contents, 127, ScalarInteger(internal->dim_wA_2));
  SET_VECTOR_ELT(contents, 128, ScalarInteger(internal->dim_wA_3));
  SET_VECTOR_ELT(contents, 129, ScalarInteger(internal->dim_wI));
  SET_VECTOR_ELT(contents, 130, ScalarInteger(internal->dim_wI_1));
  SET_VECTOR_ELT(contents, 131, ScalarInteger(internal->dim_wI_12));
  SET_VECTOR_ELT(contents, 132, ScalarInteger(internal->dim_wI_2));
  SET_VECTOR_ELT(contents, 133, ScalarInteger(internal->dim_wI_3));
  SET_VECTOR_ELT(contents, 134, ScalarInteger(internal->dim_wS));
  SET_VECTOR_ELT(contents, 135, ScalarInteger(internal->dim_wS_1));
  SET_VECTOR_ELT(contents, 136, ScalarInteger(internal->dim_wS_12));
  SET_VECTOR_ELT(contents, 137, ScalarInteger(internal->dim_wS_2));
  SET_VECTOR_ELT(contents, 138, ScalarInteger(internal->dim_wS_3));
  SET_VECTOR_ELT(contents, 139, ScalarInteger(internal->dim_wT));
  SET_VECTOR_ELT(contents, 140, ScalarInteger(internal->dim_wT_1));
  SET_VECTOR_ELT(contents, 141, ScalarInteger(internal->dim_wT_12));
  SET_VECTOR_ELT(contents, 142, ScalarInteger(internal->dim_wT_2));
  SET_VECTOR_ELT(contents, 143, ScalarInteger(internal->dim_wT_3));
  SET_VECTOR_ELT(contents, 144, ScalarInteger(internal->dim_wU));
  SET_VECTOR_ELT(contents, 145, ScalarInteger(internal->dim_wU_1));
  SET_VECTOR_ELT(contents, 146, ScalarInteger(internal->dim_wU_12));
  SET_VECTOR_ELT(contents, 147, ScalarInteger(internal->dim_wU_2));
  SET_VECTOR_ELT(contents, 148, ScalarInteger(internal->dim_wU_3));
  SET_VECTOR_ELT(contents, 149, ScalarReal(internal->dt));
  SEXP eta = PROTECT(allocVector(REALSXP, internal->dim_eta));
  memcpy(REAL(eta), internal->eta, internal->dim_eta * sizeof(double));
  SET_VECTOR_ELT(contents, 150, eta);
  SET_VECTOR_ELT(contents, 151, ScalarReal(internal->eta_h));
  SET_VECTOR_ELT(contents, 152, ScalarReal(internal->eta_l));
  SEXP I0 = PROTECT(allocVector(REALSXP, internal->dim_I0));
  memcpy(REAL(I0), internal->I0, internal->dim_I0 * sizeof(double));
  odin_set_dim(I0, 2, internal->dim_I0_1, internal->dim_I0_2);
  SET_VECTOR_ELT(contents, 153, I0);
  SEXP initial_A = PROTECT(allocVector(REALSXP, internal->dim_A));
  memcpy(REAL(initial_A), internal->initial_A, internal->dim_A * sizeof(double));
  odin_set_dim(initial_A, 2, internal->dim_A_1, internal->dim_A_2);
  SET_VECTOR_ELT(contents, 154, initial_A);
  SEXP initial_cum_diag_a = PROTECT(allocVector(REALSXP, internal->dim_cum_diag_a));
  memcpy(REAL(initial_cum_diag_a), internal->initial_cum_diag_a, internal->dim_cum_diag_a * sizeof(double));
  odin_set_dim(initial_cum_diag_a, 2, internal->dim_cum_diag_a_1, internal->dim_cum_diag_a_2);
  SET_VECTOR_ELT(contents, 155, initial_cum_diag_a);
  SEXP initial_cum_diag_s = PROTECT(allocVector(REALSXP, internal->dim_cum_diag_s));
  memcpy(REAL(initial_cum_diag_s), internal->initial_cum_diag_s, internal->dim_cum_diag_s * sizeof(double));
  odin_set_dim(initial_cum_diag_s, 2, internal->dim_cum_diag_s_1, internal->dim_cum_diag_s_2);
  SET_VECTOR_ELT(contents, 156, initial_cum_diag_s);
  SEXP initial_cum_incid = PROTECT(allocVector(REALSXP, internal->dim_cum_incid));
  memcpy(REAL(initial_cum_incid), internal->initial_cum_incid, internal->dim_cum_incid * sizeof(double));
  odin_set_dim(initial_cum_incid, 2, internal->dim_cum_incid_1, internal->dim_cum_incid_2);
  SET_VECTOR_ELT(contents, 157, initial_cum_incid);
  SEXP initial_cum_screened = PROTECT(allocVector(REALSXP, internal->dim_cum_screened));
  memcpy(REAL(initial_cum_screened), internal->initial_cum_screened, internal->dim_cum_screened * sizeof(double));
  odin_set_dim(initial_cum_screened, 2, internal->dim_cum_screened_1, internal->dim_cum_screened_2);
  SET_VECTOR_ELT(contents, 158, initial_cum_screened);
  SEXP initial_cum_treated = PROTECT(allocVector(REALSXP, internal->dim_cum_treated));
  memcpy(REAL(initial_cum_treated), internal->initial_cum_treated, internal->dim_cum_treated * sizeof(double));
  odin_set_dim(initial_cum_treated, 2, internal->dim_cum_treated_1, internal->dim_cum_treated_2);
  SET_VECTOR_ELT(contents, 159, initial_cum_treated);
  SEXP initial_I = PROTECT(allocVector(REALSXP, internal->dim_I));
  memcpy(REAL(initial_I), internal->initial_I, internal->dim_I * sizeof(double));
  odin_set_dim(initial_I, 2, internal->dim_I_1, internal->dim_I_2);
  SET_VECTOR_ELT(contents, 160, initial_I);
  SEXP initial_S = PROTECT(allocVector(REALSXP, internal->dim_S));
  memcpy(REAL(initial_S), internal->initial_S, internal->dim_S * sizeof(double));
  odin_set_dim(initial_S, 2, internal->dim_S_1, internal->dim_S_2);
  SET_VECTOR_ELT(contents, 161, initial_S);
  SEXP initial_T = PROTECT(allocVector(REALSXP, internal->dim_T));
  memcpy(REAL(initial_T), internal->initial_T, internal->dim_T * sizeof(double));
  odin_set_dim(initial_T, 2, internal->dim_T_1, internal->dim_T_2);
  SET_VECTOR_ELT(contents, 162, initial_T);
  SET_VECTOR_ELT(contents, 163, ScalarReal(internal->initial_time));
  SEXP initial_U = PROTECT(allocVector(REALSXP, internal->dim_U));
  memcpy(REAL(initial_U), internal->initial_U, internal->dim_U * sizeof(double));
  odin_set_dim(initial_U, 2, internal->dim_U_1, internal->dim_U_2);
  SET_VECTOR_ELT(contents, 164, initial_U);
  SET_VECTOR_ELT(contents, 165, ScalarReal(internal->lambda));
  SET_VECTOR_ELT(contents, 166, ScalarReal(internal->mu));
  SEXP N = PROTECT(allocVector(REALSXP, internal->dim_N));
  memcpy(REAL(N), internal->N, internal->dim_N * sizeof(double));
  odin_set_dim(N, 2, internal->dim_N_1, internal->dim_N_2);
  SET_VECTOR_ELT(contents, 167, N);
  SEXP n_AT = PROTECT(allocVector(REALSXP, internal->dim_n_AT));
  memcpy(REAL(n_AT), internal->n_AT, internal->dim_n_AT * sizeof(double));
  odin_set_dim(n_AT, 2, internal->dim_n_AT_1, internal->dim_n_AT_2);
  SET_VECTOR_ELT(contents, 168, n_AT);
  SEXP n_AU = PROTECT(allocVector(REALSXP, internal->dim_n_AU));
  memcpy(REAL(n_AU), internal->n_AU, internal->dim_n_AU * sizeof(double));
  odin_set_dim(n_AU, 2, internal->dim_n_AU_1, internal->dim_n_AU_2);
  SET_VECTOR_ELT(contents, 169, n_AU);
  ...
  SET_VECTOR_ELT(contents, 170, n_AUT);
  ...
  SET_VECTOR_ELT(contents, 171, n_Aw);
  SET_VECTOR_ELT(contents, 172, ScalarInteger(internal->n_group));
  ...
  SET_VECTOR_ELT(contents, 173, n_IA);
  ...
  SET_VECTOR_ELT(contents, 174, n_IAS);
  ...
  SET_VECTOR_ELT(contents, 175, n_IS);
  ...
  SET_VECTOR_ELT(contents, 176, n_Iw);
  SEXP n_ST = PROTECT(allocVector(REALSXP, internal->dim_n_ST));
  memcpy(REAL(n_ST), internal->n_ST, internal->dim_n_ST * sizeof(double));
  odin_set_dim(n_ST, 2, internal->dim_n_ST_1, internal->dim_n_ST_2);
  SET_VECTOR_ELT(contents, 177, n_ST);
  ...
  SET_VECTOR_ELT(contents, 178, n_Sw);
  SEXP n_TU = PROTECT(allocVector(REALSXP, internal->dim_n_TU));
  memcpy(REAL(n_TU), internal->n_TU, internal->dim_n_TU * sizeof(double));
  odin_set_dim(n_TU, 2, internal->dim_n_TU_1, internal->dim_n_TU_2);
  SET_VECTOR_ELT(contents, 179, n_TU);
  ...
  SET_VECTOR_ELT(contents, 180, n_Tw);
  SEXP n_UI = PROTECT(allocVector(REALSXP, internal->dim_n_UI));
  memcpy(REAL(n_UI), internal->n_UI, internal->dim_n_UI * sizeof(double));
  odin_set_dim(n_UI, 2, internal->dim_n_UI_1, internal->dim_n_UI_2);
  SET_VECTOR_ELT(contents, 181, n_UI);
  ...
  SET_VECTOR_ELT(contents, 182, n_Uw);
  SET_VECTOR_ELT(contents, 183, ScalarInteger(internal->n_vax));
  SET_VECTOR_ELT(contents, 184, ScalarReal(internal->nu));
  SET_VECTOR_ELT(contents, 185, ScalarInteger(internal->offset_variable_A));
  SET_VECTOR_ELT(contents, 186, ScalarInteger(internal->offset_variable_cum_diag_a));
  SET_VECTOR_ELT(contents, 187, ScalarInteger(internal->offset_variable_cum_diag_s));
  SET_VECTOR_ELT(contents, 188, ScalarInteger(internal->offset_variable_cum_incid));
  SET_VECTOR_ELT(contents, 189, ScalarInteger(internal->offset_variable_cum_screened));
  SET_VECTOR_ELT(contents, 190, ScalarInteger(internal->offset_variable_cum_treated));
  SET_VECTOR_ELT(contents, 191, ScalarInteger(internal->offset_variable_I));
  SET_VECTOR_ELT(contents, 192, ScalarInteger(internal->offset_variable_S));
  SET_VECTOR_ELT(contents, 193, ScalarInteger(internal->offset_variable_T));
  SEXP p_A_or_S = PROTECT(allocVector(REALSXP, internal->dim_p_A_or_S));
  memcpy(REAL(p_A_or_S), internal->p_A_or_S, internal->dim_p_A_or_S * sizeof(double));
  odin_set_dim(p_A_or_S, 2, internal->dim_p_A_or_S_1, internal->dim_p_A_or_S_2);
  SET_VECTOR_ELT(contents, 194, p_A_or_S);
  SEXP p_ST = PROTECT(allocVector(REALSXP, internal->dim_p_ST));
  memcpy(REAL(p_ST), internal->p_ST, internal->dim_p_ST * sizeof(double));
  odin_set_dim(p_ST, 2, internal->dim_p_ST_1, internal->dim_p_ST_2);
  SET_VECTOR_ELT(contents, 195, p_ST);
  SEXP p_T_or_U = PROTECT(allocVector(REALSXP, internal->dim_p_T_or_U));
  memcpy(REAL(p_T_or_U), internal->p_T_or_U, internal->dim_p_T_or_U * sizeof(double));
  odin_set_dim(p_T_or_U, 2, internal->dim_p_T_or_U_1, internal->dim_p_T_or_U_2);
  SET_VECTOR_ELT(contents, 196, p_T_or_U);
  SEXP p_TU = PROTECT(allocVector(REALSXP, internal->dim_p_TU));
  memcpy(REAL(p_TU), internal->p_TU, internal->dim_p_TU * sizeof(double));
  odin_set_dim(p_TU, 2, internal->dim_p_TU_1, internal->dim_p_TU_2);
  SET_VECTOR_ELT(contents, 197, p_TU);
  SEXP p_UI = PROTECT(allocVector(REALSXP, internal->dim_p_UI));
  memcpy(REAL(p_UI), internal->p_UI, internal->dim_p_UI * sizeof(double));
  odin_set_dim(p_UI, 2, internal->dim_p_UI_1, internal->dim_p_UI_2);
  SET_VECTOR_ELT(contents, 198, p_UI);
  SET_VECTOR_ELT(contents, 199, ScalarReal(internal->psi));
  ...
  SET_VECTOR_ELT(contents, 200, r_AT);
  ...
  SET_VECTOR_ELT(contents, 201, r_AU);
  SET_VECTOR_ELT(contents, 202, ScalarReal(internal->rho));
  SEXP S0 = PROTECT(allocVector(REALSXP, internal->dim_S0));
  memcpy(REAL(S0), internal->S0, internal->dim_S0 * sizeof(double));
  odin_set_dim(S0, 2, internal->dim_S0_1, internal->dim_S0_2);
  SET_VECTOR_ELT(contents, 203, S0);
  SEXP screened = PROTECT(allocVector(REALSXP, internal->dim_screened));
  memcpy(REAL(screened), internal->screened, internal->dim_screened * sizeof(double));
  odin_set_dim(screened, 2, internal->dim_screened_1, internal->dim_screened_2);
  SET_VECTOR_ELT(contents, 204, screened);
  SET_VECTOR_ELT(contents, 205, ScalarReal(internal->sigma));
  SET_VECTOR_ELT(contents, 206, ScalarReal(internal->steps_per_year));
  SEXP T0 = PROTECT(allocVector(REALSXP, internal->dim_T0));
  memcpy(REAL(T0), internal->T0, internal->dim_T0 * sizeof(double));
  odin_set_dim(T0, 2, internal->dim_T0_1, internal->dim_T0_2);
  SET_VECTOR_ELT(contents, 207, T0);
  SEXP U0 = PROTECT(allocVector(REALSXP, internal->dim_U0));
  memcpy(REAL(U0), internal->U0, internal->dim_U0 * sizeof(double));
  odin_set_dim(U0, 2, internal->dim_U0_1, internal->dim_U0_2);
  SET_VECTOR_ELT(contents, 208, U0);
  SEXP vea = PROTECT(allocVector(REALSXP, internal->dim_vea));
  memcpy(REAL(vea), internal->vea, internal->dim_vea * sizeof(double));
  SET_VECTOR_ELT(contents, 209, vea);
  SEXP ved = PROTECT(allocVector(REALSXP, internal->dim_ved));
  memcpy(REAL(ved), internal->ved, internal->dim_ved * sizeof(double));
  SET_VECTOR_ELT(contents, 210, ved);
  SEXP ves = PROTECT(allocVector(REALSXP, internal->dim_ves));
  memcpy(REAL(ves), internal->ves, internal->dim_ves * sizeof(double));
  SET_VECTOR_ELT(contents, 211, ves);
  SEXP w = PROTECT(allocVector(REALSXP, internal->dim_w));
  memcpy(REAL(w), internal->w, internal->dim_w * sizeof(double));
  odin_set_dim(w, 2, internal->dim_w_1, internal->dim_w_2);
  SET_VECTOR_ELT(contents, 212, w);
  SEXP wA = PROTECT(allocVector(REALSXP, internal->dim_wA));
  memcpy(REAL(wA), internal->wA, internal->dim_wA * sizeof(double));
  odin_set_dim(wA, 3, internal->dim_wA_1, internal->dim_wA_2, internal->dim_wA_3);
  SET_VECTOR_ELT(contents, 213, wA);
  SEXP wI = PROTECT(allocVector(REALSXP, internal->dim_wI));
  memcpy(REAL(wI), internal->wI, internal->dim_wI * sizeof(double));
  odin_set_dim(wI, 3, internal->dim_wI_1, internal->dim_wI_2, internal->dim_wI_3);
  SET_VECTOR_ELT(contents, 214, wI);
  SEXP wS = PROTECT(allocVector(REALSXP, internal->dim_wS));
  memcpy(REAL(wS), internal->wS, internal->dim_wS * sizeof(double));
  odin_set_dim(wS, 3, internal->dim_wS_1, internal->dim_wS_2, internal->dim_wS_3);
  SET_VECTOR_ELT(contents, 215, wS);
  SEXP wT = PROTECT(allocVector(REALSXP, internal->dim_wT));
  memcpy(REAL(wT), internal->wT, internal->dim_wT * sizeof(double));
  odin_set_dim(wT, 3, internal->dim_wT_1, internal->dim_wT_2, internal->dim_wT_3);
  SET_VECTOR_ELT(contents, 216, wT);
  SEXP wU = PROTECT(allocVector(REALSXP, internal->dim_wU));
  memcpy(REAL(wU), internal->wU, internal->dim_wU * sizeof(double));
  odin_set_dim(wU, 3, internal->dim_wU_1, internal->dim_wU_2, internal->dim_wU_3);
  SET_VECTOR_ELT(contents, 217, wU);
  SEXP nms = PROTECT(allocVector(STRSXP, 218));
  SET_STRING_ELT(nms, 0, mkChar("A0"));
  ...
  SET_STRING_ELT(nms, 23, mkChar("dim_D"));
  SET_STRING_ELT(nms, 24, mkChar("dim_eta"));
  SET_STRING_ELT(nms, 25, mkChar("dim_I"));
  SET_STRING_ELT(nms, 26, mkChar("dim_I_1"));
  SET_STRING_ELT(nms, 27, mkChar("dim_I_2"));
  SET_STRING_ELT(nms, 28, mkChar("dim_I0"));
  SET_STRING_ELT(nms, 29, mkChar("dim_I0_1"));
  SET_STRING_ELT(nms, 30, mkChar("dim_I0_2"));
  SET_STRING_ELT(nms, 31, mkChar("dim_N"));
  SET_STRING_ELT(nms, 32, mkChar("dim_N_1"));
  SET_STRING_ELT(nms, 33, mkChar("dim_N_2"));
  SET_STRING_ELT(nms, 34, mkChar("dim_n_AT"));
  SET_STRING_ELT(nms, 35, mkChar("dim_n_AT_1"));
  SET_STRING_ELT(nms, 36, mkChar("dim_n_AT_2"));
  SET_STRING_ELT(nms, 37, mkChar("dim_n_AU"));
  SET_STRING_ELT(nms, 38, mkChar("dim_n_AU_1"));
  SET_STRING_ELT(nms, 39, mkChar("dim_n_AU_2"));
  SET_STRING_ELT(nms, 40, mkChar("dim_n_AUT"));
  SET_STRING_ELT(nms, 41, mkChar("dim_n_AUT_1"));
  SET_STRING_ELT(nms, 42, mkChar("dim_n_AUT_2"));
  SET_STRING_ELT(nms, 43, mkChar("dim_n_Aw"));
  SET_STRING_ELT(nms, 44, mkChar("dim_n_Aw_1"));
  SET_STRING_ELT(nms, 45, mkChar("dim_n_Aw_2"));
  SET_STRING_ELT(nms, 46, mkChar("dim_n_IA"));
  SET_STRING_ELT(nms, 47, mkChar("dim_n_IA_1"));
  SET_STRING_ELT(nms, 48, mkChar("dim_n_IA_2"));
  SET_STRING_ELT(nms, 49, mkChar("dim_n_IAS"));
  SET_STRING_ELT(nms, 50, mkChar("dim_n_IAS_1"));
  SET_STRING_ELT(nms, 51, mkChar("dim_n_IAS_2"));
  SET_STRING_ELT(nms, 52, mkChar("dim_n_IS"));
  SET_STRING_ELT(nms, 53, mkChar("dim_n_IS_1"));
  SET_STRING_ELT(nms, 54, mkChar("dim_n_IS_2"));
  SET_STRING_ELT(nms, 55, mkChar("dim_n_Iw"));
  SET_STRING_ELT(nms, 56, mkChar("dim_n_Iw_1"));
  SET_STRING_ELT(nms, 57, mkChar("dim_n_Iw_2"));
  SET_STRING_ELT(nms, 58, mkChar("dim_n_ST"));
  SET_STRING_ELT(nms, 59, mkChar("dim_n_ST_1"));
  SET_STRING_ELT(nms, 60, mkChar("dim_n_ST_2"));
  SET_STRING_ELT(nms, 61, mkChar("dim_n_Sw"));
  SET_STRING_ELT(nms, 62, mkChar("dim_n_Sw_1"));
  SET_STRING_ELT(nms, 63, mkChar("dim_n_Sw_2"));
  SET_STRING_ELT(nms, 64, mkChar("dim_n_TU"));
  SET_STRING_ELT(nms, 65, mkChar("dim_n_TU_1"));
  SET_STRING_ELT(nms, 66, mkChar("dim_n_TU_2"));
  SET_STRING_ELT(nms, 67, mkChar("dim_n_Tw"));
  SET_STRING_ELT(nms, 68, mkChar("dim_n_Tw_1"));
  SET_STRING_ELT(nms, 69, mkChar("dim_n_Tw_2"));
  SET_STRING_ELT(nms, 70, mkChar("dim_n_UI"));
  SET_STRING_ELT(nms, 71, mkChar("dim_n_UI_1"));
  SET_STRING_ELT(nms, 72, mkChar("dim_n_UI_2"));
  SET_STRING_ELT(nms, 73, mkChar("dim_n_Uw"));
  SET_STRING_ELT(nms, 74, mkChar("dim_n_Uw_1"));
  SET_STRING_ELT(nms, 75, mkChar("dim_n_Uw_2"));
  SET_STRING_ELT(nms, 76, mkChar("dim_p_A_or_S"));
  SET_STRING_ELT(nms, 77, mkChar("dim_p_A_or_S_1"));
  SET_STRING_ELT(nms, 78, mkChar("dim_p_A_or_S_2"));
  SET_STRING_ELT(nms, 79, mkChar("dim_p_ST"));
  SET_STRING_ELT(nms, 80, mkChar("dim_p_ST_1"));
  SET_STRING_ELT(nms, 81, mkChar("dim_p_ST_2"));
  SET_STRING_ELT(nms, 82, mkChar("dim_p_T_or_U"));
  SET_STRING_ELT(nms, 83, mkChar("dim_p_T_or_U_1"));
  SET_STRING_ELT(nms, 84, mkChar("dim_p_T_or_U_2"));
  SET_STRING_ELT(nms, 85, mkChar("dim_p_TU"));
  SET_STRING_ELT(nms, 86, mkChar("dim_p_TU_1"));
  SET_STRING_ELT(nms, 87, mkChar("dim_p_TU_2"));
  SET_STRING_ELT(nms, 88, mkChar("dim_p_UI"));
  SET_STRING_ELT(nms, 89, mkChar("dim_p_UI_1"));
  SET_STRING_ELT(nms, 90, mkChar("dim_p_UI_2"));
  SET_STRING_ELT(nms, 91, mkChar("dim_r_AT"));
  SET_STRING_ELT(nms, 92, mkChar("dim_r_AT_1"));
  SET_STRING_ELT(nms, 93, mkChar("dim_r_AT_2"));
  SET_STRING_ELT(nms, 94, mkChar("dim_r_AU"));
  SET_STRING_ELT(nms, 95, mkChar("dim_r_AU_1"));
  SET_STRING_ELT(nms, 96, mkChar("dim_r_AU_2"));
  SET_STRING_ELT(nms, 97, mkChar("dim_S"));
  SET_STRING_ELT(nms, 98, mkChar("dim_S_1"));
  SET_STRING_ELT(nms, 99, mkChar("dim_S_2"));
  SET_STRING_ELT(nms, 100, mkChar("dim_S0"));
  SET_STRING_ELT(nms, 101, mkChar("dim_S0_1"));
  SET_STRING_ELT(nms, 102, mkChar("dim_S0_2"));
  SET_STRING_ELT(nms, 103, mkChar("dim_screened"));
  SET_STRING_ELT(nms, 104, mkChar("dim_screened_1"));
  SET_STRING_ELT(nms, 105, mkChar("dim_screened_2"));
  SET_STRING_ELT(nms, 106, mkChar("dim_T"));
  SET_STRING_ELT(nms, 107, mkChar("dim_T_1"));
  SET_STRING_ELT(nms, 108, mkChar("dim_T_2"));
  SET_STRING_ELT(nms, 109, mkChar("dim_T0"));
  SET_STRING_ELT(nms, 110, mkChar("dim_T0_1"));
  SET_STRING_ELT(nms, 111, mkChar("dim_T0_2"));
  SET_STRING_ELT(nms, 112, mkChar("dim_U"));
  SET_STRING_ELT(nms, 113, mkChar("dim_U_1"));
  SET_STRING_ELT(nms, 114, mkChar("dim_U_2"));
  SET_STRING_ELT(nms, 115, mkChar("dim_U0"));
  SET_STRING_ELT(nms, 116, mkChar("dim_U0_1"));
  SET_STRING_ELT(nms, 117, mkChar("dim_U0_2"));
  SET_STRING_ELT(nms, 118, mkChar("dim_vea"));
  SET_STRING_ELT(nms, 119, mkChar("dim_ved"));
  SET_STRING_ELT(nms, 120, mkChar("dim_ves"));
  SET_STRING_ELT(nms, 121, mkChar("dim_w"));
  SET_STRING_ELT(nms, 122, mkChar("dim_w_1"));
  SET_STRING_ELT(nms, 123, mkChar("dim_w_2"));
  SET_STRING_ELT(nms, 124, mkChar("dim_wA"));
  SET_STRING_ELT(nms, 125, mkChar("dim_wA_1"));
  SET_STRING_ELT(nms, 126, mkChar("dim_wA_12"));
  SET_STRING_ELT(nms, 127, mkChar("dim_wA_2"));
  SET_STRING_ELT(nms, 128, mkChar("dim_wA_3"));
  SET_STRING_ELT(nms, 129, mkChar("dim_wI"));
  SET_STRING_ELT(nms, 130, mkChar("dim_wI_1"));
  SET_STRING_ELT(nms, 131, mkChar("dim_wI_12"));
  SET_STRING_ELT(nms, 132, mkChar("dim_wI_2"));
  SET_STRING_ELT(nms, 133, mkChar("dim_wI_3"));
  SET_STRING_ELT(nms, 134, mkChar("dim_wS"));
  SET_STRING_ELT(nms, 135, mkChar("dim_wS_1"));
  SET_STRING_ELT(nms, 136, mkChar("dim_wS_12"));
  SET_STRING_ELT(nms, 137, mkChar("dim_wS_2"));
  SET_STRING_ELT(nms, 138, mkChar("dim_wS_3"));
  SET_STRING_ELT(nms, 139, mkChar("dim_wT"));
  SET_STRING_ELT(nms, 140, mkChar("dim_wT_1"));
  SET_STRING_ELT(nms, 141, mkChar("dim_wT_12"));
  SET_STRING_ELT(nms, 142, mkChar("dim_wT_2"));
  SET_STRING_ELT(nms, 143, mkChar("dim_wT_3"));
  SET_STRING_ELT(nms, 144, mkChar("dim_wU"));
  SET_STRING_ELT(nms, 145, mkChar("dim_wU_1"));
  SET_STRING_ELT(nms, 146, mkChar("dim_wU_12"));
  SET_STRING_ELT(nms, 147, mkChar("dim_wU_2"));
  SET_STRING_ELT(nms, 148, mkChar("dim_wU_3"));
  SET_STRING_ELT(nms, 149, mkChar("dt"));
  SET_STRING_ELT(nms, 150, mkChar("eta"));
  SET_STRING_ELT(nms, 151, mkChar("eta_h"));
  SET_STRING_ELT(nms, 152, mkChar("eta_l"));
  SET_STRING_ELT(nms, 153, mkChar("I0"));
  SET_STRING_ELT(nms, 154, mkChar("initial_A"));
  SET_STRING_ELT(nms, 155, mkChar("initial_cum_diag_a"));
  SET_STRING_ELT(nms, 156, mkChar("initial_cum_diag_s"));
  SET_STRING_ELT(nms, 157, mkChar("initial_cum_incid"));
  SET_STRING_ELT(nms, 158, mkChar("initial_cum_screened"));
  SET_STRING_ELT(nms, 159, mkChar("initial_cum_treated"));
  SET_STRING_ELT(nms, 160, mkChar("initial_I"));
  SET_STRING_ELT(nms, 161, mkChar("initial_S"));
  SET_STRING_ELT(nms, 162, mkChar("initial_T"));
  SET_STRING_ELT(nms, 163, mkChar("initial_time"));
  SET_STRING_ELT(nms, 164, mkChar("initial_U"));
  SET_STRING_ELT(nms, 165, mkChar("lambda"));
  SET_STRING_ELT(nms, 166, mkChar("mu"));
  SET_STRING_ELT(nms, 167, mkChar("N"));
  SET_STRING_ELT(nms, 168, mkChar("n_AT"));
  SET_STRING_ELT(nms, 169, mkChar("n_AU"));
  SET_STRING_ELT(nms, 170, mkChar("n_AUT"));
  SET_STRING_ELT(nms, 171, mkChar("n_Aw"));
  SET_STRING_ELT(nms, 172, mkChar("n_group"));
  SET_STRING_ELT(nms, 173, mkChar("n_IA"));
  SET_STRING_ELT(nms, 174, mkChar("n_IAS"));
  SET_STRING_ELT(nms, 175, mkChar("n_IS"));
  SET_STRING_ELT(nms, 176, mkChar("n_Iw"));
  SET_STRING_ELT(nms, 177, mkChar("n_ST"));
  SET_STRING_ELT(nms, 178, mkChar("n_Sw"));
  SET_STRING_ELT(nms, 179, mkChar("n_TU"));
  SET_STRING_ELT(nms, 180, mkChar("n_Tw"));
  SET_STRING_ELT(nms, 181, mkChar("n_UI"));
  SET_STRING_ELT(nms, 182, mkChar("n_Uw"));
  SET_STRING_ELT(nms, 183, mkChar("n_vax"));
  SET_STRING_ELT(nms, 184, mkChar("nu"));
  SET_STRING_ELT(nms, 185, mkChar("offset_variable_A"));
  SET_STRING_ELT(nms, 186, mkChar("offset_variable_cum_diag_a"));
  SET_STRING_ELT(nms, 187, mkChar("offset_variable_cum_diag_s"));
  SET_STRING_ELT(nms, 188, mkChar("offset_variable_cum_incid"));
  SET_STRING_ELT(nms, 189, mkChar("offset_variable_cum_screened"));
  SET_STRING_ELT(nms, 190, mkChar("offset_variable_cum_treated"));
  SET_STRING_ELT(nms, 191, mkChar("offset_variable_I"));
  SET_STRING_ELT(nms, 192, mkChar("offset_variable_S"));
  SET_STRING_ELT(nms, 193, mkChar("offset_variable_T"));
  SET_STRING_ELT(nms, 194, mkChar("p_A_or_S"));
  SET_STRING_ELT(nms, 195, mkChar("p_ST"));
  SET_STRING_ELT(nms, 196, mkChar("p_T_or_U"));
  SET_STRING_ELT(nms, 197, mkChar("p_TU"));
  SET_STRING_ELT(nms, 198, mkChar("p_UI"));
  SET_STRING_ELT(nms, 199, mkChar("psi"));
  SET_STRING_ELT(nms, 200, mkChar("r_AT"));
  SET_STRING_ELT(nms, 201, mkChar("r_AU"));
  SET_STRING_ELT(nms, 202, mkChar("rho"));
  SET_STRING_ELT(nms, 203, mkChar("S0"));
  SET_STRING_ELT(nms, 204, mkChar("screened"));
  SET_STRING_ELT(nms, 205, mkChar("sigma"));
  SET_STRING_ELT(nms, 206, mkChar("steps_per_year"));
  SET_STRING_ELT(nms, 207, mkChar("T0"));
  SET_STRING_ELT(nms, 208, mkChar("U0"));
  SET_STRING_ELT(nms, 209, mkChar("vea"));
  SET_STRING_ELT(nms, 210, mkChar("ved"));
  SET_STRING_ELT(nms, 211, mkChar("ves"));
  SET_STRING_ELT(nms, 212, mkChar("w"));
  SET_STRING_ELT(nms, 213, mkChar("wA"));
  SET_STRING_ELT(nms, 214, mkChar("wI"));
  SET_STRING_ELT(nms, 215, mkChar("wS"));
  SET_STRING_ELT(nms, 216, mkChar("wT"));
  SET_STRING_ELT(nms, 217, mkChar("wU"));
  setAttrib(contents, R_NamesSymbol, nms);
  UNPROTECT(51);
  return contents;
}
SEXP model_trial_stochastic_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->dim_p_A_or_S_1 = internal->n_group;
  internal->dim_p_A_or_S_2 = internal->n_vax;
  internal->dim_p_ST_1 = internal->n_group;
  internal->dim_p_ST_2 = internal->n_vax;
  internal->dim_p_T_or_U_1 = internal->n_group;
  internal->dim_p_T_or_U_2 = internal->n_vax;
  internal->dim_p_TU_1 = internal->n_group;
  internal->dim_p_TU_2 = internal->n_vax;
  internal->dim_p_UI_1 = internal->n_group;
  internal->dim_p_UI_2 = internal->n_vax;
  ...
  internal->dim_p_A_or_S = internal->dim_p_A_or_S_1 * internal->dim_p_A_or_S_2;
  internal->dim_p_ST = internal->dim_p_ST_1 * internal->dim_p_ST_2;
  internal->dim_p_T_or_U = internal->dim_p_T_or_U_1 * internal->dim_p_T_or_U_2;
  internal->dim_p_TU = internal->dim_p_TU_1 * internal->dim_p_TU_2;
  internal->dim_p_UI = internal->dim_p_UI_1 * internal->dim_p_UI_2;
  ...
  R_Free(internal->p_A_or_S);
  internal->p_A_or_S = (double*) R_Calloc(internal->dim_p_A_or_S, double);
  R_Free(internal->p_ST);
  internal->p_ST = (double*) R_Calloc(internal->dim_p_ST, double);
  R_Free(internal->p_T_or_U);
  internal->p_T_or_U = (double*) R_Calloc(internal->dim_p_T_or_U, double);
  R_Free(internal->p_TU);
  internal->p_TU = (double*) R_Calloc(internal->dim_p_TU, double);
  R_Free(internal->p_UI);
  internal->p_UI = (double*) R_Calloc(internal->dim_p_UI, double);
  R_Free(internal->r_AT);
  ...
  for (int i = 1; i <= internal->dim_p_A_or_S_1; ++i) {
    for (int j = 1; j <= internal->dim_p_A_or_S_2; ++j) {
      internal->p_A_or_S[i - 1 + internal->dim_p_A_or_S_1 * (j - 1)] = 1 - exp(-(internal->sigma) * internal->dt);
    }
  }
  for (int i = 1; i <= internal->dim_p_ST_1; ++i) {
    for (int j = 1; j <= internal->dim_p_ST_2; ++j) {
      internal->p_ST[i - 1 + internal->dim_p_ST_1 * (j - 1)] = 1 - exp(-(internal->mu) * internal->dt);
    }
  }
  for (int i = 1; i <= internal->dim_p_TU_1; ++i) {
    for (int j = 1; j <= internal->dim_p_TU_2; ++j) {
      internal->p_TU[i - 1 + internal->dim_p_TU_1 * (j - 1)] = 1 - exp(-(internal->rho) * internal->dt);
    }
  }
  for (int i = 1; i <= internal->dim_p_UI_1; ++i) {
    for (int j = 1; j <= internal->dim_p_UI_2; ++j) {
      internal->p_UI[i - 1 + internal->dim_p_UI_1 * (j - 1)] = 1 - exp(-((internal->lambda * (1 - internal->vea[j - 1]) * internal->dt)));
    }
  }
  for (int i = 1; i <= internal->dim_r_AT_1; ++i) {
    for (int j = 1; j <= internal->dim_r_AT_2; ++j) {
      internal->r_AT[i - 1 + internal->dim_r_AT_1 * (j - 1)] = internal->eta[i - 1];
    }
  }
...
void model_trial_stochastic_rhs(model_trial_stochastic_internal* internal, size_t step, double * state, double * state_next, double * output) {
  ...
  for (int i = 1; i <= internal->dim_n_IAS_1; ++i) {
    for (int j = 1; j <= internal->dim_n_IAS_2; ++j) {
      internal->n_IAS[i - 1 + internal->dim_n_IAS_1 * (j - 1)] = Rf_rbinom(round(I[internal->dim_I_1 * (j - 1) + i - 1]), internal->p_A_or_S[internal->dim_p_A_or_S_1 * (j - 1) + i - 1]);
    }
  }
  for (int i = 1; i <= internal->dim_n_ST_1; ++i) {
    for (int j = 1; j <= internal->dim_n_ST_2; ++j) {
      internal->n_ST[i - 1 + internal->dim_n_ST_1 * (j - 1)] = Rf_rbinom(round(S[internal->dim_S_1 * (j - 1) + i - 1]), internal->p_ST[internal->dim_p_ST_1 * (j - 1) + i - 1]);
    }
  }
  for (int i = 1; i <= internal->dim_n_TU_1; ++i) {
    for (int j = 1; j <= internal->dim_n_TU_2; ++j) {
      internal->n_TU[i - 1 + internal->dim_n_TU_1 * (j - 1)] = Rf_rbinom(round(T[internal->dim_T_1 * (j - 1) + i - 1]), internal->p_TU[internal->dim_p_TU_1 * (j - 1) + i - 1]);
    }
  }
  for (int i = 1; i <= internal->dim_n_UI_1; ++i) {
    for (int j = 1; j <= internal->dim_n_UI_2; ++j) {
      internal->n_UI[i - 1 + internal->dim_n_UI_1 * (j - 1)] = Rf_rbinom(round(U[internal->dim_U_1 * (j - 1) + i - 1]), internal->p_UI[internal->dim_p_UI_1 * (j - 1) + i - 1]);
    }
  }
  for (int i = 1; i <= internal->dim_cum_screened_1; ++i) {
    for (int j = 1; j <= internal->dim_cum_screened_2; ++j) {
  ...
  for (int i = 1; i <= internal->dim_n_AUT_1; ++i) {
    for (int j = 1; j <= internal->dim_n_AUT_2; ++j) {
      internal->n_AUT[i - 1 + internal->dim_n_AUT_1 * (j - 1)] = Rf_rbinom(round(A[internal->dim_A_1 * (j - 1) + i - 1]), internal->p_T_or_U[internal->dim_p_T_or_U_1 * (j - 1) + i - 1]);
    }
  }
  ...
  for (int i = 1; i <= internal->dim_n_Iw_1; ++i) {
    for (int j = 1; j <= internal->dim_n_Iw_2; ++j) {
      internal->n_Iw[i - 1 + internal->dim_n_Iw_1 * (j - 1)] = Rf_rbinom(round(I[internal->dim_I_1 * (j - 1) + i - 1] - internal->n_IAS[internal->dim_n_IAS_1 * (j - 1) + i - 1]), 1 - exp(internal->D[j - 1] * internal->dt));
    }
  }
  for (int i = 1; i <= internal->dim_n_Sw_1; ++i) {
    for (int j = 1; j <= internal->dim_n_Sw_2; ++j) {
      internal->n_Sw[i - 1 + internal->dim_n_Sw_1 * (j - 1)] = Rf_rbinom(round(S[internal->dim_S_1 * (j - 1) + i - 1] - internal->n_ST[internal->dim_n_ST_1 * (j - 1) + i - 1]), 1 - exp(internal->D[j - 1] * internal->dt));
    }
  }
  for (int i = 1; i <= internal->dim_n_Tw_1; ++i) {
    for (int j = 1; j <= internal->dim_n_Tw_2; ++j) {
      internal->n_Tw[i - 1 + internal->dim_n_Tw_1 * (j - 1)] = Rf_rbinom(round(T[internal->dim_T_1 * (j - 1) + i - 1] - internal->n_TU[internal->dim_n_TU_1 * (j - 1) + i - 1]), 1 - exp(internal->D[j - 1] * internal->dt));
    }
  }
  for (int i = 1; i <= internal->dim_n_Uw_1; ++i) {
    for (int j = 1; j <= internal->dim_n_Uw_2; ++j) {
      internal->n_Uw[i - 1 + internal->dim_n_Uw_1 * (j - 1)] = Rf_rbinom(round(U[internal->dim_U_1 * (j - 1) + i - 1] - internal->n_UI[internal->dim_n_UI_1 * (j - 1) + i - 1]), 1 - exp(internal->D[j - 1] * internal->dt));
    }
  }
  for (int i = 1; i <= internal->dim_cum_diag_s_1; ++i) {
    for (int j = 1; j <= internal->dim_cum_diag_s_2; ++j) {
  ...
  for (int i = 1; i <= internal->dim_n_Aw_1; ++i) {
    for (int j = 1; j <= internal->dim_n_Aw_2; ++j) {
      internal->n_Aw[i - 1 + internal->dim_n_Aw_1 * (j - 1)] = Rf_rbinom(round(A[internal->dim_A_1 * (j - 1) + i - 1] - internal->n_AUT[internal->dim_n_AUT_1 * (j - 1) + i - 1]), 1 - exp(internal->D[j - 1] * internal->dt));
    }
  }
