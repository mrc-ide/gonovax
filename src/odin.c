...
SEXP model_contents(SEXP internal_p) {
  ...
  SET_VECTOR_ELT(contents, 12, ScalarInteger(internal->dim_cum_diag_a));
  SET_VECTOR_ELT(contents, 13, ScalarInteger(internal->dim_cum_diag_a_1));
  SET_VECTOR_ELT(contents, 14, ScalarInteger(internal->dim_cum_diag_a_2));
  SET_VECTOR_ELT(contents, 15, ScalarInteger(internal->dim_cum_diag_s));
  SET_VECTOR_ELT(contents, 16, ScalarInteger(internal->dim_cum_diag_s_1));
  SET_VECTOR_ELT(contents, 17, ScalarInteger(internal->dim_cum_diag_s_2));
  SET_VECTOR_ELT(contents, 18, ScalarInteger(internal->dim_cum_incid));
  SET_VECTOR_ELT(contents, 19, ScalarInteger(internal->dim_cum_incid_1));
  SET_VECTOR_ELT(contents, 20, ScalarInteger(internal->dim_cum_incid_2));
  SET_VECTOR_ELT(contents, 21, ScalarInteger(internal->dim_cum_screened));
  SET_VECTOR_ELT(contents, 22, ScalarInteger(internal->dim_cum_screened_1));
  SET_VECTOR_ELT(contents, 23, ScalarInteger(internal->dim_cum_screened_2));
  ...
  SET_VECTOR_ELT(contents, 26, ScalarInteger(internal->dim_cum_treated_2));
  SET_VECTOR_ELT(contents, 27, ScalarInteger(internal->dim_cum_vaccinated));
  SET_VECTOR_ELT(contents, 28, ScalarInteger(internal->dim_cum_vaccinated_1));
  SET_VECTOR_ELT(contents, 29, ScalarInteger(internal->dim_cum_vaccinated_2));
  SET_VECTOR_ELT(contents, 30, ScalarInteger(internal->dim_eff));
  SET_VECTOR_ELT(contents, 31, ScalarInteger(internal->dim_entrants));
  SET_VECTOR_ELT(contents, 32, ScalarInteger(internal->dim_entrants_1));
  SET_VECTOR_ELT(contents, 33, ScalarInteger(internal->dim_entrants_2));
  SET_VECTOR_ELT(contents, 34, ScalarInteger(internal->dim_foi));
  SET_VECTOR_ELT(contents, 35, ScalarInteger(internal->dim_foi_1));
  SET_VECTOR_ELT(contents, 36, ScalarInteger(internal->dim_foi_2));
  SET_VECTOR_ELT(contents, 37, ScalarInteger(internal->dim_I));
  SET_VECTOR_ELT(contents, 38, ScalarInteger(internal->dim_I_1));
  SET_VECTOR_ELT(contents, 39, ScalarInteger(internal->dim_I_2));
  SET_VECTOR_ELT(contents, 40, ScalarInteger(internal->dim_I0));
  SET_VECTOR_ELT(contents, 41, ScalarInteger(internal->dim_I0_1));
  SET_VECTOR_ELT(contents, 42, ScalarInteger(internal->dim_I0_2));
  SET_VECTOR_ELT(contents, 43, ScalarInteger(internal->dim_m));
  SET_VECTOR_ELT(contents, 44, ScalarInteger(internal->dim_m_1));
  SET_VECTOR_ELT(contents, 45, ScalarInteger(internal->dim_m_2));
  ...
  SET_VECTOR_ELT(contents, 52, ScalarInteger(internal->dim_n_ST));
  SET_VECTOR_ELT(contents, 53, ScalarInteger(internal->dim_n_ST_1));
  SET_VECTOR_ELT(contents, 54, ScalarInteger(internal->dim_n_ST_2));
  SET_VECTOR_ELT(contents, 55, ScalarInteger(internal->dim_n_TU));
  SET_VECTOR_ELT(contents, 56, ScalarInteger(internal->dim_n_TU_1));
  SET_VECTOR_ELT(contents, 57, ScalarInteger(internal->dim_n_TU_2));
  SET_VECTOR_ELT(contents, 58, ScalarInteger(internal->dim_n_UI));
  SET_VECTOR_ELT(contents, 59, ScalarInteger(internal->dim_n_UI_1));
  SET_VECTOR_ELT(contents, 60, ScalarInteger(internal->dim_n_UI_2));
  SET_VECTOR_ELT(contents, 61, ScalarInteger(internal->dim_n_vd));
  SET_VECTOR_ELT(contents, 62, ScalarInteger(internal->dim_n_vd_1));
  SET_VECTOR_ELT(contents, 63, ScalarInteger(internal->dim_n_vd_12));
  SET_VECTOR_ELT(contents, 64, ScalarInteger(internal->dim_n_vd_2));
  SET_VECTOR_ELT(contents, 65, ScalarInteger(internal->dim_n_vd_3));
  SET_VECTOR_ELT(contents, 66, ScalarInteger(internal->dim_n_ve));
  SET_VECTOR_ELT(contents, 67, ScalarInteger(internal->dim_n_ve_1));
  SET_VECTOR_ELT(contents, 68, ScalarInteger(internal->dim_n_ve_12));
  SET_VECTOR_ELT(contents, 69, ScalarInteger(internal->dim_n_ve_2));
  SET_VECTOR_ELT(contents, 70, ScalarInteger(internal->dim_n_ve_3));
  SET_VECTOR_ELT(contents, 71, ScalarInteger(internal->dim_n_vs));
  SET_VECTOR_ELT(contents, 72, ScalarInteger(internal->dim_n_vs_1));
  SET_VECTOR_ELT(contents, 73, ScalarInteger(internal->dim_n_vs_12));
  SET_VECTOR_ELT(contents, 74, ScalarInteger(internal->dim_n_vs_2));
  SET_VECTOR_ELT(contents, 75, ScalarInteger(internal->dim_n_vs_3));
  SET_VECTOR_ELT(contents, 76, ScalarInteger(internal->dim_Np));
  SET_VECTOR_ELT(contents, 77, ScalarInteger(internal->dim_p));
  SET_VECTOR_ELT(contents, 78, ScalarInteger(internal->dim_q));
  SET_VECTOR_ELT(contents, 79, ScalarInteger(internal->dim_S));
  SET_VECTOR_ELT(contents, 80, ScalarInteger(internal->dim_S_1));
  SET_VECTOR_ELT(contents, 81, ScalarInteger(internal->dim_S_2));
  SET_VECTOR_ELT(contents, 82, ScalarInteger(internal->dim_S0));
  SET_VECTOR_ELT(contents, 83, ScalarInteger(internal->dim_S0_1));
  SET_VECTOR_ELT(contents, 84, ScalarInteger(internal->dim_S0_2));
  SET_VECTOR_ELT(contents, 85, ScalarInteger(internal->dim_screened));
  SET_VECTOR_ELT(contents, 86, ScalarInteger(internal->dim_screened_1));
  SET_VECTOR_ELT(contents, 87, ScalarInteger(internal->dim_screened_2));
  SET_VECTOR_ELT(contents, 88, ScalarInteger(internal->dim_T));
  SET_VECTOR_ELT(contents, 89, ScalarInteger(internal->dim_T_1));
  SET_VECTOR_ELT(contents, 90, ScalarInteger(internal->dim_T_2));
  SET_VECTOR_ELT(contents, 91, ScalarInteger(internal->dim_T0));
  SET_VECTOR_ELT(contents, 92, ScalarInteger(internal->dim_T0_1));
  SET_VECTOR_ELT(contents, 93, ScalarInteger(internal->dim_T0_2));
  SET_VECTOR_ELT(contents, 94, ScalarInteger(internal->dim_U));
  SET_VECTOR_ELT(contents, 95, ScalarInteger(internal->dim_U_1));
  SET_VECTOR_ELT(contents, 96, ScalarInteger(internal->dim_U_2));
  SET_VECTOR_ELT(contents, 97, ScalarInteger(internal->dim_U0));
  SET_VECTOR_ELT(contents, 98, ScalarInteger(internal->dim_U0_1));
  SET_VECTOR_ELT(contents, 99, ScalarInteger(internal->dim_U0_2));
  SET_VECTOR_ELT(contents, 100, ScalarInteger(internal->dim_vax_t));
  SET_VECTOR_ELT(contents, 101, ScalarInteger(internal->dim_vax_y));
  SET_VECTOR_ELT(contents, 102, ScalarInteger(internal->dim_vd));
  SET_VECTOR_ELT(contents, 103, ScalarInteger(internal->dim_vd_1));
  SET_VECTOR_ELT(contents, 104, ScalarInteger(internal->dim_vd_12));
  SET_VECTOR_ELT(contents, 105, ScalarInteger(internal->dim_vd_2));
  SET_VECTOR_ELT(contents, 106, ScalarInteger(internal->dim_vd_3));
  SET_VECTOR_ELT(contents, 107, ScalarInteger(internal->dim_ve));
  SET_VECTOR_ELT(contents, 108, ScalarInteger(internal->dim_ve_1));
  SET_VECTOR_ELT(contents, 109, ScalarInteger(internal->dim_ve_12));
  SET_VECTOR_ELT(contents, 110, ScalarInteger(internal->dim_ve_2));
  SET_VECTOR_ELT(contents, 111, ScalarInteger(internal->dim_ve_3));
  SET_VECTOR_ELT(contents, 112, ScalarInteger(internal->dim_vs));
  SET_VECTOR_ELT(contents, 113, ScalarInteger(internal->dim_vs_1));
  SET_VECTOR_ELT(contents, 114, ScalarInteger(internal->dim_vs_12));
  SET_VECTOR_ELT(contents, 115, ScalarInteger(internal->dim_vs_2));
  SET_VECTOR_ELT(contents, 116, ScalarInteger(internal->dim_vs_3));
  SET_VECTOR_ELT(contents, 117, ScalarInteger(internal->dim_w));
  SET_VECTOR_ELT(contents, 118, ScalarInteger(internal->dim_w_1));
  SET_VECTOR_ELT(contents, 119, ScalarInteger(internal->dim_w_2));
  SET_VECTOR_ELT(contents, 120, ScalarInteger(internal->dim_wA));
  SET_VECTOR_ELT(contents, 121, ScalarInteger(internal->dim_wA_1));
  SET_VECTOR_ELT(contents, 122, ScalarInteger(internal->dim_wA_12));
  SET_VECTOR_ELT(contents, 123, ScalarInteger(internal->dim_wA_2));
  SET_VECTOR_ELT(contents, 124, ScalarInteger(internal->dim_wA_3));
  SET_VECTOR_ELT(contents, 125, ScalarInteger(internal->dim_wI));
  SET_VECTOR_ELT(contents, 126, ScalarInteger(internal->dim_wI_1));
  SET_VECTOR_ELT(contents, 127, ScalarInteger(internal->dim_wI_12));
  SET_VECTOR_ELT(contents, 128, ScalarInteger(internal->dim_wI_2));
  SET_VECTOR_ELT(contents, 129, ScalarInteger(internal->dim_wI_3));
  SET_VECTOR_ELT(contents, 130, ScalarInteger(internal->dim_wS));
  SET_VECTOR_ELT(contents, 131, ScalarInteger(internal->dim_wS_1));
  SET_VECTOR_ELT(contents, 132, ScalarInteger(internal->dim_wS_12));
  SET_VECTOR_ELT(contents, 133, ScalarInteger(internal->dim_wS_2));
  SET_VECTOR_ELT(contents, 134, ScalarInteger(internal->dim_wS_3));
  SET_VECTOR_ELT(contents, 135, ScalarInteger(internal->dim_wT));
  SET_VECTOR_ELT(contents, 136, ScalarInteger(internal->dim_wT_1));
  SET_VECTOR_ELT(contents, 137, ScalarInteger(internal->dim_wT_12));
  SET_VECTOR_ELT(contents, 138, ScalarInteger(internal->dim_wT_2));
  SET_VECTOR_ELT(contents, 139, ScalarInteger(internal->dim_wT_3));
  SET_VECTOR_ELT(contents, 140, ScalarInteger(internal->dim_wU));
  SET_VECTOR_ELT(contents, 141, ScalarInteger(internal->dim_wU_1));
  SET_VECTOR_ELT(contents, 142, ScalarInteger(internal->dim_wU_12));
  SET_VECTOR_ELT(contents, 143, ScalarInteger(internal->dim_wU_2));
  SET_VECTOR_ELT(contents, 144, ScalarInteger(internal->dim_wU_3));
  SEXP eff = PROTECT(allocVector(REALSXP, internal->dim_eff));
  memcpy(REAL(eff), internal->eff, internal->dim_eff * sizeof(double));
  SET_VECTOR_ELT(contents, 145, eff);
  SET_VECTOR_ELT(contents, 146, ScalarReal(internal->enr));
  ...
  SET_VECTOR_ELT(contents, 147, entrants);
  SET_VECTOR_ELT(contents, 148, ScalarReal(internal->epsilon));
  SET_VECTOR_ELT(contents, 149, ScalarReal(internal->eta));
  SET_VECTOR_ELT(contents, 150, ScalarReal(internal->exr));
  ...
  SET_VECTOR_ELT(contents, 151, foi);
  ...
  SET_VECTOR_ELT(contents, 152, I0);
  ...
  SET_VECTOR_ELT(contents, 153, initial_A);
  ...
  SET_VECTOR_ELT(contents, 154, initial_cum_diag_a);
  ...
  SET_VECTOR_ELT(contents, 155, initial_cum_diag_s);
  ...
  SET_VECTOR_ELT(contents, 156, initial_cum_incid);
  ...
  SET_VECTOR_ELT(contents, 157, initial_cum_screened);
  ...
  SET_VECTOR_ELT(contents, 158, initial_cum_treated);
  ...
  SET_VECTOR_ELT(contents, 159, initial_cum_vaccinated);
  ...
  SET_VECTOR_ELT(contents, 163, initial_U);
  ...
  SET_VECTOR_ELT(contents, 170, n_ST);
  ...
  SET_VECTOR_ELT(contents, 171, n_TU);
  ...
  SET_VECTOR_ELT(contents, 172, n_UI);
  SET_VECTOR_ELT(contents, 173, ScalarInteger(internal->n_vax));
  ...
  SET_VECTOR_ELT(contents, 174, n_vd);
  ...
  SET_VECTOR_ELT(contents, 175, n_ve);
  ...
  SET_VECTOR_ELT(contents, 176, n_vs);
  SEXP Np = PROTECT(allocVector(REALSXP, internal->dim_Np));
  memcpy(REAL(Np), internal->Np, internal->dim_Np * sizeof(double));
  SET_VECTOR_ELT(contents, 177, Np);
  SET_VECTOR_ELT(contents, 178, ScalarReal(internal->nu));
  SET_VECTOR_ELT(contents, 179, ScalarInteger(internal->offset_output_foi));
  SET_VECTOR_ELT(contents, 180, ScalarInteger(internal->offset_variable_A));
  SET_VECTOR_ELT(contents, 181, ScalarInteger(internal->offset_variable_cum_diag_a));
  SET_VECTOR_ELT(contents, 182, ScalarInteger(internal->offset_variable_cum_diag_s));
  SET_VECTOR_ELT(contents, 183, ScalarInteger(internal->offset_variable_cum_incid));
  SET_VECTOR_ELT(contents, 184, ScalarInteger(internal->offset_variable_cum_screened));
  SET_VECTOR_ELT(contents, 185, ScalarInteger(internal->offset_variable_cum_treated));
  SET_VECTOR_ELT(contents, 186, ScalarInteger(internal->offset_variable_cum_vaccinated));
  SET_VECTOR_ELT(contents, 187, ScalarInteger(internal->offset_variable_S));
  SET_VECTOR_ELT(contents, 188, ScalarInteger(internal->offset_variable_T));
  SEXP p = PROTECT(allocVector(REALSXP, internal->dim_p));
  memcpy(REAL(p), internal->p, internal->dim_p * sizeof(double));
  SET_VECTOR_ELT(contents, 189, p);
  SET_VECTOR_ELT(contents, 190, ScalarReal(internal->psi));
  SEXP q = PROTECT(allocVector(REALSXP, internal->dim_q));
  memcpy(REAL(q), internal->q, internal->dim_q * sizeof(double));
  SET_VECTOR_ELT(contents, 191, q);
  SET_VECTOR_ELT(contents, 192, ScalarReal(internal->rho));
  ...
  SET_VECTOR_ELT(contents, 193, S0);
  ...
  SET_VECTOR_ELT(contents, 194, screened);
  SET_VECTOR_ELT(contents, 195, ScalarReal(internal->sigma));
  ...
  SET_VECTOR_ELT(contents, 196, T0);
  ...
  SET_VECTOR_ELT(contents, 197, U0);
  ...
  SET_VECTOR_ELT(contents, 198, vax_t);
  ...
  SET_VECTOR_ELT(contents, 199, vax_y);
  ...
  SET_VECTOR_ELT(contents, 200, vd);
  ...
  SET_VECTOR_ELT(contents, 201, ve);
  ...
  SET_VECTOR_ELT(contents, 202, vs);
  ...
  SET_VECTOR_ELT(contents, 204, wA);
  ...
  SET_VECTOR_ELT(contents, 205, wI);
  ...
  SET_VECTOR_ELT(contents, 206, wS);
  ...
  SET_VECTOR_ELT(contents, 207, wT);
  ...
  SET_VECTOR_ELT(contents, 208, wU);
  ...
  SET_STRING_ELT(nms, 12, mkChar("dim_cum_diag_a"));
  SET_STRING_ELT(nms, 13, mkChar("dim_cum_diag_a_1"));
  SET_STRING_ELT(nms, 14, mkChar("dim_cum_diag_a_2"));
  SET_STRING_ELT(nms, 15, mkChar("dim_cum_diag_s"));
  SET_STRING_ELT(nms, 16, mkChar("dim_cum_diag_s_1"));
  SET_STRING_ELT(nms, 17, mkChar("dim_cum_diag_s_2"));
  SET_STRING_ELT(nms, 18, mkChar("dim_cum_incid"));
  SET_STRING_ELT(nms, 19, mkChar("dim_cum_incid_1"));
  SET_STRING_ELT(nms, 20, mkChar("dim_cum_incid_2"));
  SET_STRING_ELT(nms, 21, mkChar("dim_cum_screened"));
  SET_STRING_ELT(nms, 22, mkChar("dim_cum_screened_1"));
  SET_STRING_ELT(nms, 23, mkChar("dim_cum_screened_2"));
  SET_STRING_ELT(nms, 24, mkChar("dim_cum_treated"));
  SET_STRING_ELT(nms, 25, mkChar("dim_cum_treated_1"));
  SET_STRING_ELT(nms, 26, mkChar("dim_cum_treated_2"));
  SET_STRING_ELT(nms, 27, mkChar("dim_cum_vaccinated"));
  SET_STRING_ELT(nms, 28, mkChar("dim_cum_vaccinated_1"));
  SET_STRING_ELT(nms, 29, mkChar("dim_cum_vaccinated_2"));
  SET_STRING_ELT(nms, 30, mkChar("dim_eff"));
  SET_STRING_ELT(nms, 31, mkChar("dim_entrants"));
  SET_STRING_ELT(nms, 32, mkChar("dim_entrants_1"));
  SET_STRING_ELT(nms, 33, mkChar("dim_entrants_2"));
  SET_STRING_ELT(nms, 34, mkChar("dim_foi"));
  SET_STRING_ELT(nms, 35, mkChar("dim_foi_1"));
  SET_STRING_ELT(nms, 36, mkChar("dim_foi_2"));
  SET_STRING_ELT(nms, 37, mkChar("dim_I"));
  SET_STRING_ELT(nms, 38, mkChar("dim_I_1"));
  SET_STRING_ELT(nms, 39, mkChar("dim_I_2"));
  SET_STRING_ELT(nms, 40, mkChar("dim_I0"));
  SET_STRING_ELT(nms, 41, mkChar("dim_I0_1"));
  SET_STRING_ELT(nms, 42, mkChar("dim_I0_2"));
  SET_STRING_ELT(nms, 43, mkChar("dim_m"));
  SET_STRING_ELT(nms, 44, mkChar("dim_m_1"));
  SET_STRING_ELT(nms, 45, mkChar("dim_m_2"));
  ...
  SET_STRING_ELT(nms, 52, mkChar("dim_n_ST"));
  SET_STRING_ELT(nms, 53, mkChar("dim_n_ST_1"));
  SET_STRING_ELT(nms, 54, mkChar("dim_n_ST_2"));
  SET_STRING_ELT(nms, 55, mkChar("dim_n_TU"));
  SET_STRING_ELT(nms, 56, mkChar("dim_n_TU_1"));
  SET_STRING_ELT(nms, 57, mkChar("dim_n_TU_2"));
  SET_STRING_ELT(nms, 58, mkChar("dim_n_UI"));
  SET_STRING_ELT(nms, 59, mkChar("dim_n_UI_1"));
  SET_STRING_ELT(nms, 60, mkChar("dim_n_UI_2"));
  SET_STRING_ELT(nms, 61, mkChar("dim_n_vd"));
  SET_STRING_ELT(nms, 62, mkChar("dim_n_vd_1"));
  SET_STRING_ELT(nms, 63, mkChar("dim_n_vd_12"));
  SET_STRING_ELT(nms, 64, mkChar("dim_n_vd_2"));
  SET_STRING_ELT(nms, 65, mkChar("dim_n_vd_3"));
  SET_STRING_ELT(nms, 66, mkChar("dim_n_ve"));
  SET_STRING_ELT(nms, 67, mkChar("dim_n_ve_1"));
  SET_STRING_ELT(nms, 68, mkChar("dim_n_ve_12"));
  SET_STRING_ELT(nms, 69, mkChar("dim_n_ve_2"));
  SET_STRING_ELT(nms, 70, mkChar("dim_n_ve_3"));
  SET_STRING_ELT(nms, 71, mkChar("dim_n_vs"));
  SET_STRING_ELT(nms, 72, mkChar("dim_n_vs_1"));
  SET_STRING_ELT(nms, 73, mkChar("dim_n_vs_12"));
  SET_STRING_ELT(nms, 74, mkChar("dim_n_vs_2"));
  SET_STRING_ELT(nms, 75, mkChar("dim_n_vs_3"));
  SET_STRING_ELT(nms, 76, mkChar("dim_Np"));
  SET_STRING_ELT(nms, 77, mkChar("dim_p"));
  SET_STRING_ELT(nms, 78, mkChar("dim_q"));
  SET_STRING_ELT(nms, 79, mkChar("dim_S"));
  SET_STRING_ELT(nms, 80, mkChar("dim_S_1"));
  SET_STRING_ELT(nms, 81, mkChar("dim_S_2"));
  SET_STRING_ELT(nms, 82, mkChar("dim_S0"));
  SET_STRING_ELT(nms, 83, mkChar("dim_S0_1"));
  SET_STRING_ELT(nms, 84, mkChar("dim_S0_2"));
  SET_STRING_ELT(nms, 85, mkChar("dim_screened"));
  SET_STRING_ELT(nms, 86, mkChar("dim_screened_1"));
  SET_STRING_ELT(nms, 87, mkChar("dim_screened_2"));
  SET_STRING_ELT(nms, 88, mkChar("dim_T"));
  SET_STRING_ELT(nms, 89, mkChar("dim_T_1"));
  SET_STRING_ELT(nms, 90, mkChar("dim_T_2"));
  SET_STRING_ELT(nms, 91, mkChar("dim_T0"));
  SET_STRING_ELT(nms, 92, mkChar("dim_T0_1"));
  SET_STRING_ELT(nms, 93, mkChar("dim_T0_2"));
  SET_STRING_ELT(nms, 94, mkChar("dim_U"));
  SET_STRING_ELT(nms, 95, mkChar("dim_U_1"));
  SET_STRING_ELT(nms, 96, mkChar("dim_U_2"));
  SET_STRING_ELT(nms, 97, mkChar("dim_U0"));
  SET_STRING_ELT(nms, 98, mkChar("dim_U0_1"));
  SET_STRING_ELT(nms, 99, mkChar("dim_U0_2"));
  SET_STRING_ELT(nms, 100, mkChar("dim_vax_t"));
  SET_STRING_ELT(nms, 101, mkChar("dim_vax_y"));
  SET_STRING_ELT(nms, 102, mkChar("dim_vd"));
  SET_STRING_ELT(nms, 103, mkChar("dim_vd_1"));
  SET_STRING_ELT(nms, 104, mkChar("dim_vd_12"));
  SET_STRING_ELT(nms, 105, mkChar("dim_vd_2"));
  SET_STRING_ELT(nms, 106, mkChar("dim_vd_3"));
  SET_STRING_ELT(nms, 107, mkChar("dim_ve"));
  SET_STRING_ELT(nms, 108, mkChar("dim_ve_1"));
  SET_STRING_ELT(nms, 109, mkChar("dim_ve_12"));
  SET_STRING_ELT(nms, 110, mkChar("dim_ve_2"));
  SET_STRING_ELT(nms, 111, mkChar("dim_ve_3"));
  SET_STRING_ELT(nms, 112, mkChar("dim_vs"));
  SET_STRING_ELT(nms, 113, mkChar("dim_vs_1"));
  SET_STRING_ELT(nms, 114, mkChar("dim_vs_12"));
  SET_STRING_ELT(nms, 115, mkChar("dim_vs_2"));
  SET_STRING_ELT(nms, 116, mkChar("dim_vs_3"));
  SET_STRING_ELT(nms, 117, mkChar("dim_w"));
  SET_STRING_ELT(nms, 118, mkChar("dim_w_1"));
  SET_STRING_ELT(nms, 119, mkChar("dim_w_2"));
  SET_STRING_ELT(nms, 120, mkChar("dim_wA"));
  SET_STRING_ELT(nms, 121, mkChar("dim_wA_1"));
  SET_STRING_ELT(nms, 122, mkChar("dim_wA_12"));
  SET_STRING_ELT(nms, 123, mkChar("dim_wA_2"));
  SET_STRING_ELT(nms, 124, mkChar("dim_wA_3"));
  SET_STRING_ELT(nms, 125, mkChar("dim_wI"));
  SET_STRING_ELT(nms, 126, mkChar("dim_wI_1"));
  SET_STRING_ELT(nms, 127, mkChar("dim_wI_12"));
  SET_STRING_ELT(nms, 128, mkChar("dim_wI_2"));
  SET_STRING_ELT(nms, 129, mkChar("dim_wI_3"));
  SET_STRING_ELT(nms, 130, mkChar("dim_wS"));
  SET_STRING_ELT(nms, 131, mkChar("dim_wS_1"));
  SET_STRING_ELT(nms, 132, mkChar("dim_wS_12"));
  SET_STRING_ELT(nms, 133, mkChar("dim_wS_2"));
  SET_STRING_ELT(nms, 134, mkChar("dim_wS_3"));
  SET_STRING_ELT(nms, 135, mkChar("dim_wT"));
  SET_STRING_ELT(nms, 136, mkChar("dim_wT_1"));
  SET_STRING_ELT(nms, 137, mkChar("dim_wT_12"));
  SET_STRING_ELT(nms, 138, mkChar("dim_wT_2"));
  SET_STRING_ELT(nms, 139, mkChar("dim_wT_3"));
  SET_STRING_ELT(nms, 140, mkChar("dim_wU"));
  SET_STRING_ELT(nms, 141, mkChar("dim_wU_1"));
  SET_STRING_ELT(nms, 142, mkChar("dim_wU_12"));
  SET_STRING_ELT(nms, 143, mkChar("dim_wU_2"));
  SET_STRING_ELT(nms, 144, mkChar("dim_wU_3"));
  SET_STRING_ELT(nms, 145, mkChar("eff"));
  SET_STRING_ELT(nms, 146, mkChar("enr"));
  SET_STRING_ELT(nms, 147, mkChar("entrants"));
  SET_STRING_ELT(nms, 148, mkChar("epsilon"));
  SET_STRING_ELT(nms, 149, mkChar("eta"));
  SET_STRING_ELT(nms, 150, mkChar("exr"));
  SET_STRING_ELT(nms, 151, mkChar("foi"));
  SET_STRING_ELT(nms, 152, mkChar("I0"));
  SET_STRING_ELT(nms, 153, mkChar("initial_A"));
  SET_STRING_ELT(nms, 154, mkChar("initial_cum_diag_a"));
  SET_STRING_ELT(nms, 155, mkChar("initial_cum_diag_s"));
  SET_STRING_ELT(nms, 156, mkChar("initial_cum_incid"));
  SET_STRING_ELT(nms, 157, mkChar("initial_cum_screened"));
  SET_STRING_ELT(nms, 158, mkChar("initial_cum_treated"));
  SET_STRING_ELT(nms, 159, mkChar("initial_cum_vaccinated"));
  SET_STRING_ELT(nms, 160, mkChar("initial_I"));
  SET_STRING_ELT(nms, 161, mkChar("initial_S"));
  SET_STRING_ELT(nms, 162, mkChar("initial_T"));
  SET_STRING_ELT(nms, 163, mkChar("initial_U"));
  SET_STRING_ELT(nms, 164, mkChar("interpolate_vax_switch"));
  SET_STRING_ELT(nms, 165, mkChar("m"));
  ...
  SET_STRING_ELT(nms, 170, mkChar("n_ST"));
  SET_STRING_ELT(nms, 171, mkChar("n_TU"));
  SET_STRING_ELT(nms, 172, mkChar("n_UI"));
  SET_STRING_ELT(nms, 173, mkChar("n_vax"));
  SET_STRING_ELT(nms, 174, mkChar("n_vd"));
  SET_STRING_ELT(nms, 175, mkChar("n_ve"));
  SET_STRING_ELT(nms, 176, mkChar("n_vs"));
  SET_STRING_ELT(nms, 177, mkChar("Np"));
  SET_STRING_ELT(nms, 178, mkChar("nu"));
  SET_STRING_ELT(nms, 179, mkChar("offset_output_foi"));
  SET_STRING_ELT(nms, 180, mkChar("offset_variable_A"));
  SET_STRING_ELT(nms, 181, mkChar("offset_variable_cum_diag_a"));
  SET_STRING_ELT(nms, 182, mkChar("offset_variable_cum_diag_s"));
  SET_STRING_ELT(nms, 183, mkChar("offset_variable_cum_incid"));
  SET_STRING_ELT(nms, 184, mkChar("offset_variable_cum_screened"));
  SET_STRING_ELT(nms, 185, mkChar("offset_variable_cum_treated"));
  SET_STRING_ELT(nms, 186, mkChar("offset_variable_cum_vaccinated"));
  SET_STRING_ELT(nms, 187, mkChar("offset_variable_S"));
  SET_STRING_ELT(nms, 188, mkChar("offset_variable_T"));
  SET_STRING_ELT(nms, 189, mkChar("p"));
  SET_STRING_ELT(nms, 190, mkChar("psi"));
  SET_STRING_ELT(nms, 191, mkChar("q"));
  SET_STRING_ELT(nms, 192, mkChar("rho"));
  SET_STRING_ELT(nms, 193, mkChar("S0"));
  SET_STRING_ELT(nms, 194, mkChar("screened"));
  SET_STRING_ELT(nms, 195, mkChar("sigma"));
  SET_STRING_ELT(nms, 196, mkChar("T0"));
  SET_STRING_ELT(nms, 197, mkChar("U0"));
  SET_STRING_ELT(nms, 198, mkChar("vax_t"));
  SET_STRING_ELT(nms, 199, mkChar("vax_y"));
  SET_STRING_ELT(nms, 200, mkChar("vd"));
  SET_STRING_ELT(nms, 201, mkChar("ve"));
  SET_STRING_ELT(nms, 202, mkChar("vs"));
  SET_STRING_ELT(nms, 203, mkChar("w"));
  SET_STRING_ELT(nms, 204, mkChar("wA"));
  SET_STRING_ELT(nms, 205, mkChar("wI"));
  SET_STRING_ELT(nms, 206, mkChar("wS"));
  SET_STRING_ELT(nms, 207, mkChar("wT"));
  SET_STRING_ELT(nms, 208, mkChar("wU"));
...
void model_rhs(model_internal* internal, double t, double * state, double * dstatedt, double * output) {
  ...
  for (int i = 1; i <= internal->dim_foi_1; ++i) {
    for (int j = 1; j <= internal->dim_foi_2; ++j) {
      internal->foi[i - 1 + internal->dim_foi_1 * (j - 1)] = internal->beta * internal->p[i - 1] * internal->m[internal->dim_m_1 * (j - 1) + i - 1] * odin_sum2(internal->C, j - 1, j, 0, internal->dim_C_2, internal->dim_C_1) / (double) odin_sum2(internal->N, j - 1, j, 0, internal->dim_N_2, internal->dim_N_1);
    }
  }
