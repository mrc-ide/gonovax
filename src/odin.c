...
typedef struct model_internal {
  ...
  int dim_I0_1;
  int dim_I0_2;
  int dim_incidence_rate;
  int dim_incidence_rate_1;
  int dim_incidence_rate_2;
  int dim_lambda;
  int dim_lambda_1;
  int dim_lambda_2;
  int dim_N;
  ...
  double *Np;
  double nu;
  int offset_output_incidence_rate;
...
SEXP model_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 448));
  ...
  SET_VECTOR_ELT(contents, 82, ScalarInteger(internal->dim_incidence_rate));
  SET_VECTOR_ELT(contents, 83, ScalarInteger(internal->dim_incidence_rate_1));
  SET_VECTOR_ELT(contents, 84, ScalarInteger(internal->dim_incidence_rate_2));
  ...
  SET_VECTOR_ELT(contents, 330, initial_cum_offered);
  ...
  SET_VECTOR_ELT(contents, 331, initial_cum_offered_pn);
  ...
  SET_VECTOR_ELT(contents, 332, initial_cum_offered_vbe);
  ...
  SET_VECTOR_ELT(contents, 333, initial_cum_screened);
  ...
  SET_VECTOR_ELT(contents, 334, initial_cum_treated);
  ...
  SET_VECTOR_ELT(contents, 335, initial_cum_vaccinated);
  ...
  SET_VECTOR_ELT(contents, 336, initial_cum_vaccinated_pn);
  ...
  SET_VECTOR_ELT(contents, 337, initial_cum_vaccinated_screen);
  ...
  SET_VECTOR_ELT(contents, 338, initial_cum_vbe);
  ...
  SET_VECTOR_ELT(contents, 339, initial_I);
  ...
  SET_VECTOR_ELT(contents, 340, initial_S);
  ...
  SET_VECTOR_ELT(contents, 341, initial_T);
  ...
  SET_VECTOR_ELT(contents, 342, initial_U);
  SET_VECTOR_ELT(contents, 347, ScalarReal(internal->kappa));
  ...
  SET_VECTOR_ELT(contents, 348, lambda);
  SET_VECTOR_ELT(contents, 349, ScalarReal(internal->mu));
  ...
  SET_VECTOR_ELT(contents, 351, n_AT);
  ...
  SET_VECTOR_ELT(contents, 352, n_AU);
  ...
  SET_VECTOR_ELT(contents, 353, n_diag_rec);
  SET_VECTOR_ELT(contents, 354, ScalarInteger(internal->n_group));
  ...
  SET_VECTOR_ELT(contents, 355, N_hesgroup);
  ...
  SET_VECTOR_ELT(contents, 356, n_obe);
  ...
  SET_VECTOR_ELT(contents, 357, n_ood);
  ...
  SET_VECTOR_ELT(contents, 358, n_oopn);
  ...
  SET_VECTOR_ELT(contents, 359, n_oos);
  ...
  SET_VECTOR_ELT(contents, 360, n_ST);
  ...
  SET_VECTOR_ELT(contents, 361, n_TU);
  ...
  SET_VECTOR_ELT(contents, 362, n_UI);
  SET_VECTOR_ELT(contents, 363, ScalarInteger(internal->n_vax));
  ...
  SET_VECTOR_ELT(contents, 364, n_vbe);
  ...
  SET_VECTOR_ELT(contents, 365, n_vod);
  ...
  SET_VECTOR_ELT(contents, 366, n_vopn);
  ...
  SET_VECTOR_ELT(contents, 367, n_vos);
  ...
  SET_VECTOR_ELT(contents, 368, notifiedandattended);
  SET_VECTOR_ELT(contents, 369, ScalarReal(internal->notifiedprev));
  SEXP Np = PROTECT(allocVector(REALSXP, internal->dim_Np));
  memcpy(REAL(Np), internal->Np, internal->dim_Np * sizeof(double));
  SET_VECTOR_ELT(contents, 370, Np);
  SET_VECTOR_ELT(contents, 371, ScalarReal(internal->nu));
  SET_VECTOR_ELT(contents, 372, ScalarInteger(internal->offset_output_incidence_rate));
  ...
  SET_VECTOR_ELT(contents, 384, ScalarInteger(internal->offset_variable_cum_offered));
  SET_VECTOR_ELT(contents, 385, ScalarInteger(internal->offset_variable_cum_offered_pn));
  SET_VECTOR_ELT(contents, 386, ScalarInteger(internal->offset_variable_cum_offered_vbe));
  SET_VECTOR_ELT(contents, 387, ScalarInteger(internal->offset_variable_cum_screened));
  SET_VECTOR_ELT(contents, 388, ScalarInteger(internal->offset_variable_cum_treated));
  SET_VECTOR_ELT(contents, 389, ScalarInteger(internal->offset_variable_cum_vaccinated));
  SET_VECTOR_ELT(contents, 390, ScalarInteger(internal->offset_variable_cum_vaccinated_pn));
  SET_VECTOR_ELT(contents, 391, ScalarInteger(internal->offset_variable_cum_vaccinated_screen));
  SET_VECTOR_ELT(contents, 392, ScalarInteger(internal->offset_variable_cum_vbe));
  SET_VECTOR_ELT(contents, 393, ScalarInteger(internal->offset_variable_S));
  SET_VECTOR_ELT(contents, 394, ScalarInteger(internal->offset_variable_T));
  ...
  SET_VECTOR_ELT(contents, 395, omega_C);
  ...
  SET_VECTOR_ELT(contents, 396, omega_C_withdiag);
  ...
  SET_VECTOR_ELT(contents, 397, omega_C_withdiag_rg);
  ...
  SET_VECTOR_ELT(contents, 398, omega_U);
  ...
  SET_VECTOR_ELT(contents, 399, omega_U_withdiag);
  ...
  SET_VECTOR_ELT(contents, 402, phi);
  ...
  SET_VECTOR_ELT(contents, 403, prop_C);
  ...
  SET_VECTOR_ELT(contents, 404, prop_C_hesgroup);
  ...
  SET_VECTOR_ELT(contents, 405, prop_C_hesriskgroup);
  ...
  SET_VECTOR_ELT(contents, 406, prop_CCsubgroup);
  ...
  SET_VECTOR_ELT(contents, 407, prop_UUsubgroup);
  SET_VECTOR_ELT(contents, 408, ScalarReal(internal->psi));
  SEXP q = PROTECT(allocVector(REALSXP, internal->dim_q));
  memcpy(REAL(q), internal->q, internal->dim_q * sizeof(double));
  SET_VECTOR_ELT(contents, 409, q);
  SET_VECTOR_ELT(contents, 410, ScalarReal(internal->rho));
  ...
  SET_VECTOR_ELT(contents, 411, S0);
  ...
  SET_VECTOR_ELT(contents, 412, screened);
  SET_VECTOR_ELT(contents, 413, ScalarReal(internal->sigma));
  ...
  SET_VECTOR_ELT(contents, 416, u_d);
  ...
  SET_VECTOR_ELT(contents, 417, u_pn);
  ...
  SET_VECTOR_ELT(contents, 418, u_s);
  SET_VECTOR_ELT(contents, 419, ScalarReal(internal->u_vbe));
  ...
  SET_VECTOR_ELT(contents, 420, U0);
  SEXP Up = PROTECT(allocVector(REALSXP, internal->dim_Up));
  memcpy(REAL(Up), internal->Up, internal->dim_Up * sizeof(double));
  SET_VECTOR_ELT(contents, 421, Up);
  SET_VECTOR_ELT(contents, 422, ScalarReal(internal->vax_switch_2));
  SET_VECTOR_ELT(contents, 423, ScalarReal(internal->vax_switch_3));
  ...
  SET_VECTOR_ELT(contents, 424, vax_t);
  ...
  SET_VECTOR_ELT(contents, 425, vax_y);
  ...
  SET_VECTOR_ELT(contents, 431, vod);
  ...
  SET_VECTOR_ELT(contents, 432, vopn);
  ...
  SET_VECTOR_ELT(contents, 433, vos);
  ...
  SET_VECTOR_ELT(contents, 435, wA);
  ...
  SET_VECTOR_ELT(contents, 436, wd);
  ...
  SET_VECTOR_ELT(contents, 437, wdA);
  ...
  SET_VECTOR_ELT(contents, 438, wdI);
  ...
  SET_VECTOR_ELT(contents, 439, wdS);
  ...
  SET_VECTOR_ELT(contents, 440, wdT);
  ...
  SET_VECTOR_ELT(contents, 441, wdU);
  ...
  SET_VECTOR_ELT(contents, 442, wI);
  ...
  SET_VECTOR_ELT(contents, 443, willing);
  ...
  SET_VECTOR_ELT(contents, 444, wS);
  ...
  SET_VECTOR_ELT(contents, 445, wT);
  ...
  SET_VECTOR_ELT(contents, 446, wU);
  ...
  SET_VECTOR_ELT(contents, 447, xi);
  SEXP nms = PROTECT(allocVector(STRSXP, 448));
  ...
  SET_STRING_ELT(nms, 82, mkChar("dim_incidence_rate"));
  SET_STRING_ELT(nms, 83, mkChar("dim_incidence_rate_1"));
  SET_STRING_ELT(nms, 84, mkChar("dim_incidence_rate_2"));
  ...
  SET_STRING_ELT(nms, 330, mkChar("initial_cum_offered"));
  SET_STRING_ELT(nms, 331, mkChar("initial_cum_offered_pn"));
  SET_STRING_ELT(nms, 332, mkChar("initial_cum_offered_vbe"));
  SET_STRING_ELT(nms, 333, mkChar("initial_cum_screened"));
  SET_STRING_ELT(nms, 334, mkChar("initial_cum_treated"));
  SET_STRING_ELT(nms, 335, mkChar("initial_cum_vaccinated"));
  SET_STRING_ELT(nms, 336, mkChar("initial_cum_vaccinated_pn"));
  SET_STRING_ELT(nms, 337, mkChar("initial_cum_vaccinated_screen"));
  SET_STRING_ELT(nms, 338, mkChar("initial_cum_vbe"));
  SET_STRING_ELT(nms, 339, mkChar("initial_I"));
  SET_STRING_ELT(nms, 340, mkChar("initial_S"));
  SET_STRING_ELT(nms, 341, mkChar("initial_T"));
  SET_STRING_ELT(nms, 342, mkChar("initial_U"));
  SET_STRING_ELT(nms, 343, mkChar("interpolate_beta"));
  SET_STRING_ELT(nms, 344, mkChar("interpolate_eta_h"));
  SET_STRING_ELT(nms, 345, mkChar("interpolate_eta_l"));
  SET_STRING_ELT(nms, 346, mkChar("interpolate_vax_switch_1"));
  SET_STRING_ELT(nms, 347, mkChar("kappa"));
  SET_STRING_ELT(nms, 348, mkChar("lambda"));
  SET_STRING_ELT(nms, 349, mkChar("mu"));
  SET_STRING_ELT(nms, 350, mkChar("N"));
  SET_STRING_ELT(nms, 351, mkChar("n_AT"));
  SET_STRING_ELT(nms, 352, mkChar("n_AU"));
  SET_STRING_ELT(nms, 353, mkChar("n_diag_rec"));
  SET_STRING_ELT(nms, 354, mkChar("n_group"));
  SET_STRING_ELT(nms, 355, mkChar("N_hesgroup"));
  SET_STRING_ELT(nms, 356, mkChar("n_obe"));
  SET_STRING_ELT(nms, 357, mkChar("n_ood"));
  SET_STRING_ELT(nms, 358, mkChar("n_oopn"));
  SET_STRING_ELT(nms, 359, mkChar("n_oos"));
  SET_STRING_ELT(nms, 360, mkChar("n_ST"));
  SET_STRING_ELT(nms, 361, mkChar("n_TU"));
  SET_STRING_ELT(nms, 362, mkChar("n_UI"));
  SET_STRING_ELT(nms, 363, mkChar("n_vax"));
  SET_STRING_ELT(nms, 364, mkChar("n_vbe"));
  SET_STRING_ELT(nms, 365, mkChar("n_vod"));
  SET_STRING_ELT(nms, 366, mkChar("n_vopn"));
  SET_STRING_ELT(nms, 367, mkChar("n_vos"));
  SET_STRING_ELT(nms, 368, mkChar("notifiedandattended"));
  SET_STRING_ELT(nms, 369, mkChar("notifiedprev"));
  SET_STRING_ELT(nms, 370, mkChar("Np"));
  SET_STRING_ELT(nms, 371, mkChar("nu"));
  SET_STRING_ELT(nms, 372, mkChar("offset_output_incidence_rate"));
  ...
  SET_STRING_ELT(nms, 384, mkChar("offset_variable_cum_offered"));
  SET_STRING_ELT(nms, 385, mkChar("offset_variable_cum_offered_pn"));
  SET_STRING_ELT(nms, 386, mkChar("offset_variable_cum_offered_vbe"));
  SET_STRING_ELT(nms, 387, mkChar("offset_variable_cum_screened"));
  SET_STRING_ELT(nms, 388, mkChar("offset_variable_cum_treated"));
  SET_STRING_ELT(nms, 389, mkChar("offset_variable_cum_vaccinated"));
  SET_STRING_ELT(nms, 390, mkChar("offset_variable_cum_vaccinated_pn"));
  SET_STRING_ELT(nms, 391, mkChar("offset_variable_cum_vaccinated_screen"));
  SET_STRING_ELT(nms, 392, mkChar("offset_variable_cum_vbe"));
  SET_STRING_ELT(nms, 393, mkChar("offset_variable_S"));
  SET_STRING_ELT(nms, 394, mkChar("offset_variable_T"));
  SET_STRING_ELT(nms, 395, mkChar("omega_C"));
  SET_STRING_ELT(nms, 396, mkChar("omega_C_withdiag"));
  SET_STRING_ELT(nms, 397, mkChar("omega_C_withdiag_rg"));
  SET_STRING_ELT(nms, 398, mkChar("omega_U"));
  SET_STRING_ELT(nms, 399, mkChar("omega_U_withdiag"));
  SET_STRING_ELT(nms, 400, mkChar("omega_U_withdiag_rg"));
  SET_STRING_ELT(nms, 401, mkChar("p"));
  SET_STRING_ELT(nms, 402, mkChar("phi"));
  SET_STRING_ELT(nms, 403, mkChar("prop_C"));
  SET_STRING_ELT(nms, 404, mkChar("prop_C_hesgroup"));
  SET_STRING_ELT(nms, 405, mkChar("prop_C_hesriskgroup"));
  SET_STRING_ELT(nms, 406, mkChar("prop_CCsubgroup"));
  SET_STRING_ELT(nms, 407, mkChar("prop_UUsubgroup"));
  SET_STRING_ELT(nms, 408, mkChar("psi"));
  SET_STRING_ELT(nms, 409, mkChar("q"));
  SET_STRING_ELT(nms, 410, mkChar("rho"));
  SET_STRING_ELT(nms, 411, mkChar("S0"));
  SET_STRING_ELT(nms, 412, mkChar("screened"));
  SET_STRING_ELT(nms, 413, mkChar("sigma"));
  SET_STRING_ELT(nms, 414, mkChar("T0"));
  SET_STRING_ELT(nms, 415, mkChar("tt"));
  SET_STRING_ELT(nms, 416, mkChar("u_d"));
  SET_STRING_ELT(nms, 417, mkChar("u_pn"));
  SET_STRING_ELT(nms, 418, mkChar("u_s"));
  SET_STRING_ELT(nms, 419, mkChar("u_vbe"));
  SET_STRING_ELT(nms, 420, mkChar("U0"));
  SET_STRING_ELT(nms, 421, mkChar("Up"));
  SET_STRING_ELT(nms, 422, mkChar("vax_switch_2"));
  SET_STRING_ELT(nms, 423, mkChar("vax_switch_3"));
  SET_STRING_ELT(nms, 424, mkChar("vax_t"));
  SET_STRING_ELT(nms, 425, mkChar("vax_y"));
  SET_STRING_ELT(nms, 426, mkChar("vbe"));
  SET_STRING_ELT(nms, 427, mkChar("vea"));
  SET_STRING_ELT(nms, 428, mkChar("ved"));
  SET_STRING_ELT(nms, 429, mkChar("vei"));
  SET_STRING_ELT(nms, 430, mkChar("ves"));
  SET_STRING_ELT(nms, 431, mkChar("vod"));
  SET_STRING_ELT(nms, 432, mkChar("vopn"));
  SET_STRING_ELT(nms, 433, mkChar("vos"));
  SET_STRING_ELT(nms, 434, mkChar("w"));
  SET_STRING_ELT(nms, 435, mkChar("wA"));
  SET_STRING_ELT(nms, 436, mkChar("wd"));
  SET_STRING_ELT(nms, 437, mkChar("wdA"));
  SET_STRING_ELT(nms, 438, mkChar("wdI"));
  SET_STRING_ELT(nms, 439, mkChar("wdS"));
  SET_STRING_ELT(nms, 440, mkChar("wdT"));
  SET_STRING_ELT(nms, 441, mkChar("wdU"));
  SET_STRING_ELT(nms, 442, mkChar("wI"));
  SET_STRING_ELT(nms, 443, mkChar("willing"));
  SET_STRING_ELT(nms, 444, mkChar("wS"));
  SET_STRING_ELT(nms, 445, mkChar("wT"));
  SET_STRING_ELT(nms, 446, mkChar("wU"));
  SET_STRING_ELT(nms, 447, mkChar("xi"));
...
SEXP model_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->dim_incidence_rate_1 = 1;
  internal->dim_incidence_rate_2 = internal->n_vax;
  ...
  internal->dim_incidence_rate = internal->dim_incidence_rate_1 * internal->dim_incidence_rate_2;
  ...
  internal->offset_output_incidence_rate = internal->dim_eta + internal->dim_prop_C_hesgroup + 3;
  ...
  internal->offset_output_lambda = internal->dim_eta + internal->dim_incidence_rate + internal->dim_N + internal->dim_prop_C_hesgroup + 3;
  internal->offset_output_N = internal->dim_eta + internal->dim_incidence_rate + internal->dim_prop_C_hesgroup + 3;
  internal->offset_output_notifiedandattended = internal->dim_eta + internal->dim_incidence_rate + internal->dim_lambda + internal->dim_N + internal->dim_phi + internal->dim_prop_C_hesgroup + 3;
  internal->offset_output_phi = internal->dim_eta + internal->dim_incidence_rate + internal->dim_lambda + internal->dim_N + internal->dim_prop_C_hesgroup + 3;
  internal->offset_output_prop_C_hesriskgroup = internal->dim_eta + internal->dim_incidence_rate + internal->dim_lambda + internal->dim_N + internal->dim_notifiedandattended + internal->dim_phi + internal->dim_prop_C_hesgroup + 3;
...
SEXP model_metadata(SEXP internal_p) {
  ...
  int * dim_incidence_rate = INTEGER(VECTOR_ELT(output_length, 5));
  dim_incidence_rate[0] = internal->dim_incidence_rate_1;
  dim_incidence_rate[1] = internal->dim_incidence_rate_2;
  ...
  int * dim_prop_C_hesriskgroup = INTEGER(VECTOR_ELT(output_length, 10));
  ...
  SET_STRING_ELT(output_names, 5, mkChar("incidence_rate"));
  SET_STRING_ELT(output_names, 6, mkChar("N"));
  SET_STRING_ELT(output_names, 7, mkChar("lambda"));
  SET_STRING_ELT(output_names, 8, mkChar("phi"));
  SET_STRING_ELT(output_names, 9, mkChar("notifiedandattended"));
  SET_STRING_ELT(output_names, 10, mkChar("prop_C_hesriskgroup"));
  SET_VECTOR_ELT(ret, 1, output_length);
  UNPROTECT(2);
  SET_VECTOR_ELT(ret, 2, ScalarInteger(internal->dim_eta + internal->dim_incidence_rate + internal->dim_lambda + internal->dim_N + internal->dim_notifiedandattended + internal->dim_phi + internal->dim_prop_C_hesgroup + internal->dim_prop_C_hesriskgroup + 3));
...
void model_rhs(model_internal* internal, double t, double * state, double * dstatedt, double * output) {
  ...
  if (output) {
    ...
    for (int i = 1; i <= internal->dim_incidence_rate_1; ++i) {
      for (int j = 1; j <= internal->dim_incidence_rate_2; ++j) {
        output[internal->offset_output_incidence_rate + i - 1 + internal->dim_incidence_rate_1 * (j - 1)] = odin_sum2(internal->n_UI, 0, internal->dim_n_UI_1, i - 1, i, internal->dim_n_UI_1) / (double) odin_sum2(U, 0, internal->dim_U_1, i - 1, i, internal->dim_U_1);
      }
    }
...
SEXP model_rhs_r(SEXP internal_p, SEXP t, SEXP state) {
  ...
  model_internal *internal = model_get_internal(internal_p, 1);
  SEXP output_ptr = PROTECT(allocVector(REALSXP, internal->dim_eta + internal->dim_incidence_rate + internal->dim_lambda + internal->dim_N + internal->dim_notifiedandattended + internal->dim_phi + internal->dim_prop_C_hesgroup + internal->dim_prop_C_hesriskgroup + 3));
