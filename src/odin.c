...
SEXP model_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 449));
  ...
  SET_VECTOR_ELT(contents, 102, ScalarInteger(internal->dim_N_hesgroup));
  SET_VECTOR_ELT(contents, 103, ScalarInteger(internal->dim_N_hesgroup_1));
  SET_VECTOR_ELT(contents, 104, ScalarInteger(internal->dim_N_hesgroup_12));
  SET_VECTOR_ELT(contents, 105, ScalarInteger(internal->dim_N_hesgroup_2));
  SET_VECTOR_ELT(contents, 106, ScalarInteger(internal->dim_N_hesgroup_3));
  SET_VECTOR_ELT(contents, 107, ScalarInteger(internal->dim_n_obe));
  SET_VECTOR_ELT(contents, 108, ScalarInteger(internal->dim_n_obe_1));
  SET_VECTOR_ELT(contents, 109, ScalarInteger(internal->dim_n_obe_12));
  SET_VECTOR_ELT(contents, 110, ScalarInteger(internal->dim_n_obe_2));
  SET_VECTOR_ELT(contents, 111, ScalarInteger(internal->dim_n_obe_3));
  SET_VECTOR_ELT(contents, 112, ScalarInteger(internal->dim_n_ood));
  SET_VECTOR_ELT(contents, 113, ScalarInteger(internal->dim_n_ood_1));
  SET_VECTOR_ELT(contents, 114, ScalarInteger(internal->dim_n_ood_12));
  SET_VECTOR_ELT(contents, 115, ScalarInteger(internal->dim_n_ood_2));
  SET_VECTOR_ELT(contents, 116, ScalarInteger(internal->dim_n_ood_3));
  SET_VECTOR_ELT(contents, 117, ScalarInteger(internal->dim_n_oopn));
  SET_VECTOR_ELT(contents, 118, ScalarInteger(internal->dim_n_oopn_1));
  SET_VECTOR_ELT(contents, 119, ScalarInteger(internal->dim_n_oopn_12));
  SET_VECTOR_ELT(contents, 120, ScalarInteger(internal->dim_n_oopn_2));
  SET_VECTOR_ELT(contents, 121, ScalarInteger(internal->dim_n_oopn_3));
  SET_VECTOR_ELT(contents, 122, ScalarInteger(internal->dim_n_oos));
  SET_VECTOR_ELT(contents, 123, ScalarInteger(internal->dim_n_oos_1));
  SET_VECTOR_ELT(contents, 124, ScalarInteger(internal->dim_n_oos_12));
  SET_VECTOR_ELT(contents, 125, ScalarInteger(internal->dim_n_oos_2));
  SET_VECTOR_ELT(contents, 126, ScalarInteger(internal->dim_n_oos_3));
  SET_VECTOR_ELT(contents, 127, ScalarInteger(internal->dim_n_ST));
  SET_VECTOR_ELT(contents, 128, ScalarInteger(internal->dim_n_ST_1));
  SET_VECTOR_ELT(contents, 129, ScalarInteger(internal->dim_n_ST_2));
  SET_VECTOR_ELT(contents, 130, ScalarInteger(internal->dim_n_TU));
  SET_VECTOR_ELT(contents, 131, ScalarInteger(internal->dim_n_TU_1));
  SET_VECTOR_ELT(contents, 132, ScalarInteger(internal->dim_n_TU_2));
  SET_VECTOR_ELT(contents, 133, ScalarInteger(internal->dim_n_UI));
  SET_VECTOR_ELT(contents, 134, ScalarInteger(internal->dim_n_UI_1));
  SET_VECTOR_ELT(contents, 135, ScalarInteger(internal->dim_n_UI_2));
  SET_VECTOR_ELT(contents, 136, ScalarInteger(internal->dim_n_vbe));
  SET_VECTOR_ELT(contents, 137, ScalarInteger(internal->dim_n_vbe_1));
  SET_VECTOR_ELT(contents, 138, ScalarInteger(internal->dim_n_vbe_12));
  ...
  SET_VECTOR_ELT(contents, 141, ScalarInteger(internal->dim_n_vod));
  SET_VECTOR_ELT(contents, 142, ScalarInteger(internal->dim_n_vod_1));
  SET_VECTOR_ELT(contents, 143, ScalarInteger(internal->dim_n_vod_12));
  SET_VECTOR_ELT(contents, 144, ScalarInteger(internal->dim_n_vod_2));
  SET_VECTOR_ELT(contents, 145, ScalarInteger(internal->dim_n_vod_3));
  SET_VECTOR_ELT(contents, 146, ScalarInteger(internal->dim_n_vopn));
  SET_VECTOR_ELT(contents, 147, ScalarInteger(internal->dim_n_vopn_1));
  SET_VECTOR_ELT(contents, 148, ScalarInteger(internal->dim_n_vopn_12));
  SET_VECTOR_ELT(contents, 149, ScalarInteger(internal->dim_n_vopn_2));
  SET_VECTOR_ELT(contents, 150, ScalarInteger(internal->dim_n_vopn_3));
  SET_VECTOR_ELT(contents, 151, ScalarInteger(internal->dim_n_vos));
  SET_VECTOR_ELT(contents, 152, ScalarInteger(internal->dim_n_vos_1));
  SET_VECTOR_ELT(contents, 153, ScalarInteger(internal->dim_n_vos_12));
  SET_VECTOR_ELT(contents, 154, ScalarInteger(internal->dim_n_vos_2));
  SET_VECTOR_ELT(contents, 155, ScalarInteger(internal->dim_n_vos_3));
  SET_VECTOR_ELT(contents, 156, ScalarInteger(internal->dim_notifiedandattended));
  SET_VECTOR_ELT(contents, 157, ScalarInteger(internal->dim_notifiedandattended_1));
  SET_VECTOR_ELT(contents, 158, ScalarInteger(internal->dim_notifiedandattended_2));
  SET_VECTOR_ELT(contents, 159, ScalarInteger(internal->dim_Np));
  SET_VECTOR_ELT(contents, 160, ScalarInteger(internal->dim_omega_C));
  SET_VECTOR_ELT(contents, 161, ScalarInteger(internal->dim_omega_C_1));
  SET_VECTOR_ELT(contents, 162, ScalarInteger(internal->dim_omega_C_2));
  SET_VECTOR_ELT(contents, 163, ScalarInteger(internal->dim_omega_C_withdiag));
  SET_VECTOR_ELT(contents, 164, ScalarInteger(internal->dim_omega_C_withdiag_1));
  SET_VECTOR_ELT(contents, 165, ScalarInteger(internal->dim_omega_C_withdiag_2));
  SET_VECTOR_ELT(contents, 166, ScalarInteger(internal->dim_omega_C_withdiag_rg));
  SET_VECTOR_ELT(contents, 167, ScalarInteger(internal->dim_omega_U));
  SET_VECTOR_ELT(contents, 168, ScalarInteger(internal->dim_omega_U_1));
  SET_VECTOR_ELT(contents, 169, ScalarInteger(internal->dim_omega_U_2));
  SET_VECTOR_ELT(contents, 170, ScalarInteger(internal->dim_omega_U_withdiag));
  SET_VECTOR_ELT(contents, 171, ScalarInteger(internal->dim_omega_U_withdiag_1));
  SET_VECTOR_ELT(contents, 172, ScalarInteger(internal->dim_omega_U_withdiag_2));
  SET_VECTOR_ELT(contents, 173, ScalarInteger(internal->dim_omega_U_withdiag_rg));
  SET_VECTOR_ELT(contents, 174, ScalarInteger(internal->dim_p));
  SET_VECTOR_ELT(contents, 175, ScalarInteger(internal->dim_phi));
  SET_VECTOR_ELT(contents, 176, ScalarInteger(internal->dim_phi_1));
  SET_VECTOR_ELT(contents, 177, ScalarInteger(internal->dim_phi_2));
  SET_VECTOR_ELT(contents, 178, ScalarInteger(internal->dim_prop_C));
  SET_VECTOR_ELT(contents, 179, ScalarInteger(internal->dim_prop_C_hesgroup));
  SET_VECTOR_ELT(contents, 180, ScalarInteger(internal->dim_prop_C_hesriskgroup));
  SET_VECTOR_ELT(contents, 181, ScalarInteger(internal->dim_prop_C_hesriskgroup_1));
  SET_VECTOR_ELT(contents, 182, ScalarInteger(internal->dim_prop_C_hesriskgroup_2));
  SET_VECTOR_ELT(contents, 183, ScalarInteger(internal->dim_prop_CCsubgroup));
  SET_VECTOR_ELT(contents, 184, ScalarInteger(internal->dim_prop_CCsubgroup_1));
  SET_VECTOR_ELT(contents, 185, ScalarInteger(internal->dim_prop_CCsubgroup_2));
  SET_VECTOR_ELT(contents, 186, ScalarInteger(internal->dim_prop_UUsubgroup));
  SET_VECTOR_ELT(contents, 187, ScalarInteger(internal->dim_prop_UUsubgroup_1));
  SET_VECTOR_ELT(contents, 188, ScalarInteger(internal->dim_prop_UUsubgroup_2));
  SET_VECTOR_ELT(contents, 189, ScalarInteger(internal->dim_q));
  SET_VECTOR_ELT(contents, 190, ScalarInteger(internal->dim_S));
  SET_VECTOR_ELT(contents, 191, ScalarInteger(internal->dim_S_1));
  SET_VECTOR_ELT(contents, 192, ScalarInteger(internal->dim_S_2));
  SET_VECTOR_ELT(contents, 193, ScalarInteger(internal->dim_S0));
  SET_VECTOR_ELT(contents, 194, ScalarInteger(internal->dim_S0_1));
  SET_VECTOR_ELT(contents, 195, ScalarInteger(internal->dim_S0_2));
  SET_VECTOR_ELT(contents, 196, ScalarInteger(internal->dim_screened));
  SET_VECTOR_ELT(contents, 197, ScalarInteger(internal->dim_screened_1));
  SET_VECTOR_ELT(contents, 198, ScalarInteger(internal->dim_screened_2));
  SET_VECTOR_ELT(contents, 199, ScalarInteger(internal->dim_T));
  SET_VECTOR_ELT(contents, 200, ScalarInteger(internal->dim_T_1));
  SET_VECTOR_ELT(contents, 201, ScalarInteger(internal->dim_T_2));
  SET_VECTOR_ELT(contents, 202, ScalarInteger(internal->dim_T0));
  SET_VECTOR_ELT(contents, 203, ScalarInteger(internal->dim_T0_1));
  SET_VECTOR_ELT(contents, 204, ScalarInteger(internal->dim_T0_2));
  SET_VECTOR_ELT(contents, 205, ScalarInteger(internal->dim_tt));
  SET_VECTOR_ELT(contents, 206, ScalarInteger(internal->dim_U));
  SET_VECTOR_ELT(contents, 207, ScalarInteger(internal->dim_U_1));
  SET_VECTOR_ELT(contents, 208, ScalarInteger(internal->dim_U_2));
  SET_VECTOR_ELT(contents, 209, ScalarInteger(internal->dim_u_d));
  SET_VECTOR_ELT(contents, 210, ScalarInteger(internal->dim_u_d_1));
  SET_VECTOR_ELT(contents, 211, ScalarInteger(internal->dim_u_d_12));
  SET_VECTOR_ELT(contents, 212, ScalarInteger(internal->dim_u_d_2));
  SET_VECTOR_ELT(contents, 213, ScalarInteger(internal->dim_u_d_3));
  SET_VECTOR_ELT(contents, 214, ScalarInteger(internal->dim_u_pn));
  SET_VECTOR_ELT(contents, 215, ScalarInteger(internal->dim_u_pn_1));
  SET_VECTOR_ELT(contents, 216, ScalarInteger(internal->dim_u_pn_12));
  SET_VECTOR_ELT(contents, 217, ScalarInteger(internal->dim_u_pn_2));
  SET_VECTOR_ELT(contents, 218, ScalarInteger(internal->dim_u_pn_3));
  SET_VECTOR_ELT(contents, 219, ScalarInteger(internal->dim_u_s));
  SET_VECTOR_ELT(contents, 220, ScalarInteger(internal->dim_u_s_1));
  SET_VECTOR_ELT(contents, 221, ScalarInteger(internal->dim_u_s_12));
  SET_VECTOR_ELT(contents, 222, ScalarInteger(internal->dim_u_s_2));
  SET_VECTOR_ELT(contents, 223, ScalarInteger(internal->dim_u_s_3));
  SET_VECTOR_ELT(contents, 224, ScalarInteger(internal->dim_U0));
  SET_VECTOR_ELT(contents, 225, ScalarInteger(internal->dim_U0_1));
  SET_VECTOR_ELT(contents, 226, ScalarInteger(internal->dim_U0_2));
  SET_VECTOR_ELT(contents, 227, ScalarInteger(internal->dim_Up));
  SET_VECTOR_ELT(contents, 228, ScalarInteger(internal->dim_vax_t));
  SET_VECTOR_ELT(contents, 229, ScalarInteger(internal->dim_vax_y));
  SET_VECTOR_ELT(contents, 230, ScalarInteger(internal->dim_vbe));
  SET_VECTOR_ELT(contents, 231, ScalarInteger(internal->dim_vbe_1));
  SET_VECTOR_ELT(contents, 232, ScalarInteger(internal->dim_vbe_12));
  SET_VECTOR_ELT(contents, 233, ScalarInteger(internal->dim_vbe_2));
  SET_VECTOR_ELT(contents, 234, ScalarInteger(internal->dim_vbe_3));
  SET_VECTOR_ELT(contents, 235, ScalarInteger(internal->dim_vea));
  SET_VECTOR_ELT(contents, 236, ScalarInteger(internal->dim_ved));
  SET_VECTOR_ELT(contents, 237, ScalarInteger(internal->dim_vei));
  SET_VECTOR_ELT(contents, 238, ScalarInteger(internal->dim_ves));
  SET_VECTOR_ELT(contents, 239, ScalarInteger(internal->dim_vod));
  SET_VECTOR_ELT(contents, 240, ScalarInteger(internal->dim_vod_1));
  SET_VECTOR_ELT(contents, 241, ScalarInteger(internal->dim_vod_12));
  SET_VECTOR_ELT(contents, 242, ScalarInteger(internal->dim_vod_2));
  SET_VECTOR_ELT(contents, 243, ScalarInteger(internal->dim_vod_3));
  SET_VECTOR_ELT(contents, 244, ScalarInteger(internal->dim_vopn));
  SET_VECTOR_ELT(contents, 245, ScalarInteger(internal->dim_vopn_1));
  SET_VECTOR_ELT(contents, 246, ScalarInteger(internal->dim_vopn_12));
  SET_VECTOR_ELT(contents, 247, ScalarInteger(internal->dim_vopn_2));
  SET_VECTOR_ELT(contents, 248, ScalarInteger(internal->dim_vopn_3));
  SET_VECTOR_ELT(contents, 249, ScalarInteger(internal->dim_vos));
  SET_VECTOR_ELT(contents, 250, ScalarInteger(internal->dim_vos_1));
  SET_VECTOR_ELT(contents, 251, ScalarInteger(internal->dim_vos_12));
  SET_VECTOR_ELT(contents, 252, ScalarInteger(internal->dim_vos_2));
  SET_VECTOR_ELT(contents, 253, ScalarInteger(internal->dim_vos_3));
  SET_VECTOR_ELT(contents, 254, ScalarInteger(internal->dim_w));
  SET_VECTOR_ELT(contents, 255, ScalarInteger(internal->dim_w_1));
  SET_VECTOR_ELT(contents, 256, ScalarInteger(internal->dim_w_2));
  SET_VECTOR_ELT(contents, 257, ScalarInteger(internal->dim_wA));
  SET_VECTOR_ELT(contents, 258, ScalarInteger(internal->dim_wA_1));
  SET_VECTOR_ELT(contents, 259, ScalarInteger(internal->dim_wA_12));
  SET_VECTOR_ELT(contents, 260, ScalarInteger(internal->dim_wA_2));
  SET_VECTOR_ELT(contents, 261, ScalarInteger(internal->dim_wA_3));
  SET_VECTOR_ELT(contents, 262, ScalarInteger(internal->dim_wd));
  SET_VECTOR_ELT(contents, 263, ScalarInteger(internal->dim_wd_1));
  SET_VECTOR_ELT(contents, 264, ScalarInteger(internal->dim_wd_2));
  SET_VECTOR_ELT(contents, 265, ScalarInteger(internal->dim_wdA));
  SET_VECTOR_ELT(contents, 266, ScalarInteger(internal->dim_wdA_1));
  SET_VECTOR_ELT(contents, 267, ScalarInteger(internal->dim_wdA_12));
  SET_VECTOR_ELT(contents, 268, ScalarInteger(internal->dim_wdA_2));
  SET_VECTOR_ELT(contents, 269, ScalarInteger(internal->dim_wdA_3));
  SET_VECTOR_ELT(contents, 270, ScalarInteger(internal->dim_wdI));
  SET_VECTOR_ELT(contents, 271, ScalarInteger(internal->dim_wdI_1));
  SET_VECTOR_ELT(contents, 272, ScalarInteger(internal->dim_wdI_12));
  SET_VECTOR_ELT(contents, 273, ScalarInteger(internal->dim_wdI_2));
  SET_VECTOR_ELT(contents, 274, ScalarInteger(internal->dim_wdI_3));
  SET_VECTOR_ELT(contents, 275, ScalarInteger(internal->dim_wdS));
  SET_VECTOR_ELT(contents, 276, ScalarInteger(internal->dim_wdS_1));
  SET_VECTOR_ELT(contents, 277, ScalarInteger(internal->dim_wdS_12));
  SET_VECTOR_ELT(contents, 278, ScalarInteger(internal->dim_wdS_2));
  SET_VECTOR_ELT(contents, 279, ScalarInteger(internal->dim_wdS_3));
  SET_VECTOR_ELT(contents, 280, ScalarInteger(internal->dim_wdT));
  SET_VECTOR_ELT(contents, 281, ScalarInteger(internal->dim_wdT_1));
  SET_VECTOR_ELT(contents, 282, ScalarInteger(internal->dim_wdT_12));
  SET_VECTOR_ELT(contents, 283, ScalarInteger(internal->dim_wdT_2));
  SET_VECTOR_ELT(contents, 284, ScalarInteger(internal->dim_wdT_3));
  SET_VECTOR_ELT(contents, 285, ScalarInteger(internal->dim_wdU));
  SET_VECTOR_ELT(contents, 286, ScalarInteger(internal->dim_wdU_1));
  SET_VECTOR_ELT(contents, 287, ScalarInteger(internal->dim_wdU_12));
  SET_VECTOR_ELT(contents, 288, ScalarInteger(internal->dim_wdU_2));
  SET_VECTOR_ELT(contents, 289, ScalarInteger(internal->dim_wdU_3));
  SET_VECTOR_ELT(contents, 290, ScalarInteger(internal->dim_wI));
  SET_VECTOR_ELT(contents, 291, ScalarInteger(internal->dim_wI_1));
  SET_VECTOR_ELT(contents, 292, ScalarInteger(internal->dim_wI_12));
  SET_VECTOR_ELT(contents, 293, ScalarInteger(internal->dim_wI_2));
  SET_VECTOR_ELT(contents, 294, ScalarInteger(internal->dim_wI_3));
  SET_VECTOR_ELT(contents, 295, ScalarInteger(internal->dim_willing));
  SET_VECTOR_ELT(contents, 296, ScalarInteger(internal->dim_wS));
  SET_VECTOR_ELT(contents, 297, ScalarInteger(internal->dim_wS_1));
  SET_VECTOR_ELT(contents, 298, ScalarInteger(internal->dim_wS_12));
  SET_VECTOR_ELT(contents, 299, ScalarInteger(internal->dim_wS_2));
  SET_VECTOR_ELT(contents, 300, ScalarInteger(internal->dim_wS_3));
  SET_VECTOR_ELT(contents, 301, ScalarInteger(internal->dim_wT));
  SET_VECTOR_ELT(contents, 302, ScalarInteger(internal->dim_wT_1));
  SET_VECTOR_ELT(contents, 303, ScalarInteger(internal->dim_wT_12));
  SET_VECTOR_ELT(contents, 304, ScalarInteger(internal->dim_wT_2));
  SET_VECTOR_ELT(contents, 305, ScalarInteger(internal->dim_wT_3));
  SET_VECTOR_ELT(contents, 306, ScalarInteger(internal->dim_wU));
  SET_VECTOR_ELT(contents, 307, ScalarInteger(internal->dim_wU_1));
  SET_VECTOR_ELT(contents, 308, ScalarInteger(internal->dim_wU_12));
  SET_VECTOR_ELT(contents, 309, ScalarInteger(internal->dim_wU_2));
  SET_VECTOR_ELT(contents, 310, ScalarInteger(internal->dim_wU_3));
  SET_VECTOR_ELT(contents, 311, ScalarInteger(internal->dim_xi));
  SET_VECTOR_ELT(contents, 312, ScalarInteger(internal->dim_xi_1));
  SET_VECTOR_ELT(contents, 313, ScalarInteger(internal->dim_xi_2));
  SET_VECTOR_ELT(contents, 314, ScalarReal(internal->enr));
  ...
  SET_VECTOR_ELT(contents, 315, entrants);
  SET_VECTOR_ELT(contents, 316, ScalarReal(internal->epsilon));
  SET_VECTOR_ELT(contents, 317, ScalarReal(internal->epsilon_hes));
  SEXP eta = PROTECT(allocVector(REALSXP, internal->dim_eta));
  memcpy(REAL(eta), internal->eta, internal->dim_eta * sizeof(double));
  SET_VECTOR_ELT(contents, 318, eta);
  ...
  SET_VECTOR_ELT(contents, 319, eta_h_t);
  ...
  SET_VECTOR_ELT(contents, 320, eta_l_t);
  SET_VECTOR_ELT(contents, 321, ScalarReal(internal->exr));
  ...
  SET_VECTOR_ELT(contents, 322, foi_LH);
  ...
  SET_VECTOR_ELT(contents, 323, hesgroupmatrix);
  ...
  SET_VECTOR_ELT(contents, 324, I0);
  ...
  SET_VECTOR_ELT(contents, 325, initial_A);
  ...
  SET_VECTOR_ELT(contents, 326, initial_cum_diag_a);
  ...
  SET_VECTOR_ELT(contents, 327, initial_cum_diag_s);
  ...
  SET_VECTOR_ELT(contents, 328, initial_cum_entrants);
  ...
  SET_VECTOR_ELT(contents, 329, initial_cum_incid);
  ...
  SET_VECTOR_ELT(contents, 330, initial_cum_lifeyears_U);
  ...
  SET_VECTOR_ELT(contents, 331, initial_cum_offered);
  ...
  SET_VECTOR_ELT(contents, 332, initial_cum_offered_pn);
  ...
  SET_VECTOR_ELT(contents, 333, initial_cum_offered_vbe);
  ...
  SET_VECTOR_ELT(contents, 334, initial_cum_screened);
  ...
  SET_VECTOR_ELT(contents, 335, initial_cum_treated);
  ...
  SET_VECTOR_ELT(contents, 336, initial_cum_vaccinated);
  ...
  SET_VECTOR_ELT(contents, 337, initial_cum_vaccinated_pn);
  ...
  SET_VECTOR_ELT(contents, 338, initial_cum_vaccinated_screen);
  ...
  SET_VECTOR_ELT(contents, 339, initial_cum_vbe);
  ...
  SET_VECTOR_ELT(contents, 340, initial_I);
  ...
  SET_VECTOR_ELT(contents, 341, initial_S);
  ...
  SET_VECTOR_ELT(contents, 342, initial_T);
  ...
  SET_VECTOR_ELT(contents, 343, initial_U);
  SET_VECTOR_ELT(contents, 348, ScalarReal(internal->kappa));
  ...
  SET_VECTOR_ELT(contents, 350, ScalarReal(internal->mu));
  ...
  SET_VECTOR_ELT(contents, 352, n_AT);
  ...
  SET_VECTOR_ELT(contents, 353, n_AU);
  ...
  SET_VECTOR_ELT(contents, 354, n_diag_rec);
  SET_VECTOR_ELT(contents, 355, ScalarInteger(internal->n_group));
  ...
  SET_VECTOR_ELT(contents, 356, N_hesgroup);
  ...
  SET_VECTOR_ELT(contents, 357, n_obe);
  ...
  SET_VECTOR_ELT(contents, 358, n_ood);
  ...
  SET_VECTOR_ELT(contents, 359, n_oopn);
  ...
  SET_VECTOR_ELT(contents, 360, n_oos);
  ...
  SET_VECTOR_ELT(contents, 361, n_ST);
  ...
  SET_VECTOR_ELT(contents, 362, n_TU);
  ...
  SET_VECTOR_ELT(contents, 363, n_UI);
  SET_VECTOR_ELT(contents, 364, ScalarInteger(internal->n_vax));
  ...
  SET_VECTOR_ELT(contents, 365, n_vbe);
  ...
  SET_VECTOR_ELT(contents, 366, n_vod);
  ...
  SET_VECTOR_ELT(contents, 367, n_vopn);
  ...
  SET_VECTOR_ELT(contents, 368, n_vos);
  ...
  SET_VECTOR_ELT(contents, 369, notifiedandattended);
  SET_VECTOR_ELT(contents, 370, ScalarReal(internal->notifiedprev));
  SEXP Np = PROTECT(allocVector(REALSXP, internal->dim_Np));
  memcpy(REAL(Np), internal->Np, internal->dim_Np * sizeof(double));
  SET_VECTOR_ELT(contents, 371, Np);
  SET_VECTOR_ELT(contents, 372, ScalarReal(internal->nu));
  SET_VECTOR_ELT(contents, 373, ScalarInteger(internal->offset_output_lambda));
  SET_VECTOR_ELT(contents, 374, ScalarInteger(internal->offset_output_N));
  SET_VECTOR_ELT(contents, 375, ScalarInteger(internal->offset_output_notifiedandattended));
  SET_VECTOR_ELT(contents, 376, ScalarInteger(internal->offset_output_phi));
  SET_VECTOR_ELT(contents, 377, ScalarInteger(internal->offset_output_prop_C_hesgroup));
  SET_VECTOR_ELT(contents, 378, ScalarInteger(internal->offset_output_prop_C_hesriskgroup));
  SET_VECTOR_ELT(contents, 379, ScalarInteger(internal->offset_variable_A));
  SET_VECTOR_ELT(contents, 380, ScalarInteger(internal->offset_variable_cum_diag_a));
  SET_VECTOR_ELT(contents, 381, ScalarInteger(internal->offset_variable_cum_diag_s));
  SET_VECTOR_ELT(contents, 382, ScalarInteger(internal->offset_variable_cum_entrants));
  SET_VECTOR_ELT(contents, 383, ScalarInteger(internal->offset_variable_cum_incid));
  SET_VECTOR_ELT(contents, 384, ScalarInteger(internal->offset_variable_cum_lifeyears_U));
  SET_VECTOR_ELT(contents, 385, ScalarInteger(internal->offset_variable_cum_offered));
  SET_VECTOR_ELT(contents, 386, ScalarInteger(internal->offset_variable_cum_offered_pn));
  SET_VECTOR_ELT(contents, 387, ScalarInteger(internal->offset_variable_cum_offered_vbe));
  SET_VECTOR_ELT(contents, 388, ScalarInteger(internal->offset_variable_cum_screened));
  SET_VECTOR_ELT(contents, 389, ScalarInteger(internal->offset_variable_cum_treated));
  SET_VECTOR_ELT(contents, 390, ScalarInteger(internal->offset_variable_cum_vaccinated));
  SET_VECTOR_ELT(contents, 391, ScalarInteger(internal->offset_variable_cum_vaccinated_pn));
  SET_VECTOR_ELT(contents, 392, ScalarInteger(internal->offset_variable_cum_vaccinated_screen));
  SET_VECTOR_ELT(contents, 393, ScalarInteger(internal->offset_variable_cum_vbe));
  SET_VECTOR_ELT(contents, 394, ScalarInteger(internal->offset_variable_S));
  SET_VECTOR_ELT(contents, 395, ScalarInteger(internal->offset_variable_T));
  ...
  SET_VECTOR_ELT(contents, 396, omega_C);
  ...
  SET_VECTOR_ELT(contents, 397, omega_C_withdiag);
  ...
  SET_VECTOR_ELT(contents, 398, omega_C_withdiag_rg);
  ...
  SET_VECTOR_ELT(contents, 399, omega_U);
  ...
  SET_VECTOR_ELT(contents, 400, omega_U_withdiag);
  ...
  SET_VECTOR_ELT(contents, 403, phi);
  ...
  SET_VECTOR_ELT(contents, 404, prop_C);
  ...
  SET_VECTOR_ELT(contents, 405, prop_C_hesgroup);
  ...
  SET_VECTOR_ELT(contents, 406, prop_C_hesriskgroup);
  ...
  SET_VECTOR_ELT(contents, 407, prop_CCsubgroup);
  ...
  SET_VECTOR_ELT(contents, 408, prop_UUsubgroup);
  SET_VECTOR_ELT(contents, 409, ScalarReal(internal->psi));
  SEXP q = PROTECT(allocVector(REALSXP, internal->dim_q));
  memcpy(REAL(q), internal->q, internal->dim_q * sizeof(double));
  SET_VECTOR_ELT(contents, 410, q);
  SET_VECTOR_ELT(contents, 411, ScalarReal(internal->rho));
  ...
  SET_VECTOR_ELT(contents, 412, S0);
  ...
  SET_VECTOR_ELT(contents, 413, screened);
  SET_VECTOR_ELT(contents, 414, ScalarReal(internal->sigma));
  ...
  SET_VECTOR_ELT(contents, 417, u_d);
  ...
  SET_VECTOR_ELT(contents, 418, u_pn);
  ...
  SET_VECTOR_ELT(contents, 419, u_s);
  SET_VECTOR_ELT(contents, 420, ScalarReal(internal->u_vbe));
  ...
  SET_VECTOR_ELT(contents, 421, U0);
  SEXP Up = PROTECT(allocVector(REALSXP, internal->dim_Up));
  memcpy(REAL(Up), internal->Up, internal->dim_Up * sizeof(double));
  SET_VECTOR_ELT(contents, 422, Up);
  SET_VECTOR_ELT(contents, 423, ScalarReal(internal->vax_switch_2));
  SET_VECTOR_ELT(contents, 424, ScalarReal(internal->vax_switch_3));
  ...
  SET_VECTOR_ELT(contents, 425, vax_t);
  ...
  SET_VECTOR_ELT(contents, 426, vax_y);
  ...
  SET_VECTOR_ELT(contents, 432, vod);
  ...
  SET_VECTOR_ELT(contents, 433, vopn);
  ...
  SET_VECTOR_ELT(contents, 434, vos);
  ...
  SET_VECTOR_ELT(contents, 436, wA);
  ...
  SET_VECTOR_ELT(contents, 437, wd);
  ...
  SET_VECTOR_ELT(contents, 438, wdA);
  ...
  SET_VECTOR_ELT(contents, 439, wdI);
  ...
  SET_VECTOR_ELT(contents, 440, wdS);
  ...
  SET_VECTOR_ELT(contents, 441, wdT);
  ...
  SET_VECTOR_ELT(contents, 442, wdU);
  ...
  SET_VECTOR_ELT(contents, 443, wI);
  ...
  SET_VECTOR_ELT(contents, 444, willing);
  ...
  SET_VECTOR_ELT(contents, 445, wS);
  ...
  SET_VECTOR_ELT(contents, 446, wT);
  ...
  SET_VECTOR_ELT(contents, 447, wU);
  ...
  SET_VECTOR_ELT(contents, 448, xi);
  SEXP nms = PROTECT(allocVector(STRSXP, 449));
  ...
  SET_STRING_ELT(nms, 102, mkChar("dim_N_hesgroup"));
  SET_STRING_ELT(nms, 103, mkChar("dim_N_hesgroup_1"));
  SET_STRING_ELT(nms, 104, mkChar("dim_N_hesgroup_12"));
  SET_STRING_ELT(nms, 105, mkChar("dim_N_hesgroup_2"));
  SET_STRING_ELT(nms, 106, mkChar("dim_N_hesgroup_3"));
  SET_STRING_ELT(nms, 107, mkChar("dim_n_obe"));
  SET_STRING_ELT(nms, 108, mkChar("dim_n_obe_1"));
  SET_STRING_ELT(nms, 109, mkChar("dim_n_obe_12"));
  SET_STRING_ELT(nms, 110, mkChar("dim_n_obe_2"));
  SET_STRING_ELT(nms, 111, mkChar("dim_n_obe_3"));
  SET_STRING_ELT(nms, 112, mkChar("dim_n_ood"));
  SET_STRING_ELT(nms, 113, mkChar("dim_n_ood_1"));
  SET_STRING_ELT(nms, 114, mkChar("dim_n_ood_12"));
  SET_STRING_ELT(nms, 115, mkChar("dim_n_ood_2"));
  SET_STRING_ELT(nms, 116, mkChar("dim_n_ood_3"));
  SET_STRING_ELT(nms, 117, mkChar("dim_n_oopn"));
  SET_STRING_ELT(nms, 118, mkChar("dim_n_oopn_1"));
  SET_STRING_ELT(nms, 119, mkChar("dim_n_oopn_12"));
  SET_STRING_ELT(nms, 120, mkChar("dim_n_oopn_2"));
  SET_STRING_ELT(nms, 121, mkChar("dim_n_oopn_3"));
  SET_STRING_ELT(nms, 122, mkChar("dim_n_oos"));
  SET_STRING_ELT(nms, 123, mkChar("dim_n_oos_1"));
  SET_STRING_ELT(nms, 124, mkChar("dim_n_oos_12"));
  SET_STRING_ELT(nms, 125, mkChar("dim_n_oos_2"));
  SET_STRING_ELT(nms, 126, mkChar("dim_n_oos_3"));
  SET_STRING_ELT(nms, 127, mkChar("dim_n_ST"));
  SET_STRING_ELT(nms, 128, mkChar("dim_n_ST_1"));
  SET_STRING_ELT(nms, 129, mkChar("dim_n_ST_2"));
  SET_STRING_ELT(nms, 130, mkChar("dim_n_TU"));
  SET_STRING_ELT(nms, 131, mkChar("dim_n_TU_1"));
  SET_STRING_ELT(nms, 132, mkChar("dim_n_TU_2"));
  SET_STRING_ELT(nms, 133, mkChar("dim_n_UI"));
  SET_STRING_ELT(nms, 134, mkChar("dim_n_UI_1"));
  SET_STRING_ELT(nms, 135, mkChar("dim_n_UI_2"));
  SET_STRING_ELT(nms, 136, mkChar("dim_n_vbe"));
  SET_STRING_ELT(nms, 137, mkChar("dim_n_vbe_1"));
  SET_STRING_ELT(nms, 138, mkChar("dim_n_vbe_12"));
  SET_STRING_ELT(nms, 139, mkChar("dim_n_vbe_2"));
  SET_STRING_ELT(nms, 140, mkChar("dim_n_vbe_3"));
  SET_STRING_ELT(nms, 141, mkChar("dim_n_vod"));
  SET_STRING_ELT(nms, 142, mkChar("dim_n_vod_1"));
  SET_STRING_ELT(nms, 143, mkChar("dim_n_vod_12"));
  SET_STRING_ELT(nms, 144, mkChar("dim_n_vod_2"));
  SET_STRING_ELT(nms, 145, mkChar("dim_n_vod_3"));
  SET_STRING_ELT(nms, 146, mkChar("dim_n_vopn"));
  SET_STRING_ELT(nms, 147, mkChar("dim_n_vopn_1"));
  SET_STRING_ELT(nms, 148, mkChar("dim_n_vopn_12"));
  SET_STRING_ELT(nms, 149, mkChar("dim_n_vopn_2"));
  SET_STRING_ELT(nms, 150, mkChar("dim_n_vopn_3"));
  SET_STRING_ELT(nms, 151, mkChar("dim_n_vos"));
  SET_STRING_ELT(nms, 152, mkChar("dim_n_vos_1"));
  SET_STRING_ELT(nms, 153, mkChar("dim_n_vos_12"));
  SET_STRING_ELT(nms, 154, mkChar("dim_n_vos_2"));
  SET_STRING_ELT(nms, 155, mkChar("dim_n_vos_3"));
  SET_STRING_ELT(nms, 156, mkChar("dim_notifiedandattended"));
  SET_STRING_ELT(nms, 157, mkChar("dim_notifiedandattended_1"));
  SET_STRING_ELT(nms, 158, mkChar("dim_notifiedandattended_2"));
  SET_STRING_ELT(nms, 159, mkChar("dim_Np"));
  SET_STRING_ELT(nms, 160, mkChar("dim_omega_C"));
  SET_STRING_ELT(nms, 161, mkChar("dim_omega_C_1"));
  SET_STRING_ELT(nms, 162, mkChar("dim_omega_C_2"));
  SET_STRING_ELT(nms, 163, mkChar("dim_omega_C_withdiag"));
  SET_STRING_ELT(nms, 164, mkChar("dim_omega_C_withdiag_1"));
  SET_STRING_ELT(nms, 165, mkChar("dim_omega_C_withdiag_2"));
  SET_STRING_ELT(nms, 166, mkChar("dim_omega_C_withdiag_rg"));
  SET_STRING_ELT(nms, 167, mkChar("dim_omega_U"));
  SET_STRING_ELT(nms, 168, mkChar("dim_omega_U_1"));
  SET_STRING_ELT(nms, 169, mkChar("dim_omega_U_2"));
  SET_STRING_ELT(nms, 170, mkChar("dim_omega_U_withdiag"));
  SET_STRING_ELT(nms, 171, mkChar("dim_omega_U_withdiag_1"));
  SET_STRING_ELT(nms, 172, mkChar("dim_omega_U_withdiag_2"));
  SET_STRING_ELT(nms, 173, mkChar("dim_omega_U_withdiag_rg"));
  SET_STRING_ELT(nms, 174, mkChar("dim_p"));
  SET_STRING_ELT(nms, 175, mkChar("dim_phi"));
  SET_STRING_ELT(nms, 176, mkChar("dim_phi_1"));
  SET_STRING_ELT(nms, 177, mkChar("dim_phi_2"));
  SET_STRING_ELT(nms, 178, mkChar("dim_prop_C"));
  SET_STRING_ELT(nms, 179, mkChar("dim_prop_C_hesgroup"));
  SET_STRING_ELT(nms, 180, mkChar("dim_prop_C_hesriskgroup"));
  SET_STRING_ELT(nms, 181, mkChar("dim_prop_C_hesriskgroup_1"));
  SET_STRING_ELT(nms, 182, mkChar("dim_prop_C_hesriskgroup_2"));
  SET_STRING_ELT(nms, 183, mkChar("dim_prop_CCsubgroup"));
  SET_STRING_ELT(nms, 184, mkChar("dim_prop_CCsubgroup_1"));
  SET_STRING_ELT(nms, 185, mkChar("dim_prop_CCsubgroup_2"));
  SET_STRING_ELT(nms, 186, mkChar("dim_prop_UUsubgroup"));
  SET_STRING_ELT(nms, 187, mkChar("dim_prop_UUsubgroup_1"));
  SET_STRING_ELT(nms, 188, mkChar("dim_prop_UUsubgroup_2"));
  SET_STRING_ELT(nms, 189, mkChar("dim_q"));
  SET_STRING_ELT(nms, 190, mkChar("dim_S"));
  SET_STRING_ELT(nms, 191, mkChar("dim_S_1"));
  SET_STRING_ELT(nms, 192, mkChar("dim_S_2"));
  SET_STRING_ELT(nms, 193, mkChar("dim_S0"));
  SET_STRING_ELT(nms, 194, mkChar("dim_S0_1"));
  SET_STRING_ELT(nms, 195, mkChar("dim_S0_2"));
  SET_STRING_ELT(nms, 196, mkChar("dim_screened"));
  SET_STRING_ELT(nms, 197, mkChar("dim_screened_1"));
  SET_STRING_ELT(nms, 198, mkChar("dim_screened_2"));
  SET_STRING_ELT(nms, 199, mkChar("dim_T"));
  SET_STRING_ELT(nms, 200, mkChar("dim_T_1"));
  SET_STRING_ELT(nms, 201, mkChar("dim_T_2"));
  SET_STRING_ELT(nms, 202, mkChar("dim_T0"));
  SET_STRING_ELT(nms, 203, mkChar("dim_T0_1"));
  SET_STRING_ELT(nms, 204, mkChar("dim_T0_2"));
  SET_STRING_ELT(nms, 205, mkChar("dim_tt"));
  SET_STRING_ELT(nms, 206, mkChar("dim_U"));
  SET_STRING_ELT(nms, 207, mkChar("dim_U_1"));
  SET_STRING_ELT(nms, 208, mkChar("dim_U_2"));
  SET_STRING_ELT(nms, 209, mkChar("dim_u_d"));
  SET_STRING_ELT(nms, 210, mkChar("dim_u_d_1"));
  SET_STRING_ELT(nms, 211, mkChar("dim_u_d_12"));
  SET_STRING_ELT(nms, 212, mkChar("dim_u_d_2"));
  SET_STRING_ELT(nms, 213, mkChar("dim_u_d_3"));
  SET_STRING_ELT(nms, 214, mkChar("dim_u_pn"));
  SET_STRING_ELT(nms, 215, mkChar("dim_u_pn_1"));
  SET_STRING_ELT(nms, 216, mkChar("dim_u_pn_12"));
  SET_STRING_ELT(nms, 217, mkChar("dim_u_pn_2"));
  SET_STRING_ELT(nms, 218, mkChar("dim_u_pn_3"));
  SET_STRING_ELT(nms, 219, mkChar("dim_u_s"));
  SET_STRING_ELT(nms, 220, mkChar("dim_u_s_1"));
  SET_STRING_ELT(nms, 221, mkChar("dim_u_s_12"));
  SET_STRING_ELT(nms, 222, mkChar("dim_u_s_2"));
  SET_STRING_ELT(nms, 223, mkChar("dim_u_s_3"));
  SET_STRING_ELT(nms, 224, mkChar("dim_U0"));
  SET_STRING_ELT(nms, 225, mkChar("dim_U0_1"));
  SET_STRING_ELT(nms, 226, mkChar("dim_U0_2"));
  SET_STRING_ELT(nms, 227, mkChar("dim_Up"));
  SET_STRING_ELT(nms, 228, mkChar("dim_vax_t"));
  SET_STRING_ELT(nms, 229, mkChar("dim_vax_y"));
  SET_STRING_ELT(nms, 230, mkChar("dim_vbe"));
  SET_STRING_ELT(nms, 231, mkChar("dim_vbe_1"));
  SET_STRING_ELT(nms, 232, mkChar("dim_vbe_12"));
  SET_STRING_ELT(nms, 233, mkChar("dim_vbe_2"));
  SET_STRING_ELT(nms, 234, mkChar("dim_vbe_3"));
  SET_STRING_ELT(nms, 235, mkChar("dim_vea"));
  SET_STRING_ELT(nms, 236, mkChar("dim_ved"));
  SET_STRING_ELT(nms, 237, mkChar("dim_vei"));
  SET_STRING_ELT(nms, 238, mkChar("dim_ves"));
  SET_STRING_ELT(nms, 239, mkChar("dim_vod"));
  SET_STRING_ELT(nms, 240, mkChar("dim_vod_1"));
  SET_STRING_ELT(nms, 241, mkChar("dim_vod_12"));
  SET_STRING_ELT(nms, 242, mkChar("dim_vod_2"));
  SET_STRING_ELT(nms, 243, mkChar("dim_vod_3"));
  SET_STRING_ELT(nms, 244, mkChar("dim_vopn"));
  SET_STRING_ELT(nms, 245, mkChar("dim_vopn_1"));
  SET_STRING_ELT(nms, 246, mkChar("dim_vopn_12"));
  SET_STRING_ELT(nms, 247, mkChar("dim_vopn_2"));
  SET_STRING_ELT(nms, 248, mkChar("dim_vopn_3"));
  SET_STRING_ELT(nms, 249, mkChar("dim_vos"));
  SET_STRING_ELT(nms, 250, mkChar("dim_vos_1"));
  SET_STRING_ELT(nms, 251, mkChar("dim_vos_12"));
  SET_STRING_ELT(nms, 252, mkChar("dim_vos_2"));
  SET_STRING_ELT(nms, 253, mkChar("dim_vos_3"));
  SET_STRING_ELT(nms, 254, mkChar("dim_w"));
  SET_STRING_ELT(nms, 255, mkChar("dim_w_1"));
  SET_STRING_ELT(nms, 256, mkChar("dim_w_2"));
  SET_STRING_ELT(nms, 257, mkChar("dim_wA"));
  SET_STRING_ELT(nms, 258, mkChar("dim_wA_1"));
  SET_STRING_ELT(nms, 259, mkChar("dim_wA_12"));
  SET_STRING_ELT(nms, 260, mkChar("dim_wA_2"));
  SET_STRING_ELT(nms, 261, mkChar("dim_wA_3"));
  SET_STRING_ELT(nms, 262, mkChar("dim_wd"));
  SET_STRING_ELT(nms, 263, mkChar("dim_wd_1"));
  SET_STRING_ELT(nms, 264, mkChar("dim_wd_2"));
  SET_STRING_ELT(nms, 265, mkChar("dim_wdA"));
  SET_STRING_ELT(nms, 266, mkChar("dim_wdA_1"));
  SET_STRING_ELT(nms, 267, mkChar("dim_wdA_12"));
  SET_STRING_ELT(nms, 268, mkChar("dim_wdA_2"));
  SET_STRING_ELT(nms, 269, mkChar("dim_wdA_3"));
  SET_STRING_ELT(nms, 270, mkChar("dim_wdI"));
  SET_STRING_ELT(nms, 271, mkChar("dim_wdI_1"));
  SET_STRING_ELT(nms, 272, mkChar("dim_wdI_12"));
  SET_STRING_ELT(nms, 273, mkChar("dim_wdI_2"));
  SET_STRING_ELT(nms, 274, mkChar("dim_wdI_3"));
  SET_STRING_ELT(nms, 275, mkChar("dim_wdS"));
  SET_STRING_ELT(nms, 276, mkChar("dim_wdS_1"));
  SET_STRING_ELT(nms, 277, mkChar("dim_wdS_12"));
  SET_STRING_ELT(nms, 278, mkChar("dim_wdS_2"));
  SET_STRING_ELT(nms, 279, mkChar("dim_wdS_3"));
  SET_STRING_ELT(nms, 280, mkChar("dim_wdT"));
  SET_STRING_ELT(nms, 281, mkChar("dim_wdT_1"));
  SET_STRING_ELT(nms, 282, mkChar("dim_wdT_12"));
  SET_STRING_ELT(nms, 283, mkChar("dim_wdT_2"));
  SET_STRING_ELT(nms, 284, mkChar("dim_wdT_3"));
  SET_STRING_ELT(nms, 285, mkChar("dim_wdU"));
  SET_STRING_ELT(nms, 286, mkChar("dim_wdU_1"));
  SET_STRING_ELT(nms, 287, mkChar("dim_wdU_12"));
  SET_STRING_ELT(nms, 288, mkChar("dim_wdU_2"));
  SET_STRING_ELT(nms, 289, mkChar("dim_wdU_3"));
  SET_STRING_ELT(nms, 290, mkChar("dim_wI"));
  SET_STRING_ELT(nms, 291, mkChar("dim_wI_1"));
  SET_STRING_ELT(nms, 292, mkChar("dim_wI_12"));
  SET_STRING_ELT(nms, 293, mkChar("dim_wI_2"));
  SET_STRING_ELT(nms, 294, mkChar("dim_wI_3"));
  SET_STRING_ELT(nms, 295, mkChar("dim_willing"));
  SET_STRING_ELT(nms, 296, mkChar("dim_wS"));
  SET_STRING_ELT(nms, 297, mkChar("dim_wS_1"));
  SET_STRING_ELT(nms, 298, mkChar("dim_wS_12"));
  SET_STRING_ELT(nms, 299, mkChar("dim_wS_2"));
  SET_STRING_ELT(nms, 300, mkChar("dim_wS_3"));
  SET_STRING_ELT(nms, 301, mkChar("dim_wT"));
  SET_STRING_ELT(nms, 302, mkChar("dim_wT_1"));
  SET_STRING_ELT(nms, 303, mkChar("dim_wT_12"));
  SET_STRING_ELT(nms, 304, mkChar("dim_wT_2"));
  SET_STRING_ELT(nms, 305, mkChar("dim_wT_3"));
  SET_STRING_ELT(nms, 306, mkChar("dim_wU"));
  SET_STRING_ELT(nms, 307, mkChar("dim_wU_1"));
  SET_STRING_ELT(nms, 308, mkChar("dim_wU_12"));
  SET_STRING_ELT(nms, 309, mkChar("dim_wU_2"));
  SET_STRING_ELT(nms, 310, mkChar("dim_wU_3"));
  SET_STRING_ELT(nms, 311, mkChar("dim_xi"));
  SET_STRING_ELT(nms, 312, mkChar("dim_xi_1"));
  SET_STRING_ELT(nms, 313, mkChar("dim_xi_2"));
  SET_STRING_ELT(nms, 314, mkChar("enr"));
  SET_STRING_ELT(nms, 315, mkChar("entrants"));
  SET_STRING_ELT(nms, 316, mkChar("epsilon"));
  SET_STRING_ELT(nms, 317, mkChar("epsilon_hes"));
  SET_STRING_ELT(nms, 318, mkChar("eta"));
  SET_STRING_ELT(nms, 319, mkChar("eta_h_t"));
  SET_STRING_ELT(nms, 320, mkChar("eta_l_t"));
  SET_STRING_ELT(nms, 321, mkChar("exr"));
  SET_STRING_ELT(nms, 322, mkChar("foi_LH"));
  SET_STRING_ELT(nms, 323, mkChar("hesgroupmatrix"));
  SET_STRING_ELT(nms, 324, mkChar("I0"));
  SET_STRING_ELT(nms, 325, mkChar("initial_A"));
  SET_STRING_ELT(nms, 326, mkChar("initial_cum_diag_a"));
  SET_STRING_ELT(nms, 327, mkChar("initial_cum_diag_s"));
  SET_STRING_ELT(nms, 328, mkChar("initial_cum_entrants"));
  SET_STRING_ELT(nms, 329, mkChar("initial_cum_incid"));
  SET_STRING_ELT(nms, 330, mkChar("initial_cum_lifeyears_U"));
  SET_STRING_ELT(nms, 331, mkChar("initial_cum_offered"));
  SET_STRING_ELT(nms, 332, mkChar("initial_cum_offered_pn"));
  SET_STRING_ELT(nms, 333, mkChar("initial_cum_offered_vbe"));
  SET_STRING_ELT(nms, 334, mkChar("initial_cum_screened"));
  SET_STRING_ELT(nms, 335, mkChar("initial_cum_treated"));
  SET_STRING_ELT(nms, 336, mkChar("initial_cum_vaccinated"));
  SET_STRING_ELT(nms, 337, mkChar("initial_cum_vaccinated_pn"));
  SET_STRING_ELT(nms, 338, mkChar("initial_cum_vaccinated_screen"));
  SET_STRING_ELT(nms, 339, mkChar("initial_cum_vbe"));
  SET_STRING_ELT(nms, 340, mkChar("initial_I"));
  SET_STRING_ELT(nms, 341, mkChar("initial_S"));
  SET_STRING_ELT(nms, 342, mkChar("initial_T"));
  SET_STRING_ELT(nms, 343, mkChar("initial_U"));
  SET_STRING_ELT(nms, 344, mkChar("interpolate_beta"));
  SET_STRING_ELT(nms, 345, mkChar("interpolate_eta_h"));
  SET_STRING_ELT(nms, 346, mkChar("interpolate_eta_l"));
  SET_STRING_ELT(nms, 347, mkChar("interpolate_vax_switch_1"));
  SET_STRING_ELT(nms, 348, mkChar("kappa"));
  SET_STRING_ELT(nms, 349, mkChar("lambda"));
  SET_STRING_ELT(nms, 350, mkChar("mu"));
  SET_STRING_ELT(nms, 351, mkChar("N"));
  SET_STRING_ELT(nms, 352, mkChar("n_AT"));
  SET_STRING_ELT(nms, 353, mkChar("n_AU"));
  SET_STRING_ELT(nms, 354, mkChar("n_diag_rec"));
  SET_STRING_ELT(nms, 355, mkChar("n_group"));
  SET_STRING_ELT(nms, 356, mkChar("N_hesgroup"));
  SET_STRING_ELT(nms, 357, mkChar("n_obe"));
  SET_STRING_ELT(nms, 358, mkChar("n_ood"));
  SET_STRING_ELT(nms, 359, mkChar("n_oopn"));
  SET_STRING_ELT(nms, 360, mkChar("n_oos"));
  SET_STRING_ELT(nms, 361, mkChar("n_ST"));
  SET_STRING_ELT(nms, 362, mkChar("n_TU"));
  SET_STRING_ELT(nms, 363, mkChar("n_UI"));
  SET_STRING_ELT(nms, 364, mkChar("n_vax"));
  SET_STRING_ELT(nms, 365, mkChar("n_vbe"));
  SET_STRING_ELT(nms, 366, mkChar("n_vod"));
  SET_STRING_ELT(nms, 367, mkChar("n_vopn"));
  SET_STRING_ELT(nms, 368, mkChar("n_vos"));
  SET_STRING_ELT(nms, 369, mkChar("notifiedandattended"));
  SET_STRING_ELT(nms, 370, mkChar("notifiedprev"));
  SET_STRING_ELT(nms, 371, mkChar("Np"));
  SET_STRING_ELT(nms, 372, mkChar("nu"));
  SET_STRING_ELT(nms, 373, mkChar("offset_output_lambda"));
  SET_STRING_ELT(nms, 374, mkChar("offset_output_N"));
  SET_STRING_ELT(nms, 375, mkChar("offset_output_notifiedandattended"));
  SET_STRING_ELT(nms, 376, mkChar("offset_output_phi"));
  SET_STRING_ELT(nms, 377, mkChar("offset_output_prop_C_hesgroup"));
  SET_STRING_ELT(nms, 378, mkChar("offset_output_prop_C_hesriskgroup"));
  SET_STRING_ELT(nms, 379, mkChar("offset_variable_A"));
  SET_STRING_ELT(nms, 380, mkChar("offset_variable_cum_diag_a"));
  SET_STRING_ELT(nms, 381, mkChar("offset_variable_cum_diag_s"));
  SET_STRING_ELT(nms, 382, mkChar("offset_variable_cum_entrants"));
  SET_STRING_ELT(nms, 383, mkChar("offset_variable_cum_incid"));
  SET_STRING_ELT(nms, 384, mkChar("offset_variable_cum_lifeyears_U"));
  SET_STRING_ELT(nms, 385, mkChar("offset_variable_cum_offered"));
  SET_STRING_ELT(nms, 386, mkChar("offset_variable_cum_offered_pn"));
  SET_STRING_ELT(nms, 387, mkChar("offset_variable_cum_offered_vbe"));
  SET_STRING_ELT(nms, 388, mkChar("offset_variable_cum_screened"));
  SET_STRING_ELT(nms, 389, mkChar("offset_variable_cum_treated"));
  SET_STRING_ELT(nms, 390, mkChar("offset_variable_cum_vaccinated"));
  SET_STRING_ELT(nms, 391, mkChar("offset_variable_cum_vaccinated_pn"));
  SET_STRING_ELT(nms, 392, mkChar("offset_variable_cum_vaccinated_screen"));
  SET_STRING_ELT(nms, 393, mkChar("offset_variable_cum_vbe"));
  SET_STRING_ELT(nms, 394, mkChar("offset_variable_S"));
  SET_STRING_ELT(nms, 395, mkChar("offset_variable_T"));
  SET_STRING_ELT(nms, 396, mkChar("omega_C"));
  SET_STRING_ELT(nms, 397, mkChar("omega_C_withdiag"));
  SET_STRING_ELT(nms, 398, mkChar("omega_C_withdiag_rg"));
  SET_STRING_ELT(nms, 399, mkChar("omega_U"));
  SET_STRING_ELT(nms, 400, mkChar("omega_U_withdiag"));
  SET_STRING_ELT(nms, 401, mkChar("omega_U_withdiag_rg"));
  SET_STRING_ELT(nms, 402, mkChar("p"));
  SET_STRING_ELT(nms, 403, mkChar("phi"));
  SET_STRING_ELT(nms, 404, mkChar("prop_C"));
  SET_STRING_ELT(nms, 405, mkChar("prop_C_hesgroup"));
  SET_STRING_ELT(nms, 406, mkChar("prop_C_hesriskgroup"));
  SET_STRING_ELT(nms, 407, mkChar("prop_CCsubgroup"));
  SET_STRING_ELT(nms, 408, mkChar("prop_UUsubgroup"));
  SET_STRING_ELT(nms, 409, mkChar("psi"));
  SET_STRING_ELT(nms, 410, mkChar("q"));
  SET_STRING_ELT(nms, 411, mkChar("rho"));
  SET_STRING_ELT(nms, 412, mkChar("S0"));
  SET_STRING_ELT(nms, 413, mkChar("screened"));
  SET_STRING_ELT(nms, 414, mkChar("sigma"));
  SET_STRING_ELT(nms, 415, mkChar("T0"));
  SET_STRING_ELT(nms, 416, mkChar("tt"));
  SET_STRING_ELT(nms, 417, mkChar("u_d"));
  SET_STRING_ELT(nms, 418, mkChar("u_pn"));
  SET_STRING_ELT(nms, 419, mkChar("u_s"));
  SET_STRING_ELT(nms, 420, mkChar("u_vbe"));
  SET_STRING_ELT(nms, 421, mkChar("U0"));
  SET_STRING_ELT(nms, 422, mkChar("Up"));
  SET_STRING_ELT(nms, 423, mkChar("vax_switch_2"));
  SET_STRING_ELT(nms, 424, mkChar("vax_switch_3"));
  SET_STRING_ELT(nms, 425, mkChar("vax_t"));
  SET_STRING_ELT(nms, 426, mkChar("vax_y"));
  SET_STRING_ELT(nms, 427, mkChar("vbe"));
  SET_STRING_ELT(nms, 428, mkChar("vea"));
  SET_STRING_ELT(nms, 429, mkChar("ved"));
  SET_STRING_ELT(nms, 430, mkChar("vei"));
  SET_STRING_ELT(nms, 431, mkChar("ves"));
  SET_STRING_ELT(nms, 432, mkChar("vod"));
  SET_STRING_ELT(nms, 433, mkChar("vopn"));
  SET_STRING_ELT(nms, 434, mkChar("vos"));
  SET_STRING_ELT(nms, 435, mkChar("w"));
  SET_STRING_ELT(nms, 436, mkChar("wA"));
  SET_STRING_ELT(nms, 437, mkChar("wd"));
  SET_STRING_ELT(nms, 438, mkChar("wdA"));
  SET_STRING_ELT(nms, 439, mkChar("wdI"));
  SET_STRING_ELT(nms, 440, mkChar("wdS"));
  SET_STRING_ELT(nms, 441, mkChar("wdT"));
  SET_STRING_ELT(nms, 442, mkChar("wdU"));
  SET_STRING_ELT(nms, 443, mkChar("wI"));
  SET_STRING_ELT(nms, 444, mkChar("willing"));
  SET_STRING_ELT(nms, 445, mkChar("wS"));
  SET_STRING_ELT(nms, 446, mkChar("wT"));
  SET_STRING_ELT(nms, 447, mkChar("wU"));
  SET_STRING_ELT(nms, 448, mkChar("xi"));
