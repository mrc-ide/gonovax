...
SEXP model_trial_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 154));
  SEXP A0 = PROTECT(allocVector(REALSXP, internal->dim_A0));
  memcpy(REAL(A0), internal->A0, internal->dim_A0 * sizeof(double));
  odin_set_dim(A0, 2, internal->dim_A0_1, internal->dim_A0_2);
  SET_VECTOR_ELT(contents, 0, A0);
  ...
  SET_VECTOR_ELT(contents, 62, ScalarInteger(internal->dim_tt));
  SET_VECTOR_ELT(contents, 63, ScalarInteger(internal->dim_U));
  SET_VECTOR_ELT(contents, 64, ScalarInteger(internal->dim_U_1));
  SET_VECTOR_ELT(contents, 65, ScalarInteger(internal->dim_U_2));
  SET_VECTOR_ELT(contents, 66, ScalarInteger(internal->dim_U0));
  SET_VECTOR_ELT(contents, 67, ScalarInteger(internal->dim_U0_1));
  SET_VECTOR_ELT(contents, 68, ScalarInteger(internal->dim_U0_2));
  SET_VECTOR_ELT(contents, 69, ScalarInteger(internal->dim_vax_t));
  SET_VECTOR_ELT(contents, 70, ScalarInteger(internal->dim_vax_y));
  SET_VECTOR_ELT(contents, 71, ScalarInteger(internal->dim_vea));
  SET_VECTOR_ELT(contents, 72, ScalarInteger(internal->dim_ved));
  SET_VECTOR_ELT(contents, 73, ScalarInteger(internal->dim_ves));
  SET_VECTOR_ELT(contents, 74, ScalarInteger(internal->dim_w));
  SET_VECTOR_ELT(contents, 75, ScalarInteger(internal->dim_w_1));
  SET_VECTOR_ELT(contents, 76, ScalarInteger(internal->dim_w_2));
  SET_VECTOR_ELT(contents, 77, ScalarInteger(internal->dim_wA));
  SET_VECTOR_ELT(contents, 78, ScalarInteger(internal->dim_wA_1));
  SET_VECTOR_ELT(contents, 79, ScalarInteger(internal->dim_wA_12));
  SET_VECTOR_ELT(contents, 80, ScalarInteger(internal->dim_wA_2));
  SET_VECTOR_ELT(contents, 81, ScalarInteger(internal->dim_wA_3));
  SET_VECTOR_ELT(contents, 82, ScalarInteger(internal->dim_wI));
  SET_VECTOR_ELT(contents, 83, ScalarInteger(internal->dim_wI_1));
  SET_VECTOR_ELT(contents, 84, ScalarInteger(internal->dim_wI_12));
  SET_VECTOR_ELT(contents, 85, ScalarInteger(internal->dim_wI_2));
  SET_VECTOR_ELT(contents, 86, ScalarInteger(internal->dim_wI_3));
  SET_VECTOR_ELT(contents, 87, ScalarInteger(internal->dim_wS));
  SET_VECTOR_ELT(contents, 88, ScalarInteger(internal->dim_wS_1));
  SET_VECTOR_ELT(contents, 89, ScalarInteger(internal->dim_wS_12));
  SET_VECTOR_ELT(contents, 90, ScalarInteger(internal->dim_wS_2));
  SET_VECTOR_ELT(contents, 91, ScalarInteger(internal->dim_wS_3));
  SET_VECTOR_ELT(contents, 92, ScalarInteger(internal->dim_wT));
  SET_VECTOR_ELT(contents, 93, ScalarInteger(internal->dim_wT_1));
  SET_VECTOR_ELT(contents, 94, ScalarInteger(internal->dim_wT_12));
  SET_VECTOR_ELT(contents, 95, ScalarInteger(internal->dim_wT_2));
  SET_VECTOR_ELT(contents, 96, ScalarInteger(internal->dim_wT_3));
  SET_VECTOR_ELT(contents, 97, ScalarInteger(internal->dim_wU));
  SET_VECTOR_ELT(contents, 98, ScalarInteger(internal->dim_wU_1));
  SET_VECTOR_ELT(contents, 99, ScalarInteger(internal->dim_wU_12));
  SET_VECTOR_ELT(contents, 100, ScalarInteger(internal->dim_wU_2));
  SET_VECTOR_ELT(contents, 101, ScalarInteger(internal->dim_wU_3));
  SEXP eta = PROTECT(allocVector(REALSXP, internal->dim_eta));
  memcpy(REAL(eta), internal->eta, internal->dim_eta * sizeof(double));
  SET_VECTOR_ELT(contents, 102, eta);
  SET_VECTOR_ELT(contents, 103, ScalarReal(internal->eta_h));
  SET_VECTOR_ELT(contents, 104, ScalarReal(internal->eta_l));
  SEXP I0 = PROTECT(allocVector(REALSXP, internal->dim_I0));
  memcpy(REAL(I0), internal->I0, internal->dim_I0 * sizeof(double));
  odin_set_dim(I0, 2, internal->dim_I0_1, internal->dim_I0_2);
  SET_VECTOR_ELT(contents, 105, I0);
  SEXP initial_A = PROTECT(allocVector(REALSXP, internal->dim_A));
  memcpy(REAL(initial_A), internal->initial_A, internal->dim_A * sizeof(double));
  odin_set_dim(initial_A, 2, internal->dim_A_1, internal->dim_A_2);
  ...
  memcpy(REAL(initial_cum_diag_a), internal->initial_cum_diag_a, internal->dim_cum_diag_a * sizeof(double));
  odin_set_dim(initial_cum_diag_a, 2, internal->dim_cum_diag_a_1, internal->dim_cum_diag_a_2);
  SET_VECTOR_ELT(contents, 107, initial_cum_diag_a);
  SEXP initial_cum_diag_s = PROTECT(allocVector(REALSXP, internal->dim_cum_diag_s));
  memcpy(REAL(initial_cum_diag_s), internal->initial_cum_diag_s, internal->dim_cum_diag_s * sizeof(double));
  odin_set_dim(initial_cum_diag_s, 2, internal->dim_cum_diag_s_1, internal->dim_cum_diag_s_2);
  SET_VECTOR_ELT(contents, 108, initial_cum_diag_s);
  SEXP initial_cum_incid = PROTECT(allocVector(REALSXP, internal->dim_cum_incid));
  memcpy(REAL(initial_cum_incid), internal->initial_cum_incid, internal->dim_cum_incid * sizeof(double));
  odin_set_dim(initial_cum_incid, 2, internal->dim_cum_incid_1, internal->dim_cum_incid_2);
  SET_VECTOR_ELT(contents, 109, initial_cum_incid);
  SEXP initial_cum_screened = PROTECT(allocVector(REALSXP, internal->dim_cum_screened));
  memcpy(REAL(initial_cum_screened), internal->initial_cum_screened, internal->dim_cum_screened * sizeof(double));
  odin_set_dim(initial_cum_screened, 2, internal->dim_cum_screened_1, internal->dim_cum_screened_2);
  SET_VECTOR_ELT(contents, 110, initial_cum_screened);
  SEXP initial_cum_treated = PROTECT(allocVector(REALSXP, internal->dim_cum_treated));
  memcpy(REAL(initial_cum_treated), internal->initial_cum_treated, internal->dim_cum_treated * sizeof(double));
  odin_set_dim(initial_cum_treated, 2, internal->dim_cum_treated_1, internal->dim_cum_treated_2);
  SET_VECTOR_ELT(contents, 111, initial_cum_treated);
  SEXP initial_I = PROTECT(allocVector(REALSXP, internal->dim_I));
  memcpy(REAL(initial_I), internal->initial_I, internal->dim_I * sizeof(double));
  odin_set_dim(initial_I, 2, internal->dim_I_1, internal->dim_I_2);
  SET_VECTOR_ELT(contents, 112, initial_I);
  SEXP initial_S = PROTECT(allocVector(REALSXP, internal->dim_S));
  memcpy(REAL(initial_S), internal->initial_S, internal->dim_S * sizeof(double));
  odin_set_dim(initial_S, 2, internal->dim_S_1, internal->dim_S_2);
  SET_VECTOR_ELT(contents, 113, initial_S);
  SEXP initial_T = PROTECT(allocVector(REALSXP, internal->dim_T));
  memcpy(REAL(initial_T), internal->initial_T, internal->dim_T * sizeof(double));
  odin_set_dim(initial_T, 2, internal->dim_T_1, internal->dim_T_2);
  SET_VECTOR_ELT(contents, 114, initial_T);
  SEXP initial_U = PROTECT(allocVector(REALSXP, internal->dim_U));
  memcpy(REAL(initial_U), internal->initial_U, internal->dim_U * sizeof(double));
  odin_set_dim(initial_U, 2, internal->dim_U_1, internal->dim_U_2);
  SET_VECTOR_ELT(contents, 115, initial_U);
  SET_VECTOR_ELT(contents, 116, ScalarReal(internal->lambda));
  SET_VECTOR_ELT(contents, 117, ScalarReal(internal->mu));
  SEXP N = PROTECT(allocVector(REALSXP, internal->dim_N));
  memcpy(REAL(N), internal->N, internal->dim_N * sizeof(double));
  odin_set_dim(N, 2, internal->dim_N_1, internal->dim_N_2);
  SET_VECTOR_ELT(contents, 118, N);
  SEXP n_AT = PROTECT(allocVector(REALSXP, internal->dim_n_AT));
  memcpy(REAL(n_AT), internal->n_AT, internal->dim_n_AT * sizeof(double));
  odin_set_dim(n_AT, 2, internal->dim_n_AT_1, internal->dim_n_AT_2);
  SET_VECTOR_ELT(contents, 119, n_AT);
  SEXP n_AU = PROTECT(allocVector(REALSXP, internal->dim_n_AU));
  memcpy(REAL(n_AU), internal->n_AU, internal->dim_n_AU * sizeof(double));
  odin_set_dim(n_AU, 2, internal->dim_n_AU_1, internal->dim_n_AU_2);
  SET_VECTOR_ELT(contents, 120, n_AU);
  SET_VECTOR_ELT(contents, 121, ScalarInteger(internal->n_group));
  SEXP n_ST = PROTECT(allocVector(REALSXP, internal->dim_n_ST));
  memcpy(REAL(n_ST), internal->n_ST, internal->dim_n_ST * sizeof(double));
  odin_set_dim(n_ST, 2, internal->dim_n_ST_1, internal->dim_n_ST_2);
  SET_VECTOR_ELT(contents, 122, n_ST);
  SEXP n_TU = PROTECT(allocVector(REALSXP, internal->dim_n_TU));
  memcpy(REAL(n_TU), internal->n_TU, internal->dim_n_TU * sizeof(double));
  odin_set_dim(n_TU, 2, internal->dim_n_TU_1, internal->dim_n_TU_2);
  SET_VECTOR_ELT(contents, 123, n_TU);
  SEXP n_UI = PROTECT(allocVector(REALSXP, internal->dim_n_UI));
  memcpy(REAL(n_UI), internal->n_UI, internal->dim_n_UI * sizeof(double));
  odin_set_dim(n_UI, 2, internal->dim_n_UI_1, internal->dim_n_UI_2);
  SET_VECTOR_ELT(contents, 124, n_UI);
  SET_VECTOR_ELT(contents, 125, ScalarInteger(internal->n_vax));
  SET_VECTOR_ELT(contents, 126, ScalarReal(internal->nu));
  SET_VECTOR_ELT(contents, 127, ScalarInteger(internal->offset_variable_A));
  SET_VECTOR_ELT(contents, 128, ScalarInteger(internal->offset_variable_cum_diag_a));
  SET_VECTOR_ELT(contents, 129, ScalarInteger(internal->offset_variable_cum_diag_s));
  SET_VECTOR_ELT(contents, 130, ScalarInteger(internal->offset_variable_cum_incid));
  SET_VECTOR_ELT(contents, 131, ScalarInteger(internal->offset_variable_cum_screened));
  SET_VECTOR_ELT(contents, 132, ScalarInteger(internal->offset_variable_cum_treated));
  SET_VECTOR_ELT(contents, 133, ScalarInteger(internal->offset_variable_S));
  SET_VECTOR_ELT(contents, 134, ScalarInteger(internal->offset_variable_T));
  SET_VECTOR_ELT(contents, 135, ScalarReal(internal->psi));
  SET_VECTOR_ELT(contents, 136, ScalarReal(internal->rho));
  SEXP S0 = PROTECT(allocVector(REALSXP, internal->dim_S0));
  memcpy(REAL(S0), internal->S0, internal->dim_S0 * sizeof(double));
  odin_set_dim(S0, 2, internal->dim_S0_1, internal->dim_S0_2);
  SET_VECTOR_ELT(contents, 137, S0);
  SEXP screened = PROTECT(allocVector(REALSXP, internal->dim_screened));
  memcpy(REAL(screened), internal->screened, internal->dim_screened * sizeof(double));
  odin_set_dim(screened, 2, internal->dim_screened_1, internal->dim_screened_2);
  SET_VECTOR_ELT(contents, 138, screened);
  SET_VECTOR_ELT(contents, 139, ScalarReal(internal->sigma));
  SEXP T0 = PROTECT(allocVector(REALSXP, internal->dim_T0));
  memcpy(REAL(T0), internal->T0, internal->dim_T0 * sizeof(double));
  odin_set_dim(T0, 2, internal->dim_T0_1, internal->dim_T0_2);
  SET_VECTOR_ELT(contents, 140, T0);
  SEXP tt = PROTECT(allocVector(REALSXP, internal->dim_tt));
  memcpy(REAL(tt), internal->tt, internal->dim_tt * sizeof(double));
  SET_VECTOR_ELT(contents, 141, tt);
  SEXP U0 = PROTECT(allocVector(REALSXP, internal->dim_U0));
  memcpy(REAL(U0), internal->U0, internal->dim_U0 * sizeof(double));
  odin_set_dim(U0, 2, internal->dim_U0_1, internal->dim_U0_2);
  SET_VECTOR_ELT(contents, 142, U0);
  SEXP vax_t = PROTECT(allocVector(REALSXP, internal->dim_vax_t));
  memcpy(REAL(vax_t), internal->vax_t, internal->dim_vax_t * sizeof(double));
  SET_VECTOR_ELT(contents, 143, vax_t);
  SEXP vax_y = PROTECT(allocVector(REALSXP, internal->dim_vax_y));
  memcpy(REAL(vax_y), internal->vax_y, internal->dim_vax_y * sizeof(double));
  SET_VECTOR_ELT(contents, 144, vax_y);
  SEXP vea = PROTECT(allocVector(REALSXP, internal->dim_vea));
  memcpy(REAL(vea), internal->vea, internal->dim_vea * sizeof(double));
  SET_VECTOR_ELT(contents, 145, vea);
  SEXP ved = PROTECT(allocVector(REALSXP, internal->dim_ved));
  memcpy(REAL(ved), internal->ved, internal->dim_ved * sizeof(double));
  SET_VECTOR_ELT(contents, 146, ved);
  SEXP ves = PROTECT(allocVector(REALSXP, internal->dim_ves));
  memcpy(REAL(ves), internal->ves, internal->dim_ves * sizeof(double));
  SET_VECTOR_ELT(contents, 147, ves);
  SEXP w = PROTECT(allocVector(REALSXP, internal->dim_w));
  memcpy(REAL(w), internal->w, internal->dim_w * sizeof(double));
  odin_set_dim(w, 2, internal->dim_w_1, internal->dim_w_2);
  SET_VECTOR_ELT(contents, 148, w);
  SEXP wA = PROTECT(allocVector(REALSXP, internal->dim_wA));
  memcpy(REAL(wA), internal->wA, internal->dim_wA * sizeof(double));
  odin_set_dim(wA, 3, internal->dim_wA_1, internal->dim_wA_2, internal->dim_wA_3);
  SET_VECTOR_ELT(contents, 149, wA);
  SEXP wI = PROTECT(allocVector(REALSXP, internal->dim_wI));
  memcpy(REAL(wI), internal->wI, internal->dim_wI * sizeof(double));
  odin_set_dim(wI, 3, internal->dim_wI_1, internal->dim_wI_2, internal->dim_wI_3);
  SET_VECTOR_ELT(contents, 150, wI);
  SEXP wS = PROTECT(allocVector(REALSXP, internal->dim_wS));
  memcpy(REAL(wS), internal->wS, internal->dim_wS * sizeof(double));
  odin_set_dim(wS, 3, internal->dim_wS_1, internal->dim_wS_2, internal->dim_wS_3);
  SET_VECTOR_ELT(contents, 151, wS);
  SEXP wT = PROTECT(allocVector(REALSXP, internal->dim_wT));
  memcpy(REAL(wT), internal->wT, internal->dim_wT * sizeof(double));
  odin_set_dim(wT, 3, internal->dim_wT_1, internal->dim_wT_2, internal->dim_wT_3);
  SET_VECTOR_ELT(contents, 152, wT);
  SEXP wU = PROTECT(allocVector(REALSXP, internal->dim_wU));
  memcpy(REAL(wU), internal->wU, internal->dim_wU * sizeof(double));
  odin_set_dim(wU, 3, internal->dim_wU_1, internal->dim_wU_2, internal->dim_wU_3);
  SET_VECTOR_ELT(contents, 153, wU);
  SEXP nms = PROTECT(allocVector(STRSXP, 154));
  SET_STRING_ELT(nms, 0, mkChar("A0"));
  ...
  SET_STRING_ELT(nms, 62, mkChar("dim_tt"));
  SET_STRING_ELT(nms, 63, mkChar("dim_U"));
  SET_STRING_ELT(nms, 64, mkChar("dim_U_1"));
  SET_STRING_ELT(nms, 65, mkChar("dim_U_2"));
  SET_STRING_ELT(nms, 66, mkChar("dim_U0"));
  SET_STRING_ELT(nms, 67, mkChar("dim_U0_1"));
  SET_STRING_ELT(nms, 68, mkChar("dim_U0_2"));
  SET_STRING_ELT(nms, 69, mkChar("dim_vax_t"));
  SET_STRING_ELT(nms, 70, mkChar("dim_vax_y"));
  SET_STRING_ELT(nms, 71, mkChar("dim_vea"));
  SET_STRING_ELT(nms, 72, mkChar("dim_ved"));
  SET_STRING_ELT(nms, 73, mkChar("dim_ves"));
  SET_STRING_ELT(nms, 74, mkChar("dim_w"));
  SET_STRING_ELT(nms, 75, mkChar("dim_w_1"));
  SET_STRING_ELT(nms, 76, mkChar("dim_w_2"));
  SET_STRING_ELT(nms, 77, mkChar("dim_wA"));
  SET_STRING_ELT(nms, 78, mkChar("dim_wA_1"));
  SET_STRING_ELT(nms, 79, mkChar("dim_wA_12"));
  SET_STRING_ELT(nms, 80, mkChar("dim_wA_2"));
  SET_STRING_ELT(nms, 81, mkChar("dim_wA_3"));
  SET_STRING_ELT(nms, 82, mkChar("dim_wI"));
  SET_STRING_ELT(nms, 83, mkChar("dim_wI_1"));
  SET_STRING_ELT(nms, 84, mkChar("dim_wI_12"));
  SET_STRING_ELT(nms, 85, mkChar("dim_wI_2"));
  SET_STRING_ELT(nms, 86, mkChar("dim_wI_3"));
  SET_STRING_ELT(nms, 87, mkChar("dim_wS"));
  SET_STRING_ELT(nms, 88, mkChar("dim_wS_1"));
  SET_STRING_ELT(nms, 89, mkChar("dim_wS_12"));
  SET_STRING_ELT(nms, 90, mkChar("dim_wS_2"));
  SET_STRING_ELT(nms, 91, mkChar("dim_wS_3"));
  SET_STRING_ELT(nms, 92, mkChar("dim_wT"));
  SET_STRING_ELT(nms, 93, mkChar("dim_wT_1"));
  SET_STRING_ELT(nms, 94, mkChar("dim_wT_12"));
  SET_STRING_ELT(nms, 95, mkChar("dim_wT_2"));
  SET_STRING_ELT(nms, 96, mkChar("dim_wT_3"));
  SET_STRING_ELT(nms, 97, mkChar("dim_wU"));
  SET_STRING_ELT(nms, 98, mkChar("dim_wU_1"));
  SET_STRING_ELT(nms, 99, mkChar("dim_wU_12"));
  SET_STRING_ELT(nms, 100, mkChar("dim_wU_2"));
  SET_STRING_ELT(nms, 101, mkChar("dim_wU_3"));
  SET_STRING_ELT(nms, 102, mkChar("eta"));
  SET_STRING_ELT(nms, 103, mkChar("eta_h"));
  SET_STRING_ELT(nms, 104, mkChar("eta_l"));
  SET_STRING_ELT(nms, 105, mkChar("I0"));
  SET_STRING_ELT(nms, 106, mkChar("initial_A"));
  SET_STRING_ELT(nms, 107, mkChar("initial_cum_diag_a"));
  SET_STRING_ELT(nms, 108, mkChar("initial_cum_diag_s"));
  SET_STRING_ELT(nms, 109, mkChar("initial_cum_incid"));
  SET_STRING_ELT(nms, 110, mkChar("initial_cum_screened"));
  SET_STRING_ELT(nms, 111, mkChar("initial_cum_treated"));
  SET_STRING_ELT(nms, 112, mkChar("initial_I"));
  SET_STRING_ELT(nms, 113, mkChar("initial_S"));
  SET_STRING_ELT(nms, 114, mkChar("initial_T"));
  SET_STRING_ELT(nms, 115, mkChar("initial_U"));
  SET_STRING_ELT(nms, 116, mkChar("lambda"));
  SET_STRING_ELT(nms, 117, mkChar("mu"));
  SET_STRING_ELT(nms, 118, mkChar("N"));
  SET_STRING_ELT(nms, 119, mkChar("n_AT"));
  SET_STRING_ELT(nms, 120, mkChar("n_AU"));
  SET_STRING_ELT(nms, 121, mkChar("n_group"));
  SET_STRING_ELT(nms, 122, mkChar("n_ST"));
  SET_STRING_ELT(nms, 123, mkChar("n_TU"));
  SET_STRING_ELT(nms, 124, mkChar("n_UI"));
  SET_STRING_ELT(nms, 125, mkChar("n_vax"));
  SET_STRING_ELT(nms, 126, mkChar("nu"));
  SET_STRING_ELT(nms, 127, mkChar("offset_variable_A"));
  SET_STRING_ELT(nms, 128, mkChar("offset_variable_cum_diag_a"));
  SET_STRING_ELT(nms, 129, mkChar("offset_variable_cum_diag_s"));
  SET_STRING_ELT(nms, 130, mkChar("offset_variable_cum_incid"));
  SET_STRING_ELT(nms, 131, mkChar("offset_variable_cum_screened"));
  SET_STRING_ELT(nms, 132, mkChar("offset_variable_cum_treated"));
  SET_STRING_ELT(nms, 133, mkChar("offset_variable_S"));
  SET_STRING_ELT(nms, 134, mkChar("offset_variable_T"));
  SET_STRING_ELT(nms, 135, mkChar("psi"));
  SET_STRING_ELT(nms, 136, mkChar("rho"));
  SET_STRING_ELT(nms, 137, mkChar("S0"));
  SET_STRING_ELT(nms, 138, mkChar("screened"));
  SET_STRING_ELT(nms, 139, mkChar("sigma"));
  SET_STRING_ELT(nms, 140, mkChar("T0"));
  SET_STRING_ELT(nms, 141, mkChar("tt"));
  SET_STRING_ELT(nms, 142, mkChar("U0"));
  SET_STRING_ELT(nms, 143, mkChar("vax_t"));
  SET_STRING_ELT(nms, 144, mkChar("vax_y"));
  SET_STRING_ELT(nms, 145, mkChar("vea"));
  SET_STRING_ELT(nms, 146, mkChar("ved"));
  SET_STRING_ELT(nms, 147, mkChar("ves"));
  SET_STRING_ELT(nms, 148, mkChar("w"));
  SET_STRING_ELT(nms, 149, mkChar("wA"));
  SET_STRING_ELT(nms, 150, mkChar("wI"));
  SET_STRING_ELT(nms, 151, mkChar("wS"));
  SET_STRING_ELT(nms, 152, mkChar("wT"));
  SET_STRING_ELT(nms, 153, mkChar("wU"));
  setAttrib(contents, R_NamesSymbol, nms);
  UNPROTECT(37);
  return contents;
}
