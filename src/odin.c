...
SEXP model_contents(SEXP internal_p) {
  ...
  SET_VECTOR_ELT(contents, 35, ScalarInteger(internal->dim_eta_t));
  SET_VECTOR_ELT(contents, 36, ScalarInteger(internal->dim_foi));
  SET_VECTOR_ELT(contents, 37, ScalarInteger(internal->dim_foi_1));
  SET_VECTOR_ELT(contents, 38, ScalarInteger(internal->dim_foi_2));
  ...
  SET_VECTOR_ELT(contents, 44, ScalarInteger(internal->dim_I0_2));
  SET_VECTOR_ELT(contents, 45, ScalarInteger(internal->dim_m));
  SET_VECTOR_ELT(contents, 46, ScalarInteger(internal->dim_m_1));
  SET_VECTOR_ELT(contents, 47, ScalarInteger(internal->dim_m_2));
  ...
  SET_VECTOR_ELT(contents, 66, ScalarInteger(internal->dim_n_vd_2));
  SET_VECTOR_ELT(contents, 67, ScalarInteger(internal->dim_n_vd_3));
  SET_VECTOR_ELT(contents, 68, ScalarInteger(internal->dim_n_ve));
  SET_VECTOR_ELT(contents, 69, ScalarInteger(internal->dim_n_ve_1));
  SET_VECTOR_ELT(contents, 70, ScalarInteger(internal->dim_n_ve_12));
  SET_VECTOR_ELT(contents, 71, ScalarInteger(internal->dim_n_ve_2));
  SET_VECTOR_ELT(contents, 72, ScalarInteger(internal->dim_n_ve_3));
  SET_VECTOR_ELT(contents, 73, ScalarInteger(internal->dim_n_vs));
  SET_VECTOR_ELT(contents, 74, ScalarInteger(internal->dim_n_vs_1));
  SET_VECTOR_ELT(contents, 75, ScalarInteger(internal->dim_n_vs_12));
  SET_VECTOR_ELT(contents, 76, ScalarInteger(internal->dim_n_vs_2));
  SET_VECTOR_ELT(contents, 77, ScalarInteger(internal->dim_n_vs_3));
  SET_VECTOR_ELT(contents, 78, ScalarInteger(internal->dim_Np));
  SET_VECTOR_ELT(contents, 79, ScalarInteger(internal->dim_p));
  SET_VECTOR_ELT(contents, 80, ScalarInteger(internal->dim_q));
  SET_VECTOR_ELT(contents, 81, ScalarInteger(internal->dim_S));
  SET_VECTOR_ELT(contents, 82, ScalarInteger(internal->dim_S_1));
  SET_VECTOR_ELT(contents, 83, ScalarInteger(internal->dim_S_2));
  SET_VECTOR_ELT(contents, 84, ScalarInteger(internal->dim_S0));
  SET_VECTOR_ELT(contents, 85, ScalarInteger(internal->dim_S0_1));
  SET_VECTOR_ELT(contents, 86, ScalarInteger(internal->dim_S0_2));
  SET_VECTOR_ELT(contents, 87, ScalarInteger(internal->dim_screened));
  SET_VECTOR_ELT(contents, 88, ScalarInteger(internal->dim_screened_1));
  SET_VECTOR_ELT(contents, 89, ScalarInteger(internal->dim_screened_2));
  SET_VECTOR_ELT(contents, 90, ScalarInteger(internal->dim_T));
  SET_VECTOR_ELT(contents, 91, ScalarInteger(internal->dim_T_1));
  SET_VECTOR_ELT(contents, 92, ScalarInteger(internal->dim_T_2));
  SET_VECTOR_ELT(contents, 93, ScalarInteger(internal->dim_T0));
  SET_VECTOR_ELT(contents, 94, ScalarInteger(internal->dim_T0_1));
  SET_VECTOR_ELT(contents, 95, ScalarInteger(internal->dim_T0_2));
  SET_VECTOR_ELT(contents, 96, ScalarInteger(internal->dim_tt));
  SET_VECTOR_ELT(contents, 97, ScalarInteger(internal->dim_U));
  SET_VECTOR_ELT(contents, 98, ScalarInteger(internal->dim_U_1));
  SET_VECTOR_ELT(contents, 99, ScalarInteger(internal->dim_U_2));
  SET_VECTOR_ELT(contents, 100, ScalarInteger(internal->dim_U0));
  SET_VECTOR_ELT(contents, 101, ScalarInteger(internal->dim_U0_1));
  SET_VECTOR_ELT(contents, 102, ScalarInteger(internal->dim_U0_2));
  SET_VECTOR_ELT(contents, 103, ScalarInteger(internal->dim_vax_t));
  SET_VECTOR_ELT(contents, 104, ScalarInteger(internal->dim_vax_y));
  SET_VECTOR_ELT(contents, 105, ScalarInteger(internal->dim_vd));
  SET_VECTOR_ELT(contents, 106, ScalarInteger(internal->dim_vd_1));
  SET_VECTOR_ELT(contents, 107, ScalarInteger(internal->dim_vd_12));
  SET_VECTOR_ELT(contents, 108, ScalarInteger(internal->dim_vd_2));
  SET_VECTOR_ELT(contents, 109, ScalarInteger(internal->dim_vd_3));
  SET_VECTOR_ELT(contents, 110, ScalarInteger(internal->dim_ve));
  SET_VECTOR_ELT(contents, 111, ScalarInteger(internal->dim_ve_1));
  SET_VECTOR_ELT(contents, 112, ScalarInteger(internal->dim_ve_12));
  SET_VECTOR_ELT(contents, 113, ScalarInteger(internal->dim_ve_2));
  SET_VECTOR_ELT(contents, 114, ScalarInteger(internal->dim_ve_3));
  SET_VECTOR_ELT(contents, 115, ScalarInteger(internal->dim_vs));
  SET_VECTOR_ELT(contents, 116, ScalarInteger(internal->dim_vs_1));
  SET_VECTOR_ELT(contents, 117, ScalarInteger(internal->dim_vs_12));
  SET_VECTOR_ELT(contents, 118, ScalarInteger(internal->dim_vs_2));
  SET_VECTOR_ELT(contents, 119, ScalarInteger(internal->dim_vs_3));
  ...
  SET_VECTOR_ELT(contents, 148, eff);
  SET_VECTOR_ELT(contents, 149, ScalarReal(internal->enr));
  ...
  SET_VECTOR_ELT(contents, 150, entrants);
  SET_VECTOR_ELT(contents, 151, ScalarReal(internal->epsilon));
  SEXP eta_t = PROTECT(allocVector(REALSXP, internal->dim_eta_t));
  memcpy(REAL(eta_t), internal->eta_t, internal->dim_eta_t * sizeof(double));
  SET_VECTOR_ELT(contents, 152, eta_t);
  SET_VECTOR_ELT(contents, 153, ScalarReal(internal->exr));
  ...
  SET_VECTOR_ELT(contents, 154, foi);
  ...
  SET_VECTOR_ELT(contents, 155, I0);
  ...
  SET_VECTOR_ELT(contents, 156, initial_A);
  ...
  SET_VECTOR_ELT(contents, 157, initial_cum_diag_a);
  ...
  SET_VECTOR_ELT(contents, 158, initial_cum_diag_s);
  ...
  SET_VECTOR_ELT(contents, 159, initial_cum_incid);
  ...
  SET_VECTOR_ELT(contents, 160, initial_cum_screened);
  ...
  SET_VECTOR_ELT(contents, 161, initial_cum_treated);
  ...
  SET_VECTOR_ELT(contents, 162, initial_cum_vaccinated);
  ...
  SET_VECTOR_ELT(contents, 163, initial_I);
  ...
  SET_VECTOR_ELT(contents, 164, initial_S);
  ...
  SET_VECTOR_ELT(contents, 165, initial_T);
  ...
  SET_VECTOR_ELT(contents, 166, initial_U);
  ...
  SET_VECTOR_ELT(contents, 171, ScalarReal(internal->mu));
  ...
  SET_VECTOR_ELT(contents, 173, n_AT);
  SET_VECTOR_ELT(contents, 174, ScalarInteger(internal->n_group));
  ...
  SET_VECTOR_ELT(contents, 175, n_ST);
  ...
  SET_VECTOR_ELT(contents, 177, n_UI);
  SET_VECTOR_ELT(contents, 178, ScalarInteger(internal->n_vax));
  ...
  SET_VECTOR_ELT(contents, 179, n_vd);
  ...
  SET_VECTOR_ELT(contents, 180, n_ve);
  ...
  SET_VECTOR_ELT(contents, 181, n_vs);
  SEXP Np = PROTECT(allocVector(REALSXP, internal->dim_Np));
  memcpy(REAL(Np), internal->Np, internal->dim_Np * sizeof(double));
  SET_VECTOR_ELT(contents, 182, Np);
  SET_VECTOR_ELT(contents, 183, ScalarReal(internal->nu));
  SET_VECTOR_ELT(contents, 184, ScalarInteger(internal->offset_output_foi));
  ...
  SET_VECTOR_ELT(contents, 191, ScalarInteger(internal->offset_variable_cum_vaccinated));
  ...
  SET_VECTOR_ELT(contents, 194, p);
  SET_VECTOR_ELT(contents, 195, ScalarReal(internal->psi));
  SEXP q = PROTECT(allocVector(REALSXP, internal->dim_q));
  memcpy(REAL(q), internal->q, internal->dim_q * sizeof(double));
  SET_VECTOR_ELT(contents, 196, q);
  SET_VECTOR_ELT(contents, 197, ScalarReal(internal->rho));
  ...
  SET_VECTOR_ELT(contents, 198, S0);
  ...
  SET_VECTOR_ELT(contents, 199, screened);
  SET_VECTOR_ELT(contents, 200, ScalarReal(internal->sigma));
  ...
  SET_VECTOR_ELT(contents, 203, U0);
  ...
  SET_VECTOR_ELT(contents, 204, vax_t);
  ...
  SET_VECTOR_ELT(contents, 205, vax_y);
  ...
  SET_VECTOR_ELT(contents, 206, vd);
  ...
  SET_VECTOR_ELT(contents, 207, ve);
  ...
  SET_VECTOR_ELT(contents, 208, vs);
  ...
  SET_STRING_ELT(nms, 35, mkChar("dim_eta_t"));
  SET_STRING_ELT(nms, 36, mkChar("dim_foi"));
  SET_STRING_ELT(nms, 37, mkChar("dim_foi_1"));
  SET_STRING_ELT(nms, 38, mkChar("dim_foi_2"));
  ...
  SET_STRING_ELT(nms, 44, mkChar("dim_I0_2"));
  SET_STRING_ELT(nms, 45, mkChar("dim_m"));
  SET_STRING_ELT(nms, 46, mkChar("dim_m_1"));
  SET_STRING_ELT(nms, 47, mkChar("dim_m_2"));
  ...
  SET_STRING_ELT(nms, 66, mkChar("dim_n_vd_2"));
  SET_STRING_ELT(nms, 67, mkChar("dim_n_vd_3"));
  SET_STRING_ELT(nms, 68, mkChar("dim_n_ve"));
  SET_STRING_ELT(nms, 69, mkChar("dim_n_ve_1"));
  SET_STRING_ELT(nms, 70, mkChar("dim_n_ve_12"));
  SET_STRING_ELT(nms, 71, mkChar("dim_n_ve_2"));
  SET_STRING_ELT(nms, 72, mkChar("dim_n_ve_3"));
  SET_STRING_ELT(nms, 73, mkChar("dim_n_vs"));
  SET_STRING_ELT(nms, 74, mkChar("dim_n_vs_1"));
  SET_STRING_ELT(nms, 75, mkChar("dim_n_vs_12"));
  SET_STRING_ELT(nms, 76, mkChar("dim_n_vs_2"));
  SET_STRING_ELT(nms, 77, mkChar("dim_n_vs_3"));
  SET_STRING_ELT(nms, 78, mkChar("dim_Np"));
  SET_STRING_ELT(nms, 79, mkChar("dim_p"));
  SET_STRING_ELT(nms, 80, mkChar("dim_q"));
  SET_STRING_ELT(nms, 81, mkChar("dim_S"));
  SET_STRING_ELT(nms, 82, mkChar("dim_S_1"));
  SET_STRING_ELT(nms, 83, mkChar("dim_S_2"));
  SET_STRING_ELT(nms, 84, mkChar("dim_S0"));
  SET_STRING_ELT(nms, 85, mkChar("dim_S0_1"));
  SET_STRING_ELT(nms, 86, mkChar("dim_S0_2"));
  SET_STRING_ELT(nms, 87, mkChar("dim_screened"));
  SET_STRING_ELT(nms, 88, mkChar("dim_screened_1"));
  SET_STRING_ELT(nms, 89, mkChar("dim_screened_2"));
  SET_STRING_ELT(nms, 90, mkChar("dim_T"));
  SET_STRING_ELT(nms, 91, mkChar("dim_T_1"));
  SET_STRING_ELT(nms, 92, mkChar("dim_T_2"));
  SET_STRING_ELT(nms, 93, mkChar("dim_T0"));
  SET_STRING_ELT(nms, 94, mkChar("dim_T0_1"));
  SET_STRING_ELT(nms, 95, mkChar("dim_T0_2"));
  SET_STRING_ELT(nms, 96, mkChar("dim_tt"));
  SET_STRING_ELT(nms, 97, mkChar("dim_U"));
  SET_STRING_ELT(nms, 98, mkChar("dim_U_1"));
  SET_STRING_ELT(nms, 99, mkChar("dim_U_2"));
  SET_STRING_ELT(nms, 100, mkChar("dim_U0"));
  SET_STRING_ELT(nms, 101, mkChar("dim_U0_1"));
  SET_STRING_ELT(nms, 102, mkChar("dim_U0_2"));
  SET_STRING_ELT(nms, 103, mkChar("dim_vax_t"));
  SET_STRING_ELT(nms, 104, mkChar("dim_vax_y"));
  SET_STRING_ELT(nms, 105, mkChar("dim_vd"));
  SET_STRING_ELT(nms, 106, mkChar("dim_vd_1"));
  SET_STRING_ELT(nms, 107, mkChar("dim_vd_12"));
  SET_STRING_ELT(nms, 108, mkChar("dim_vd_2"));
  SET_STRING_ELT(nms, 109, mkChar("dim_vd_3"));
  SET_STRING_ELT(nms, 110, mkChar("dim_ve"));
  SET_STRING_ELT(nms, 111, mkChar("dim_ve_1"));
  SET_STRING_ELT(nms, 112, mkChar("dim_ve_12"));
  SET_STRING_ELT(nms, 113, mkChar("dim_ve_2"));
  SET_STRING_ELT(nms, 114, mkChar("dim_ve_3"));
  SET_STRING_ELT(nms, 115, mkChar("dim_vs"));
  SET_STRING_ELT(nms, 116, mkChar("dim_vs_1"));
  SET_STRING_ELT(nms, 117, mkChar("dim_vs_12"));
  SET_STRING_ELT(nms, 118, mkChar("dim_vs_2"));
  SET_STRING_ELT(nms, 119, mkChar("dim_vs_3"));
  ...
  SET_STRING_ELT(nms, 148, mkChar("eff"));
  SET_STRING_ELT(nms, 149, mkChar("enr"));
  SET_STRING_ELT(nms, 150, mkChar("entrants"));
  SET_STRING_ELT(nms, 151, mkChar("epsilon"));
  SET_STRING_ELT(nms, 152, mkChar("eta_t"));
  SET_STRING_ELT(nms, 153, mkChar("exr"));
  SET_STRING_ELT(nms, 154, mkChar("foi"));
  SET_STRING_ELT(nms, 155, mkChar("I0"));
  SET_STRING_ELT(nms, 156, mkChar("initial_A"));
  SET_STRING_ELT(nms, 157, mkChar("initial_cum_diag_a"));
  SET_STRING_ELT(nms, 158, mkChar("initial_cum_diag_s"));
  SET_STRING_ELT(nms, 159, mkChar("initial_cum_incid"));
  SET_STRING_ELT(nms, 160, mkChar("initial_cum_screened"));
  SET_STRING_ELT(nms, 161, mkChar("initial_cum_treated"));
  SET_STRING_ELT(nms, 162, mkChar("initial_cum_vaccinated"));
  SET_STRING_ELT(nms, 163, mkChar("initial_I"));
  SET_STRING_ELT(nms, 164, mkChar("initial_S"));
  SET_STRING_ELT(nms, 165, mkChar("initial_T"));
  SET_STRING_ELT(nms, 166, mkChar("initial_U"));
  SET_STRING_ELT(nms, 167, mkChar("interpolate_beta"));
  SET_STRING_ELT(nms, 168, mkChar("interpolate_eta"));
  SET_STRING_ELT(nms, 169, mkChar("interpolate_vax_switch"));
  SET_STRING_ELT(nms, 170, mkChar("m"));
  SET_STRING_ELT(nms, 171, mkChar("mu"));
  SET_STRING_ELT(nms, 172, mkChar("N"));
  SET_STRING_ELT(nms, 173, mkChar("n_AT"));
  SET_STRING_ELT(nms, 174, mkChar("n_group"));
  SET_STRING_ELT(nms, 175, mkChar("n_ST"));
  SET_STRING_ELT(nms, 176, mkChar("n_TU"));
  SET_STRING_ELT(nms, 177, mkChar("n_UI"));
  SET_STRING_ELT(nms, 178, mkChar("n_vax"));
  SET_STRING_ELT(nms, 179, mkChar("n_vd"));
  SET_STRING_ELT(nms, 180, mkChar("n_ve"));
  SET_STRING_ELT(nms, 181, mkChar("n_vs"));
  SET_STRING_ELT(nms, 182, mkChar("Np"));
  SET_STRING_ELT(nms, 183, mkChar("nu"));
  SET_STRING_ELT(nms, 184, mkChar("offset_output_foi"));
  ...
  SET_STRING_ELT(nms, 191, mkChar("offset_variable_cum_vaccinated"));
  SET_STRING_ELT(nms, 192, mkChar("offset_variable_S"));
  SET_STRING_ELT(nms, 193, mkChar("offset_variable_T"));
  SET_STRING_ELT(nms, 194, mkChar("p"));
  SET_STRING_ELT(nms, 195, mkChar("psi"));
  SET_STRING_ELT(nms, 196, mkChar("q"));
  SET_STRING_ELT(nms, 197, mkChar("rho"));
  SET_STRING_ELT(nms, 198, mkChar("S0"));
  SET_STRING_ELT(nms, 199, mkChar("screened"));
  SET_STRING_ELT(nms, 200, mkChar("sigma"));
  SET_STRING_ELT(nms, 201, mkChar("T0"));
  SET_STRING_ELT(nms, 202, mkChar("tt"));
  SET_STRING_ELT(nms, 203, mkChar("U0"));
  SET_STRING_ELT(nms, 204, mkChar("vax_t"));
  SET_STRING_ELT(nms, 205, mkChar("vax_y"));
  SET_STRING_ELT(nms, 206, mkChar("vd"));
  SET_STRING_ELT(nms, 207, mkChar("ve"));
  SET_STRING_ELT(nms, 208, mkChar("vs"));
