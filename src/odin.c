...
SEXP model_trial_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 171));
  SEXP A0 = PROTECT(allocVector(REALSXP, internal->dim_A0));
  memcpy(REAL(A0), internal->A0, internal->dim_A0 * sizeof(double));
  odin_set_dim(A0, 2, internal->dim_A0_1, internal->dim_A0_2);
  SET_VECTOR_ELT(contents, 0, A0);
  ...
  SET_VECTOR_ELT(contents, 17, ScalarInteger(internal->dim_cum_pye_trial_pov));
  SET_VECTOR_ELT(contents, 18, ScalarInteger(internal->dim_cum_pye_trial_pov_1));
  SET_VECTOR_ELT(contents, 19, ScalarInteger(internal->dim_cum_pye_trial_pov_2));
  SET_VECTOR_ELT(contents, 20, ScalarInteger(internal->dim_cum_pye_true));
  SET_VECTOR_ELT(contents, 21, ScalarInteger(internal->dim_cum_pye_true_1));
  SET_VECTOR_ELT(contents, 22, ScalarInteger(internal->dim_cum_pye_true_2));
  SET_VECTOR_ELT(contents, 23, ScalarInteger(internal->dim_cum_screened));
  SET_VECTOR_ELT(contents, 24, ScalarInteger(internal->dim_cum_screened_1));
  SET_VECTOR_ELT(contents, 25, ScalarInteger(internal->dim_cum_screened_2));
  SET_VECTOR_ELT(contents, 26, ScalarInteger(internal->dim_cum_treated));
  SET_VECTOR_ELT(contents, 27, ScalarInteger(internal->dim_cum_treated_1));
  SET_VECTOR_ELT(contents, 28, ScalarInteger(internal->dim_cum_treated_2));
  SET_VECTOR_ELT(contents, 29, ScalarInteger(internal->dim_diag_rec));
  SET_VECTOR_ELT(contents, 30, ScalarInteger(internal->dim_diag_rec_1));
  SET_VECTOR_ELT(contents, 31, ScalarInteger(internal->dim_diag_rec_12));
  SET_VECTOR_ELT(contents, 32, ScalarInteger(internal->dim_diag_rec_2));
  SET_VECTOR_ELT(contents, 33, ScalarInteger(internal->dim_diag_rec_3));
  ...
  SET_VECTOR_ELT(contents, 63, ScalarInteger(internal->dim_pye_trial));
  SET_VECTOR_ELT(contents, 64, ScalarInteger(internal->dim_pye_trial_1));
  SET_VECTOR_ELT(contents, 65, ScalarInteger(internal->dim_pye_trial_2));
  SET_VECTOR_ELT(contents, 66, ScalarInteger(internal->dim_S));
  SET_VECTOR_ELT(contents, 67, ScalarInteger(internal->dim_S_1));
  SET_VECTOR_ELT(contents, 68, ScalarInteger(internal->dim_S_2));
  SET_VECTOR_ELT(contents, 69, ScalarInteger(internal->dim_S0));
  SET_VECTOR_ELT(contents, 70, ScalarInteger(internal->dim_S0_1));
  SET_VECTOR_ELT(contents, 71, ScalarInteger(internal->dim_S0_2));
  SET_VECTOR_ELT(contents, 72, ScalarInteger(internal->dim_screened));
  SET_VECTOR_ELT(contents, 73, ScalarInteger(internal->dim_screened_1));
  SET_VECTOR_ELT(contents, 74, ScalarInteger(internal->dim_screened_2));
  SET_VECTOR_ELT(contents, 75, ScalarInteger(internal->dim_T));
  SET_VECTOR_ELT(contents, 76, ScalarInteger(internal->dim_T_1));
  SET_VECTOR_ELT(contents, 77, ScalarInteger(internal->dim_T_2));
  SET_VECTOR_ELT(contents, 78, ScalarInteger(internal->dim_T0));
  SET_VECTOR_ELT(contents, 79, ScalarInteger(internal->dim_T0_1));
  SET_VECTOR_ELT(contents, 80, ScalarInteger(internal->dim_T0_2));
  SET_VECTOR_ELT(contents, 81, ScalarInteger(internal->dim_U));
  SET_VECTOR_ELT(contents, 82, ScalarInteger(internal->dim_U_1));
  SET_VECTOR_ELT(contents, 83, ScalarInteger(internal->dim_U_2));
  SET_VECTOR_ELT(contents, 84, ScalarInteger(internal->dim_U0));
  SET_VECTOR_ELT(contents, 85, ScalarInteger(internal->dim_U0_1));
  SET_VECTOR_ELT(contents, 86, ScalarInteger(internal->dim_U0_2));
  SET_VECTOR_ELT(contents, 87, ScalarInteger(internal->dim_vea));
  SET_VECTOR_ELT(contents, 88, ScalarInteger(internal->dim_ved));
  SET_VECTOR_ELT(contents, 89, ScalarInteger(internal->dim_ves));
  SET_VECTOR_ELT(contents, 90, ScalarInteger(internal->dim_w));
  SET_VECTOR_ELT(contents, 91, ScalarInteger(internal->dim_w_1));
  SET_VECTOR_ELT(contents, 92, ScalarInteger(internal->dim_w_2));
  SET_VECTOR_ELT(contents, 93, ScalarInteger(internal->dim_wA));
  SET_VECTOR_ELT(contents, 94, ScalarInteger(internal->dim_wA_1));
  SET_VECTOR_ELT(contents, 95, ScalarInteger(internal->dim_wA_12));
  SET_VECTOR_ELT(contents, 96, ScalarInteger(internal->dim_wA_2));
  SET_VECTOR_ELT(contents, 97, ScalarInteger(internal->dim_wA_3));
  SET_VECTOR_ELT(contents, 98, ScalarInteger(internal->dim_wI));
  SET_VECTOR_ELT(contents, 99, ScalarInteger(internal->dim_wI_1));
  SET_VECTOR_ELT(contents, 100, ScalarInteger(internal->dim_wI_12));
  SET_VECTOR_ELT(contents, 101, ScalarInteger(internal->dim_wI_2));
  SET_VECTOR_ELT(contents, 102, ScalarInteger(internal->dim_wI_3));
  SET_VECTOR_ELT(contents, 103, ScalarInteger(internal->dim_wS));
  SET_VECTOR_ELT(contents, 104, ScalarInteger(internal->dim_wS_1));
  SET_VECTOR_ELT(contents, 105, ScalarInteger(internal->dim_wS_12));
  SET_VECTOR_ELT(contents, 106, ScalarInteger(internal->dim_wS_2));
  SET_VECTOR_ELT(contents, 107, ScalarInteger(internal->dim_wS_3));
  SET_VECTOR_ELT(contents, 108, ScalarInteger(internal->dim_wT));
  SET_VECTOR_ELT(contents, 109, ScalarInteger(internal->dim_wT_1));
  SET_VECTOR_ELT(contents, 110, ScalarInteger(internal->dim_wT_12));
  SET_VECTOR_ELT(contents, 111, ScalarInteger(internal->dim_wT_2));
  SET_VECTOR_ELT(contents, 112, ScalarInteger(internal->dim_wT_3));
  SET_VECTOR_ELT(contents, 113, ScalarInteger(internal->dim_wU));
  SET_VECTOR_ELT(contents, 114, ScalarInteger(internal->dim_wU_1));
  SET_VECTOR_ELT(contents, 115, ScalarInteger(internal->dim_wU_12));
  SET_VECTOR_ELT(contents, 116, ScalarInteger(internal->dim_wU_2));
  SET_VECTOR_ELT(contents, 117, ScalarInteger(internal->dim_wU_3));
  SET_VECTOR_ELT(contents, 118, ScalarReal(internal->eta));
  SEXP I0 = PROTECT(allocVector(REALSXP, internal->dim_I0));
  memcpy(REAL(I0), internal->I0, internal->dim_I0 * sizeof(double));
  odin_set_dim(I0, 2, internal->dim_I0_1, internal->dim_I0_2);
  SET_VECTOR_ELT(contents, 119, I0);
  SEXP initial_A = PROTECT(allocVector(REALSXP, internal->dim_A));
  memcpy(REAL(initial_A), internal->initial_A, internal->dim_A * sizeof(double));
  odin_set_dim(initial_A, 2, internal->dim_A_1, internal->dim_A_2);
  SET_VECTOR_ELT(contents, 120, initial_A);
  SEXP initial_cum_diag_a = PROTECT(allocVector(REALSXP, internal->dim_cum_diag_a));
  memcpy(REAL(initial_cum_diag_a), internal->initial_cum_diag_a, internal->dim_cum_diag_a * sizeof(double));
  odin_set_dim(initial_cum_diag_a, 2, internal->dim_cum_diag_a_1, internal->dim_cum_diag_a_2);
  SET_VECTOR_ELT(contents, 121, initial_cum_diag_a);
  SEXP initial_cum_diag_s = PROTECT(allocVector(REALSXP, internal->dim_cum_diag_s));
  memcpy(REAL(initial_cum_diag_s), internal->initial_cum_diag_s, internal->dim_cum_diag_s * sizeof(double));
  odin_set_dim(initial_cum_diag_s, 2, internal->dim_cum_diag_s_1, internal->dim_cum_diag_s_2);
  SET_VECTOR_ELT(contents, 122, initial_cum_diag_s);
  SEXP initial_cum_incid = PROTECT(allocVector(REALSXP, internal->dim_cum_incid));
  memcpy(REAL(initial_cum_incid), internal->initial_cum_incid, internal->dim_cum_incid * sizeof(double));
  odin_set_dim(initial_cum_incid, 2, internal->dim_cum_incid_1, internal->dim_cum_incid_2);
  SET_VECTOR_ELT(contents, 123, initial_cum_incid);
  ...
  SET_VECTOR_ELT(contents, 124, initial_cum_pye_trial_pov);
  ...
  SET_VECTOR_ELT(contents, 125, initial_cum_pye_true);
  SEXP initial_cum_screened = PROTECT(allocVector(REALSXP, internal->dim_cum_screened));
  memcpy(REAL(initial_cum_screened), internal->initial_cum_screened, internal->dim_cum_screened * sizeof(double));
  odin_set_dim(initial_cum_screened, 2, internal->dim_cum_screened_1, internal->dim_cum_screened_2);
  SET_VECTOR_ELT(contents, 126, initial_cum_screened);
  SEXP initial_cum_treated = PROTECT(allocVector(REALSXP, internal->dim_cum_treated));
  memcpy(REAL(initial_cum_treated), internal->initial_cum_treated, internal->dim_cum_treated * sizeof(double));
  odin_set_dim(initial_cum_treated, 2, internal->dim_cum_treated_1, internal->dim_cum_treated_2);
  SET_VECTOR_ELT(contents, 127, initial_cum_treated);
  SEXP initial_I = PROTECT(allocVector(REALSXP, internal->dim_I));
  memcpy(REAL(initial_I), internal->initial_I, internal->dim_I * sizeof(double));
  odin_set_dim(initial_I, 2, internal->dim_I_1, internal->dim_I_2);
  SET_VECTOR_ELT(contents, 128, initial_I);
  SEXP initial_S = PROTECT(allocVector(REALSXP, internal->dim_S));
  memcpy(REAL(initial_S), internal->initial_S, internal->dim_S * sizeof(double));
  odin_set_dim(initial_S, 2, internal->dim_S_1, internal->dim_S_2);
  SET_VECTOR_ELT(contents, 129, initial_S);
  SEXP initial_T = PROTECT(allocVector(REALSXP, internal->dim_T));
  memcpy(REAL(initial_T), internal->initial_T, internal->dim_T * sizeof(double));
  odin_set_dim(initial_T, 2, internal->dim_T_1, internal->dim_T_2);
  SET_VECTOR_ELT(contents, 130, initial_T);
  SEXP initial_U = PROTECT(allocVector(REALSXP, internal->dim_U));
  memcpy(REAL(initial_U), internal->initial_U, internal->dim_U * sizeof(double));
  odin_set_dim(initial_U, 2, internal->dim_U_1, internal->dim_U_2);
  SET_VECTOR_ELT(contents, 131, initial_U);
  SET_VECTOR_ELT(contents, 132, ScalarReal(internal->lambda));
  SET_VECTOR_ELT(contents, 133, ScalarReal(internal->mu));
  SEXP N = PROTECT(allocVector(REALSXP, internal->dim_N));
  memcpy(REAL(N), internal->N, internal->dim_N * sizeof(double));
  odin_set_dim(N, 2, internal->dim_N_1, internal->dim_N_2);
  SET_VECTOR_ELT(contents, 134, N);
  SEXP n_AT = PROTECT(allocVector(REALSXP, internal->dim_n_AT));
  memcpy(REAL(n_AT), internal->n_AT, internal->dim_n_AT * sizeof(double));
  odin_set_dim(n_AT, 2, internal->dim_n_AT_1, internal->dim_n_AT_2);
  SET_VECTOR_ELT(contents, 135, n_AT);
  SEXP n_AU = PROTECT(allocVector(REALSXP, internal->dim_n_AU));
  memcpy(REAL(n_AU), internal->n_AU, internal->dim_n_AU * sizeof(double));
  odin_set_dim(n_AU, 2, internal->dim_n_AU_1, internal->dim_n_AU_2);
  SET_VECTOR_ELT(contents, 136, n_AU);
  SEXP n_diag_rec = PROTECT(allocVector(REALSXP, internal->dim_n_diag_rec));
  memcpy(REAL(n_diag_rec), internal->n_diag_rec, internal->dim_n_diag_rec * sizeof(double));
  odin_set_dim(n_diag_rec, 3, internal->dim_n_diag_rec_1, internal->dim_n_diag_rec_2, internal->dim_n_diag_rec_3);
  SET_VECTOR_ELT(contents, 137, n_diag_rec);
  SET_VECTOR_ELT(contents, 138, ScalarInteger(internal->n_group));
  SEXP n_ST = PROTECT(allocVector(REALSXP, internal->dim_n_ST));
  memcpy(REAL(n_ST), internal->n_ST, internal->dim_n_ST * sizeof(double));
  odin_set_dim(n_ST, 2, internal->dim_n_ST_1, internal->dim_n_ST_2);
  SET_VECTOR_ELT(contents, 139, n_ST);
  SEXP n_TU = PROTECT(allocVector(REALSXP, internal->dim_n_TU));
  memcpy(REAL(n_TU), internal->n_TU, internal->dim_n_TU * sizeof(double));
  odin_set_dim(n_TU, 2, internal->dim_n_TU_1, internal->dim_n_TU_2);
  SET_VECTOR_ELT(contents, 140, n_TU);
  SEXP n_UI = PROTECT(allocVector(REALSXP, internal->dim_n_UI));
  memcpy(REAL(n_UI), internal->n_UI, internal->dim_n_UI * sizeof(double));
  odin_set_dim(n_UI, 2, internal->dim_n_UI_1, internal->dim_n_UI_2);
  SET_VECTOR_ELT(contents, 141, n_UI);
  SET_VECTOR_ELT(contents, 142, ScalarInteger(internal->n_vax));
  SET_VECTOR_ELT(contents, 143, ScalarReal(internal->nu));
  SET_VECTOR_ELT(contents, 144, ScalarInteger(internal->offset_variable_A));
  SET_VECTOR_ELT(contents, 145, ScalarInteger(internal->offset_variable_cum_diag_a));
  SET_VECTOR_ELT(contents, 146, ScalarInteger(internal->offset_variable_cum_diag_s));
  SET_VECTOR_ELT(contents, 147, ScalarInteger(internal->offset_variable_cum_incid));
  SET_VECTOR_ELT(contents, 148, ScalarInteger(internal->offset_variable_cum_pye_trial_pov));
  SET_VECTOR_ELT(contents, 149, ScalarInteger(internal->offset_variable_cum_pye_true));
  SET_VECTOR_ELT(contents, 150, ScalarInteger(internal->offset_variable_cum_screened));
  SET_VECTOR_ELT(contents, 151, ScalarInteger(internal->offset_variable_cum_treated));
  SET_VECTOR_ELT(contents, 152, ScalarInteger(internal->offset_variable_S));
  SET_VECTOR_ELT(contents, 153, ScalarInteger(internal->offset_variable_T));
  SET_VECTOR_ELT(contents, 154, ScalarReal(internal->psi));
  ...
  SET_VECTOR_ELT(contents, 155, pye_trial);
  SET_VECTOR_ELT(contents, 156, ScalarReal(internal->rho));
  SEXP S0 = PROTECT(allocVector(REALSXP, internal->dim_S0));
  memcpy(REAL(S0), internal->S0, internal->dim_S0 * sizeof(double));
  odin_set_dim(S0, 2, internal->dim_S0_1, internal->dim_S0_2);
  SET_VECTOR_ELT(contents, 157, S0);
  SEXP screened = PROTECT(allocVector(REALSXP, internal->dim_screened));
  memcpy(REAL(screened), internal->screened, internal->dim_screened * sizeof(double));
  odin_set_dim(screened, 2, internal->dim_screened_1, internal->dim_screened_2);
  SET_VECTOR_ELT(contents, 158, screened);
  SET_VECTOR_ELT(contents, 159, ScalarReal(internal->sigma));
  SEXP T0 = PROTECT(allocVector(REALSXP, internal->dim_T0));
  memcpy(REAL(T0), internal->T0, internal->dim_T0 * sizeof(double));
  odin_set_dim(T0, 2, internal->dim_T0_1, internal->dim_T0_2);
  SET_VECTOR_ELT(contents, 160, T0);
  SEXP U0 = PROTECT(allocVector(REALSXP, internal->dim_U0));
  memcpy(REAL(U0), internal->U0, internal->dim_U0 * sizeof(double));
  odin_set_dim(U0, 2, internal->dim_U0_1, internal->dim_U0_2);
  SET_VECTOR_ELT(contents, 161, U0);
  SEXP vea = PROTECT(allocVector(REALSXP, internal->dim_vea));
  memcpy(REAL(vea), internal->vea, internal->dim_vea * sizeof(double));
  SET_VECTOR_ELT(contents, 162, vea);
  SEXP ved = PROTECT(allocVector(REALSXP, internal->dim_ved));
  memcpy(REAL(ved), internal->ved, internal->dim_ved * sizeof(double));
  SET_VECTOR_ELT(contents, 163, ved);
  SEXP ves = PROTECT(allocVector(REALSXP, internal->dim_ves));
  memcpy(REAL(ves), internal->ves, internal->dim_ves * sizeof(double));
  SET_VECTOR_ELT(contents, 164, ves);
  SEXP w = PROTECT(allocVector(REALSXP, internal->dim_w));
  memcpy(REAL(w), internal->w, internal->dim_w * sizeof(double));
  odin_set_dim(w, 2, internal->dim_w_1, internal->dim_w_2);
  SET_VECTOR_ELT(contents, 165, w);
  SEXP wA = PROTECT(allocVector(REALSXP, internal->dim_wA));
  memcpy(REAL(wA), internal->wA, internal->dim_wA * sizeof(double));
  odin_set_dim(wA, 3, internal->dim_wA_1, internal->dim_wA_2, internal->dim_wA_3);
  SET_VECTOR_ELT(contents, 166, wA);
  SEXP wI = PROTECT(allocVector(REALSXP, internal->dim_wI));
  memcpy(REAL(wI), internal->wI, internal->dim_wI * sizeof(double));
  odin_set_dim(wI, 3, internal->dim_wI_1, internal->dim_wI_2, internal->dim_wI_3);
  SET_VECTOR_ELT(contents, 167, wI);
  SEXP wS = PROTECT(allocVector(REALSXP, internal->dim_wS));
  memcpy(REAL(wS), internal->wS, internal->dim_wS * sizeof(double));
  odin_set_dim(wS, 3, internal->dim_wS_1, internal->dim_wS_2, internal->dim_wS_3);
  SET_VECTOR_ELT(contents, 168, wS);
  SEXP wT = PROTECT(allocVector(REALSXP, internal->dim_wT));
  memcpy(REAL(wT), internal->wT, internal->dim_wT * sizeof(double));
  odin_set_dim(wT, 3, internal->dim_wT_1, internal->dim_wT_2, internal->dim_wT_3);
  SET_VECTOR_ELT(contents, 169, wT);
  SEXP wU = PROTECT(allocVector(REALSXP, internal->dim_wU));
  memcpy(REAL(wU), internal->wU, internal->dim_wU * sizeof(double));
  odin_set_dim(wU, 3, internal->dim_wU_1, internal->dim_wU_2, internal->dim_wU_3);
  SET_VECTOR_ELT(contents, 170, wU);
  SEXP nms = PROTECT(allocVector(STRSXP, 171));
  SET_STRING_ELT(nms, 0, mkChar("A0"));
  ...
  SET_STRING_ELT(nms, 17, mkChar("dim_cum_pye_trial_pov"));
  SET_STRING_ELT(nms, 18, mkChar("dim_cum_pye_trial_pov_1"));
  SET_STRING_ELT(nms, 19, mkChar("dim_cum_pye_trial_pov_2"));
  SET_STRING_ELT(nms, 20, mkChar("dim_cum_pye_true"));
  SET_STRING_ELT(nms, 21, mkChar("dim_cum_pye_true_1"));
  SET_STRING_ELT(nms, 22, mkChar("dim_cum_pye_true_2"));
  SET_STRING_ELT(nms, 23, mkChar("dim_cum_screened"));
  SET_STRING_ELT(nms, 24, mkChar("dim_cum_screened_1"));
  SET_STRING_ELT(nms, 25, mkChar("dim_cum_screened_2"));
  SET_STRING_ELT(nms, 26, mkChar("dim_cum_treated"));
  SET_STRING_ELT(nms, 27, mkChar("dim_cum_treated_1"));
  SET_STRING_ELT(nms, 28, mkChar("dim_cum_treated_2"));
  SET_STRING_ELT(nms, 29, mkChar("dim_diag_rec"));
  SET_STRING_ELT(nms, 30, mkChar("dim_diag_rec_1"));
  SET_STRING_ELT(nms, 31, mkChar("dim_diag_rec_12"));
  SET_STRING_ELT(nms, 32, mkChar("dim_diag_rec_2"));
  SET_STRING_ELT(nms, 33, mkChar("dim_diag_rec_3"));
  ...
  SET_STRING_ELT(nms, 63, mkChar("dim_pye_trial"));
  SET_STRING_ELT(nms, 64, mkChar("dim_pye_trial_1"));
  SET_STRING_ELT(nms, 65, mkChar("dim_pye_trial_2"));
  SET_STRING_ELT(nms, 66, mkChar("dim_S"));
  SET_STRING_ELT(nms, 67, mkChar("dim_S_1"));
  SET_STRING_ELT(nms, 68, mkChar("dim_S_2"));
  SET_STRING_ELT(nms, 69, mkChar("dim_S0"));
  SET_STRING_ELT(nms, 70, mkChar("dim_S0_1"));
  SET_STRING_ELT(nms, 71, mkChar("dim_S0_2"));
  SET_STRING_ELT(nms, 72, mkChar("dim_screened"));
  SET_STRING_ELT(nms, 73, mkChar("dim_screened_1"));
  SET_STRING_ELT(nms, 74, mkChar("dim_screened_2"));
  SET_STRING_ELT(nms, 75, mkChar("dim_T"));
  SET_STRING_ELT(nms, 76, mkChar("dim_T_1"));
  SET_STRING_ELT(nms, 77, mkChar("dim_T_2"));
  SET_STRING_ELT(nms, 78, mkChar("dim_T0"));
  SET_STRING_ELT(nms, 79, mkChar("dim_T0_1"));
  SET_STRING_ELT(nms, 80, mkChar("dim_T0_2"));
  SET_STRING_ELT(nms, 81, mkChar("dim_U"));
  SET_STRING_ELT(nms, 82, mkChar("dim_U_1"));
  SET_STRING_ELT(nms, 83, mkChar("dim_U_2"));
  SET_STRING_ELT(nms, 84, mkChar("dim_U0"));
  SET_STRING_ELT(nms, 85, mkChar("dim_U0_1"));
  SET_STRING_ELT(nms, 86, mkChar("dim_U0_2"));
  SET_STRING_ELT(nms, 87, mkChar("dim_vea"));
  SET_STRING_ELT(nms, 88, mkChar("dim_ved"));
  SET_STRING_ELT(nms, 89, mkChar("dim_ves"));
  SET_STRING_ELT(nms, 90, mkChar("dim_w"));
  SET_STRING_ELT(nms, 91, mkChar("dim_w_1"));
  SET_STRING_ELT(nms, 92, mkChar("dim_w_2"));
  SET_STRING_ELT(nms, 93, mkChar("dim_wA"));
  SET_STRING_ELT(nms, 94, mkChar("dim_wA_1"));
  SET_STRING_ELT(nms, 95, mkChar("dim_wA_12"));
  SET_STRING_ELT(nms, 96, mkChar("dim_wA_2"));
  SET_STRING_ELT(nms, 97, mkChar("dim_wA_3"));
  SET_STRING_ELT(nms, 98, mkChar("dim_wI"));
  SET_STRING_ELT(nms, 99, mkChar("dim_wI_1"));
  SET_STRING_ELT(nms, 100, mkChar("dim_wI_12"));
  SET_STRING_ELT(nms, 101, mkChar("dim_wI_2"));
  SET_STRING_ELT(nms, 102, mkChar("dim_wI_3"));
  SET_STRING_ELT(nms, 103, mkChar("dim_wS"));
  SET_STRING_ELT(nms, 104, mkChar("dim_wS_1"));
  SET_STRING_ELT(nms, 105, mkChar("dim_wS_12"));
  SET_STRING_ELT(nms, 106, mkChar("dim_wS_2"));
  SET_STRING_ELT(nms, 107, mkChar("dim_wS_3"));
  SET_STRING_ELT(nms, 108, mkChar("dim_wT"));
  SET_STRING_ELT(nms, 109, mkChar("dim_wT_1"));
  SET_STRING_ELT(nms, 110, mkChar("dim_wT_12"));
  SET_STRING_ELT(nms, 111, mkChar("dim_wT_2"));
  SET_STRING_ELT(nms, 112, mkChar("dim_wT_3"));
  SET_STRING_ELT(nms, 113, mkChar("dim_wU"));
  SET_STRING_ELT(nms, 114, mkChar("dim_wU_1"));
  SET_STRING_ELT(nms, 115, mkChar("dim_wU_12"));
  SET_STRING_ELT(nms, 116, mkChar("dim_wU_2"));
  SET_STRING_ELT(nms, 117, mkChar("dim_wU_3"));
  SET_STRING_ELT(nms, 118, mkChar("eta"));
  SET_STRING_ELT(nms, 119, mkChar("I0"));
  SET_STRING_ELT(nms, 120, mkChar("initial_A"));
  SET_STRING_ELT(nms, 121, mkChar("initial_cum_diag_a"));
  SET_STRING_ELT(nms, 122, mkChar("initial_cum_diag_s"));
  SET_STRING_ELT(nms, 123, mkChar("initial_cum_incid"));
  SET_STRING_ELT(nms, 124, mkChar("initial_cum_pye_trial_pov"));
  SET_STRING_ELT(nms, 125, mkChar("initial_cum_pye_true"));
  SET_STRING_ELT(nms, 126, mkChar("initial_cum_screened"));
  SET_STRING_ELT(nms, 127, mkChar("initial_cum_treated"));
  SET_STRING_ELT(nms, 128, mkChar("initial_I"));
  SET_STRING_ELT(nms, 129, mkChar("initial_S"));
  SET_STRING_ELT(nms, 130, mkChar("initial_T"));
  SET_STRING_ELT(nms, 131, mkChar("initial_U"));
  SET_STRING_ELT(nms, 132, mkChar("lambda"));
  SET_STRING_ELT(nms, 133, mkChar("mu"));
  SET_STRING_ELT(nms, 134, mkChar("N"));
  SET_STRING_ELT(nms, 135, mkChar("n_AT"));
  SET_STRING_ELT(nms, 136, mkChar("n_AU"));
  SET_STRING_ELT(nms, 137, mkChar("n_diag_rec"));
  SET_STRING_ELT(nms, 138, mkChar("n_group"));
  SET_STRING_ELT(nms, 139, mkChar("n_ST"));
  SET_STRING_ELT(nms, 140, mkChar("n_TU"));
  SET_STRING_ELT(nms, 141, mkChar("n_UI"));
  SET_STRING_ELT(nms, 142, mkChar("n_vax"));
  SET_STRING_ELT(nms, 143, mkChar("nu"));
  SET_STRING_ELT(nms, 144, mkChar("offset_variable_A"));
  SET_STRING_ELT(nms, 145, mkChar("offset_variable_cum_diag_a"));
  SET_STRING_ELT(nms, 146, mkChar("offset_variable_cum_diag_s"));
  SET_STRING_ELT(nms, 147, mkChar("offset_variable_cum_incid"));
  SET_STRING_ELT(nms, 148, mkChar("offset_variable_cum_pye_trial_pov"));
  SET_STRING_ELT(nms, 149, mkChar("offset_variable_cum_pye_true"));
  SET_STRING_ELT(nms, 150, mkChar("offset_variable_cum_screened"));
  SET_STRING_ELT(nms, 151, mkChar("offset_variable_cum_treated"));
  SET_STRING_ELT(nms, 152, mkChar("offset_variable_S"));
  SET_STRING_ELT(nms, 153, mkChar("offset_variable_T"));
  SET_STRING_ELT(nms, 154, mkChar("psi"));
  SET_STRING_ELT(nms, 155, mkChar("pye_trial"));
  SET_STRING_ELT(nms, 156, mkChar("rho"));
  SET_STRING_ELT(nms, 157, mkChar("S0"));
  SET_STRING_ELT(nms, 158, mkChar("screened"));
  SET_STRING_ELT(nms, 159, mkChar("sigma"));
  SET_STRING_ELT(nms, 160, mkChar("T0"));
  SET_STRING_ELT(nms, 161, mkChar("U0"));
  SET_STRING_ELT(nms, 162, mkChar("vea"));
  SET_STRING_ELT(nms, 163, mkChar("ved"));
  SET_STRING_ELT(nms, 164, mkChar("ves"));
  SET_STRING_ELT(nms, 165, mkChar("w"));
  SET_STRING_ELT(nms, 166, mkChar("wA"));
  SET_STRING_ELT(nms, 167, mkChar("wI"));
  SET_STRING_ELT(nms, 168, mkChar("wS"));
  SET_STRING_ELT(nms, 169, mkChar("wT"));
  SET_STRING_ELT(nms, 170, mkChar("wU"));
  setAttrib(contents, R_NamesSymbol, nms);
  UNPROTECT(38);
  return contents;
}
...
SEXP model_trial_stochastic_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 281));
  SEXP A0 = PROTECT(allocVector(REALSXP, internal->dim_A0));
  memcpy(REAL(A0), internal->A0, internal->dim_A0 * sizeof(double));
  odin_set_dim(A0, 2, internal->dim_A0_1, internal->dim_A0_2);
  SET_VECTOR_ELT(contents, 0, A0);
  ...
  SET_VECTOR_ELT(contents, 31, ScalarInteger(internal->dim_diag_rec));
  SET_VECTOR_ELT(contents, 32, ScalarInteger(internal->dim_diag_rec_1));
  SET_VECTOR_ELT(contents, 33, ScalarInteger(internal->dim_diag_rec_12));
  SET_VECTOR_ELT(contents, 34, ScalarInteger(internal->dim_diag_rec_2));
  SET_VECTOR_ELT(contents, 35, ScalarInteger(internal->dim_diag_rec_3));
  ...
  SET_VECTOR_ELT(contents, 122, ScalarInteger(internal->dim_pye_trial));
  SET_VECTOR_ELT(contents, 123, ScalarInteger(internal->dim_pye_trial_1));
  SET_VECTOR_ELT(contents, 124, ScalarInteger(internal->dim_pye_trial_2));
  SET_VECTOR_ELT(contents, 125, ScalarInteger(internal->dim_r_AT));
  SET_VECTOR_ELT(contents, 126, ScalarInteger(internal->dim_r_AT_1));
  SET_VECTOR_ELT(contents, 127, ScalarInteger(internal->dim_r_AT_2));
  SET_VECTOR_ELT(contents, 128, ScalarInteger(internal->dim_r_AU));
  SET_VECTOR_ELT(contents, 129, ScalarInteger(internal->dim_r_AU_1));
  SET_VECTOR_ELT(contents, 130, ScalarInteger(internal->dim_r_AU_2));
  SET_VECTOR_ELT(contents, 131, ScalarInteger(internal->dim_Rel_A));
  SET_VECTOR_ELT(contents, 132, ScalarInteger(internal->dim_Rel_A_1));
  SET_VECTOR_ELT(contents, 133, ScalarInteger(internal->dim_Rel_A_2));
  SET_VECTOR_ELT(contents, 134, ScalarInteger(internal->dim_Rel_I));
  SET_VECTOR_ELT(contents, 135, ScalarInteger(internal->dim_Rel_I_1));
  SET_VECTOR_ELT(contents, 136, ScalarInteger(internal->dim_Rel_I_2));
  SET_VECTOR_ELT(contents, 137, ScalarInteger(internal->dim_Rel_S));
  SET_VECTOR_ELT(contents, 138, ScalarInteger(internal->dim_Rel_S_1));
  SET_VECTOR_ELT(contents, 139, ScalarInteger(internal->dim_Rel_S_2));
  SET_VECTOR_ELT(contents, 140, ScalarInteger(internal->dim_Rel_T));
  SET_VECTOR_ELT(contents, 141, ScalarInteger(internal->dim_Rel_T_1));
  SET_VECTOR_ELT(contents, 142, ScalarInteger(internal->dim_Rel_T_2));
  SET_VECTOR_ELT(contents, 143, ScalarInteger(internal->dim_Rel_U));
  SET_VECTOR_ELT(contents, 144, ScalarInteger(internal->dim_Rel_U_1));
  SET_VECTOR_ELT(contents, 145, ScalarInteger(internal->dim_Rel_U_2));
  SET_VECTOR_ELT(contents, 146, ScalarInteger(internal->dim_S));
  SET_VECTOR_ELT(contents, 147, ScalarInteger(internal->dim_S_1));
  SET_VECTOR_ELT(contents, 148, ScalarInteger(internal->dim_S_2));
  SET_VECTOR_ELT(contents, 149, ScalarInteger(internal->dim_S0));
  SET_VECTOR_ELT(contents, 150, ScalarInteger(internal->dim_S0_1));
  SET_VECTOR_ELT(contents, 151, ScalarInteger(internal->dim_S0_2));
  SET_VECTOR_ELT(contents, 152, ScalarInteger(internal->dim_screened));
  SET_VECTOR_ELT(contents, 153, ScalarInteger(internal->dim_screened_1));
  SET_VECTOR_ELT(contents, 154, ScalarInteger(internal->dim_screened_2));
  SET_VECTOR_ELT(contents, 155, ScalarInteger(internal->dim_T));
  SET_VECTOR_ELT(contents, 156, ScalarInteger(internal->dim_T_1));
  SET_VECTOR_ELT(contents, 157, ScalarInteger(internal->dim_T_2));
  SET_VECTOR_ELT(contents, 158, ScalarInteger(internal->dim_T0));
  SET_VECTOR_ELT(contents, 159, ScalarInteger(internal->dim_T0_1));
  SET_VECTOR_ELT(contents, 160, ScalarInteger(internal->dim_T0_2));
  SET_VECTOR_ELT(contents, 161, ScalarInteger(internal->dim_U));
  SET_VECTOR_ELT(contents, 162, ScalarInteger(internal->dim_U_1));
  SET_VECTOR_ELT(contents, 163, ScalarInteger(internal->dim_U_2));
  SET_VECTOR_ELT(contents, 164, ScalarInteger(internal->dim_U0));
  SET_VECTOR_ELT(contents, 165, ScalarInteger(internal->dim_U0_1));
  SET_VECTOR_ELT(contents, 166, ScalarInteger(internal->dim_U0_2));
  SET_VECTOR_ELT(contents, 167, ScalarInteger(internal->dim_vea));
  SET_VECTOR_ELT(contents, 168, ScalarInteger(internal->dim_ved));
  SET_VECTOR_ELT(contents, 169, ScalarInteger(internal->dim_ves));
  SET_VECTOR_ELT(contents, 170, ScalarInteger(internal->dim_w));
  SET_VECTOR_ELT(contents, 171, ScalarInteger(internal->dim_w_1));
  SET_VECTOR_ELT(contents, 172, ScalarInteger(internal->dim_w_2));
  SET_VECTOR_ELT(contents, 173, ScalarInteger(internal->dim_wA));
  SET_VECTOR_ELT(contents, 174, ScalarInteger(internal->dim_wA_1));
  SET_VECTOR_ELT(contents, 175, ScalarInteger(internal->dim_wA_12));
  SET_VECTOR_ELT(contents, 176, ScalarInteger(internal->dim_wA_2));
  SET_VECTOR_ELT(contents, 177, ScalarInteger(internal->dim_wA_3));
  SET_VECTOR_ELT(contents, 178, ScalarInteger(internal->dim_wI));
  SET_VECTOR_ELT(contents, 179, ScalarInteger(internal->dim_wI_1));
  SET_VECTOR_ELT(contents, 180, ScalarInteger(internal->dim_wI_12));
  SET_VECTOR_ELT(contents, 181, ScalarInteger(internal->dim_wI_2));
  SET_VECTOR_ELT(contents, 182, ScalarInteger(internal->dim_wI_3));
  SET_VECTOR_ELT(contents, 183, ScalarInteger(internal->dim_wS));
  SET_VECTOR_ELT(contents, 184, ScalarInteger(internal->dim_wS_1));
  SET_VECTOR_ELT(contents, 185, ScalarInteger(internal->dim_wS_12));
  SET_VECTOR_ELT(contents, 186, ScalarInteger(internal->dim_wS_2));
  SET_VECTOR_ELT(contents, 187, ScalarInteger(internal->dim_wS_3));
  SET_VECTOR_ELT(contents, 188, ScalarInteger(internal->dim_wT));
  SET_VECTOR_ELT(contents, 189, ScalarInteger(internal->dim_wT_1));
  SET_VECTOR_ELT(contents, 190, ScalarInteger(internal->dim_wT_12));
  SET_VECTOR_ELT(contents, 191, ScalarInteger(internal->dim_wT_2));
  SET_VECTOR_ELT(contents, 192, ScalarInteger(internal->dim_wT_3));
  SET_VECTOR_ELT(contents, 193, ScalarInteger(internal->dim_wU));
  SET_VECTOR_ELT(contents, 194, ScalarInteger(internal->dim_wU_1));
  SET_VECTOR_ELT(contents, 195, ScalarInteger(internal->dim_wU_12));
  SET_VECTOR_ELT(contents, 196, ScalarInteger(internal->dim_wU_2));
  SET_VECTOR_ELT(contents, 197, ScalarInteger(internal->dim_wU_3));
  SET_VECTOR_ELT(contents, 198, ScalarReal(internal->dt));
  SET_VECTOR_ELT(contents, 199, ScalarReal(internal->eta));
  SEXP I0 = PROTECT(allocVector(REALSXP, internal->dim_I0));
  memcpy(REAL(I0), internal->I0, internal->dim_I0 * sizeof(double));
  odin_set_dim(I0, 2, internal->dim_I0_1, internal->dim_I0_2);
  SET_VECTOR_ELT(contents, 200, I0);
  SEXP initial_A = PROTECT(allocVector(REALSXP, internal->dim_A));
  memcpy(REAL(initial_A), internal->initial_A, internal->dim_A * sizeof(double));
  odin_set_dim(initial_A, 2, internal->dim_A_1, internal->dim_A_2);
  SET_VECTOR_ELT(contents, 201, initial_A);
  SEXP initial_cum_diag_a = PROTECT(allocVector(REALSXP, internal->dim_cum_diag_a));
  memcpy(REAL(initial_cum_diag_a), internal->initial_cum_diag_a, internal->dim_cum_diag_a * sizeof(double));
  odin_set_dim(initial_cum_diag_a, 2, internal->dim_cum_diag_a_1, internal->dim_cum_diag_a_2);
  SET_VECTOR_ELT(contents, 202, initial_cum_diag_a);
  SEXP initial_cum_diag_s = PROTECT(allocVector(REALSXP, internal->dim_cum_diag_s));
  memcpy(REAL(initial_cum_diag_s), internal->initial_cum_diag_s, internal->dim_cum_diag_s * sizeof(double));
  odin_set_dim(initial_cum_diag_s, 2, internal->dim_cum_diag_s_1, internal->dim_cum_diag_s_2);
  SET_VECTOR_ELT(contents, 203, initial_cum_diag_s);
  SEXP initial_cum_incid = PROTECT(allocVector(REALSXP, internal->dim_cum_incid));
  memcpy(REAL(initial_cum_incid), internal->initial_cum_incid, internal->dim_cum_incid * sizeof(double));
  odin_set_dim(initial_cum_incid, 2, internal->dim_cum_incid_1, internal->dim_cum_incid_2);
  SET_VECTOR_ELT(contents, 204, initial_cum_incid);
  SEXP initial_cum_pye_trial_pov = PROTECT(allocVector(REALSXP, internal->dim_cum_pye_trial_pov));
  memcpy(REAL(initial_cum_pye_trial_pov), internal->initial_cum_pye_trial_pov, internal->dim_cum_pye_trial_pov * sizeof(double));
  odin_set_dim(initial_cum_pye_trial_pov, 2, internal->dim_cum_pye_trial_pov_1, internal->dim_cum_pye_trial_pov_2);
  SET_VECTOR_ELT(contents, 205, initial_cum_pye_trial_pov);
  SEXP initial_cum_pye_true = PROTECT(allocVector(REALSXP, internal->dim_cum_pye_true));
  memcpy(REAL(initial_cum_pye_true), internal->initial_cum_pye_true, internal->dim_cum_pye_true * sizeof(double));
  odin_set_dim(initial_cum_pye_true, 2, internal->dim_cum_pye_true_1, internal->dim_cum_pye_true_2);
  SET_VECTOR_ELT(contents, 206, initial_cum_pye_true);
  SEXP initial_cum_screened = PROTECT(allocVector(REALSXP, internal->dim_cum_screened));
  memcpy(REAL(initial_cum_screened), internal->initial_cum_screened, internal->dim_cum_screened * sizeof(double));
  odin_set_dim(initial_cum_screened, 2, internal->dim_cum_screened_1, internal->dim_cum_screened_2);
  SET_VECTOR_ELT(contents, 207, initial_cum_screened);
  SEXP initial_cum_treated = PROTECT(allocVector(REALSXP, internal->dim_cum_treated));
  memcpy(REAL(initial_cum_treated), internal->initial_cum_treated, internal->dim_cum_treated * sizeof(double));
  odin_set_dim(initial_cum_treated, 2, internal->dim_cum_treated_1, internal->dim_cum_treated_2);
  SET_VECTOR_ELT(contents, 208, initial_cum_treated);
  SEXP initial_I = PROTECT(allocVector(REALSXP, internal->dim_I));
  memcpy(REAL(initial_I), internal->initial_I, internal->dim_I * sizeof(double));
  odin_set_dim(initial_I, 2, internal->dim_I_1, internal->dim_I_2);
  SET_VECTOR_ELT(contents, 209, initial_I);
  SEXP initial_S = PROTECT(allocVector(REALSXP, internal->dim_S));
  memcpy(REAL(initial_S), internal->initial_S, internal->dim_S * sizeof(double));
  odin_set_dim(initial_S, 2, internal->dim_S_1, internal->dim_S_2);
  ...
  memcpy(REAL(initial_T), internal->initial_T, internal->dim_T * sizeof(double));
  odin_set_dim(initial_T, 2, internal->dim_T_1, internal->dim_T_2);
  SET_VECTOR_ELT(contents, 211, initial_T);
  SET_VECTOR_ELT(contents, 212, ScalarReal(internal->initial_time));
  SEXP initial_U = PROTECT(allocVector(REALSXP, internal->dim_U));
  memcpy(REAL(initial_U), internal->initial_U, internal->dim_U * sizeof(double));
  odin_set_dim(initial_U, 2, internal->dim_U_1, internal->dim_U_2);
  SET_VECTOR_ELT(contents, 213, initial_U);
  SET_VECTOR_ELT(contents, 214, ScalarReal(internal->lambda));
  SET_VECTOR_ELT(contents, 215, ScalarReal(internal->mu));
  SEXP N = PROTECT(allocVector(REALSXP, internal->dim_N));
  memcpy(REAL(N), internal->N, internal->dim_N * sizeof(double));
  odin_set_dim(N, 2, internal->dim_N_1, internal->dim_N_2);
  SET_VECTOR_ELT(contents, 216, N);
  ...
  SET_VECTOR_ELT(contents, 217, n_A_ext);
  SEXP n_AT = PROTECT(allocVector(REALSXP, internal->dim_n_AT));
  memcpy(REAL(n_AT), internal->n_AT, internal->dim_n_AT * sizeof(double));
  odin_set_dim(n_AT, 2, internal->dim_n_AT_1, internal->dim_n_AT_2);
  SET_VECTOR_ELT(contents, 218, n_AT);
  SEXP n_AU = PROTECT(allocVector(REALSXP, internal->dim_n_AU));
  memcpy(REAL(n_AU), internal->n_AU, internal->dim_n_AU * sizeof(double));
  odin_set_dim(n_AU, 2, internal->dim_n_AU_1, internal->dim_n_AU_2);
  SET_VECTOR_ELT(contents, 219, n_AU);
  ...
  SET_VECTOR_ELT(contents, 220, n_AUT);
  ...
  SET_VECTOR_ELT(contents, 221, n_Aw);
  SEXP n_diag_rec = PROTECT(allocVector(REALSXP, internal->dim_n_diag_rec));
  memcpy(REAL(n_diag_rec), internal->n_diag_rec, internal->dim_n_diag_rec * sizeof(double));
  odin_set_dim(n_diag_rec, 3, internal->dim_n_diag_rec_1, internal->dim_n_diag_rec_2, internal->dim_n_diag_rec_3);
  SET_VECTOR_ELT(contents, 222, n_diag_rec);
  SET_VECTOR_ELT(contents, 223, ScalarInteger(internal->n_group));
  ...
  SET_VECTOR_ELT(contents, 224, n_I_ext);
  ...
  SET_VECTOR_ELT(contents, 225, n_IA);
  ...
  SET_VECTOR_ELT(contents, 226, n_IAS);
  ...
  SET_VECTOR_ELT(contents, 227, n_IS);
  ...
  SET_VECTOR_ELT(contents, 228, n_Iw);
  ...
  SET_VECTOR_ELT(contents, 229, n_S_ext);
  SEXP n_ST = PROTECT(allocVector(REALSXP, internal->dim_n_ST));
  memcpy(REAL(n_ST), internal->n_ST, internal->dim_n_ST * sizeof(double));
  odin_set_dim(n_ST, 2, internal->dim_n_ST_1, internal->dim_n_ST_2);
  SET_VECTOR_ELT(contents, 230, n_ST);
  ...
  SET_VECTOR_ELT(contents, 231, n_Sw);
  ...
  SET_VECTOR_ELT(contents, 232, n_T_ext);
  SEXP n_TU = PROTECT(allocVector(REALSXP, internal->dim_n_TU));
  memcpy(REAL(n_TU), internal->n_TU, internal->dim_n_TU * sizeof(double));
  odin_set_dim(n_TU, 2, internal->dim_n_TU_1, internal->dim_n_TU_2);
  SET_VECTOR_ELT(contents, 233, n_TU);
  ...
  SET_VECTOR_ELT(contents, 234, n_Tw);
  ...
  SET_VECTOR_ELT(contents, 235, n_U_ext);
  SEXP n_UI = PROTECT(allocVector(REALSXP, internal->dim_n_UI));
  memcpy(REAL(n_UI), internal->n_UI, internal->dim_n_UI * sizeof(double));
  odin_set_dim(n_UI, 2, internal->dim_n_UI_1, internal->dim_n_UI_2);
  SET_VECTOR_ELT(contents, 236, n_UI);
  ...
  SET_VECTOR_ELT(contents, 237, n_Uw);
  SET_VECTOR_ELT(contents, 238, ScalarInteger(internal->n_vax));
  SET_VECTOR_ELT(contents, 239, ScalarReal(internal->nu));
  SET_VECTOR_ELT(contents, 240, ScalarInteger(internal->offset_variable_A));
  SET_VECTOR_ELT(contents, 241, ScalarInteger(internal->offset_variable_cum_diag_a));
  SET_VECTOR_ELT(contents, 242, ScalarInteger(internal->offset_variable_cum_diag_s));
  SET_VECTOR_ELT(contents, 243, ScalarInteger(internal->offset_variable_cum_incid));
  SET_VECTOR_ELT(contents, 244, ScalarInteger(internal->offset_variable_cum_pye_trial_pov));
  SET_VECTOR_ELT(contents, 245, ScalarInteger(internal->offset_variable_cum_pye_true));
  SET_VECTOR_ELT(contents, 246, ScalarInteger(internal->offset_variable_cum_screened));
  SET_VECTOR_ELT(contents, 247, ScalarInteger(internal->offset_variable_cum_treated));
  SET_VECTOR_ELT(contents, 248, ScalarInteger(internal->offset_variable_I));
  SET_VECTOR_ELT(contents, 249, ScalarInteger(internal->offset_variable_S));
  SET_VECTOR_ELT(contents, 250, ScalarInteger(internal->offset_variable_T));
  ...
  SET_VECTOR_ELT(contents, 251, p_A_ext);
  ...
  SET_VECTOR_ELT(contents, 252, p_I_ext);
  ...
  SET_VECTOR_ELT(contents, 253, p_S_ext);
  ...
  SET_VECTOR_ELT(contents, 254, p_T_ext);
  ...
  SET_VECTOR_ELT(contents, 255, p_U_ext);
  SET_VECTOR_ELT(contents, 256, ScalarReal(internal->psi));
  SEXP pye_trial = PROTECT(allocVector(REALSXP, internal->dim_pye_trial));
  memcpy(REAL(pye_trial), internal->pye_trial, internal->dim_pye_trial * sizeof(double));
  odin_set_dim(pye_trial, 2, internal->dim_pye_trial_1, internal->dim_pye_trial_2);
  SET_VECTOR_ELT(contents, 257, pye_trial);
  ...
  SET_VECTOR_ELT(contents, 258, r_AT);
  ...
  SET_VECTOR_ELT(contents, 259, r_AU);
  ...
  SET_VECTOR_ELT(contents, 260, Rel_A);
  ...
  SET_VECTOR_ELT(contents, 261, Rel_I);
  ...
  SET_VECTOR_ELT(contents, 262, Rel_S);
  ...
  SET_VECTOR_ELT(contents, 263, Rel_T);
  ...
  SET_VECTOR_ELT(contents, 264, Rel_U);
  SET_VECTOR_ELT(contents, 265, ScalarReal(internal->rho));
  SEXP S0 = PROTECT(allocVector(REALSXP, internal->dim_S0));
  memcpy(REAL(S0), internal->S0, internal->dim_S0 * sizeof(double));
  odin_set_dim(S0, 2, internal->dim_S0_1, internal->dim_S0_2);
  SET_VECTOR_ELT(contents, 266, S0);
  SEXP screened = PROTECT(allocVector(REALSXP, internal->dim_screened));
  memcpy(REAL(screened), internal->screened, internal->dim_screened * sizeof(double));
  odin_set_dim(screened, 2, internal->dim_screened_1, internal->dim_screened_2);
  SET_VECTOR_ELT(contents, 267, screened);
  SET_VECTOR_ELT(contents, 268, ScalarReal(internal->sigma));
  SET_VECTOR_ELT(contents, 269, ScalarReal(internal->steps_per_year));
  SEXP T0 = PROTECT(allocVector(REALSXP, internal->dim_T0));
  memcpy(REAL(T0), internal->T0, internal->dim_T0 * sizeof(double));
  odin_set_dim(T0, 2, internal->dim_T0_1, internal->dim_T0_2);
  SET_VECTOR_ELT(contents, 270, T0);
  SEXP U0 = PROTECT(allocVector(REALSXP, internal->dim_U0));
  memcpy(REAL(U0), internal->U0, internal->dim_U0 * sizeof(double));
  odin_set_dim(U0, 2, internal->dim_U0_1, internal->dim_U0_2);
  SET_VECTOR_ELT(contents, 271, U0);
  SEXP vea = PROTECT(allocVector(REALSXP, internal->dim_vea));
  memcpy(REAL(vea), internal->vea, internal->dim_vea * sizeof(double));
  SET_VECTOR_ELT(contents, 272, vea);
  SEXP ved = PROTECT(allocVector(REALSXP, internal->dim_ved));
  memcpy(REAL(ved), internal->ved, internal->dim_ved * sizeof(double));
  SET_VECTOR_ELT(contents, 273, ved);
  SEXP ves = PROTECT(allocVector(REALSXP, internal->dim_ves));
  memcpy(REAL(ves), internal->ves, internal->dim_ves * sizeof(double));
  SET_VECTOR_ELT(contents, 274, ves);
  SEXP w = PROTECT(allocVector(REALSXP, internal->dim_w));
  memcpy(REAL(w), internal->w, internal->dim_w * sizeof(double));
  odin_set_dim(w, 2, internal->dim_w_1, internal->dim_w_2);
  SET_VECTOR_ELT(contents, 275, w);
  SEXP wA = PROTECT(allocVector(REALSXP, internal->dim_wA));
  memcpy(REAL(wA), internal->wA, internal->dim_wA * sizeof(double));
  odin_set_dim(wA, 3, internal->dim_wA_1, internal->dim_wA_2, internal->dim_wA_3);
  SET_VECTOR_ELT(contents, 276, wA);
  SEXP wI = PROTECT(allocVector(REALSXP, internal->dim_wI));
  memcpy(REAL(wI), internal->wI, internal->dim_wI * sizeof(double));
  odin_set_dim(wI, 3, internal->dim_wI_1, internal->dim_wI_2, internal->dim_wI_3);
  SET_VECTOR_ELT(contents, 277, wI);
  SEXP wS = PROTECT(allocVector(REALSXP, internal->dim_wS));
  memcpy(REAL(wS), internal->wS, internal->dim_wS * sizeof(double));
  odin_set_dim(wS, 3, internal->dim_wS_1, internal->dim_wS_2, internal->dim_wS_3);
  SET_VECTOR_ELT(contents, 278, wS);
  SEXP wT = PROTECT(allocVector(REALSXP, internal->dim_wT));
  memcpy(REAL(wT), internal->wT, internal->dim_wT * sizeof(double));
  odin_set_dim(wT, 3, internal->dim_wT_1, internal->dim_wT_2, internal->dim_wT_3);
  SET_VECTOR_ELT(contents, 279, wT);
  SEXP wU = PROTECT(allocVector(REALSXP, internal->dim_wU));
  memcpy(REAL(wU), internal->wU, internal->dim_wU * sizeof(double));
  odin_set_dim(wU, 3, internal->dim_wU_1, internal->dim_wU_2, internal->dim_wU_3);
  SET_VECTOR_ELT(contents, 280, wU);
  SEXP nms = PROTECT(allocVector(STRSXP, 281));
  SET_STRING_ELT(nms, 0, mkChar("A0"));
  ...
  SET_STRING_ELT(nms, 31, mkChar("dim_diag_rec"));
  SET_STRING_ELT(nms, 32, mkChar("dim_diag_rec_1"));
  SET_STRING_ELT(nms, 33, mkChar("dim_diag_rec_12"));
  SET_STRING_ELT(nms, 34, mkChar("dim_diag_rec_2"));
  SET_STRING_ELT(nms, 35, mkChar("dim_diag_rec_3"));
  ...
  SET_STRING_ELT(nms, 122, mkChar("dim_pye_trial"));
  SET_STRING_ELT(nms, 123, mkChar("dim_pye_trial_1"));
  SET_STRING_ELT(nms, 124, mkChar("dim_pye_trial_2"));
  SET_STRING_ELT(nms, 125, mkChar("dim_r_AT"));
  SET_STRING_ELT(nms, 126, mkChar("dim_r_AT_1"));
  SET_STRING_ELT(nms, 127, mkChar("dim_r_AT_2"));
  SET_STRING_ELT(nms, 128, mkChar("dim_r_AU"));
  SET_STRING_ELT(nms, 129, mkChar("dim_r_AU_1"));
  SET_STRING_ELT(nms, 130, mkChar("dim_r_AU_2"));
  SET_STRING_ELT(nms, 131, mkChar("dim_Rel_A"));
  SET_STRING_ELT(nms, 132, mkChar("dim_Rel_A_1"));
  SET_STRING_ELT(nms, 133, mkChar("dim_Rel_A_2"));
  SET_STRING_ELT(nms, 134, mkChar("dim_Rel_I"));
  SET_STRING_ELT(nms, 135, mkChar("dim_Rel_I_1"));
  SET_STRING_ELT(nms, 136, mkChar("dim_Rel_I_2"));
  SET_STRING_ELT(nms, 137, mkChar("dim_Rel_S"));
  SET_STRING_ELT(nms, 138, mkChar("dim_Rel_S_1"));
  SET_STRING_ELT(nms, 139, mkChar("dim_Rel_S_2"));
  SET_STRING_ELT(nms, 140, mkChar("dim_Rel_T"));
  SET_STRING_ELT(nms, 141, mkChar("dim_Rel_T_1"));
  SET_STRING_ELT(nms, 142, mkChar("dim_Rel_T_2"));
  SET_STRING_ELT(nms, 143, mkChar("dim_Rel_U"));
  SET_STRING_ELT(nms, 144, mkChar("dim_Rel_U_1"));
  SET_STRING_ELT(nms, 145, mkChar("dim_Rel_U_2"));
  SET_STRING_ELT(nms, 146, mkChar("dim_S"));
  SET_STRING_ELT(nms, 147, mkChar("dim_S_1"));
  SET_STRING_ELT(nms, 148, mkChar("dim_S_2"));
  SET_STRING_ELT(nms, 149, mkChar("dim_S0"));
  SET_STRING_ELT(nms, 150, mkChar("dim_S0_1"));
  SET_STRING_ELT(nms, 151, mkChar("dim_S0_2"));
  SET_STRING_ELT(nms, 152, mkChar("dim_screened"));
  SET_STRING_ELT(nms, 153, mkChar("dim_screened_1"));
  SET_STRING_ELT(nms, 154, mkChar("dim_screened_2"));
  SET_STRING_ELT(nms, 155, mkChar("dim_T"));
  SET_STRING_ELT(nms, 156, mkChar("dim_T_1"));
  SET_STRING_ELT(nms, 157, mkChar("dim_T_2"));
  SET_STRING_ELT(nms, 158, mkChar("dim_T0"));
  SET_STRING_ELT(nms, 159, mkChar("dim_T0_1"));
  SET_STRING_ELT(nms, 160, mkChar("dim_T0_2"));
  SET_STRING_ELT(nms, 161, mkChar("dim_U"));
  SET_STRING_ELT(nms, 162, mkChar("dim_U_1"));
  SET_STRING_ELT(nms, 163, mkChar("dim_U_2"));
  SET_STRING_ELT(nms, 164, mkChar("dim_U0"));
  SET_STRING_ELT(nms, 165, mkChar("dim_U0_1"));
  SET_STRING_ELT(nms, 166, mkChar("dim_U0_2"));
  SET_STRING_ELT(nms, 167, mkChar("dim_vea"));
  SET_STRING_ELT(nms, 168, mkChar("dim_ved"));
  SET_STRING_ELT(nms, 169, mkChar("dim_ves"));
  SET_STRING_ELT(nms, 170, mkChar("dim_w"));
  SET_STRING_ELT(nms, 171, mkChar("dim_w_1"));
  SET_STRING_ELT(nms, 172, mkChar("dim_w_2"));
  SET_STRING_ELT(nms, 173, mkChar("dim_wA"));
  SET_STRING_ELT(nms, 174, mkChar("dim_wA_1"));
  SET_STRING_ELT(nms, 175, mkChar("dim_wA_12"));
  SET_STRING_ELT(nms, 176, mkChar("dim_wA_2"));
  SET_STRING_ELT(nms, 177, mkChar("dim_wA_3"));
  SET_STRING_ELT(nms, 178, mkChar("dim_wI"));
  SET_STRING_ELT(nms, 179, mkChar("dim_wI_1"));
  SET_STRING_ELT(nms, 180, mkChar("dim_wI_12"));
  SET_STRING_ELT(nms, 181, mkChar("dim_wI_2"));
  SET_STRING_ELT(nms, 182, mkChar("dim_wI_3"));
  SET_STRING_ELT(nms, 183, mkChar("dim_wS"));
  SET_STRING_ELT(nms, 184, mkChar("dim_wS_1"));
  SET_STRING_ELT(nms, 185, mkChar("dim_wS_12"));
  SET_STRING_ELT(nms, 186, mkChar("dim_wS_2"));
  SET_STRING_ELT(nms, 187, mkChar("dim_wS_3"));
  SET_STRING_ELT(nms, 188, mkChar("dim_wT"));
  SET_STRING_ELT(nms, 189, mkChar("dim_wT_1"));
  SET_STRING_ELT(nms, 190, mkChar("dim_wT_12"));
  SET_STRING_ELT(nms, 191, mkChar("dim_wT_2"));
  SET_STRING_ELT(nms, 192, mkChar("dim_wT_3"));
  SET_STRING_ELT(nms, 193, mkChar("dim_wU"));
  SET_STRING_ELT(nms, 194, mkChar("dim_wU_1"));
  SET_STRING_ELT(nms, 195, mkChar("dim_wU_12"));
  SET_STRING_ELT(nms, 196, mkChar("dim_wU_2"));
  SET_STRING_ELT(nms, 197, mkChar("dim_wU_3"));
  SET_STRING_ELT(nms, 198, mkChar("dt"));
  SET_STRING_ELT(nms, 199, mkChar("eta"));
  SET_STRING_ELT(nms, 200, mkChar("I0"));
  SET_STRING_ELT(nms, 201, mkChar("initial_A"));
  SET_STRING_ELT(nms, 202, mkChar("initial_cum_diag_a"));
  SET_STRING_ELT(nms, 203, mkChar("initial_cum_diag_s"));
  SET_STRING_ELT(nms, 204, mkChar("initial_cum_incid"));
  SET_STRING_ELT(nms, 205, mkChar("initial_cum_pye_trial_pov"));
  SET_STRING_ELT(nms, 206, mkChar("initial_cum_pye_true"));
  SET_STRING_ELT(nms, 207, mkChar("initial_cum_screened"));
  SET_STRING_ELT(nms, 208, mkChar("initial_cum_treated"));
  SET_STRING_ELT(nms, 209, mkChar("initial_I"));
  SET_STRING_ELT(nms, 210, mkChar("initial_S"));
  SET_STRING_ELT(nms, 211, mkChar("initial_T"));
  SET_STRING_ELT(nms, 212, mkChar("initial_time"));
  SET_STRING_ELT(nms, 213, mkChar("initial_U"));
  SET_STRING_ELT(nms, 214, mkChar("lambda"));
  SET_STRING_ELT(nms, 215, mkChar("mu"));
  SET_STRING_ELT(nms, 216, mkChar("N"));
  SET_STRING_ELT(nms, 217, mkChar("n_A_ext"));
  SET_STRING_ELT(nms, 218, mkChar("n_AT"));
  SET_STRING_ELT(nms, 219, mkChar("n_AU"));
  SET_STRING_ELT(nms, 220, mkChar("n_AUT"));
  SET_STRING_ELT(nms, 221, mkChar("n_Aw"));
  SET_STRING_ELT(nms, 222, mkChar("n_diag_rec"));
  SET_STRING_ELT(nms, 223, mkChar("n_group"));
  SET_STRING_ELT(nms, 224, mkChar("n_I_ext"));
  SET_STRING_ELT(nms, 225, mkChar("n_IA"));
  SET_STRING_ELT(nms, 226, mkChar("n_IAS"));
  SET_STRING_ELT(nms, 227, mkChar("n_IS"));
  SET_STRING_ELT(nms, 228, mkChar("n_Iw"));
  SET_STRING_ELT(nms, 229, mkChar("n_S_ext"));
  SET_STRING_ELT(nms, 230, mkChar("n_ST"));
  SET_STRING_ELT(nms, 231, mkChar("n_Sw"));
  SET_STRING_ELT(nms, 232, mkChar("n_T_ext"));
  SET_STRING_ELT(nms, 233, mkChar("n_TU"));
  SET_STRING_ELT(nms, 234, mkChar("n_Tw"));
  SET_STRING_ELT(nms, 235, mkChar("n_U_ext"));
  SET_STRING_ELT(nms, 236, mkChar("n_UI"));
  SET_STRING_ELT(nms, 237, mkChar("n_Uw"));
  SET_STRING_ELT(nms, 238, mkChar("n_vax"));
  SET_STRING_ELT(nms, 239, mkChar("nu"));
  SET_STRING_ELT(nms, 240, mkChar("offset_variable_A"));
  SET_STRING_ELT(nms, 241, mkChar("offset_variable_cum_diag_a"));
  SET_STRING_ELT(nms, 242, mkChar("offset_variable_cum_diag_s"));
  SET_STRING_ELT(nms, 243, mkChar("offset_variable_cum_incid"));
  SET_STRING_ELT(nms, 244, mkChar("offset_variable_cum_pye_trial_pov"));
  SET_STRING_ELT(nms, 245, mkChar("offset_variable_cum_pye_true"));
  SET_STRING_ELT(nms, 246, mkChar("offset_variable_cum_screened"));
  SET_STRING_ELT(nms, 247, mkChar("offset_variable_cum_treated"));
  SET_STRING_ELT(nms, 248, mkChar("offset_variable_I"));
  SET_STRING_ELT(nms, 249, mkChar("offset_variable_S"));
  SET_STRING_ELT(nms, 250, mkChar("offset_variable_T"));
  SET_STRING_ELT(nms, 251, mkChar("p_A_ext"));
  SET_STRING_ELT(nms, 252, mkChar("p_I_ext"));
  SET_STRING_ELT(nms, 253, mkChar("p_S_ext"));
  SET_STRING_ELT(nms, 254, mkChar("p_T_ext"));
  SET_STRING_ELT(nms, 255, mkChar("p_U_ext"));
  SET_STRING_ELT(nms, 256, mkChar("psi"));
  SET_STRING_ELT(nms, 257, mkChar("pye_trial"));
  SET_STRING_ELT(nms, 258, mkChar("r_AT"));
  SET_STRING_ELT(nms, 259, mkChar("r_AU"));
  SET_STRING_ELT(nms, 260, mkChar("Rel_A"));
  SET_STRING_ELT(nms, 261, mkChar("Rel_I"));
  SET_STRING_ELT(nms, 262, mkChar("Rel_S"));
  SET_STRING_ELT(nms, 263, mkChar("Rel_T"));
  SET_STRING_ELT(nms, 264, mkChar("Rel_U"));
  SET_STRING_ELT(nms, 265, mkChar("rho"));
  SET_STRING_ELT(nms, 266, mkChar("S0"));
  SET_STRING_ELT(nms, 267, mkChar("screened"));
  SET_STRING_ELT(nms, 268, mkChar("sigma"));
  SET_STRING_ELT(nms, 269, mkChar("steps_per_year"));
  SET_STRING_ELT(nms, 270, mkChar("T0"));
  SET_STRING_ELT(nms, 271, mkChar("U0"));
  SET_STRING_ELT(nms, 272, mkChar("vea"));
  SET_STRING_ELT(nms, 273, mkChar("ved"));
  SET_STRING_ELT(nms, 274, mkChar("ves"));
  SET_STRING_ELT(nms, 275, mkChar("w"));
  SET_STRING_ELT(nms, 276, mkChar("wA"));
  SET_STRING_ELT(nms, 277, mkChar("wI"));
  SET_STRING_ELT(nms, 278, mkChar("wS"));
  SET_STRING_ELT(nms, 279, mkChar("wT"));
  SET_STRING_ELT(nms, 280, mkChar("wU"));
  setAttrib(contents, R_NamesSymbol, nms);
  UNPROTECT(65);
  return contents;
}
