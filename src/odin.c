...
SEXP model_create(SEXP user) {
  ...
  internal->offset_output_N = internal->dim_eta + 3;
  R_Free(internal->omega_C);
...
SEXP model_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 458));
  ...
  SET_VECTOR_ELT(contents, 391, ScalarInteger(internal->offset_variable_A));
  SET_VECTOR_ELT(contents, 392, ScalarInteger(internal->offset_variable_cum_diag_a));
  SET_VECTOR_ELT(contents, 393, ScalarInteger(internal->offset_variable_cum_diag_s));
  SET_VECTOR_ELT(contents, 394, ScalarInteger(internal->offset_variable_cum_entrants));
  SET_VECTOR_ELT(contents, 395, ScalarInteger(internal->offset_variable_cum_incid));
  ...
  SET_VECTOR_ELT(contents, 428, u_d);
  ...
  SET_VECTOR_ELT(contents, 429, u_pn);
  ...
  SET_VECTOR_ELT(contents, 430, u_s);
  SET_VECTOR_ELT(contents, 431, ScalarReal(internal->u_vbe));
  ...
  SET_VECTOR_ELT(contents, 434, vax_t);
  ...
  SET_VECTOR_ELT(contents, 435, vax_y);
  ...
  SET_VECTOR_ELT(contents, 441, vod);
  ...
  SET_VECTOR_ELT(contents, 442, vopn);
  ...
  SET_VECTOR_ELT(contents, 443, vos);
  ...
  SET_VECTOR_ELT(contents, 445, wA);
  ...
  SET_VECTOR_ELT(contents, 446, wd);
  ...
  SET_VECTOR_ELT(contents, 447, wdA);
  ...
  SET_VECTOR_ELT(contents, 448, wdI);
  ...
  SET_VECTOR_ELT(contents, 449, wdS);
  ...
  SET_VECTOR_ELT(contents, 450, wdT);
  ...
  SET_VECTOR_ELT(contents, 451, wdU);
  ...
  SET_VECTOR_ELT(contents, 452, wI);
  ...
  SET_VECTOR_ELT(contents, 453, willing);
  ...
  SET_VECTOR_ELT(contents, 454, wS);
  ...
  SET_VECTOR_ELT(contents, 455, wT);
  ...
  SET_VECTOR_ELT(contents, 456, wU);
  ...
  SET_VECTOR_ELT(contents, 457, xi);
  SEXP nms = PROTECT(allocVector(STRSXP, 458));
  ...
  SET_STRING_ELT(nms, 391, mkChar("offset_variable_A"));
  SET_STRING_ELT(nms, 392, mkChar("offset_variable_cum_diag_a"));
  SET_STRING_ELT(nms, 393, mkChar("offset_variable_cum_diag_s"));
  SET_STRING_ELT(nms, 394, mkChar("offset_variable_cum_entrants"));
  SET_STRING_ELT(nms, 395, mkChar("offset_variable_cum_incid"));
  ...
  SET_STRING_ELT(nms, 426, mkChar("T0"));
  SET_STRING_ELT(nms, 427, mkChar("tt"));
  SET_STRING_ELT(nms, 428, mkChar("u_d"));
  SET_STRING_ELT(nms, 429, mkChar("u_pn"));
  SET_STRING_ELT(nms, 430, mkChar("u_s"));
  SET_STRING_ELT(nms, 431, mkChar("u_vbe"));
  SET_STRING_ELT(nms, 432, mkChar("U0"));
  SET_STRING_ELT(nms, 433, mkChar("Up"));
  SET_STRING_ELT(nms, 434, mkChar("vax_t"));
  SET_STRING_ELT(nms, 435, mkChar("vax_y"));
  SET_STRING_ELT(nms, 436, mkChar("vbe"));
  SET_STRING_ELT(nms, 437, mkChar("vea"));
  SET_STRING_ELT(nms, 438, mkChar("ved"));
  SET_STRING_ELT(nms, 439, mkChar("vei"));
  SET_STRING_ELT(nms, 440, mkChar("ves"));
  SET_STRING_ELT(nms, 441, mkChar("vod"));
  SET_STRING_ELT(nms, 442, mkChar("vopn"));
  SET_STRING_ELT(nms, 443, mkChar("vos"));
  SET_STRING_ELT(nms, 444, mkChar("w"));
  SET_STRING_ELT(nms, 445, mkChar("wA"));
  SET_STRING_ELT(nms, 446, mkChar("wd"));
  SET_STRING_ELT(nms, 447, mkChar("wdA"));
  SET_STRING_ELT(nms, 448, mkChar("wdI"));
  SET_STRING_ELT(nms, 449, mkChar("wdS"));
  SET_STRING_ELT(nms, 450, mkChar("wdT"));
  SET_STRING_ELT(nms, 451, mkChar("wdU"));
  SET_STRING_ELT(nms, 452, mkChar("wI"));
  SET_STRING_ELT(nms, 453, mkChar("willing"));
  SET_STRING_ELT(nms, 454, mkChar("wS"));
  SET_STRING_ELT(nms, 455, mkChar("wT"));
  SET_STRING_ELT(nms, 456, mkChar("wU"));
  SET_STRING_ELT(nms, 457, mkChar("xi"));
...
SEXP model_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->offset_output_lambda = internal->dim_eta + internal->dim_N + 3;
...
SEXP model_metadata(SEXP internal_p) {
  ...
  int * dim_lambda = INTEGER(VECTOR_ELT(output_length, 5));
  ...
  SET_STRING_ELT(output_names, 5, mkChar("lambda"));
