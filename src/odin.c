...
void model_finalise(SEXP internal_p) {
  ...
  if (internal_p) {
    ...
    Free(internal->initial_cum_diag_a);
    Free(internal->initial_cum_diag_s);
    Free(internal->initial_cum_entrants);
    Free(internal->initial_cum_incid);
...
SEXP model_contents(SEXP internal_p) {
  ...
  SET_VECTOR_ELT(contents, 19, ScalarInteger(internal->dim_cum_entrants));
  SET_VECTOR_ELT(contents, 20, ScalarInteger(internal->dim_cum_entrants_1));
  SET_VECTOR_ELT(contents, 21, ScalarInteger(internal->dim_cum_entrants_2));
  SET_VECTOR_ELT(contents, 22, ScalarInteger(internal->dim_cum_incid));
  SET_VECTOR_ELT(contents, 23, ScalarInteger(internal->dim_cum_incid_1));
  SET_VECTOR_ELT(contents, 24, ScalarInteger(internal->dim_cum_incid_2));
  SET_VECTOR_ELT(contents, 25, ScalarInteger(internal->dim_cum_offered));
  SET_VECTOR_ELT(contents, 26, ScalarInteger(internal->dim_cum_offered_1));
  SET_VECTOR_ELT(contents, 27, ScalarInteger(internal->dim_cum_offered_2));
  ...
  SET_VECTOR_ELT(contents, 126, ScalarInteger(internal->dim_u_2));
  SET_VECTOR_ELT(contents, 127, ScalarInteger(internal->dim_U_2));
  SET_VECTOR_ELT(contents, 128, ScalarInteger(internal->dim_U0));
  SET_VECTOR_ELT(contents, 129, ScalarInteger(internal->dim_U0_1));
  SET_VECTOR_ELT(contents, 130, ScalarInteger(internal->dim_U0_2));
  SET_VECTOR_ELT(contents, 131, ScalarInteger(internal->dim_vax_t));
  SET_VECTOR_ELT(contents, 132, ScalarInteger(internal->dim_vax_y));
  SET_VECTOR_ELT(contents, 133, ScalarInteger(internal->dim_vbe));
  SET_VECTOR_ELT(contents, 134, ScalarInteger(internal->dim_vbe_1));
  SET_VECTOR_ELT(contents, 135, ScalarInteger(internal->dim_vbe_12));
  SET_VECTOR_ELT(contents, 136, ScalarInteger(internal->dim_vbe_2));
  SET_VECTOR_ELT(contents, 137, ScalarInteger(internal->dim_vbe_3));
  SET_VECTOR_ELT(contents, 138, ScalarInteger(internal->dim_vea));
  SET_VECTOR_ELT(contents, 139, ScalarInteger(internal->dim_ved));
  SET_VECTOR_ELT(contents, 140, ScalarInteger(internal->dim_vei));
  SET_VECTOR_ELT(contents, 141, ScalarInteger(internal->dim_ves));
  SET_VECTOR_ELT(contents, 142, ScalarInteger(internal->dim_vod));
  SET_VECTOR_ELT(contents, 143, ScalarInteger(internal->dim_vod_1));
  SET_VECTOR_ELT(contents, 144, ScalarInteger(internal->dim_vod_12));
  SET_VECTOR_ELT(contents, 145, ScalarInteger(internal->dim_vod_2));
  SET_VECTOR_ELT(contents, 146, ScalarInteger(internal->dim_vod_3));
  SET_VECTOR_ELT(contents, 147, ScalarInteger(internal->dim_vos));
  SET_VECTOR_ELT(contents, 148, ScalarInteger(internal->dim_vos_1));
  SET_VECTOR_ELT(contents, 149, ScalarInteger(internal->dim_vos_12));
  SET_VECTOR_ELT(contents, 150, ScalarInteger(internal->dim_vos_2));
  SET_VECTOR_ELT(contents, 151, ScalarInteger(internal->dim_vos_3));
  SET_VECTOR_ELT(contents, 152, ScalarInteger(internal->dim_w));
  SET_VECTOR_ELT(contents, 153, ScalarInteger(internal->dim_w_1));
  SET_VECTOR_ELT(contents, 154, ScalarInteger(internal->dim_w_2));
  SET_VECTOR_ELT(contents, 155, ScalarInteger(internal->dim_wA));
  SET_VECTOR_ELT(contents, 156, ScalarInteger(internal->dim_wA_1));
  SET_VECTOR_ELT(contents, 157, ScalarInteger(internal->dim_wA_12));
  SET_VECTOR_ELT(contents, 158, ScalarInteger(internal->dim_wA_2));
  SET_VECTOR_ELT(contents, 159, ScalarInteger(internal->dim_wA_3));
  SET_VECTOR_ELT(contents, 160, ScalarInteger(internal->dim_wI));
  SET_VECTOR_ELT(contents, 161, ScalarInteger(internal->dim_wI_1));
  SET_VECTOR_ELT(contents, 162, ScalarInteger(internal->dim_wI_12));
  SET_VECTOR_ELT(contents, 163, ScalarInteger(internal->dim_wI_2));
  SET_VECTOR_ELT(contents, 164, ScalarInteger(internal->dim_wI_3));
  SET_VECTOR_ELT(contents, 165, ScalarInteger(internal->dim_willing));
  SET_VECTOR_ELT(contents, 166, ScalarInteger(internal->dim_wS));
  SET_VECTOR_ELT(contents, 167, ScalarInteger(internal->dim_wS_1));
  SET_VECTOR_ELT(contents, 168, ScalarInteger(internal->dim_wS_12));
  SET_VECTOR_ELT(contents, 169, ScalarInteger(internal->dim_wS_2));
  SET_VECTOR_ELT(contents, 170, ScalarInteger(internal->dim_wS_3));
  SET_VECTOR_ELT(contents, 171, ScalarInteger(internal->dim_wT));
  SET_VECTOR_ELT(contents, 172, ScalarInteger(internal->dim_wT_1));
  SET_VECTOR_ELT(contents, 173, ScalarInteger(internal->dim_wT_12));
  SET_VECTOR_ELT(contents, 174, ScalarInteger(internal->dim_wT_2));
  SET_VECTOR_ELT(contents, 175, ScalarInteger(internal->dim_wT_3));
  ...
  SET_VECTOR_ELT(contents, 179, ScalarInteger(internal->dim_wU_2));
  SET_VECTOR_ELT(contents, 180, ScalarInteger(internal->dim_wU_3));
  SET_VECTOR_ELT(contents, 181, ScalarReal(internal->enr));
  ...
  SET_VECTOR_ELT(contents, 182, entrants);
  SET_VECTOR_ELT(contents, 183, ScalarReal(internal->epsilon));
  SEXP eta = PROTECT(allocVector(REALSXP, internal->dim_eta));
  memcpy(REAL(eta), internal->eta, internal->dim_eta * sizeof(double));
  SET_VECTOR_ELT(contents, 184, eta);
  ...
  SET_VECTOR_ELT(contents, 185, eta_h_t);
  ...
  SET_VECTOR_ELT(contents, 186, eta_l_t);
  ...
  SET_VECTOR_ELT(contents, 188, foi_LH);
  SEXP I0 = PROTECT(allocVector(REALSXP, internal->dim_I0));
  memcpy(REAL(I0), internal->I0, internal->dim_I0 * sizeof(double));
  odin_set_dim(I0, 2, internal->dim_I0_1, internal->dim_I0_2);
  ...
  memcpy(REAL(initial_A), internal->initial_A, internal->dim_A * sizeof(double));
  odin_set_dim(initial_A, 2, internal->dim_A_1, internal->dim_A_2);
  SET_VECTOR_ELT(contents, 190, initial_A);
  SEXP initial_cum_diag_a = PROTECT(allocVector(REALSXP, internal->dim_cum_diag_a));
  memcpy(REAL(initial_cum_diag_a), internal->initial_cum_diag_a, internal->dim_cum_diag_a * sizeof(double));
  odin_set_dim(initial_cum_diag_a, 2, internal->dim_cum_diag_a_1, internal->dim_cum_diag_a_2);
  SET_VECTOR_ELT(contents, 191, initial_cum_diag_a);
  SEXP initial_cum_diag_s = PROTECT(allocVector(REALSXP, internal->dim_cum_diag_s));
  memcpy(REAL(initial_cum_diag_s), internal->initial_cum_diag_s, internal->dim_cum_diag_s * sizeof(double));
  odin_set_dim(initial_cum_diag_s, 2, internal->dim_cum_diag_s_1, internal->dim_cum_diag_s_2);
  SET_VECTOR_ELT(contents, 192, initial_cum_diag_s);
  ...
  SET_VECTOR_ELT(contents, 193, initial_cum_entrants);
  SEXP initial_cum_incid = PROTECT(allocVector(REALSXP, internal->dim_cum_incid));
  memcpy(REAL(initial_cum_incid), internal->initial_cum_incid, internal->dim_cum_incid * sizeof(double));
  odin_set_dim(initial_cum_incid, 2, internal->dim_cum_incid_1, internal->dim_cum_incid_2);
  SET_VECTOR_ELT(contents, 194, initial_cum_incid);
  ...
  SET_VECTOR_ELT(contents, 195, initial_cum_offered);
  SEXP initial_cum_screened = PROTECT(allocVector(REALSXP, internal->dim_cum_screened));
  memcpy(REAL(initial_cum_screened), internal->initial_cum_screened, internal->dim_cum_screened * sizeof(double));
  odin_set_dim(initial_cum_screened, 2, internal->dim_cum_screened_1, internal->dim_cum_screened_2);
  ...
  SET_VECTOR_ELT(contents, 199, initial_cum_vbe);
  SEXP initial_I = PROTECT(allocVector(REALSXP, internal->dim_I));
  memcpy(REAL(initial_I), internal->initial_I, internal->dim_I * sizeof(double));
  odin_set_dim(initial_I, 2, internal->dim_I_1, internal->dim_I_2);
  SET_VECTOR_ELT(contents, 200, initial_I);
  SEXP initial_S = PROTECT(allocVector(REALSXP, internal->dim_S));
  memcpy(REAL(initial_S), internal->initial_S, internal->dim_S * sizeof(double));
  odin_set_dim(initial_S, 2, internal->dim_S_1, internal->dim_S_2);
  SET_VECTOR_ELT(contents, 201, initial_S);
  SEXP initial_T = PROTECT(allocVector(REALSXP, internal->dim_T));
  memcpy(REAL(initial_T), internal->initial_T, internal->dim_T * sizeof(double));
  odin_set_dim(initial_T, 2, internal->dim_T_1, internal->dim_T_2);
  SET_VECTOR_ELT(contents, 202, initial_T);
  SEXP initial_U = PROTECT(allocVector(REALSXP, internal->dim_U));
  memcpy(REAL(initial_U), internal->initial_U, internal->dim_U * sizeof(double));
  odin_set_dim(initial_U, 2, internal->dim_U_1, internal->dim_U_2);
  SET_VECTOR_ELT(contents, 203, initial_U);
  ...
  SET_VECTOR_ELT(contents, 208, lambda);
  SET_VECTOR_ELT(contents, 209, ScalarReal(internal->mu));
  SEXP N = PROTECT(allocVector(REALSXP, internal->dim_N));
  memcpy(REAL(N), internal->N, internal->dim_N * sizeof(double));
  odin_set_dim(N, 2, internal->dim_N_1, internal->dim_N_2);
  SET_VECTOR_ELT(contents, 210, N);
  SEXP n_AT = PROTECT(allocVector(REALSXP, internal->dim_n_AT));
  memcpy(REAL(n_AT), internal->n_AT, internal->dim_n_AT * sizeof(double));
  odin_set_dim(n_AT, 2, internal->dim_n_AT_1, internal->dim_n_AT_2);
  SET_VECTOR_ELT(contents, 211, n_AT);
  SEXP n_AU = PROTECT(allocVector(REALSXP, internal->dim_n_AU));
  memcpy(REAL(n_AU), internal->n_AU, internal->dim_n_AU * sizeof(double));
  odin_set_dim(n_AU, 2, internal->dim_n_AU_1, internal->dim_n_AU_2);
  SET_VECTOR_ELT(contents, 212, n_AU);
  SET_VECTOR_ELT(contents, 213, ScalarInteger(internal->n_group));
  ...
  SET_VECTOR_ELT(contents, 214, n_obe);
  ...
  SET_VECTOR_ELT(contents, 215, n_ood);
  ...
  SET_VECTOR_ELT(contents, 216, n_oos);
  SEXP n_ST = PROTECT(allocVector(REALSXP, internal->dim_n_ST));
  memcpy(REAL(n_ST), internal->n_ST, internal->dim_n_ST * sizeof(double));
  odin_set_dim(n_ST, 2, internal->dim_n_ST_1, internal->dim_n_ST_2);
  SET_VECTOR_ELT(contents, 217, n_ST);
  SEXP n_TU = PROTECT(allocVector(REALSXP, internal->dim_n_TU));
  memcpy(REAL(n_TU), internal->n_TU, internal->dim_n_TU * sizeof(double));
  odin_set_dim(n_TU, 2, internal->dim_n_TU_1, internal->dim_n_TU_2);
  SET_VECTOR_ELT(contents, 218, n_TU);
  SEXP n_UI = PROTECT(allocVector(REALSXP, internal->dim_n_UI));
  memcpy(REAL(n_UI), internal->n_UI, internal->dim_n_UI * sizeof(double));
  odin_set_dim(n_UI, 2, internal->dim_n_UI_1, internal->dim_n_UI_2);
  SET_VECTOR_ELT(contents, 219, n_UI);
  SET_VECTOR_ELT(contents, 220, ScalarInteger(internal->n_vax));
  ...
  SET_VECTOR_ELT(contents, 221, n_vbe);
  ...
  SET_VECTOR_ELT(contents, 222, n_vod);
  ...
  SET_VECTOR_ELT(contents, 223, n_vos);
  SEXP Np = PROTECT(allocVector(REALSXP, internal->dim_Np));
  memcpy(REAL(Np), internal->Np, internal->dim_Np * sizeof(double));
  SET_VECTOR_ELT(contents, 224, Np);
  SET_VECTOR_ELT(contents, 225, ScalarReal(internal->nu));
  SET_VECTOR_ELT(contents, 226, ScalarInteger(internal->offset_output_lambda));
  SET_VECTOR_ELT(contents, 227, ScalarInteger(internal->offset_output_N));
  SET_VECTOR_ELT(contents, 228, ScalarInteger(internal->offset_variable_A));
  SET_VECTOR_ELT(contents, 229, ScalarInteger(internal->offset_variable_cum_diag_a));
  SET_VECTOR_ELT(contents, 230, ScalarInteger(internal->offset_variable_cum_diag_s));
  SET_VECTOR_ELT(contents, 231, ScalarInteger(internal->offset_variable_cum_entrants));
  SET_VECTOR_ELT(contents, 232, ScalarInteger(internal->offset_variable_cum_incid));
  SET_VECTOR_ELT(contents, 233, ScalarInteger(internal->offset_variable_cum_offered));
  SET_VECTOR_ELT(contents, 234, ScalarInteger(internal->offset_variable_cum_screened));
  SET_VECTOR_ELT(contents, 235, ScalarInteger(internal->offset_variable_cum_treated));
  SET_VECTOR_ELT(contents, 236, ScalarInteger(internal->offset_variable_cum_vaccinated));
  SET_VECTOR_ELT(contents, 237, ScalarInteger(internal->offset_variable_cum_vbe));
  SET_VECTOR_ELT(contents, 238, ScalarInteger(internal->offset_variable_S));
  SET_VECTOR_ELT(contents, 239, ScalarInteger(internal->offset_variable_T));
  SEXP p = PROTECT(allocVector(REALSXP, internal->dim_p));
  memcpy(REAL(p), internal->p, internal->dim_p * sizeof(double));
  SET_VECTOR_ELT(contents, 240, p);
  ...
  SET_VECTOR_ELT(contents, 241, prop_C);
  SET_VECTOR_ELT(contents, 242, ScalarReal(internal->psi));
  SEXP q = PROTECT(allocVector(REALSXP, internal->dim_q));
  memcpy(REAL(q), internal->q, internal->dim_q * sizeof(double));
  SET_VECTOR_ELT(contents, 243, q);
  SET_VECTOR_ELT(contents, 244, ScalarReal(internal->rho));
  SEXP S0 = PROTECT(allocVector(REALSXP, internal->dim_S0));
  memcpy(REAL(S0), internal->S0, internal->dim_S0 * sizeof(double));
  odin_set_dim(S0, 2, internal->dim_S0_1, internal->dim_S0_2);
  SET_VECTOR_ELT(contents, 245, S0);
  SEXP screened = PROTECT(allocVector(REALSXP, internal->dim_screened));
  memcpy(REAL(screened), internal->screened, internal->dim_screened * sizeof(double));
  odin_set_dim(screened, 2, internal->dim_screened_1, internal->dim_screened_2);
  SET_VECTOR_ELT(contents, 246, screened);
  SET_VECTOR_ELT(contents, 247, ScalarReal(internal->sigma));
  SEXP T0 = PROTECT(allocVector(REALSXP, internal->dim_T0));
  memcpy(REAL(T0), internal->T0, internal->dim_T0 * sizeof(double));
  odin_set_dim(T0, 2, internal->dim_T0_1, internal->dim_T0_2);
  SET_VECTOR_ELT(contents, 248, T0);
  SEXP tt = PROTECT(allocVector(REALSXP, internal->dim_tt));
  memcpy(REAL(tt), internal->tt, internal->dim_tt * sizeof(double));
  SET_VECTOR_ELT(contents, 249, tt);
  ...
  SET_VECTOR_ELT(contents, 250, u);
  SET_VECTOR_ELT(contents, 251, ScalarReal(internal->u_vbe));
  SEXP U0 = PROTECT(allocVector(REALSXP, internal->dim_U0));
  memcpy(REAL(U0), internal->U0, internal->dim_U0 * sizeof(double));
  odin_set_dim(U0, 2, internal->dim_U0_1, internal->dim_U0_2);
  SET_VECTOR_ELT(contents, 252, U0);
  ...
  SET_VECTOR_ELT(contents, 253, vax_t);
  ...
  SET_VECTOR_ELT(contents, 254, vax_y);
  ...
  SET_VECTOR_ELT(contents, 255, vbe);
  SEXP vea = PROTECT(allocVector(REALSXP, internal->dim_vea));
  memcpy(REAL(vea), internal->vea, internal->dim_vea * sizeof(double));
  SET_VECTOR_ELT(contents, 256, vea);
  SEXP ved = PROTECT(allocVector(REALSXP, internal->dim_ved));
  memcpy(REAL(ved), internal->ved, internal->dim_ved * sizeof(double));
  SET_VECTOR_ELT(contents, 257, ved);
  SEXP vei = PROTECT(allocVector(REALSXP, internal->dim_vei));
  memcpy(REAL(vei), internal->vei, internal->dim_vei * sizeof(double));
  SET_VECTOR_ELT(contents, 258, vei);
  SEXP ves = PROTECT(allocVector(REALSXP, internal->dim_ves));
  memcpy(REAL(ves), internal->ves, internal->dim_ves * sizeof(double));
  SET_VECTOR_ELT(contents, 259, ves);
  ...
  SET_VECTOR_ELT(contents, 260, vod);
  ...
  SET_VECTOR_ELT(contents, 261, vos);
  SEXP w = PROTECT(allocVector(REALSXP, internal->dim_w));
  memcpy(REAL(w), internal->w, internal->dim_w * sizeof(double));
  odin_set_dim(w, 2, internal->dim_w_1, internal->dim_w_2);
  SET_VECTOR_ELT(contents, 262, w);
  SEXP wA = PROTECT(allocVector(REALSXP, internal->dim_wA));
  memcpy(REAL(wA), internal->wA, internal->dim_wA * sizeof(double));
  odin_set_dim(wA, 3, internal->dim_wA_1, internal->dim_wA_2, internal->dim_wA_3);
  SET_VECTOR_ELT(contents, 263, wA);
  SEXP wI = PROTECT(allocVector(REALSXP, internal->dim_wI));
  memcpy(REAL(wI), internal->wI, internal->dim_wI * sizeof(double));
  odin_set_dim(wI, 3, internal->dim_wI_1, internal->dim_wI_2, internal->dim_wI_3);
  SET_VECTOR_ELT(contents, 264, wI);
  ...
  SET_VECTOR_ELT(contents, 265, willing);
  SEXP wS = PROTECT(allocVector(REALSXP, internal->dim_wS));
  memcpy(REAL(wS), internal->wS, internal->dim_wS * sizeof(double));
  odin_set_dim(wS, 3, internal->dim_wS_1, internal->dim_wS_2, internal->dim_wS_3);
  SET_VECTOR_ELT(contents, 266, wS);
  SEXP wT = PROTECT(allocVector(REALSXP, internal->dim_wT));
  memcpy(REAL(wT), internal->wT, internal->dim_wT * sizeof(double));
  odin_set_dim(wT, 3, internal->dim_wT_1, internal->dim_wT_2, internal->dim_wT_3);
  SET_VECTOR_ELT(contents, 267, wT);
  SEXP wU = PROTECT(allocVector(REALSXP, internal->dim_wU));
  memcpy(REAL(wU), internal->wU, internal->dim_wU * sizeof(double));
  odin_set_dim(wU, 3, internal->dim_wU_1, internal->dim_wU_2, internal->dim_wU_3);
  SET_VECTOR_ELT(contents, 268, wU);
  ...
  SET_STRING_ELT(nms, 19, mkChar("dim_cum_entrants"));
  SET_STRING_ELT(nms, 20, mkChar("dim_cum_entrants_1"));
  SET_STRING_ELT(nms, 21, mkChar("dim_cum_entrants_2"));
  SET_STRING_ELT(nms, 22, mkChar("dim_cum_incid"));
  SET_STRING_ELT(nms, 23, mkChar("dim_cum_incid_1"));
  SET_STRING_ELT(nms, 24, mkChar("dim_cum_incid_2"));
  SET_STRING_ELT(nms, 25, mkChar("dim_cum_offered"));
  SET_STRING_ELT(nms, 26, mkChar("dim_cum_offered_1"));
  SET_STRING_ELT(nms, 27, mkChar("dim_cum_offered_2"));
  ...
  SET_STRING_ELT(nms, 126, mkChar("dim_u_2"));
  SET_STRING_ELT(nms, 127, mkChar("dim_U_2"));
  SET_STRING_ELT(nms, 128, mkChar("dim_U0"));
  SET_STRING_ELT(nms, 129, mkChar("dim_U0_1"));
  SET_STRING_ELT(nms, 130, mkChar("dim_U0_2"));
  SET_STRING_ELT(nms, 131, mkChar("dim_vax_t"));
  SET_STRING_ELT(nms, 132, mkChar("dim_vax_y"));
  SET_STRING_ELT(nms, 133, mkChar("dim_vbe"));
  SET_STRING_ELT(nms, 134, mkChar("dim_vbe_1"));
  SET_STRING_ELT(nms, 135, mkChar("dim_vbe_12"));
  SET_STRING_ELT(nms, 136, mkChar("dim_vbe_2"));
  SET_STRING_ELT(nms, 137, mkChar("dim_vbe_3"));
  SET_STRING_ELT(nms, 138, mkChar("dim_vea"));
  SET_STRING_ELT(nms, 139, mkChar("dim_ved"));
  SET_STRING_ELT(nms, 140, mkChar("dim_vei"));
  SET_STRING_ELT(nms, 141, mkChar("dim_ves"));
  SET_STRING_ELT(nms, 142, mkChar("dim_vod"));
  SET_STRING_ELT(nms, 143, mkChar("dim_vod_1"));
  SET_STRING_ELT(nms, 144, mkChar("dim_vod_12"));
  SET_STRING_ELT(nms, 145, mkChar("dim_vod_2"));
  SET_STRING_ELT(nms, 146, mkChar("dim_vod_3"));
  SET_STRING_ELT(nms, 147, mkChar("dim_vos"));
  SET_STRING_ELT(nms, 148, mkChar("dim_vos_1"));
  SET_STRING_ELT(nms, 149, mkChar("dim_vos_12"));
  SET_STRING_ELT(nms, 150, mkChar("dim_vos_2"));
  SET_STRING_ELT(nms, 151, mkChar("dim_vos_3"));
  SET_STRING_ELT(nms, 152, mkChar("dim_w"));
  SET_STRING_ELT(nms, 153, mkChar("dim_w_1"));
  SET_STRING_ELT(nms, 154, mkChar("dim_w_2"));
  SET_STRING_ELT(nms, 155, mkChar("dim_wA"));
  SET_STRING_ELT(nms, 156, mkChar("dim_wA_1"));
  SET_STRING_ELT(nms, 157, mkChar("dim_wA_12"));
  SET_STRING_ELT(nms, 158, mkChar("dim_wA_2"));
  SET_STRING_ELT(nms, 159, mkChar("dim_wA_3"));
  SET_STRING_ELT(nms, 160, mkChar("dim_wI"));
  SET_STRING_ELT(nms, 161, mkChar("dim_wI_1"));
  SET_STRING_ELT(nms, 162, mkChar("dim_wI_12"));
  SET_STRING_ELT(nms, 163, mkChar("dim_wI_2"));
  SET_STRING_ELT(nms, 164, mkChar("dim_wI_3"));
  SET_STRING_ELT(nms, 165, mkChar("dim_willing"));
  SET_STRING_ELT(nms, 166, mkChar("dim_wS"));
  SET_STRING_ELT(nms, 167, mkChar("dim_wS_1"));
  SET_STRING_ELT(nms, 168, mkChar("dim_wS_12"));
  SET_STRING_ELT(nms, 169, mkChar("dim_wS_2"));
  SET_STRING_ELT(nms, 170, mkChar("dim_wS_3"));
  SET_STRING_ELT(nms, 171, mkChar("dim_wT"));
  SET_STRING_ELT(nms, 172, mkChar("dim_wT_1"));
  SET_STRING_ELT(nms, 173, mkChar("dim_wT_12"));
  SET_STRING_ELT(nms, 174, mkChar("dim_wT_2"));
  SET_STRING_ELT(nms, 175, mkChar("dim_wT_3"));
  SET_STRING_ELT(nms, 176, mkChar("dim_wU"));
  SET_STRING_ELT(nms, 177, mkChar("dim_wU_1"));
  SET_STRING_ELT(nms, 178, mkChar("dim_wU_12"));
  SET_STRING_ELT(nms, 179, mkChar("dim_wU_2"));
  SET_STRING_ELT(nms, 180, mkChar("dim_wU_3"));
  SET_STRING_ELT(nms, 181, mkChar("enr"));
  SET_STRING_ELT(nms, 182, mkChar("entrants"));
  SET_STRING_ELT(nms, 183, mkChar("epsilon"));
  SET_STRING_ELT(nms, 184, mkChar("eta"));
  SET_STRING_ELT(nms, 185, mkChar("eta_h_t"));
  SET_STRING_ELT(nms, 186, mkChar("eta_l_t"));
  SET_STRING_ELT(nms, 187, mkChar("exr"));
  SET_STRING_ELT(nms, 188, mkChar("foi_LH"));
  SET_STRING_ELT(nms, 189, mkChar("I0"));
  SET_STRING_ELT(nms, 190, mkChar("initial_A"));
  SET_STRING_ELT(nms, 191, mkChar("initial_cum_diag_a"));
  SET_STRING_ELT(nms, 192, mkChar("initial_cum_diag_s"));
  SET_STRING_ELT(nms, 193, mkChar("initial_cum_entrants"));
  SET_STRING_ELT(nms, 194, mkChar("initial_cum_incid"));
  SET_STRING_ELT(nms, 195, mkChar("initial_cum_offered"));
  ...
  SET_STRING_ELT(nms, 199, mkChar("initial_cum_vbe"));
  SET_STRING_ELT(nms, 200, mkChar("initial_I"));
  SET_STRING_ELT(nms, 201, mkChar("initial_S"));
  SET_STRING_ELT(nms, 202, mkChar("initial_T"));
  SET_STRING_ELT(nms, 203, mkChar("initial_U"));
  SET_STRING_ELT(nms, 204, mkChar("interpolate_beta"));
  SET_STRING_ELT(nms, 205, mkChar("interpolate_eta_h"));
  SET_STRING_ELT(nms, 206, mkChar("interpolate_eta_l"));
  SET_STRING_ELT(nms, 207, mkChar("interpolate_vax_switch"));
  SET_STRING_ELT(nms, 208, mkChar("lambda"));
  SET_STRING_ELT(nms, 209, mkChar("mu"));
  SET_STRING_ELT(nms, 210, mkChar("N"));
  SET_STRING_ELT(nms, 211, mkChar("n_AT"));
  SET_STRING_ELT(nms, 212, mkChar("n_AU"));
  SET_STRING_ELT(nms, 213, mkChar("n_group"));
  SET_STRING_ELT(nms, 214, mkChar("n_obe"));
  SET_STRING_ELT(nms, 215, mkChar("n_ood"));
  SET_STRING_ELT(nms, 216, mkChar("n_oos"));
  SET_STRING_ELT(nms, 217, mkChar("n_ST"));
  SET_STRING_ELT(nms, 218, mkChar("n_TU"));
  SET_STRING_ELT(nms, 219, mkChar("n_UI"));
  SET_STRING_ELT(nms, 220, mkChar("n_vax"));
  SET_STRING_ELT(nms, 221, mkChar("n_vbe"));
  SET_STRING_ELT(nms, 222, mkChar("n_vod"));
  SET_STRING_ELT(nms, 223, mkChar("n_vos"));
  SET_STRING_ELT(nms, 224, mkChar("Np"));
  SET_STRING_ELT(nms, 225, mkChar("nu"));
  SET_STRING_ELT(nms, 226, mkChar("offset_output_lambda"));
  SET_STRING_ELT(nms, 227, mkChar("offset_output_N"));
  SET_STRING_ELT(nms, 228, mkChar("offset_variable_A"));
  SET_STRING_ELT(nms, 229, mkChar("offset_variable_cum_diag_a"));
  SET_STRING_ELT(nms, 230, mkChar("offset_variable_cum_diag_s"));
  SET_STRING_ELT(nms, 231, mkChar("offset_variable_cum_entrants"));
  SET_STRING_ELT(nms, 232, mkChar("offset_variable_cum_incid"));
  SET_STRING_ELT(nms, 233, mkChar("offset_variable_cum_offered"));
  SET_STRING_ELT(nms, 234, mkChar("offset_variable_cum_screened"));
  SET_STRING_ELT(nms, 235, mkChar("offset_variable_cum_treated"));
  SET_STRING_ELT(nms, 236, mkChar("offset_variable_cum_vaccinated"));
  SET_STRING_ELT(nms, 237, mkChar("offset_variable_cum_vbe"));
  SET_STRING_ELT(nms, 238, mkChar("offset_variable_S"));
  SET_STRING_ELT(nms, 239, mkChar("offset_variable_T"));
  SET_STRING_ELT(nms, 240, mkChar("p"));
  SET_STRING_ELT(nms, 241, mkChar("prop_C"));
  SET_STRING_ELT(nms, 242, mkChar("psi"));
  SET_STRING_ELT(nms, 243, mkChar("q"));
  SET_STRING_ELT(nms, 244, mkChar("rho"));
  SET_STRING_ELT(nms, 245, mkChar("S0"));
  SET_STRING_ELT(nms, 246, mkChar("screened"));
  SET_STRING_ELT(nms, 247, mkChar("sigma"));
  SET_STRING_ELT(nms, 248, mkChar("T0"));
  SET_STRING_ELT(nms, 249, mkChar("tt"));
  SET_STRING_ELT(nms, 250, mkChar("u"));
  SET_STRING_ELT(nms, 251, mkChar("u_vbe"));
  SET_STRING_ELT(nms, 252, mkChar("U0"));
  SET_STRING_ELT(nms, 253, mkChar("vax_t"));
  SET_STRING_ELT(nms, 254, mkChar("vax_y"));
  SET_STRING_ELT(nms, 255, mkChar("vbe"));
  SET_STRING_ELT(nms, 256, mkChar("vea"));
  SET_STRING_ELT(nms, 257, mkChar("ved"));
  SET_STRING_ELT(nms, 258, mkChar("vei"));
  SET_STRING_ELT(nms, 259, mkChar("ves"));
  SET_STRING_ELT(nms, 260, mkChar("vod"));
  SET_STRING_ELT(nms, 261, mkChar("vos"));
  SET_STRING_ELT(nms, 262, mkChar("w"));
  SET_STRING_ELT(nms, 263, mkChar("wA"));
  SET_STRING_ELT(nms, 264, mkChar("wI"));
  SET_STRING_ELT(nms, 265, mkChar("willing"));
  SET_STRING_ELT(nms, 266, mkChar("wS"));
  SET_STRING_ELT(nms, 267, mkChar("wT"));
  SET_STRING_ELT(nms, 268, mkChar("wU"));
  setAttrib(contents, R_NamesSymbol, nms);
  UNPROTECT(64);
  return contents;
}
SEXP model_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->initial_cum_diag_s = (double*) Calloc(internal->dim_cum_diag_s, double);
  Free(internal->initial_cum_entrants);
  internal->initial_cum_entrants = (double*) Calloc(internal->dim_cum_entrants, double);
  Free(internal->initial_cum_incid);
  internal->initial_cum_incid = (double*) Calloc(internal->dim_cum_incid, double);
  Free(internal->initial_cum_offered);
...
SEXP model_metadata(SEXP internal_p) {
  ...
  int * dim_cum_entrants = INTEGER(VECTOR_ELT(variable_length, 13));
  ...
  SET_STRING_ELT(variable_names, 13, mkChar("cum_entrants"));
  SET_VECTOR_ELT(ret, 0, variable_length);
  UNPROTECT(2);
